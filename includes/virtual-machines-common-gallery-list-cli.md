...
Você pode compartilhar imagens através de assinaturas usando rbac (Role-Based Access Control, controle de acesso baseado em função). Qualquer usuário que tenha permissões de leitura para uma versão de imagem, mesmo entre assinaturas, poderá implantar uma máquina virtual usando a versão da imagem.
