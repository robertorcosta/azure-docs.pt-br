...
| **Conta de armazenamento/Tipos de armazenamento com suporte** | **Blob de blocos** |**Bolha de página*** |**Arquivos Azure** |**Observações**|
| --- | --- | -- | -- | -- |
...
\**- Os dados carregados para blobs de página devem ser 512 bytes alinhados, como VHDs.*
