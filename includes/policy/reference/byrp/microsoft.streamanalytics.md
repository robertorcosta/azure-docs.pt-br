...
ms.locfileid: "94989778"
---
|Nome<br /><sub>(Portal do Azure)</sub> |Descrição |Efeito(s) |Versão<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Azure Stream Analytics trabalhos devem usar chaves gerenciadas pelo cliente para criptografar dados](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F87ba29ef-1ab3-4d82-b763-87fcd4f531f7) |Use chaves gerenciadas pelo cliente quando desejar armazenar com segurança quaisquer metadados e ativos de dados privados de seus trabalhos de Stream Analytics em sua conta de armazenamento. Isso lhe dá controle total sobre como seus dados de Stream Analytics são criptografados. |auditar, negar, desabilitado |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Stream%20Analytics/StreamAnalytics_CMK_Audit.json) |
