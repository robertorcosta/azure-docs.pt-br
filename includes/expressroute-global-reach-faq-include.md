...
O ExpressRoute Global Reach é suportado em [países/regiões ou lugares selecionados.](../articles/expressroute/expressroute-global-reach.md) Os circuitos ExpressRoute devem ser criados nos locais de peering nesses países/regiões ou lugares.
...
Sim, você pode, desde que os circuitos estejam nos países/regiões suportadas. Você precisa conectar dois circuitos do ExpressRoute por vez. Para criar uma rede de malha completa, você precisa enumerar todos os pares de circuitos e repetir a configuração. 
...
Não. Os dois circuitos precisam vir de locais de emparelhamento diferentes. Se um metrô em um país/região suportado tiver mais de um local de peering ExpressRoute, você pode conectar os circuitos ExpressRoute criados em diferentes locais de peering naquele metrô. 
...
A taxa de transferência de rede entre as redes locais, habilitadas pelo Alcance Global do ExpressRoute, é limitada pelo menor dos dois circuitos do ExpressRoute. O tráfego local-para-Azure e o tráfego local-para-local compartilham o mesmo circuito e estão sujeitos à mesma tampa de largura de banda. 
