...
Este exemplo implementa um dispositivo controlador de temperatura do IoT Plug and Play. Este exemplo implementa um modelo com [vários componentes](../articles/iot-pnp/concepts-components.md). O [arquivo de modelo de DTDL (linguagem de definição de Gêmeos Digitais) do dispositivo de temperatura](https://github.com/Azure/opendigitaltwins-dtdl/blob/master/DTDL/v2/samples/TemperatureController.json) define a telemetria, as propriedades e os comandos que o dispositivo implementa.
