...
---
Você é cobrado pelo Azure Storage com base no uso da sua conta de armazenamento. Todos os objetos em uma conta de armazenamento são cobrados juntos como um grupo. 
...
* **O tipo** de conta refere-se ao tipo de conta de armazenamento que você está usando. 
* **O nível de acesso** refere-se ao padrão de uso de dados especificado para sua conta de armazenamento v2 ou Blob de uso geral.
* **Capacidade de** armazenamento refere-se ao quanto do loteamento da sua conta de armazenamento você está usando para armazenar dados.
* A **replicação** determina quantas cópias dos seus dados serão mantidas de uma só vez e em quais locais.
* **As transações** referem-se a todas as operações de leitura e gravação no Azure Storage.
