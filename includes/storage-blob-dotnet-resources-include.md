...
- [Pacote (NuGet) para a versão 12. x-Preview](https://www.nuget.org/packages/Azure.Storage.Blobs)
- [Exemplos](https://azure.microsoft.com/resources/samples/?sort=0&service=storage&platform=dotnet&term=blob)
