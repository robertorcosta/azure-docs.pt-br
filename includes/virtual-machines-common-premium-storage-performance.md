...
| **Latency** |Tempo total para concluir uma solicitação de E/S no disco. |Média por Segundo do Disco/Leitura  <br>  Média por segundo do disco/Gravação |await  <br>  svctm |
...
| **Maximizar. Memória** |Quantidade de memória exigida para execução perfeita do aplicativo |% de Bytes Confirmados em Uso |Usar o vmstat |
| **Maximizar. CPUs** |Quantidade de CPU exigida para a execução perfeita do aplicativo |% do Tempo do Processador |%util |
...
| &nbsp; | **IOPS** | **Taxa de transferência** | **Latency** |
| --- | --- | --- | --- |
...
| CentOS | 6,5, 6,6, 6,7, 7,0 ou mais recente| &nbsp; | [LIS4 necessário](https://www.microsoft.com/download/details.aspx?id=55106) <br> *Confira a observação na próxima seção* |
