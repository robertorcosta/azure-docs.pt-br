...
| **Taxa de transferência** |Volume de dados lidos ou gravados no disco por segundo. |Bytes/s Lidos em Disco <br> Bytes Gravados no Disco/s |kB_read/s <br> kB_wrtn/s |
