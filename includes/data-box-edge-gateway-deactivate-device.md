...
Use o `Reset-HcsAppliance` cmdlet para apagar os discos de dados e o disco de inicialização ou apenas os discos de dados. As `ClearData` opções `BootDisk` e permitem apagar os discos de dados e o disco de inicialização, respectivamente.
