...
3. Clique no nome da conexão que você deseja verificar para abrir **Essentials**. No Essentials, você pode exibir mais informações sobre a conexão. O **Status** é 'Bem Sucedido' e 'Conectado' quando você fez uma conexão bem sucedida.
