...
As instâncias da série ESv3 apresentam os processadores Intel® Xeon® 8171M 2,1 GHz (Skylake) ou Intel® Xeon® E5-2673 v4 2,3 GHz (Broadwell) e podem atingir 3,5 GHz com a tecnologia Intel Turbo Boost 2,0 e usar o armazenamento Premium. As instâncias Ev3-series são ideais para aplicativos empresariais com uso intensivo de memória.
...
As instâncias da série Ev3 apresentam os processadores Intel® Xeon® 8171M 2,1 GHz (Skylake) ou Intel® Xeon® E5-2673 v4 2,3 GHz (Broadwell) e podem atingir 3,5 GHz com a tecnologia Intel Turbo Boost 2,0. As instâncias Ev3-series são ideais para aplicativos empresariais com uso intensivo de memória.
...
<sup>1</sup> A taxa de transferência máxima possível do disco (IOPS ou MBps) com uma VM da série DSv2 pode ser limitada pelo número, tamanho e distribuição dos discos anexados.  Para saber mais, consulte [Projetar para alto desempenho](../articles/virtual-machines/windows/premium-storage-performance.md).  
