...
1. Na guia **Visão geral**, selecione o link nomeado em **Grupo de Recursos**.
    ...
    ![Selecione o grupo de recursos para excluir a partir da página do aplicativo de funções.](./media/functions-cleanup-resources-vs-code/functions-app-delete-resource-group.png)
