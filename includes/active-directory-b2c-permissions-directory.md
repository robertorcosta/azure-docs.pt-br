...
1. Expanda o grupo de permissões apropriado e marque a caixa de seleção da permissão para conceder ao seu aplicativo de gerenciamento. Por exemplo:
    ...
    * **Diretório de diretório** > **. ReadWrite. All**: para cenários de migração de usuário ou de gerenciamento de usuário.
    * **Diretiva de política** > **. ReadWrite. TrustFramework**: para cenários de CI/CD (integração contínua/entrega contínua). Por exemplo, implantação de política personalizada com Azure Pipelines.
