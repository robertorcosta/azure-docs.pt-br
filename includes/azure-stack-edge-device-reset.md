...
2. Selecione **Redefinir dispositivo**.
    ...
    ![Redefinir dispositivo](media/azure-stack-edge-device-reset/device-reset-1.png)

3. Quando a confirmação for solicitada, examine o aviso e selecione **Sim** para continuar.

    ![Confirmar redefinição](media/azure-stack-edge-device-reset/device-reset-2.png)  
