...
Os preços diferem entre os SKUs de gateway. Para obter mais informações, consulte [PREÇOS do Gateway VPN](https://azure.microsoft.com/pricing/details/vpn-gateway).
