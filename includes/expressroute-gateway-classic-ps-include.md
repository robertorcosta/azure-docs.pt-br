...
> Para obter mais informações sobre como trabalhar com gateways em uma configuração coexista, consulte [Configurar conexões coexistentes.](../articles/expressroute/expressroute-howto-coexist-classic.md#gw)
