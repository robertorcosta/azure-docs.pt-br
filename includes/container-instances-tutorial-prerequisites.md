...
**CLI do Azure**: você deve ter a CLI do Azure versão 2.0.29 ou posterior instalada no computador local. Execute `az --version` para encontrar a versão. Se você precisar instalar ou atualizar, confira [Instalar a CLI do Azure][azure-cli-install].
