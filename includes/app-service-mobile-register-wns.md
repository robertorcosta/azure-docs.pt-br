...
---
1. No Gerenciador de Soluções do Visual Studio, clique com o botão direito do mouse no projeto de aplicativo do Windows Store. Em seguida, **selecione Aplicativo** > **Associado da Loja com a Loja**.
...
5. Navegue até [Centro de Desenvolvimento do Windows](https://dev.windows.com/en-us/overview) e, em seguida, entre com sua conta da Microsoft. Em **Meus aplicativos**, selecione o novo registro do aplicativo. Em seguida, expanda > **as notificações push de** **serviços**.
