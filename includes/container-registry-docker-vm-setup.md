...
Siga as etapas em [Instalar a CLI do Azure com apt](/cli/azure/install-azure-cli-apt) para instalar a CLI do Azure em sua máquina virtual do Ubuntu. Por exemplo:
