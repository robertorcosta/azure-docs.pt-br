...
O [**Gerenciador de gêmeos (ADT) do Azure digital**](/samples/azure-samples/digital-twins-explorer/digital-twins-explorer/) é um aplicativo de exemplo para visualizar e trabalhar com o Azure digital gêmeos. Siga as instruções fornecidas com o exemplo para baixar e executar o código do aplicativo. 
...
:::image type="content" source="../articles/digital-twins/media/includes/azure-digital-twins-explorer.png" alt-text="Captura de tela do aplicativo de exemplo do explorador dos Gêmeos Digitais do Azure que mostra um grafo de nós representando os gêmeos digitais" lightbox="../articles/digital-twins/media/includes/azure-digital-twins-explorer.png":::
