...
* [**Azure Cosmos DB**](https://azure.microsoft.com/services/cosmos-db/): Um serviço de banco de dados escalável e totalmente indexado para dados semiestruturados que gerencia metadados para os dispositivos fornecidos, como atributos, configuração e propriedades de segurança. O Azure Cosmos DB oferece processamento de alto desempenho e alta produtividade, indexação de dados independente de esquema e uma interface de consulta SQL avançada.
