...
5. Para acessar rapidamente o cofre do painel, clique em **Fixar no painel** > **Criar**.
   ...
   ![Captura de tela das opções de criação do cofre dos Serviços de Recuperação.](./media/site-recovery-create-vault/new-vault-settings.png)
