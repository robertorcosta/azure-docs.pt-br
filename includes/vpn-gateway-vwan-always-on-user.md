...
1. Configure o cliente VPN Always On por meio do PowerShell, do Configuration Manager ou do Intune seguindo as instruções em [Configurar o cliente do Windows 10 Always on conexões VPN](/windows-server/remote/remote-access/vpn/always-on-vpn/deploy/vpn-deploy-client-vpn-connections).
