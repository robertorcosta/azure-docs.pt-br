...
* Usa o DPS para provisionar o dispositivo. As informações de provisionamento incluem a ID do modelo.
...
A função `provision_device` usa o DPS para provisionar o dispositivo e registrá-lo no IoT Central. A função inclui a ID do modelo de dispositivo no conteúdo de provisionamento:
