...
7. Selecione **Criar** para criar o hub. Depois de 30 minutos, clique em **Atualizar** para exibir o hub na página **Hubs**. Selecione **Ir para o recurso** para navegar até o recurso.