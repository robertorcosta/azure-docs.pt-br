...
ms.locfileid: "106491017"
---
## <a name="prerequisites"></a>Pré-requisitos

Para concluir as etapas deste artigo, você precisará do aplicativo do Azure IoT Central criado por meio do modelo de **Aplicativo Personalizado**. Para obter mais informações, consulte o [Criar um início rápido de aplicativo](../articles/iot-central/core/quick-deploy-iot-central.md). O aplicativo precisa ter sido criado em 14 de julho de 2020 ou após essa data.
...
Em `pnp_thermostat_component.c`, a função `PnP_ThermostatComponent_SendTelemetry` mostra como o dispositivo envia a telemetria de temperatura de um componente para o IoT Central:
