...
As camadas com transação otimizada, quentes e frias são armazenadas no mesmo hardware de armazenamento padrão. A principal diferença dessas três camadas são os preços de armazenamento de dados em repouso, que são menores nas camadas mais frias, e os preços de transação, que são mais altos nas camadas mais frias. Isso significa:
...
- A camada quente destina-se a cargas de trabalho ativas que não envolvem um grande número de transações e tem um preço de armazenamento de dados em repouso um pouco menor, porém, preços de transação ligeiramente mais altos comparado à camada com transação otimizada.
- A camada fria otimiza o preço das cargas de trabalho que não têm muita atividade, oferecendo o preço de armazenamento de dados em repouso mais baixo, porém, os preços de transação mais altos.

Seu nível de atividade e carga de trabalho determinará a camada mais econômica para o compartilhamento de arquivo padrão. Veja os preços exatos da região, da moeda e do nível de redundância desejados na [página de preços dos Arquivos do Azure](https://azure.microsoft.com/pricing/details/storage/files/).
