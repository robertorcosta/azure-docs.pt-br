...
ms.locfileid: "74980590"
---
## <a name="create-an-azure-resource"></a>Criar um recurso do Azure

Comece a usar a API de Pesquisa de Imagem do Bing criando um dos recursos do Azure abaixo.
...
* [Criar recurso de Pesquisa do Bing v7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7):
