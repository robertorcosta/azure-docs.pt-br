...
O ExpressRoute Direct fornece aos clientes a capacidade de conectar-se diretamente à rede global da Microsoft em locais de emparelhamento distribuídos estrategicamente no mundo todo. O ExpressRoute Direct oferece conectividade dupla de 100 ou 10 Gbps, que suporta conectividade Ativa/Ativa em escala. 
...
### <a name="what-locations-currently-support-expressroute-direct"></a>Quais locais atualmente suportam o ExpressRoute Direct? 
...
### <a name="when-does-billing-start-for-the-expressroute-direct-port-pairs"></a>Quando começa o faturamento dos pares de portas ExpressRoute Direct?
