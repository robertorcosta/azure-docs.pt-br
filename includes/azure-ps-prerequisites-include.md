...
> [!NOTE]
> É necessária uma conta do Azure para concluir essas etapas. Se você não tiver uma conta do Azure, poderá se inscrever para uma [avaliação gratuita](../articles/active-directory/fundamentals/sign-up-organization.md).
