...
- Verifique se as senhas do dispositivo são fortes e bem protegidas. Siga as [práticas recomendadas de senha](../articles/security/fundamentals/identity-management-best-practices.md#enable-password-management).