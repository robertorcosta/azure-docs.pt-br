...
2. Na listagem tabular das políticas, selecione e clique na política que você deseja modificar. Clique com o botão direito do mouse para invocar o menu de contexto e então selecione **Adicionar agenda**.
    ...
    ![Captura de tela mostra uma política de backup selecionada com adicionar agenda selecionada em um menu de contexto.](./media/storsimple-8000-add-modify-backup-schedule-u2/addschedule1.png)
...
3. Na folha **Adicionar agenda** , modifique o tipo de instantâneo, a frequência de backup, a retenção e a data e hora de início. Clique em **Adicionar**.
    ...
    ![Captura de tela mostra o painel Adicionar agenda com valores inseridos.](./media/storsimple-8000-add-modify-backup-schedule-u2/addschedule5.png)
...
4. Você será notificado quando a criação de política de backup for concluída. A lista de políticas de backup também é atualizada.
    ...
    ![Captura de tela mostra uma política de backup selecionada com dois backups agendados.](./media/storsimple-8000-add-modify-backup-schedule-u2/addschedule4.png)
