...
1. No portal do Azure, vá até a página **Grupo de recursos**. 
   ...
   ![Selecione o grupo de recursos para excluir a partir da página do aplicativo de funções.](./media/functions-quickstart-cleanup/functions-app-delete-resource-group.png)

   Para ir até essa página a partir do painel, selecione **Grupos de recursos** e depois selecione o grupo de recursos que você usou para esse guia de início rápido.
