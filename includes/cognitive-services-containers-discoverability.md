...
* [Como executar Contêineres de Serviços Cognitivos](https://azure.microsoft.com/blog/running-cognitive-service-containers/)
...
* Implantar os Serviços Cognitivos em qualquer computador que usa o Docker
* Implantar os Serviços Cognitivos no AKS
