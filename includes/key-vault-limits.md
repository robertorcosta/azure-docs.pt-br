...
### <a name="azure-private-link-integration"></a>Integração do Azure Private Link

| Recurso | Limite |
| -------- | ----- |
| Pontos finais privados por cofre de chaves | 64 |
| Cofres-chave com pontos finais privados por assinatura | 64 |
