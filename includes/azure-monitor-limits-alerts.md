...
| Configurações de autoescala |100 por região e assinatura. | Igual ao padrão |
| Perfis de dimensionamento automático |20 perfis por configuração de dimensionamento automático. | Igual ao padrão |
