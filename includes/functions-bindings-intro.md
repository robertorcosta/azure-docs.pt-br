...
* [Azure Functions referência do desenvolvedor.](../articles/azure-functions/functions-reference.md)
* Referência específica a um idioma: [c#](../articles/azure-functions/functions-dotnet-class-library.md), [script c#](../articles/azure-functions/functions-reference-csharp.md), [F #](../articles/azure-functions/functions-reference-fsharp.md), [Java](../articles/azure-functions/functions-reference-java.md), [JavaScript](../articles/azure-functions/functions-reference-node.md)ou [Python](../articles/azure-functions/functions-reference-python.md).
* [Conceitos de Azure Functions de gatilhos e associações.](../articles/azure-functions/functions-triggers-bindings.md)
* [Código e teste Azure Functions localmente.](../articles/azure-functions/functions-develop-local.md)
