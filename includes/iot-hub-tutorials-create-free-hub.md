...
1. Na guia **Básico**, preencha os campos da seguinte maneira:
   ...
   ![Criar um hub no portal do Azure](media/iot-hub-tutorials-create-free-hub/hub-definition-basics.png)
...
1. Selecione **Avançar: Rede** para continuar criando o hub.
   ...
   ![Escolha os pontos de extremidade que podem se conectar](media/iot-hub-tutorials-create-free-hub/hub-definition-networking.png)

1. Selecione **Avançar: Gerenciamento** para continuar criando o hub.

    ![Definir o tamanho e a escala para um novo hub usando o portal do Azure](media/iot-hub-tutorials-create-free-hub/hub-definition-management.png)
...
1.  Selecione **Avançar: Marcas** para avançar para a próxima tela.
    ...
    ![Atribuir marcas para o hub usando o portal do Azure](media/iot-hub-tutorials-create-free-hub/hub-definition-tags.png)
...
1.  Selecione **Avançar: Analisar + criar** para examinar suas escolhas. Você verá algo semelhante a esta tela, mas com os valores que você selecionou ao criar o hub.
    ...
    ![Examinar informações para criar o hub](media/iot-hub-tutorials-create-free-hub/hub-definition-create.png)
