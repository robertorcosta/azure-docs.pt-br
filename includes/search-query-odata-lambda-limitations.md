...
| `Collection(Edm.String)` | Comparações `eq` com ou`search.in` <br/><br/> Combinando subexpressãos com`or` | Comparações `ne` com ou`not search.in()` <br/><br/> Combinando subexpressãos com`and` |
