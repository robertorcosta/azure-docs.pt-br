...
**2. Os clientes podem criar aplicativos usando um Azure Cosmos DB SDK aposentado "a ser" aposentado durante o período de 12 meses?** 
...
**3. Os clientes podem autorizar e modificar aplicativos usando um Azure Cosmos DB SDK aposentado após o período de notificação de 12 meses?**
...
**4. O que acontece com os aplicativos em execução do Cliente que estão usando a versão SDK do Azure Cosmos SDK sem suporte?**

As tentativas de conexão com o serviço do Azure Cosmos DB com uma versão de SDK desativada serão recusadas. 

**5. Novos recursos e funcionalidades serão aplicados a todos os SDKs não aposentados?**
...
**6. O que devo fazer se não puder atualizar meu aplicativo antes de uma data de corte?**
