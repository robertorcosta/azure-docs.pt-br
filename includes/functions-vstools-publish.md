...
1. Em **Instância de Função**, selecione **Criar uma Função do Azure...** e use os valores especificados na seguinte tabela:
    ...
    | **[Tipo de Plano](../articles/azure-functions/functions-scale.md)** | Consumo | Quando você publica seu projeto em um aplicativo de funções executado em um [Plano de consumo](../articles/azure-functions/functions-scale.md#consumption-plan), você paga apenas pelas execuções do seu aplicativo de funções. Outros planos de hospedagem incorrem em custos mais altos. |
