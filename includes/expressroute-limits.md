...
| Número máximo de circuitos do ExpressRoute vinculados a um gateway de desempenho padrão/ErGw1AZ |4 | 
| Número máximo de circuitos do ExpressRoute vinculados a um gateway de alto desempenho/ErGw2AZ |8 | 
| Número máximo de circuitos do ExpressRoute vinculados a um gateway de ultradesempenho/ErGw3AZ |16 | 
| Número máximo de circuitos do ExpressRoute vinculados à mesma rede virtual em diferentes locais de emparelhamento (todos os SKUs) |4 |
