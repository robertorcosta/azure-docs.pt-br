...
| Tamanho máximo do esquema de API usado pela [política de validação](../articles/api-management/validation-policies.md)<sup>10</sup> | 4 MB |
| Tamanho máximo do corpo da solicitação ou da resposta na [política de validação de conteúdo](../articles/api-management/validation-policies.md#validate-content) | 100 KB |
...
<sup>10</sup> Para aumentar o limite, entre em contato com o [suporte](https://azure.microsoft.com/support/options/).<br/>
