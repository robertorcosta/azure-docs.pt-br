...
| Limite máximo de fluxos de trabalho|1 MiB|Um fluxo não pode ser maior do que 1 MB.|
...
| **Recurso** | **Limite**| **Observações** |
|---|---|---|
|Número de computadores por implantação de atualização|500||