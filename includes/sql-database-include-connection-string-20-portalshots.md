...
1. Selecione **Todos os serviços** > **de bancos de dados SQL**.
...
Para obter mais informações, consulte [strings e arquivos de configuração](https://msdn.microsoft.com/library/ms254494.aspx)de Conexão .
