...
|[JavaScript](../articles/azure-functions/functions-reference-node.md#node-version)|GA (Nó 6)|GA (Nó 8 e 10)| GA (Nó 10 e 12) |
...
|[Python](../articles/azure-functions/functions-reference-python.md)#versão-de-python|N/D|GA (Python 3.6 e 3.7)| GA (Python 3.6, 3.7 e 3.8)|
|[TypeScript](../articles/azure-functions/functions-reference-node.md#typescript) |N/D|GA<sup>1</sup>| GA<sup>1</sup> |


<sup>1</sup>Suporte por meio de transcompilação para JavaScript.
