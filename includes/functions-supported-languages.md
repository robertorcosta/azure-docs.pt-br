...
ms.locfileid: "96309691"
---
|Idioma                                 |1.x         |2. x| 3.x |
|-----------------------------------------|------------|---| --- |
|[C#](../articles/azure-functions/functions-reference-csharp.md)|GA (.NET Framework 4.7)|GA (.NET Core 2.2)| GA (.NET Core 3.1) |
|[JavaScript](../articles/azure-functions/functions-reference-node.md#node-version)|GA (Nó 6)|GA (Node 10 e 8)| GA (Nó 12 e 10)<br />Versão Prévia (Nó 14) |
...
<sup>*</sup> Suporte por meio de transcompilação para JavaScript.
