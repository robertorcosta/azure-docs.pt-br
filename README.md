...
Confira os tópicos [LICENSE](LICENSE), [LICENSE-CODE](LICENSE-CODE) e [ThirdPartyNotices](ThirdPartyNotices.md) para todas as informações de licenciamento.
