...
| Lab account setting | Instruções |
| ------------------- | ------------ |
...
| ------------ | ------------------ |
|Tamanho da Máquina Virtual| Média. This size is best suited for relational databases, in-memory caching, and analytics.|
