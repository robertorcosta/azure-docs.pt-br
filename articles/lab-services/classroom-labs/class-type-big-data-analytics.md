...
| ------------ | ------------------ |
|Tamanho da Máquina Virtual| Médio (virtualização aninhada). Esse tamanho de VM é mais adequado para bancos de dados relacionais, cache na memória e análise.  Esse tamanho também dá suporte à virtualização aninhada.|  
