...
- Uma conta de email da Microsoft, `@outlook.com`como `@hotmail.com`, `@msn.com`, ou `@live.com`.
...
Para se inscrever em um conta Microsoft, os instrutores devem [http://signup.live.com](http://signup.live.com)ir para.  
