...
Para criar uma conta de laboratório, você precisa ter acesso a uma assinatura do Azure configurada para sua escola. Sua escola pode ter uma ou mais assinaturas. Você usa uma assinatura para gerenciar a cobrança e a segurança de todos os seus recursos e serviços do Azure, incluindo contas de laboratório.  As assinaturas do Azure são normalmente gerenciadas pelo seu departamento de ti.  Para obter mais informações, leia o tópico a seguir:
 - [Guia do administrador-assinatura](https://docs.microsoft.com/azure/lab-services/classroom-labs/administrator-guide#subscription)

### <a name="estimate-the-number-of-vms-and-vm-sizes-that-you-need"></a>Estimar o número de VMs e os tamanhos de VM necessários
Você precisará estimar o número de VMs (máquinas virtuais) e os [tamanhos de VM](https://docs.microsoft.com/azure/lab-services/administrator-guide#vm-sizing) de que sua escola precisa.  Leia a seguinte postagem no blog para obter orientação sobre como estruturar seu labs\images.  Esta postagem de blog também ajudará você a decidir o número de VMs e os tamanhos de VM necessários:
...
- [Guia do administrador – laboratório](https://docs.microsoft.com/azure/lab-services/administrator-guide#classroom-lab)
...
- [Guia do administrador – grupo de recursos](https://docs.microsoft.com/azure/lab-services/administrator-guide#resource-group)
- [Guia do administrador – conta do laboratório](https://docs.microsoft.com/azure/lab-services/administrator-guide#lab-account) 
- [Gerenciamento de custos para Azure Lab Services](https://docs.microsoft.com/azure/lab-services/cost-management-guide)
...
### <a name="who-should-be-owners-and-contributors-of-the-lab-account"></a>Quem deve ser proprietários e colaboradores da conta do laboratório?
   ...
   -  [Guia do administrador-gerenciar identidade](https://docs.microsoft.com/azure/lab-services/administrator-guide#manage-identity).
...
- [Guia do administrador-Galeria de imagens compartilhadas](https://docs.microsoft.com/azure/lab-services/administrator-guide#shared-image-gallery)
- [Guia do administrador-preços da Galeria de imagens compartilhadas](https://docs.microsoft.com/azure/lab-services/administrator-guide#shared-image-gallery-2)
...
- [Especificar imagens do Marketplace disponíveis para os criadores de laboratório](https://docs.microsoft.com/azure/lab-services/specify-marketplace-images)
...
- [Conceitos básicos da arquitetura – rede virtual](https://docs.microsoft.com/azure/lab-services/classroom-labs-fundamentals#virtual-network)
- [Como se conectar a uma rede virtual](https://docs.microsoft.com/azure/lab-services/how-to-connect-peer-virtual-network)
- [Como criar um laboratório com um recurso compartilhado no Azure Lab Services](https://docs.microsoft.com/azure/lab-services/how-to-create-a-lab-with-shared-resource)

## <a name="set-up-your-lab-account"></a>Configurar sua conta de laboratório

Depois de concluir o planejamento, você estará pronto para configurar sua conta de laboratório.  Essas mesmas etapas são aplicáveis para configurar um Azure Lab Services de laboratório [com equipes](https://docs.microsoft.com/azure/lab-services/lab-services-within-teams-overview).
