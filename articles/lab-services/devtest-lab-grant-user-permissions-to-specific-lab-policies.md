...
Por exemplo, para conceder aos usuários permissão de leitura/gravação para a política **De tamanhos de VM permitidos,** você criaria uma função personalizada que funciona com o **Microsoft.DevTestLab/labs/policySets/policies/action** e, em seguida, atribuiria os usuários apropriados a essa função personalizada no escopo do **Microsoft.DevTestLab/labs/policySets/policies/AllowedVmSizesInLab**.
