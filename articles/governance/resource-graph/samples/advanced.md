...
## <a name="show-resource-types-and-api-versions"></a><a name="apiversion" />Mostrar tipos de recursos e versões de API
...
## <a name="get-virtual-machine-scale-set-capacity-and-size"></a><a name="vmss-capacity" />Obter a capacidade e o tamanho do conjunto de dimensionamento de máquinas virtuais
...
## <a name="remove-columns-from-results"></a><a name="remove-column" />Remover colunas dos resultados
...
## <a name="list-all-tag-names"></a><a name="list-all-tags" />Listar todos os nomes de marca
...
## <a name="virtual-machines-matched-by-regex"></a><a name="vm-regex" />Correspondência de máquinas virtuais por regex
...
## <a name="list-cosmos-db-with-specific-write-locations"></a><a name="mvexpand-cosmosdb" />Listar o Cosmos DB com localizações de gravação específicas
...
## <a name="key-vault-with-subscription-name"></a><a name="join" />Cofre de chaves com o nome da assinatura
...
## <a name="list-sql-databases-and-their-elastic-pools"></a><a name="join-sql" />Listar Bancos de Dados SQL e os pools elásticos
...
## <a name="list-virtual-machines-with-their-network-interface-and-public-ip"></a><a name="join-vmpip" />Listar as máquinas virtuais com o adaptador de rede e o IP público
...
## <a name="find-storage-accounts-with-a-specific-tag-on-the-resource-group"></a><a name="join-findstoragetag" />Localizar contas de armazenamento com uma marca específica no grupo de recursos
...
- Portal do Azure Government: <a href="https://portal.azure.us/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%20%7C%20where%20type%20%3D~%20'microsoft.storage%2Fstorageaccounts'%20%7C%20join%20kind%3Dinner%20(%20ResourceContainers%20%7C%20where%20type%20%3D~%20'microsoft.resources%2Fsubscriptions%2Fresourcegroups'%20%7C%20where%20tags%5B'Key1'%5D%20%3D~%20'Value1'%20%7C%20project%20subscriptionId%2C%20resourceGroup)%20on%20subscriptionId%2C%20resourceGroup%20%7C%20project-away%20subscriptionId1%2C%20resourceGroup1" target="_blank">portal.azure.us</a> ![Ícone Abrir link em nova janela](../../media/new-window.png)
...
- Portal do Azure: <a href="https://portal.azure.com/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%20%7C%20where%20type%20%3D~%20%27microsoft.storage%2Fstorageaccounts%27%20%7C%20join%20kind%3Dinner%20%28%20ResourceContainers%20%7C%20where%20type%20%3D~%20%27microsoft.resources%2Fsubscriptions%2Fresourcegroups%27%20%7C%20mv-expand%20bagexpansion%3Darray%20tags%20%7C%20where%20isnotempty%28tags%29%20%7C%20where%20tags%5B0%5D%20%3D~%20%27key1%27%20and%20tags%5B1%5D%20%3D~%20%27value1%27%20%7C%20project%20subscriptionId%2C%20resourceGroup%29%20on%20subscriptionId%2C%20resourceGroup%20%7C%20project-away%20subscriptionId1%2C%20resourceGroup1" target="_blank">portal.azure.com</a> ![ícone Abrir link em uma nova janela](../../media/new-window.png)
- Portal do Azure Government: <a href="https://portal.azure.us/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%20%7C%20where%20type%20%3D~%20%27microsoft.storage%2Fstorageaccounts%27%20%7C%20join%20kind%3Dinner%20%28%20ResourceContainers%20%7C%20where%20type%20%3D~%20%27microsoft.resources%2Fsubscriptions%2Fresourcegroups%27%20%7C%20mv-expand%20bagexpansion%3Darray%20tags%20%7C%20where%20isnotempty%28tags%29%20%7C%20where%20tags%5B0%5D%20%3D~%20%27key1%27%20and%20tags%5B1%5D%20%3D~%20%27value1%27%20%7C%20project%20subscriptionId%2C%20resourceGroup%29%20on%20subscriptionId%2C%20resourceGroup%20%7C%20project-away%20subscriptionId1%2C%20resourceGroup1" target="_blank">portal.azure.us</a> ![Ícone Abrir link em nova janela](../../media/new-window.png)
...
## <a name="combine-results-from-two-queries-into-a-single-result"></a><a name="unionresults" />Combinar os resultados de duas consultas em um único resultado
...
## <a name="include-the-tenant-and-subscription-names-with-displaynames"></a><a name="displaynames" />Incluir os nomes de locatário e assinatura com DisplayNames
