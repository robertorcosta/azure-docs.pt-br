...
## <a name="a-namecount-keyvaultscount-key-vault-resources"></a><a name="count-keyvaults">Contagem de recursos do cofre de chaves
...
## <a name="a-nameunassociated-nsgsshow-unassociated-network-security-groups"></a><a name="unassociated-nsgs"/>Mostrar grupos de segurança de rede não associados
