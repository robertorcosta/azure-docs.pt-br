---
title: Implantar a amostra do blueprint da IRS 1075
description: Etapas de implantação do modelo de blueprint da IRS 1075 (Rev.11-2016), incluindo detalhes do parâmetro do artefato de blueprint.
ms.date: 04/02/2021
ms.topic: sample
...
ms.locfileid: "106386527"
---
# <a name="deploy-the-irs-1075-blueprint-sample"></a>Implantar amostra do blueprint IRS 1075

Para implantar a amostra de blueprint da IRS 1075 (Rev.11-2016) do Azure Blueprints, as seguintes etapas precisam ser executadas:
...
1. Localize a amostra de blueprint **IRS 1075 (Rev.11-2016)** em _Outras Amostras_ e selecione **Usar esta amostra**.

1. Insira as informações _Básicas_ do exemplo de blueprint:

   - **Nome do blueprint**: Forneça um nome para a sua cópia da amostra de blueprint IRS 1075 (Rev.11-2016).
...
Agora que você examinou as etapas para implantar a amostra de blueprint IRS 1075 (Rev.11-2016), leia os seguintes artigos para saber mais sobre o blueprint e o mapeamento de controle:

> [!div class="nextstepaction"]
> [Blueprint da IRS 1075 – Visão geral](./index.md)
> [Blueprint da IRS 1075 – Mapeamento de controle](./control-mapping.md)
