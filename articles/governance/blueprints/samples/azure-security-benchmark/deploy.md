---
title: Implantar um exemplo de blueprint do Azure Security Benchmark
description: Etapas de implantação do blueprint do Azure Security Benchmark, incluindo detalhes do parâmetro do artefato de blueprint.
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82702667"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>Implantar o exemplo de blueprint do Azure Security Benchmark
...
|-|-|-|-|
|Auditar as recomendações do Azure Security Benchmark e implantar Extensões de VM de suporte específicas|Atribuição de política|
Lista de usuários excluídos do grupo de Administradores de VM do Windows|Uma lista separada por ponto e vírgula de membros que devem ser excluídos do grupo local de Administradores. Por exemplo: Administrador; myUser1; myUser2|
...
Agora que você examinou as etapas para implantar o exemplo do blueprint do Azure Security Benchmark, leia os seguintes artigos para saber mais sobre o blueprint e o mapeamento de controle:

> [!div class="nextstepaction"]
> [Blueprint do Azure Security Benchmark – Visão geral](./index.md)
> [Blueprint do Azure Security Benchmark – Mapeamento de controle](./control-mapping.md)
