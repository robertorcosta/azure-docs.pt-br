---
title: Amostra – Blueprint SWIFT CSP-CSCF v2020 – etapas de implantação
description: Etapas de implantação da amostra de blueprint SWIFT CSP-CSCF v2020.
author: DCtheGeek
ms.author: meladie
ms.date: 09/24/2019
ms.topic: sample
...
1. Encontre a amostra de blueprint **SWIFT CSP-CSCF v2020** em _Outras Amostras_ e selecione **Usar esta amostra**.
...
> [Blueprint SWIFT CSP-CSCF v2020 – Mapeamento de controle](./control-mapping.md)
