---
title: Amostra de blueprint do FedRAMP Moderado – etapas de implantação
...
ms.locfileid: "73581339"
---
# <a name="deploy-the-fedramp-moderate-blueprint-sample"></a>Implantar a amostra de blueprint do FedRAMP Moderado

Para implantar a amostra de blueprint FedRAMP Moderado do Azure Blueprints, as seguintes etapas precisam ser executadas:
...
1. Encontre a amostra de blueprint **FedRAMP Moderado** em _Outras Amostras_ e selecione **Usar esta amostra**.

1. Insira as informações _Básicas_ do exemplo de blueprint:

   - **Nome do blueprint**: forneça um nome para a sua cópia da amostra de blueprint FedRAMP Moderado.
...
Agora que você examinou as etapas para implantar a amostra do blueprint FedRAMP Moderado, leia os seguintes artigos para saber mais sobre o blueprint e o mapeamento de controle:
