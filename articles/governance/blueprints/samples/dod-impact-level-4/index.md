...
A seção de mapeamento de controle oferece detalhes sobre políticas incluídas nesse blueprint e sobre como elas abordam vários controles no Nível de Impacto 4 do DoD. Quando atribuídos a uma arquitetura, os recursos são avaliados pelo Azure Policy para verificar a não conformidade com políticas atribuídas. Para saber mais, veja [Azure Policy](../../../policy/overview.md).

## <a name="next-steps"></a>Próximas etapas

Você analisou a visão geral do exemplo de blueprint do Nível de Impacto 4 do DoD. Em seguida, visite os seguintes artigos para saber mais sobre o mapeamento de controle e como implantar este exemplo:
