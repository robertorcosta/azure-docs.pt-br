...
description: Esta definição de política de exemplo exige que o ExpressRoute use as localizações de emparelhamento especificadas definidas em um parâmetro.
ms.date: 01/23/2019
ms.topic: sample
