...
description: Esta definição de política de exemplo exige a implantação de todos os recursos nos locais aprovados definidos em um parâmetro.
ms.date: 01/26/2019
ms.topic: sample
