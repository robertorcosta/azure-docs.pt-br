...
description: Esta definição de política de exemplo exige que a criptografia de arquivo esteja habilitada para contas de armazenamento do Azure.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463429"
---
# <a name="sample---ensure-storage-file-encryption"></a>Exemplo – Assegurar a criptografia de arquivo de armazenamento
