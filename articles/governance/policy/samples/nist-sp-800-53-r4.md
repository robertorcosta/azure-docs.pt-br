...
O artigo a seguir fornece detalhes sobre como a definição da iniciativa interna de Conformidade Regulatória do Azure Policy é mapeada para **domínios de conformidade** e **controles** do NIST SP 800-53 R4.
...
Em seguida, localize e selecione a definição de iniciativa interna de Conformidade Regulatória **[Versão prévia]: Auditar controles NIST SP 800-53 R4 e implantar Extensões de VM específicas para dar suporte a requisitos de auditoria**.
...
|Nome<br /><sub>(Portal do Azure)</sup> |Descrição |Efeito(s) |Versão<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
...
|[Implantar os pré-requisitos para auditar as VMs do Windows nas quais o grupo Administradores contém qualquer um dos membros especificados](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F144f1397-32f9-4598-8c88-118decc3ccba) |Essa política cria uma atribuição de configuração de convidado para auditar máquinas virtuais do Windows nas quais o grupo Administradores contém qualquer um dos membros especificados. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembersToExclude_Deploy.json) |
|[Implantar os pré-requisitos para auditar as VMs do Windows nas quais o grupo Administradores não contém todos os membros especificados](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F93507a81-10a4-4af0-9ee2-34cf25a96e98) |Essa política cria uma atribuição de configuração de convidado para auditar máquinas virtuais do Windows nas quais o grupo Administradores não contém todos os membros especificados. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembersToInclude_Deploy.json) |
...
|Nome<br /><sub>(Portal do Azure)</sup> |Descrição |Efeito(s) |Versão<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[A Segurança de Dados Avançada deve ser habilitada nas instâncias gerenciadas do SQL](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fabfb7388-5bf4-4ad7-ba99-2cd2f41cebb9) |Auditar instâncias gerenciadas de SQL sem Segurança de Dados Avançada |AuditIfNotExists, desabilitado |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurity_Audit.json) |
|[A Segurança de Dados Avançada deve ser habilitada nos servidores SQL](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fabfb4388-5bf4-4ad7-ba82-2cd2f41ceae9) |Auditar servidores SQL sem Segurança de Dados Avançada |AuditIfNotExists, desabilitado |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlServer_AdvancedDataSecurity_Audit.json) |
...
|Nome<br /><sub>(Portal do Azure)</sup> |Descrição |Efeito(s) |Versão<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[Implantar pré-requisitos para auditar as VMs do Linux que permitem conexões remotas em contas que não usam senhas](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fec49586f-4939-402d-a29e-6ff502b20592) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Linux que permitem conexões remotas em contas que não usam senhas. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword110_Deploy.json) |
...
|[Mostrar os resultados da auditoria das VMs do Linux que permitem conexões remotas em contas que não usam senhas](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d67222d-05fd-4526-a171-2ee132ad9e83) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Linux que permitem conexões remotas em contas que não usam senhas. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword110_Audit.json) |
...
|Nome<br /><sub>(Portal do Azure)</sup> |Descrição |Efeito(s) |Versão<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[Implantar pré-requisitos para auditar as VMs do Linux que não têm as permissões de arquivo de senha definidas como 0644](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff19aa1c1-6b91-4c27-ae6a-970279f03db9) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Linux que não têm as permissões de arquivo de senha definidas como 0644. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Deploy.json) |
|[Implantar pré-requisitos para auditar as VMs do Linux que têm contas que não usam senhas](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F3470477a-b35a-49db-aca5-1073d04524fe) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Linux que têm contas que não usam senhas. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Deploy.json) |
|[Implantar pré-requisitos para auditar as VMs do Windows que não armazenam senhas usando a criptografia reversível](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F8ff0b18b-262e-4512-857a-48ad0aeb9a78) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Windows que não armazenam senhas usando a criptografia reversível. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Deploy.json) |
...
|[Mostrar os resultados da auditoria das VMs do Linux que não têm as permissões de arquivo de senha definidas como 0644](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb18175dd-c599-4c64-83ba-bb018a06d35b) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Linux que não têm as permissões de arquivo de senha definidas como 0644. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Audit.json) |
|[Mostrar os resultados da auditoria das VMs do Linux que têm contas que não usam senhas](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc40c9087-1981-4e73-9f53-39743eda9d05) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Linux que têm contas que não usam senhas. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Audit.json) |
|[Mostrar os resultados da auditoria das VMs do Windows que não armazenam senhas usando a criptografia reversível](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Windows que não armazenam senhas usando a criptografia reversível. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|Nome<br /><sub>(Portal do Azure)</sup> |Descrição |Efeito(s) |Versão<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[Implantar pré-requisitos para auditar as VMs do Windows que permitem reutilizar as 24 senhas anteriores](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F726671ac-c4de-4908-8c7d-6043ae62e3b6) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Windows que permitem reutilizar as 24 senhas anteriores. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Deploy.json) |
|[Implantar pré-requisitos para auditar as VMs do Windows que não têm uma duração máxima da senha de 70 dias](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F356a906e-05e5-4625-8729-90771e0ee934) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Windows que não têm uma duração máxima da senha de 70 dias. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Deploy.json) |
|[Implantar pré-requisitos para auditar as VMs do Windows que não têm uma duração mínima da senha de 1 dia](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F16390df4-2f73-4b42-af13-c801066763df) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Windows que não têm uma duração mínima da senha de 1 dia. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Deploy.json) |
|[Implantar pré-requisitos para auditar as VMs do Windows que não têm a configuração de complexidade de senha habilitada](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F7ed40801-8a0f-4ceb-85c0-9fd25c1d61a8) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Windows que não têm a configuração de complexidade de senha habilitada. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Deploy.json) |
|[Implantar pré-requisitos para auditar as VMs do Windows que não restringem o tamanho mínimo da senha a 14 caracteres](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F23020aa6-1135-4be2-bae2-149982b06eca) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Windows que não restringem o tamanho mínimo da senha a 14 caracteres. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Deploy.json) |
|[Implantar pré-requisitos para auditar as VMs do Windows que não armazenam senhas usando a criptografia reversível](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F8ff0b18b-262e-4512-857a-48ad0aeb9a78) |Esta política cria uma atribuição de Configuração de Convidado para auditar as máquinas virtuais do Windows que não armazenam senhas usando a criptografia reversível. Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Deploy.json) |
...
|[Mostrar os resultados da auditoria das VMs do Windows que permitem reutilizar as 24 senhas anteriores](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fcdbf72d9-ac9c-4026-8a3a-491a5ac59293) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Windows que permitem reutilizar as 24 senhas anteriores. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Audit.json) |
|[Mostrar os resultados da auditoria das VMs do Windows que não têm uma duração máxima da senha de 70 dias](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F24dde96d-f0b1-425e-884f-4a1421e2dcdc) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Windows que não têm uma duração máxima da senha de 70 dias. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Audit.json) |
|[Mostrar os resultados da auditoria das VMs do Windows que não têm uma duração mínima da senha de 1 dia](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aa11bbc-5c76-4302-80e5-aba46a4282e7) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Windows que não têm uma duração mínima da senha de 1 dia. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Audit.json) |
|[Mostrar os resultados da auditoria das VMs do Windows que não têm a configuração de complexidade de senha habilitada](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff48b2913-1dc5-4834-8c72-ccc1dfd819bb) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Windows que não têm a configuração de complexidade de senha habilitada. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Audit.json) |
|[Mostrar os resultados da auditoria das VMs do Windows que não restringem o tamanho mínimo da senha a 14 caracteres](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aebc8d1-020d-4037-89a0-02043a7524ec) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Windows que não restringem o tamanho mínimo da senha a 14 caracteres. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Audit.json) |
|[Mostrar os resultados da auditoria das VMs do Windows que não armazenam senhas usando a criptografia reversível](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Essa política só deve ser usada juntamente com a política de implantação correspondente em uma iniciativa. Esta definição permite que o Azure Policy processe os resultados da auditoria das máquinas virtuais do Windows que não armazenam senhas usando a criptografia reversível. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – versão prévia](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|Nome<br /><sub>(Portal do Azure)</sup> |Descrição |Efeito(s) |Versão<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[A Proteção contra DDoS Standard deve ser habilitada](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fa7aca53f-2ed4-4466-a25e-0b45ade68efd) |A proteção contra DDoS padrão deve ser habilitada para todas as redes virtuais com uma sub-rede que é parte de um gateway de aplicativo com um IP público. |AuditIfNotExists, desabilitado |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Security%20Center/ASC_EnableDDoSProtection_Audit.json) |
...
|[Implantar pré-requisitos para auditar os servidores Web do Windows que não estão usando protocolos de comunicação segura](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb2fc8f91-866d-4434-9089-5ebfe38d6fd8) |Essa política cria uma atribuição de configuração de convidado para auditar servidores Web do Windows que não estão usando protocolos de comunicação segura (TLS 1.1 ou TLS 1.2). Ela também cria uma identidade gerenciada atribuída pelo sistema e implanta a extensão de VM para configuração de convidado. Essa política só deve ser usada juntamente com a política de auditoria correspondente em uma iniciativa. Para obter mais informações sobre as políticas de Configuração de Convidado, acesse [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsTLS_Deploy.json) |
