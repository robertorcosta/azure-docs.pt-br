...
description: Esta definição de política de exemplo proíbe a implantação dos tipos de recursos especificados definidos em um parâmetro.
ms.date: 01/23/2019
ms.topic: sample
