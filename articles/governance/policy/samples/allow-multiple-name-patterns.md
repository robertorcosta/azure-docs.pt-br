...
description: Esta definição de política de amostra exige que um recurso corresponda a um dos padrões de nome de número ou dígito fornecidos.
ms.date: 01/23/2019
ms.topic: sample
