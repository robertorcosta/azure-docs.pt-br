...
### <a name="passwords-are-not-displayed-when-entered"></a>As senhas não são exibidas quando inseridas.

**ID**: 1002.01d1System.1 – 01.d **Propriedade**: Cliente
...
### <a name="electronic-signatures-based-upon-biometrics-are-designed-to-ensure-that-they-cannot-be-used-by-any-individual-other-than-their-genuine-owners"></a>As assinaturas eletrônicas baseadas em biometria foram criadas para garantir que não possam ser usadas por nenhum indivíduo além dos proprietários originais.

**ID**: 11209.01q2Organizational.9 – 01.q **Propriedade**: Não Aplicável
...
### <a name="unique-ids-that-can-be-used-to-trace-activities-to-the-responsible-individual-are-required-for-all-types-of-organizational-and-non-organizational-users"></a>As IDs exclusivas que podem ser usadas para rastrear as atividades até o indivíduo responsável são necessárias para todos os tipos de usuários organizacionais e não organizacionais.

**ID**: 1122.01q1System.1 – 01.q **Propriedade**: Cliente
...
### <a name="sharedgroup-and-generic-user-ids-are-only-used-in-exceptional-circumstances-where-there-is-a-clear-business-benefit-when-user-functions-do-not-need-to-be-traced-additional-accountability-controls-are-implemented-and-after-approval-by-management"></a>As IDs de usuário compartilhadas/de grupo e genéricas são usadas apenas em circunstâncias excepcionais em que há um benefício comercial evidente, quando as funções de usuário não precisam ser rastreadas, os controles de responsabilidade adicionais foram implementados e após a aprovação pela gerência.

**ID**: 1124.01q1System.34 – 01.q **Propriedade**: Cliente
...
### <a name="help-desk-support-requires-user-identification-for-any-transaction-that-has-information-security-implications"></a>O suporte técnico exige a identificação do usuário para qualquer transação que tenha implicações de segurança da informação.

**ID**: 1128.01q2System.5 – 01.q **Propriedade**: Cliente
...
### <a name="information-collected-from-multiple-sources-shall-be-aggregated-for-review"></a>As informações coletadas de várias fontes devem ser agregadas para revisão.

**ID**: 12103.09ab1Organizational.5 – 09.ab **Propriedade**: Cliente
...
### <a name="automated-systems-support-near-real-time-analysis-and-alerting-of-events-eg-malicious-code-potential-intrusions-and-integrate-intrusion-detection-into-access-and-flow-control-mechanisms"></a>Os sistemas automatizados dão suporte à análise e aos alertas de eventos quase em tempo real (por exemplo, código malicioso, potenciais invasões) e integram a detecção de intrusões a mecanismos de controle de acesso e fluxo.

**ID**: 1218.09ab3System.47 – 09.ab **Propriedade**: Cliente
...
### <a name="security-is-maintained-through-all-aspects-of-the-transaction"></a>A segurança é mantida em todos os aspectos da transação.

**ID**: 0944.09y1Organizational.2 – 09.y **Propriedade**: Não Aplicável
...
### <a name="internal-and-external-vulnerability-assessments-of-covered-information-systems-virtualized-environments-and-networked-environments-including-both-network--and-application-layer-tests-are-performed-by-a-qualified-individual-on-a-quarterly-basis-or-after-significant-changes"></a>As avaliações de vulnerabilidades internas e externas de sistemas de informações sigilosas, ambientes virtualizados e ambientes em rede, incluindo testes na camada de aplicativos e de redes, são executadas por um indivíduo qualificado trimestralmente ou após alterações significativas.

**ID**: 0712.10m2Organizational.4 – 10.m **Propriedade**: Cliente
