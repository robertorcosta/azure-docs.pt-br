---
title: Exemplo – SKUs do BD SQL permitidos
description: Esta definição de política de exemplo exige que os bancos de dados SQL usem um SKU aprovado. Novos recursos que não atendem ao requisito são negados.
author: DCtheGeek
...
ms.locfileid: "72244199"
---
# <a name="sample---allowed-sql-database-skus"></a>Exemplo – SKUs permitidas do banco de dados SQL

Essa política requer que os Bancos de Dados SQL usem um SKU aprovado. Especifique uma matriz de IDs de SKU permitidas ou uma matriz de nomes de SKU permitidos.
