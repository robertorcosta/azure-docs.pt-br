...
:::image type="content" source="../media/policy-as-code/policy-as-code-workflow.png" alt-text="Visão geral da política como fluxo de trabalho de código" border="false":::
