...
description: Saiba como atualizar aplicativos escritos para versões anteriores do Azure Key Vault para trabalhar com a versão 2,0 da biblioteca de Azure Key Vault para C# e .NET.
services: key-vault
author: msmbaldwin
manager: rkarlin
editor: bryanla
