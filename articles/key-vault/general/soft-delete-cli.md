...
description: Saiba como usar a CLI do Azure para aproveitar o recurso de exclusão reversível do Azure Key Vault que permite a recuperação de cofres de chaves e objetos do cofre de chaves.
services: key-vault
...
A exclusão temporária fica habilitada automaticamente por padrão em todos os cofres de chaves. A partir de 31 de dezembro de 2020, não será mais possível criar um cofre de chaves sem a exclusão temporária habilitada.
