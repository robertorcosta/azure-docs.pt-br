...
1. Verifique o acesso inserindo *a az account\/get-token --recurso https: /vault.azure.net*. Se você receber um erro, verifique se a versão certa do Azure CLI está instalada corretamente.
