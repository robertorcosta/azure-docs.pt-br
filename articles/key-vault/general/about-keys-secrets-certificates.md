---
title: Visão geral da API REST do Azure Key Vault
...
ms.locfileid: "90983280"
---
# <a name="azure-key-vault-rest-api-overview"></a>Visão geral da API REST do Azure Key Vault
