...
|-|----|--|
|Habilite a exclusão suave | [Soft delete](key-vault-ovw-soft-delete.md) permite recuperar cofres excluídos e objetos de cofre |  - |
...
| Restringir quem pode acessar seus registros de cofres do Azure Key | [Os registros do Key Vault](key-vault-logging.md) salvam informações sobre as atividades realizadas em seu cofre, como criação ou exclusão de cofres, chaves, segredos e podem ser usados durante uma investigação |  - |

## <a name="networking"></a>Rede

| Recomendação | Comentários | Central de Segurança |
|-|----|--|
|Limitar a exposição da rede | O acesso à rede deve ser limitado às redes virtuais utilizadas por soluções que requerem acesso ao cofre. Revisar informações sobre [os pontos finais de serviço de rede virtual para o Azure Key Vault](key-vault-overview-vnet-service-endpoints.md) | - |
