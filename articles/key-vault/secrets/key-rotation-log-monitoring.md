...
Primeiro, você deve habilitar o log no cofre de chaves. Use os seguintes comandos PowerShell. (Você pode ver os detalhes completos [neste artigo sobre o registro do cofre de chaves](../general/logging.md).)
