...
Você pode criar um cofre de chaves seguindo as etapas em [Definir e recuperar um segredo do Azure Key Vault usando o portal do Azure](quick-create-portal.md)
