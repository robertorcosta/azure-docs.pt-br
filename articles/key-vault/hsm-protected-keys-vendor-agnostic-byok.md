...
Para obter mais informações e para que um tutorial comece a usar o Key Vault (incluindo como criar um cofre de chaves para chaves protegidas pelo HSM), consulte [O que é o Azure Key Vault?](key-vault-overview.md)
