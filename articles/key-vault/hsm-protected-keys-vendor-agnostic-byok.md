...
| CLI do Azure versão 2.0.82 ou mais recente | Consulte [instalar o CLI do Azure](/cli/azure/install-azure-cli?view=azure-cli-latest) para obter mais informações.|

## <a name="supported-hsms"></a>HSMs com suporte

|Nome do fornecedor do HSM|Modelos HSM com suporte|Detalhes adicionais|
|---|---|---|
|Thales|Família SafeNet Luna HSM 7 com firmware versão 7,3 ou mais recente| [Ferramenta e documentação do SafeNet Luna BYOK](https://safenet.gemalto.com/blah-blah)|
