...
Esta partida rápida requer a versão 2.0.4 ou posterior do Azure CLI. Execute `az --version` para localizar a versão atual. Caso precise instalar ou atualizar, confira [Instalar a CLI do Azure](/cli/azure/install-azure-cli?view=azure-cli-latest). 
...
- [Fornecer a autenticação do Key Vault com uma política de controle de acesso](key-vault-group-permissions-for-apps.md)
