...
|Serviço de Backup do Azure|Permitir backup e restauração de chaves e segredos relevantes durante o backup do Azure Virtual Machines, usando [o Azure Backup](../backup/backup-introduction-to-azure-backup.md).|
