---
title: Como gerar & transferir chaves protegidas por HSM – BYOK – Azure Key Vault
...
ms.locfileid: "87061102"
---
# <a name="import-hsm-protected-keys-to-key-vault-byok"></a>Importar chaves protegidas por HSM para Key Vault (BYOK)
...
| CLI do Azure versão 2.1.0 ou posterior | Confira [Instalar a CLI do Azure](/cli/azure/install-azure-cli?view=azure-cli-latest).|

## <a name="supported-hsms"></a>HSMs com suporte

|Nome do fornecedor|Tipo de fornecedor|Modelos HSM com suporte|Mais informações|
|---|---|---|---|
|nCipher|Manufacturer<br/>HSM como um serviço|<ul><li>família de HSMs nShield</li><li>nShield como um serviço</ul>|[nCipher nova ferramenta e documentação do BYOK](https://www.ncipher.com/products/key-management/cloud-microsoft-azure)|
|Thales|Fabricante|<ul><li>Família de HSM 7 da Luna com firmware versão 7,3 ou mais recente</li></ul>| [Ferramenta e documentação de lunar BYOK](https://supportportal.thalesgroup.com/csm?id=kb_article_view&sys_kb_id=3892db6ddb8fc45005c9143b0b961987&sysparm_article=KB0021016)|
|Fortanix|Manufacturer<br/>HSM como um serviço|<ul><li>Serviço de gerenciamento de chaves de autodefesa (SDKMS)</li><li>Equinix SmartKey</li></ul>|[Exportando chaves SDKMS para provedores de nuvem para BYOK-Azure Key Vault](https://support.fortanix.com/hc/en-us/articles/360040071192-Exporting-SDKMS-keys-to-Cloud-Providers-for-BYOK-Azure-Key-Vault)|
|Marvell|Fabricante|Todos os HSMs LiquidSecurity com<ul><li>Firmware versão 2.0.4 ou posterior</li><li>Firmware versão 3,2 ou mais recente</li></ul>|[Ferramenta e documentação do Marvell BYOK](https://www.marvell.com/products/security-solutions/nitrox-hs-adapters/exporting-marvell-hsm-keys-to-cloud-azure-key-vault.html)|
|Cryptomathic|ISV (sistema de gerenciamento de chaves empresariais)|Várias marcas e modelos HSM, incluindo<ul><li>nCipher</li><li>Thales</li><li>Utimaco</li></ul>Consulte o [site do Cryptomathic para obter detalhes](https://www.cryptomathic.com/azurebyok)|[Ferramenta e documentação do Cryptomathic BYOK](https://www.cryptomathic.com/azurebyok)|
...
Use o comando [AZ keyvault Key Create](/cli/azure/keyvault/key?view=azure-cli-latest#az-keyvault-key-create) para criar um Kek que tenha operações de chave definidas como `import` . Registre o identificador de chave ( `kid` ) que é retornado do comando a seguir. (Você usará o `kid` valor na [etapa 3](#step-3-generate-and-prepare-your-key-for-transfer).)
...
> 
> **Problema conhecido**: a importação de uma chave de destino RSA 4K a partir de HSMs de Luna só tem suporte com o firmware 7.4.0 ou mais recente.
