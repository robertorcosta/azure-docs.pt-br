...
> [!NOTE]
> O método de importação de chave HSM descrito neste documento só funciona com a família de HSMs nCipher nShield. Para importar chaves HSM de outros HSMs, [acesse aqui](hsm-protected-keys-byok.md).
