...
- O usuário precisaria ter uma função interna do RBAC atribuída, por ex. colaborador. [Saiba mais aqui](https://docs.microsoft.com/azure/role-based-access-control/role-assignments-portal)
