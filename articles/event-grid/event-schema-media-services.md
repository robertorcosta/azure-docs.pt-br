---
title: Serviços de mídia do Azure como origem da grade de eventos
...
Você pode encontrar os códigos de resultado de erro em [códigos de erro de eventos ao vivo](../media-services/latest/live-event-error-codes.md).
...
| Propriedade | Tipo | Descrição |
| -------- | ---- | ----------- |
| `topic` | string | O tópico da grade de eventos. Essa propriedade tem a ID de recurso para a conta de Serviços de Mídia. |
...
| `data` | object | Dados de eventos dos Serviços de Mídia. |
...
[Registre-se para eventos de alteração de estado do trabalho](../media-services/latest/monitoring/job-state-events-cli-how-to.md)
