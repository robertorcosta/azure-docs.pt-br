...
description: Descreve os manipuladores de eventos com suporte para a grade de eventos do Azure. O manipulador usa alguma ação adicional para processar o evento.
services: event-grid
author: spelluru
