...
description: Este artigo fornece um script de exemplo da CLI do Azure que mostra como assinar eventos da Grade de Eventos do Azure usando a CLI do Azure.
services: event-grid
