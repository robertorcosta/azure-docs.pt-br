...
Para publicar em um ponto de extremidade de webhook, defina o `endpointType` como `WebHook` e forneça:
...
Para publicar em um ponto de extremidade de nuvem da grade de eventos do Azure, defina o `endpointType` como `eventGrid` e forneça:
...
Para publicar em um módulo do Hub do Edge, defina o `endpointType` como `edgeHub` e forneça:
