...
ms.locfileid: "72992373"
---
# <a name="event-schemas"></a>Esquemas de evento

O módulo de grade de eventos aceita e entrega eventos no formato JSON. Atualmente, há dois esquemas com suporte na grade de eventos:-
...
| Propriedade | Type | obrigatórios | Descrição |
| -------- | ---- | ----------- |-----------
| topic | string | Não | Deve corresponder ao tópico no qual ele está publicado. A grade de eventos popula com o nome do tópico no qual ele é publicado, se não for especificado. |
