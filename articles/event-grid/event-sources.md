...
description: Assinaturas do Azure, Registro de Contêineres, tópicos personalizados, Hubs de Eventos, Hub ioT, Key Vault, Serviços de Mídia, grupos de recursos, Service Bus, Storage, Mapas, Configuração de Aplicativos, Signal R, Machine Learning.
services: event-grid
author: spelluru
...
| [Esquema de eventos](event-schema-subscriptions.md) | Mostra campos nos eventos de assinatura do Azure. |
...
| [Esquema de eventos](event-schema-container-registry.md) | Mostra campos nos eventos do Registro de Contêiner. |
...
| [Esquema de eventos](event-schema.md) | Mostra campos em eventos personalizados. |
...
| [Esquema de eventos](event-schema-event-hubs.md) | Mostra campos nos eventos de Hubs de Eventos. |
...
Inscreva-se em eventos do IoT Hub para responder a eventos de dispositivos criados, excluídos, conectados, desconectados e de telemetria.
...
| [Esquema de eventos](event-schema-iot-hub.md) | Mostra campos nos eventos de Hub IoT. |
...
## <a name="key-vault-preview"></a>Cofre de Chaves (visualização)

A integração do Key Vault com a Grade de Eventos encontra-se atualmente em versão prévia. 

Assine os eventos do Key Vault para ser notificado quando um segredo estiver prestes a expirar, um segredo expirar ou um segredo tiver uma nova versão disponível. 
...
| [Esquema de eventos](event-schema-key-vault.md) | Mostra campos em eventos do Key Vault. |
...
| [Esquema de eventos](../media-services/latest/media-services-event-schemas.md?toc=%2fazure%2fevent-grid%2ftoc.json) | Mostra campos nos eventos de Serviços de Mídia. |
...
| [Esquema de eventos](event-schema-service-bus.md) | Mostra os campos nos eventos de Barramento de Serviço. |
...
>[!NOTE]
> Somente contas de armazenamento do tipo **StorageV2 (v2 de uso geral)** e **BlobStorage** dão suporte à integração de eventos. **O armazenamento (objetivo geral v1)** *não* suporta integração com a Event Grid.
...
| [Esquema de eventos](event-schema-blob-storage.md) | Mostra campos nos eventos de Armazenamento de Blobs. |
...
| [Esquema de eventos](event-schema-azure-maps.md) | Mostra campos nos eventos do Azure Mapas. |

## <a name="app-configuration"></a>Configuração de aplicativos
Inscreva-se em eventos de configuração do aplicativo Azure para responder a eventos de modificação de valor-chave.
...
| [Esquema de eventos](event-schema-app-configuration.md) | Mostra campos em eventos de configuração do aplicativo Azure. |

## <a name="azure-signalr"></a>Azure SignalR
Inscreva-se nos eventos do Azure SignalR Service para responder a eventos de conexão com o cliente.
...
| [Esquema de eventos](event-schema-azure-signalr.md) | Mostra campos em eventos do Azure SignalR Service. |

## <a name="azure-machine-learning"></a>Azure Machine Learning

Inscreva-se em eventos de espaço de trabalho de Machine Learning do Azure para responder ao registro do modelo.
...
| [Esquema de eventos do Azure Event Grid para aprendizado de máquina do Azure](event-schema-machine-learning.md) | Mostra campos nos eventos de Machine Learning do Azure. |
