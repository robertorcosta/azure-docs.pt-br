...
description: Assinaturas do Azure, registro de contêiner, tópicos personalizados, hubs de eventos, Hub IoT, Key Vault, serviços de mídia, grupos de recursos, barramento de serviço, armazenamento, mapas, configuração de aplicativo, sinal R Machine Learning.
services: event-grid
author: spelluru
...
>[!NOTE]
> Somente contas de armazenamento do tipo **StorageV2 (v2 de uso geral)** e **BlobStorage** dão suporte à integração de eventos. O **armazenamento (uso geral v1)** *não oferece* suporte à integração com a grade de eventos.
