                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Guia de Introdução para Desenvolvedores do Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Cloud Adoption Framework para Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Cursos gratuitos do Azure da Pluralsight</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    ...
                                    <p>Explore nossos serviços mais populares com guias de início rápido, exemplos e tutoriais.</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Implantar a infraestrutura</h3>
                                                <ul class="noBullet">
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Segurança e gerenciamento de recursos</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/backup/">Serviço de Backup do Azure</a></li>
                                                    <li><a class="barLink" href="/azure/cost-management/">Gerenciamento de Custos do Azure</a></li>
                                                    <li><a class="barLink" href="/azure/migrate/">Migrações para Azure</a></li>
                                                    ...
                                                    <li><a class="barLink" href="/azure/security-center/">Central de Segurança do Azure</a></li>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Gerenciar dados e AI</h3>
                                                <h4>Bancos de dados relacionais</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/sql-database/">Banco de Dados SQL como serviço</a></li>
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">Banco de Dados SQL para a borda</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">SQL Server em uma VM do Azure</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics (antigo SQL DW)</a></li>
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="https://docs.microsoft.com/media/common/i_mobile-app-developement.svg" alt=""> Aplicativo móvel do Azure </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/tour-azure-portal/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/tour-azure-services-and-features.svg" alt=""> Conheça os recursos e os serviços do Azure </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/principles-cloud-computing/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/principles-cloud-computing.svg" alt=""> Princípios de computação em nuvem </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/automate-azure-tasks-with-powershell/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/automate-azure-tasks-with-powershell.svg" alt=""> Automatizar tarefas do Azure usando scripts com o PowerShell </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/browse/?products=azure">Mais aprendizado interativo...</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Exibir todos os Serviços do Azure<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <ul id="products">
                        ...
                        <ul id="all" class="directory">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/machine-learning/service">
                                                ...
                                                <p>Serviço de Machine Learning</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="https://docs.microsoft.com/bot-framework/bot-service-overview-introduction">
                                                ...
                                                <p>Serviço de Bot do Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/search/">
                                                <img src="media/index/Search.svg" alt="" />
                                                <p>Pesquisa Cognitiva do Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/computer-vision/">
                                                ...
                                                <p>API da Pesquisa Visual Computacional</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/Bing-Video-Search/">
                                                ...
                                                <p>API de Pesquisa de Vídeo do Bing</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics (antigo SQL DW)</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/blockchain/service/">
                                                ...
                                                <p>Serviço do Azure Blockchain</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/blockchain/tokens/">
                                                ...
                                                <p>Tokens do Azure Blockchain</p>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/container-instances/">
                                                ...
                                                <p>Instâncias de Contêiner do Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/aks/">
                                                ...
                                                <p>AKS (Serviço de Kubernetes do Azure)</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/vmware-cloudsimple/">
                                                ...
                                                <p>Solução VMware no Azure pela CloudSimple</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Contêineres</h3>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/container-registry/">
                                                ...
                                                <p>Registro de Contêiner</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/container-instances/">
                                                <img src="media/index/ContainerInstances.svg" alt="" />
                                                <p>Instâncias de Contêiner</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/postgresql/">
                                                ...
                                                <p>Banco de Dados do Azure para PostgreSQL</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/mysql/">
                                                <img src="media/index/MySQL.svg" alt="" />
                                                <p>Banco de Dados do Azure para MySQL</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/mariadb/">
                                                <img src="media/index/MariaDB.svg" alt="" />
                                                <p>Banco de Dados do Azure para MariaDB</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/dms/dms-overview">
                                                <img src="media/index/database-migration.svg" alt="" />
                                                <p>Serviço de Migração de Banco de Dados do Azure</p>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/integrations">
                                                ...
                                                <p>Integrações de ferramentas de desenvolvedor</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cli">
                            ...
                            <li>
                                <div class="group">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/iot-dps/">
                                                ...
                                                <p>Provisionamento de Dispositivos no Hub IoT</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <h3>Gerenciamento e governança</h3>
                                    <ul>
                                        <li>
                                            <a href="/azure/backup/">
                                        ...
                                        <li>
                                            <a href="/azure/service-health">
                                                ...
                                                <p>Integridade do Serviço do Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/governance/resource-graph/">
                                                ...
                                                <p>Gráfico de Recursos do Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/azure-resource-manager/managed-applications">
                                                ...
                                                <p>Aplicativos gerenciados do Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/media-services/media-services-manage-channels-overview">
                                                ...
                                                <p>Streaming ao vivo e sob demanda</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/azure-stack/user">
                                                <img src="media/index/azure-stack.svg" alt="" />
                                                <p>Usuário do Azure Stack</p>
                                            </a>
                                        </li>                                        <li>
                                            <a href="/azure-stack/asdk/">
                                                <img src="media/index/azure-stack.svg" alt="" />
                                                <p>ASDK (Kit de Desenvolvimento do Azure Stack)</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Migração</h3>
                                ...
                                <div class="group">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/app-service-mobile/">
                                                ...
                                                <p>Serviço de Aplicativo - Aplicativos Móveis</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Rede</h3>
                                    <ul>
                                        <li>
                                            <a href="/azure/networking/networking-overview">
                                                ...
                                                <p>Visão Geral da Rede</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cdn/">
                                                <img src="media/index/ContentDeliveryNetwork.svg" alt="" />
                                                <p>Rede de Distribuição de Conteúdo</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/asc-for-iot/">
                                                ...
                                                <p>Central de Segurança do Azure para IoT</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Nuvens Soberanas</h3>
                                    <ul>
                                        <li>
                                            <a href="/azure/azure-government/">
                                                <img src="media/index/azure-government.svg" alt="" />
                                                <p>Governo dos EUA para Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/app-service-web/">
                                                ...
                                                <p>Serviço de Aplicativo – Aplicativos Web</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/api-management/">
                                    ...
                                    <h3>Área de Trabalho Virtual do Windows</h3>
                                    <ul>
                                        <li>
                                            <a href="/azure/virtual-desktop/">
                                                <img src="media/index/windows-virtual-desktop.svg" alt="" />
                                                <p>Área de Trabalho Virtual do Windows</p>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <li>
                        ...
                        <ul id="ai" class="cardsA">
                            <li class="fullSpan">
                                <h2>Inteligência Artificial + Machine Learning</h2>
                            </li>
                            <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Introduzir aplicativos, sites e bots com inteligência para ver, ouvir, falar e entender</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Serviço do Machine Learning</h3>
                                                    <p>Criar, implantar e gerenciar o aprendizado de máquina e modelos de IA</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Pesquisa Cognitiva do Azure</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Conjuntos de dados em aberto</h3>
                                                    <p>Conjuntos de dados públicos coletados para aprimorar os modelos de machine learning</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics (antigo SQL DW)</h3>
                                                    <p>Serviço de análise ilimitado com tempo para insight inigualável</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Data Factory</h3>
                                                    <p>Orquestrar e gerenciar transformação e movimentação de dados</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Serviço de exploração de dados rápido e altamente escalonável para dados de log e telemetria</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Análise em tempo real sobre fluxos de dados de movimentação rápida de aplicativos e dispositivos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Spark para Azure HDInsight</h3>
                                                    <p>Apache Spark na nuvem para implantações críticas</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Storm para Azure HDInsight</h3>
                                                    <p>Processamento de streaming em tempo real facilitado para Big Data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>R Server para Azure HDInsight</h3>
                                                    <p>Análise preditiva, machine learning e modelagem estatística para Big Data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Armazenamento do Data Lake seguro, amplamente escalonável criado no armazenamento de Blobs</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Repositório da Hiperescala para cargas de trabalho de análise de Big Data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Um serviço simples e seguro para compartilhamento de Big Data com organizações externas</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Serviço do Azure Blockchain</h3>
                                                    <p>Criar, reger e expandir as redes de blockchain de consórcio</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Tokens do Azure Blockchain</h3>
                                                    <p>Definir, criar e gerenciar com facilidade tokens baseados em razão</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Provisionar máquinas virtuais do Ubuntu, Red Hat e muito mais</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Provisionar máquinas virtuais para SQL Server, SharePoint e muito mais</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Funções</h3>
                                                    <p>Processar eventos com o código sem servidor</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Instâncias de Contêiner</h3>
                                                    <p>Execute facilmente contêineres com um único comando</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Desenvolver microsserviços e orquestrar contêineres no Windows ou Linux</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>AKS (Serviço de Kubernetes do Azure)</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Criar aplicativos e APIs na nuvem altamente disponíveis e infinitamente escalonáveis</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Hospede aplicativos empresariais do SQL Server na nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Execute as maiores cargas de trabalhos do SAP HANA de qualquer provedor de nuvem em hiperescala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CycleCloud</h3>
                                                    <p>Criar, gerenciar, operar e otimizar a HPC e grandes clusters de cálculo de qualquer escala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Solução VMware no Azure pela CloudSimple</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Registro de Contêiner do Azure</h3>
                                                    <p>Armazenar e gerenciar imagens de contêiner em todos os tipos de implantações do Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Serviços Cognitivos</h3>
                                                    <p>Usar contêineres dos Serviços Cognitivos do Azure com Docker, Kubernetes, AKS e Instâncias de Contêiner</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Banco de Dados SQL do Azure</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Banco de Dados SQL do Azure no Edge</h3>
                                                    <p>Mecanismo de banco de dados relacional otimizado para implantações de borda e IoT.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Amplie dinamicamente os bancos de dados SQL Server locais para o Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Banco de Dados do Azure para PostgreSQL</h3>
                                                    <p>Um serviço de banco de dados PostgreSQL gerenciado para desenvolvedores de aplicativos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Banco de Dados do Azure para MySQL</h3>
                                                    <p>Um serviço de banco de dados MySQL gerenciado para desenvolvedores de aplicativos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Banco de Dados do Azure para MariaDB</h3>
                                                    <p>Serviço de banco de dados MariaDB gerenciado para desenvolvedores de aplicativos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Reduzir a complexidade de sua migração para a nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#devtools">Ferramentas de Desenvolvedor</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>Ambiente completo de desenvolvimento integrado (IDE) para iOS, Android, Windows, Web e nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DevOps</h3>
                                                    <p>Serviços para equipes compartilharem código, acompanharem trabalho e enviarem software</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>O Visual Studio Code é um de código-fonte leve mas poderoso, que é executado na área de trabalho e está disponível para Windows, macOS e Linux.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SDKs</h3>
                                                    <p>Compilar aplicativos de nuvem com as linguagens de programação que você já sabe</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integrações de ferramentas de desenvolvedor</h3>
                                                    <p>Ferramentas de terceiros para ajudar você com o desenvolvimento do Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CLI</h3>
                                                    <p>Acessar a nuvem diretamente a partir de ferramentas de linha de comando</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Detectar, fazer triagem e diagnosticar problemas em seus serviços e aplicativos Web</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Criar laboratórios na nuvem para sala de aula, desenvolvimento e teste e outros cenários (anteriormente conhecido como DevTest Labs)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integrações de ferramentas de desenvolvedor</h3>
                                                    <p>Estender o Azure com extensões populares</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sincronizar diretórios locais e habilitar o logon único</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Criar e implantar políticas organizacionais para controlar informações confidenciais</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Active Directory para Domain Services</h3>
                                                    <p>Unir as máquinas virtuais do Azure a um domínio sem controladores de domínio</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gerenciamento de identidade e de acesso na nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Saiba como proteger suas soluções de nuvem no Azure com nossas diretrizes e melhores práticas</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Barramento de Serviço</h3>
                                                    <p>Conectar-se em ambientes de nuvem privada e pública</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Aplicativos Lógicos</h3>
                                                    <p>Automatizar o acesso e o uso dos dados nas nuvens sem precisar escrever código</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Compila rapidamente soluções de agricultura digital na nuvem.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Soluções e casos de uso para o setor de serviços financeiros.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Saúde e ciências naturais</h3>
                                                    <p>Soluções e casos de uso para o setor de Saúde e Ciências Naturais.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Manufatura</h3>
                                                    <p>Soluções e casos de uso para o setor de manufatura.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Varejo</h3>
                                                    <p>Soluções e casos de uso para o setor de varejo.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#iot">Internet das Coisas</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Central da IoT</h3>
                                                    <p>Acelere a criação de soluções de IoT</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Hub IoT</h3>
                                                    <p>Conectar, monitorar e controlar bilhões de ativos de IoT</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Conecte dispositivos à sua solução de IoT sem gravar nenhum código de dispositivo</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Aceleradores de solução do IoT</h3>
                                                    <p>Capturar e analisar dados inexplorados para melhorar os resultados dos negócios</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Criar réplicas digitais de espaços e infraestrutura</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Provisionamento de Dispositivos no Hub IoT</h3>
                                                    <p>Provisionamento de toque zero e Just-In-Time para o Hub IoT do Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Explore e analise instantaneamente dados de série temporal</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Gerenciamento e governança</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Backup</h3>
                                                    <p>Backup de servidor simples e confiável na nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Agendador</h3>
                                                    <p>Execute seus trabalhos em agendamentos recorrentes simples ou complexos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Automação</h3>
                                                    <p>Simplificar o gerenciamento em nuvem com a automação de processo</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gerenciador de Tráfego</h3>
                                                    <p>Faça o roteamento de tráfego de entrada para alto desempenho e disponibilidade</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Monitor</h3>
                                                    <p>Dados de monitoramento altamente granulares e em tempo real para qualquer recurso do Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Habilite a detecção e a prevenção de ameaças por meio de segurança avançada na nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integridade do Serviço do Azure</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Crie, gerencie e monitore todos os produtos Azure em um console único e unificado</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Simplifique como você gerencia seus recursos de aplicativo</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cloud Shell</h3>
                                                    <p>Agilizar a administração do Azure com um shell baseado em navegador</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Aplicativo móvel do Azure</h3>
                                                    <p>Mantenha-se conectado aos seus recursos do Azure - em qualquer lugar, a qualquer hora</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Implantar e atualizar os ambientes de nuvem de maneira repetida usando artefatos combináveis</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gráfico de Recursos do Azure</h3>
                                                    <p>Explorar os recursos em escala com uma linguagem de consulta avançada</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Aplicativos gerenciados do Azure</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migrações para Azure</h3>
                                                    <p>Descubra, avalie, redimensione e migre com facilidade suas VMs locais para o Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cobrança</h3>
                                                    <p>Saiba como ler e entender o uso e a fatura da sua assinatura do Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Gerenciar recursos do cliente em grande escala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Serviços de mídia</h3>
                                                    <p>Codificar, armazenar e transmitir áudio e vídeo em escala</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Codificação</h3>
                                                    <p>Codificação de nível de estúdio na dimensão da nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Streaming sob demanda e ao vivo</h3>
                                                    <p>Forneça seu conteúdo para praticamente todos os dispositivos com escala para atender às necessidades dos seus negócios</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Player de Mídia do Azure</h3>
                                                    <p>Um único player para todas as suas necessidades de reprodução</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Proteção do conteúdo</h3>
                                                    <p>Distribua conteúdo com segurança usando AES, PlayReady, Widevine e FairPlay</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Descubra informações sobre arquivos de vídeo com serviços visuais e de voz</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Video Indexer</h3>
                                                    <p>Faça com que suas multimídias sejam mais acessíveis e de fácil descoberta</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Stack</h3>
                                                    <p>Estenda os serviços e as funcionalidades locais do Azure, para criar e implantar aplicativos de nuvem híbrida e de borda pelos limites da nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Operador do Azure Stack</h3>
                                                    <p>Saiba como gerenciar a infraestrutura de sistemas integrados do Azure Stack e oferecer serviços</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="/azure/azure-stack/user">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Usuário do Azure Stack</h3>
                                                <p>Usar os serviços e criar aplicativos para o Azure Stack</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="/azure-stack/asdk/">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ASDK (Kit de Desenvolvimento do Azure Stack)</h3>
                                                <p>Um ambiente de não produção para avaliação e teste</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Crie seu caminho com um dispositivo sensor versátil</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin</h3>
                                                    <p>Criar aplicativos móveis incríveis movidos a nuvem ainda mais rápidos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visão Geral da Rede</h3>
                                                    <p>Uma exibição integrada dos serviços de rede no Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>DNS do Azure</h3>
                                                    <p>Hospede seu domínio DNS no Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Rede Virtual</h3>
                                                    <p>Provisione redes privadas e, opcionalmente, conecte-se a datacenters locais</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Load Balancer</h3>
                                                    <p>Forneça alta disponibilidade e desempenho de rede a seus aplicativos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Proteger seus aplicativos contra ataques de DDoS (negação de serviço distribuído)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Escalonável e um ponto de entrada seguro para entregar aplicativos Web globais</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Bastion</h3>
                                                    <p>Assegure conectividade ininterrupta a máquinas virtuais sobre SSL por meio do portal do Azure sem um endereço IP público</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Firewall do Aplicativo Web</h3>
                                                    <p>Forneça proteção centralizada para seus aplicativos Web contra vulnerabilidades e explorações comuns</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Serviço de Emparelhamento</h3>
                                                    <p>Obtenha a conectividade de Internet ideal para acessar a rede da Microsoft</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Analisador de Internet do Azure</h3>
                                                    <p>Avalie como as alterações na infraestrutura de rede afetam o desempenho dos seus clientes</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Link Privado do Azure</h3>
                                                    <p>Acesse de maneira privada serviços hospedados na plataforma do Azure, mantendo seus dados dentro da rede da Microsoft</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gerenciador de Firewall do Azure</h3>
                                                    <p>Um serviço de gerenciamento de segurança globalmente distribuído</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HSM dedicado</h3>
                                                    <p>Usar armazenamento de chaves de criptografia no Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Proteção Avançada contra Ameaças do Azure</h3>
                                                    <p>Proteja sua empresa contra ameaças locais e na nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Central de Segurança do Azure para IoT</h3>
                                                    <p>Saiba como unificar o gerenciamento de segurança e habilitar a proteção avançada contra ameaças em sua solução de IoT</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#other">Nuvens Soberanas</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Governo dos EUA para Microsoft Azure</h3>
                                                    <p>Compilar e hospedar aplicativos das missões do Governo dos EUA em uma instância dedicada do Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Crie e hospede aplicativos em conformidade com as normas Alemães, bem como os principais padrões internacionais, com controle adicional por um objeto de confiança de dados</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Armazenamento</h3>
                                                    <p>Armazenamento em nuvem durável, com alta disponibilidade e massivamente escalonável</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Família de dispositivos de armazenamento que permitem a transferência de dados offline ou baseada em rede</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Executar cargas de trabalho flexíveis baseadas em arquivo no Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Avere vFXT</h3>
                                                    <p>Executar cargas de trabalho de alto desempenho baseadas em arquivo no Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Solução de otimização de armazenamento híbrido para ambientes de HPC</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Gerenciador de Armazenamento</h3>
                                                    <p>Gerencie o Armazenamento facilmente e de qualquer lugar com o Windows, o macOS e o Linux</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Serviço de Aplicativo – Aplicativos Web</h3>
                    ...
                    <li>
                        <a href="#windowsvirtualdesktop">Área de Trabalho Virtual do Windows</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Área de Trabalho Virtual do Windows</h3>
                                                    <p>Forneça uma experiência de área de trabalho virtual para qualquer dispositivo em escala de nuvem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure para desenvolvedores .NET </h3>
                                                <p>
                                                    <a href="/dotnet/azure">Introdução</a>
                                                </p>
                                                <p>
                                                    <a href="/dotnet/api/overview/azure/?view=azure-dotnet">Referência de API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure para desenvolvedores de Python </h3>
                                                <p>
                                                    <a href="/azure/python">Introdução</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">Referência de API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Desenvolvedores do Azure para Node.js </h3>
                                                <p>
                                                    <a href="/azure/javascript/">Introdução</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure para desenvolvedores Java </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure para desenvolvedores Go </h3>
                                                <p>
                                                    <a href="/azure/go/">Introdução</a>
                                                </p>
                                                <p>
                                                    <a href="https://godoc.org/github.com/Azure/azure-sdk-for-go">Referência de API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
APIs REST do Azure </h3>
                                                <p>
                                                    <a href="/rest/api">Referência de API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
CLI do Azure </h3>
                                                ...
                                                <p>
                                                    <a href="/cli/azure/reference-index">Referência</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=navigation+cta&utm_content=download+vs2017">Download do Windows</a>
                                                </p>
                                                 <p>
                                                    <a href="https://visualstudio.microsoft.com/vs/mac/">Download para Mac</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-azureappservice">Serviço de aplicativo</a>
                                                </p>
                                                 <p>
...
Docker </h3>
                                                ...
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780682">Download do Azure DevOps</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Ferramentas de Java </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/api/overview/azure/maven/readme">Plugins Maven</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/azure/java-azure-tools">IntelliJ e Eclipse</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://storageexplorer.com">Gerenciador de Armazenamento</a>
                                                </h3>
                                                <p>
                                                    <a href="/azure/vs-azure-tools-storage-manage-with-storage-explorer">Introdução</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=722418">Download para Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708342">Download para Mac</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708343">Download do Windows</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Ferramentas e SDK do Service Fabric </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started">Download do Windows</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-linux">Download para Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-mac">Baixar o Mac OS X</a>
                                                </p>
                                                <p>
...
Ferramentas do SQL </h3>
                                                <p>
                                                    <a href="/sql/azure-data-studio/download">Azure Data Studio <sup>VERSÃO PRÉVIA</sup></a>
                                                </p>
                                                <p>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Este guia apresenta uma abordagem estruturada para a criação de aplicativos do Azure que são escalonáveis, flexíveis e altamente disponíveis. Ele se baseia nas práticas comprovadas que aprendemos nos contratos com clientes.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Um conjunto de arquiteturas recomendadas para a nuvem. Cada arquitetura inclui práticas recomendadas, etapas prescritivas e uma solução implantável.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
