...
* Azure Synapse Analytics: esse experimento carrega dados no Azure Synapse Analytics criado com 6.000 DWUs
    ...
    Consulte [criar uma análise de Synapse do Azure](../../sql-data-warehouse/sql-data-warehouse-get-started-provision.md) para obter instruções detalhadas sobre como criar um banco de dados de análise do Azure Synapse.  Para obter o melhor desempenho de carga possível na análise de Synapse do Azure usando o polybase, escolhemos o número máximo de unidades de data warehouse (DWUs) permitido na configuração de desempenho, que é 6.000 DWUs.
  ...
  >
    ...
    Para criar um pool SQL Synapse com 6.000 DWUs, mova o controle deslizante de desempenho até o lado direito:
    ...
    Para obter a melhor taxa de transferência possível, a cópia precisa ser executada usando um usuário do Azure Synapse Analytics pertencente à `xlargerc` classe de recurso.  Saiba como fazer isso seguindo [Alterar um exemplo de classe de recurso de usuário](../../sql-data-warehouse/sql-data-warehouse-develop-concurrency.md).  
