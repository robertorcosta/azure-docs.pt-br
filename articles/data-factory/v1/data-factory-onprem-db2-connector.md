...
Primeiramente, instale e configure um gateway de dados. As instruções estão no artigo [movendo dados entre os locais e a nuvem local](data-factory-move-data-between-onprem-and-cloud.md) .
