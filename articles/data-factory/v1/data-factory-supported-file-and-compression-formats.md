...
* Ler dados compactados em GZIP de um blob do Azure, descompactá-los e gravar os dados resultantes em um banco de dados SQL do Azure. Você define o conjunto de dados de blob do Azure de entrada com a propriedade JSON de `compression` `type` como GZIP.
...
* Leia o arquivo .zip de servidor FTP, descompacte-o para obter os arquivos contidos nele e inclua-os no Azure Data Lake Store. Você define um conjunto de dados de FTP de entrada com o `compression` `type` Propriedade JSON como ZipDeflate.
