...
Para usar esse recurso, [Baixe](/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017) e instale o SSMS (SQL Server Management Studio mais recente). Detalhes de suporte de versão como abaixo:
