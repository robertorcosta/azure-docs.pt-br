...
- **LogLevel**:  Insira o escopo selecionado de registro em log de opções de**desempenho** **NULL**/**Basic**/**Verbose**/ detalhadas para suas execuções de pacote no Azure-SSIS ir.
