...
Para usar o AzureDTExec, baixe e instale a versão mais recente do SSMS, que é a versão 18,3 ou posterior. Baixe-o [neste site](/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017).
...
Invocar AzureDTExec oferece opções semelhantes como invocar dtexec. Para saber mais, veja [dtexec Utility](/sql/integration-services/packages/dtexec-utility?view=sql-server-2017). Aqui estão as opções com suporte no momento:
...
- **/De [criptu]** : define a senha de descriptografia para o pacote que é configurado **EncryptAllWithPassword** com o / nível de proteção **EncryptSensitiveWithPassword** do EncryptAllWithPassword.
