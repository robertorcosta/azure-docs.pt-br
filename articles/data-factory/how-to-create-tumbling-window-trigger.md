...
|:--- |:--- |:--- |:--- |:--- |
| **type** | O tipo do gatilho. O tipo é o valor fixo "TumblingWindowTrigger". | Cadeia de caracteres | "TumblingWindowTrigger" | Sim |
...
| **depende: tipo** | O tipo de TumblingWindowTriggerReference. Necessário se uma dependência for definida. | Cadeia de caracteres |  "TumblingWindowTriggerDependencyReference", "SelfDependencyTumblingWindowTriggerReference" | Não |
