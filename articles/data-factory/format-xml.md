...
| ---------------- | ------------------------------------------------------------ | -------- |
| type             | A propriedade Type do conjunto de conjuntos deve ser definida como **XML**. | Sim      |
...
As propriedades a seguir têm suporte na seção *** \* origem \* *** da atividade de cópia. Saiba mais sobre o [comportamento do conector XML](#xml-connector-behavior).

| Propriedade      | Descrição                                                  | Obrigatório |
| ------------- | ------------------------------------------------------------ | -------- |
| type          | A propriedade Type da fonte da atividade de cópia deve ser definida como **xmlSource**. | Sim      |
