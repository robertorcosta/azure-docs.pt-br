...
O ADF SAP BW Open Hub Connector oferece duas propriedades `excludeLastRequest` opcionais `baseRequestId` : e que podem ser usadas para lidar com a carga Delta do Open Hub. 
