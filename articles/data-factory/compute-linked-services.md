...
| [Aprendizado de máquina do Azure](#azure-machine-learning-linked-service) | [Azure Machine Learning executar pipeline](transform-data-machine-learning-service.md) |
| [Aprendizado de máquina do Azure](#azure-machine-learning-linked-service) | [Azure Machine Learning executar pipeline](transform-data-machine-learning-service.md) |
...
Você pode criar **o serviço vinculado ao Azure Databricks** para registrar o espaço de trabalho databricks que você usará para executar as cargas de trabalho databricks (notebook, jar, python). 
> [!IMPORTANT]
