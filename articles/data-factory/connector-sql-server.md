...
**Exemplo 2: Use a autenticação do SQL com uma senha no Azure Key Vault @ no__t-0
...
**Exemplo 2: Invocar um procedimento armazenado durante a cópia @ no__t-0
