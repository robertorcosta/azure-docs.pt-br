...
Atualmente, o fluxo de dados dá suporte ao banco de dados do Azure para PostgreSQL servidor único, mas não a um servidor ou hiperescala (Citus) flexível.
