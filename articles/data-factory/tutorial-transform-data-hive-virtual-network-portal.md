---
title: Transformar dados usando o Hive na Rede Virtual do Azure usando o portal do Azure
...
ms.locfileid: "100377951"
---
# <a name="transform-data-in-azure-virtual-network-using-hive-activity-in-azure-data-factory-using-the-azure-portal"></a>Transformar dados na Rede Virtual do Azure usando a atividade do Hive no Azure Data Factory usando o portal do Azure
...
- **Cluster HDInsight.** Crie um cluster HDInsight e ingresse-o na rede virtual criada na etapa anterior seguindo este artigo: [Estender o Azure HDInsight usando uma Rede Virtual do Azure](../hdinsight/hdinsight-plan-virtual-network-deployment.md). Aqui está uma amostra de configuração do HDInsight em uma Rede Virtual do Azure. 
...
3. Na página **Novo data factory**, insira **ADFTutorialHiveFactory** como o **nome**. 
    ...
    *O nome do data factory “MyAzureSsisDataFactory” não está disponível*
...
1. Para publicar artefatos no Data Factory, clique em **Publicar**.
    ...
    ![A captura de tela mostra a opção de publicação em um Data Factory.](./media/tutorial-transform-data-using-hive-in-vnet-portal/publish.png)
