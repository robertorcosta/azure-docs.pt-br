...
description: Saiba como copiar dados do e para o Microsoft Access usando uma atividade de cópia em um pipeline de Azure Data Factory.
ms.author: jingwang
author: linda33wj
...
ms.locfileid: "104588759"
---
# <a name="copy-data-from-and-to-microsoft-access-using-azure-data-factory"></a>Copiar dados de e para o Microsoft Access usando Azure Data Factory
...
Você pode copiar dados da fonte do Microsoft Access para qualquer armazenamento de dados de coletor com suporte ou copiar de qualquer armazenamento de dados de origem com suporte para o coletor de acesso da Microsoft. Para obter uma lista de armazenamentos de dados com suporte como origens/coletores da atividade de cópia, confira a tabela [Armazenamentos de dados com suporte](copy-activity-overview.md#supported-data-stores-and-formats).
...
Para copiar dados do Microsoft Access, há suporte para as seguintes propriedades na seção **origem** da atividade de cópia:
...
### <a name="microsoft-access-as-sink"></a>Microsoft Access como coletor

Para copiar dados para o Microsoft Access, há suporte para as seguintes propriedades na seção **coletor** de atividade de cópia:

| Propriedade | Descrição | Obrigatório |
|:--- |:--- |:--- |
| type | A propriedade Type do coletor da atividade de cópia deve ser definida como: **MicrosoftAccessSink** | Sim |
