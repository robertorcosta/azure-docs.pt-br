...
description: Transformação achatamento do fluxo de dados do mapeamento de data factory do Azure
author: kromerm
ms.author: makromer
...
Por padrão, o ADF mesclará a estrutura na matriz de redistribuição que você escolheu acima. Ou, você pode escolher uma parte diferente da hierarquia para a qual reverter.
