...
>[!NOTE]
>Se o seu cluster não suportar sessão aderente, por ex. HDInsight, inclua explicitamente o índice do nó no final da configuração do caminho http, por ex. especifique `/hbaserest0`em vez de`/hbaserest`.
