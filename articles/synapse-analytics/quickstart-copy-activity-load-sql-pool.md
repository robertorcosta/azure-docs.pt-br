---
title: Um guia de início rápido para carregar dados no pool de SQL usando a atividade de Cópia
description: Use o Azure Synapse Analytics para carregar dados em um pool de SQL
...
ms.locfileid: "93280721"
---
# <a name="quickstart-load-data-into-sql-pool-using-copy-activity"></a>Início Rápido: Carregar dados no pool de SQL usando a atividade de Cópia
...
Neste guia de início rápido, você aprende a *carregar dados do Banco de Dados SQL do Azure no Azure Synapse Analytics*. Você pode seguir as etapas semelhantes para copiar dados de outros tipos de armazenamentos de dados. E o fluxo semelhante também se aplica à cópia de dados entre outras fontes e coletores.
...
* Azure Synapse Analytics: Você usa um pool de SQL como um armazenamento de dados de coletor. Se você não tiver uma instância do Azure Synapse Analytics, confira [Criar um pool de SQL](quickstart-create-sql-pool-portal.md) para obter as etapas de como criar uma.
...
No Azure Synapse Analytics, um serviço vinculado é onde você define as informações de conexão com outros serviços. Nesta seção, você criará os seguintes dois tipos de serviços vinculados: Serviços vinculados do Banco de Dados SQL do Azure e do Azure Data Lake Storage Gen2.
...
Um pipeline contém o fluxo lógico para uma execução de um conjunto de atividades. Nesta seção, você criará um pipeline que contém uma atividade de cópia que ingere dados do Banco de Dados SQL do Azure em um pool de SQL.
...
1. Selecione **Pool de Análise de SQL** como o seu armazenamento de dados e selecione **Continuar**.
...
> [Visão geral do conector](https://docs.microsoft.com/azure/data-factory/connector-overview?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json)
> [Atividade de cópia](https://docs.microsoft.com/azure/data-factory/copy-activity-overview?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json)