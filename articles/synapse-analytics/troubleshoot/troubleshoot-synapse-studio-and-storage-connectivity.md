...
ms.locfileid: "94557505"
---
# <a name="troubleshoot-connectivity-between-azure-synapse-analytics-synapse-studio-and-storage"></a>Solucionar problemas de conectividade entre o Azure Synapse Analytics Synapse Studio e o armazenamento

No Synapse Studio (versão prévia), você pode explorar os recursos de dados localizados no armazenamento vinculado. Este guia o ajudará a resolver problemas de conectividade quando você estiver tentando acessar seus recursos de dados. 
