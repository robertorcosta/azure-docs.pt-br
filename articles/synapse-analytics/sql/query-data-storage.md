...
Para consultar dados de origem Parquet, use FORMAT = 'CSV'. Você pode especificar o esquema do arquivo CSV como parte da função `OPENROWSET` ao consultar arquivos CSV:
