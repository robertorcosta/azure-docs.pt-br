...
description: Recomendações para projetar tabelas replicadas no SQL Analytics
...
- A instância do SQL Analytics é dimensionada para um nível diferente
...
- [TABELA DE CRIAÇÃO (SQL Analytics)](/sql/t-sql/statements/create-table-azure-sql-data-warehouse)
- [CRIAR TABELA COMO SELECT (SQL Analytics)](/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse)
