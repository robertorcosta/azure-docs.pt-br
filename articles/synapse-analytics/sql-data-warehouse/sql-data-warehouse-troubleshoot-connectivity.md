...
- [ODBCODBC](/sql/connect/odbc/download-odbc-driver-for-sql-server)
...
Verifique se as cadeias de conexão estão configuradas corretamente.  Abaixo estão algumas amostras.  Você pode encontrar informações adicionais sobre [cadeias de conexão aqui](/sql-data-warehouse/sql-data-warehouse-connection-strings.md).
...
Crie um bilhete de [suporte para](/sql-data-warehouse/sql-data-warehouse-get-started-create-support-ticket.md) que a equipe de engenharia possa apoiá-lo.
