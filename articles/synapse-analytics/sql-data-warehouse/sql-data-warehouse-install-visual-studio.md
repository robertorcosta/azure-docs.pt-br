...
description: Instale o Visual Studio e o SQL Server Development Tools (SSDT) para análise sql
...
Há momentos em que os lançamentos de recursos para o SQL Analytics podem não incluir suporte para SSDT. Os seguintes recursos não são suportados no momento:
