...
Veja também [índices de tabela,](sql-data-warehouse-tables-index.md) [guia de índices de columnstore](https://msdn.microsoft.com/library/gg492088.aspx)e[índices de reconstrução de columnstore](sql-data-warehouse-tables-index.md#rebuilding-indexes-to-improve-segment-quality).
