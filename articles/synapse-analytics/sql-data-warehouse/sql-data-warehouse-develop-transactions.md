...
| [DWU](sql-data-warehouse-overview-what-is.md) | Tampa por distribuição (GB) | Número de distribuições | Tamanho da transação MAX (GB) | Nº de linhas por distribuição | Máximo de linhas por transação |
| --- | --- | --- | --- | --- | --- |
