...
Você pode instalar pacotes NuGet de sua escolha em seu bloco de anotações usando o `#r` símbolo antes do nome do pacote NuGet. O diagrama a seguir mostra um exemplo:
