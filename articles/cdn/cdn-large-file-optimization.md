...
description: Saiba como os downloads de arquivos grandes podem ser otimizados na rede de distribuição de conteúdo do Azure. Este artigo inclui vários cenários.
services: cdn
documentationcenter: ''
author: asudbring
manager: danielgi
