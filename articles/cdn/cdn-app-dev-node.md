...
description: Saiba como criar um simples aplicativo de console Node.js que demonstra como automatizar a criação e o gerenciamento de perfis e pontos de extremidade da CDN do Azure.
services: cdn
