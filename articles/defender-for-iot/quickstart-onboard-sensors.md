...
| **Atualizar os parâmetros de rede do sensor antes da ativação** | Atualize os parâmetros definidos durante a instalação do sensor. Para obter mais informações, confira **Carregar arquivos de ativação do sensor**.|
...
4. Selecione uma opção para adquirir um sensor.
   ...
   ![Exibição do sensor de rede do Azure Defender para IoT](media/updates/image6.png)
