---
title: Defender para serviço de IoT sem agentes de segurança
description: Introdução ao fluxo de trabalho interno do serviço defender para IoT.
...
ms.locfileid: "90933277"
---
# <a name="get-started-with-built-in-iot-hub-integration"></a>Introdução à integração interna do Hub IoT

Essa opção permite que você use o serviço sem usar o defender para agentes de segurança de IoT.
...
Parabéns! Você concluiu a habilitação do serviço defender para IoT em seu hub IoT.
