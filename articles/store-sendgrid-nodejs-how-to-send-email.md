...
Algumas propriedades de e-mail podem ser sobreescritas usando **setProperty** ou anexadas usando **addProperty**. Por exemplo, você pode adicionar destinatários adicionais ao usar
