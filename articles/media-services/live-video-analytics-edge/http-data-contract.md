...
description: Neste artigo, você aprenderá a usar o protocolo HTTP para enviar mensagens entre o módulo da Análise Dinâmica de Vídeo e o módulo de IA ou CV.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88701883"
---
# <a name="http-extension-data-contract"></a>Contrato de dados de extensão HTTP

Neste artigo, você aprenderá a usar o protocolo HTTP para enviar mensagens entre o módulo da Análise Dinâmica de Vídeo e o módulo de IA ou CV.
