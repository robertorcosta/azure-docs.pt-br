...
ms.locfileid: "84260719"
---
# <a name="manage-recording-policy"></a>Gerenciar política de gravação

Você pode usar a análise de vídeo ao vivo em IoT Edge para [gravação contínua de vídeo](continuous-video-recording-concept.md), na qual você pode gravar vídeo na nuvem por semanas ou meses. Você pode gerenciar o tamanho (em dias) desse arquivo de nuvem usando as [ferramentas de gerenciamento de ciclo de vida](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal) internas no armazenamento do Azure.  

Sua conta de serviço de mídia está vinculada a uma conta de armazenamento do Azure e, ao gravar vídeo na nuvem, o conteúdo é gravado em um [ativo](../latest/assets-concept.md)de serviço de mídia. Cada ativo é mapeado para um contêiner na conta de armazenamento. o gerenciamento do ciclo de vida permite que você defina uma [política](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#policy) para uma conta de armazenamento, onde você pode especificar uma [regra](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#rules) como a seguinte.
...
* Especifica que, quando os BLOBs envelhecem além de 30 dias, eles são movidos da [camada de acesso quente para fria](https://docs.microsoft.com/azure/storage/blobs/storage-blob-storage-tiers?tabs=azure-portal).
...
* As atualizações de política de gerenciamento de ciclo de vida não são imediatas. Consulte [esta seção de perguntas frequentes](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#faq) para obter mais detalhes.
