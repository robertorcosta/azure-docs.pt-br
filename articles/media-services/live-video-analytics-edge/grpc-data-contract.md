---
title: Contrato de dados de extensão gRPC – Azure
description: Neste artigo, você aprenderá a usar o protocolo gRPC para enviar mensagens entre o módulo da Análise Dinâmica de Vídeo e a extensão personalizada de IA ou CV.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88687088"
---
# <a name="grpc-extension-data-contract"></a>Contrato de dados de extensão gRPC

Neste artigo, você aprenderá a usar o protocolo gRPC para enviar mensagens entre o módulo da Análise Dinâmica de Vídeo e a extensão personalizada de IA ou CV.
...
Em uma só sessão: O cliente envia um descritor de fluxo de mídia seguido de quadros de vídeo ao servidor como uma mensagem [protobuf](https://developers.google.com/protocol-buffers) na sessão de fluxo gRPC. O servidor valida o descritor de fluxo, analisa o quadro de vídeo e retorna os resultados de inferência como uma mensagem protobuf.
...
![Mensagens de protocolo](./media/data-contracts/grpc2.png)
