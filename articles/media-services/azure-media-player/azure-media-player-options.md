...
Outras propriedades da `playbackSpeed` configuração são fornecidas pelo objeto [PlaybackSpeedOptions](/javascript/api/azuremediaplayer/playbackspeedoptions) .
