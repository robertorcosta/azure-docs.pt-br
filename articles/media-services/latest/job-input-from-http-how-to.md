...
description: Este tópico demonstra como criar uma entrada de trabalho do Azure Media Services a partir de uma URL HTTPS.
...
[Crie uma entrada de trabalho a partir de um arquivo local](job-input-from-local-file-how-to.md).
