...
Para exibir todas as transformações da API REST que estão disponíveis, consulte [transformações-criar ou atualizar](/rest/api/media/transforms/createorupdate#definitions).
