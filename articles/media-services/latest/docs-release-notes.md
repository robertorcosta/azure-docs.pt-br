---
title: Atualizações de documentação dos serviços de mídia do Azure v3
description: Para se manter atualizado com as atualizações mais recentes da documentação dos serviços de mídia v3.
...
* A visualização da análise de vídeo ao vivo em IoT Edge ficou pública. Consulte os detalhes na documentação de [análise de vídeo ao vivo na IOT Edge](../live-video-analytics-edge/index.yml) .
...
A [transmissão ao vivo com](live-events-wirecast-quickstart.md) o guia de início rápido do Telestream Wirecast foi adicionada. Ele mostra como criar uma transmissão ao vivo dos serviços de mídia do Azure usando o portal do Azure e o Telestream Wirecast.

## <a name="next-steps"></a>Próximas etapas

- [Visão geral](media-services-overview.md)
- [Notas de versão dos serviços de mídia v3](release-notes.md)
