---
title: Usar chaves gerenciadas pelo cliente ou BYOK
...
ms.locfileid: "92740466"
---
# <a name="tutorial-use-customer-managed-keys-or-byok-with-media-services"></a>Tutorial: Usar chaves gerenciadas pelo cliente ou BYOK com os Serviços de Mídia

Com a API 2020-05-01, você pode usar uma chave RSA gerenciada pelo cliente com uma conta dos Serviços de Mídia do Azure que tenha uma identidade gerenciada pelo sistema. Este tutorial inclui uma coleção e um ambiente de do Postman para enviar solicitações REST para os serviços do Azure. Os serviços usados são:
...
1. [Crie uma entidade de serviço](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal).
1. Vá para a [Opção 2: Criar um segredo do aplicativo](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal#authentication-two-options) para obter o segredo da entidade de serviço.
