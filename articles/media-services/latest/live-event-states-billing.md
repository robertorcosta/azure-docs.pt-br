...
|Estado|Description|
|---|---|
|**Stopped (parado)**| Esse é o estado inicial do evento ao vivo após a criação (a menos que AutoStart tenha sido definido como true). Nenhuma cobrança ocorre nesse estado. Nesse estado, as propriedades do evento ao vivo poderão ser atualizadas, mas streamings não serão permitidos.|
