...
ms.locfileid: "104608990"
---
# <a name="monitor-media-services-diagnostic-logs"></a>Monitorar logs de diagnóstico dos serviços de mídia

[!INCLUDE [media services api v3 logo](../includes/v3-hr.md)]

[Azure monitor](https://docs.microsoft.com/azure/azure-monitor/overview.md) permite que você monitore as métricas e os logs de diagnóstico que ajudam a entender como seus aplicativos estão sendo executados. Para obter uma descrição detalhada desse recurso e ver por que você desejaria usar os logs de diagnóstico e as métricas dos serviços de mídia do Azure, consulte [monitorar as métricas dos serviços de mídia e os logs de diagnóstico](monitor-media-services.md).
...
- Examine os  [serviços de mídia do monitor](monitor-media-services.md).
...
* [Azure Monitor logs de diagnóstico](https://docs.microsoft.com/azure/azure-monitor/essentials/platform-logs-overview.md)
* [Como coletar e consumir dados de log de seus recursos do Azure](https://docs.microsoft.com/azure/azure-monitor/essentials/platform-logs-overview.md)
