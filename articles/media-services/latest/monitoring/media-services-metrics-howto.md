...
ms.locfileid: "104608988"
---
# <a name="monitor-media-services-metrics"></a>Monitorar as métricas dos Serviços de Mídia do Microsoft Azure

[!INCLUDE [media services api v3 logo](../includes/v3-hr.md)]

[Azure monitor](https://docs.microsoft.com/azure/azure-monitor/overview.md) permite que você monitore as métricas e os logs de diagnóstico que ajudam a entender como seus aplicativos estão sendo executados. Para obter uma descrição detalhada desse recurso e entender por que você deve usar as métricas dos serviços de mídia do Azure e os logs de diagnóstico, consulte [monitorar as métricas dos serviços de mídia e os logs de diagnóstico](monitor-media-services-data-reference.md).
...
- Examinar  [os logs de diagnóstico e as métricas dos serviços de mídia](monitor-media-services-data-reference.md)
...
1. Clique na caixa **escopo** e selecione o recurso que você deseja monitorar.
    ...
    * &lt;nome da conta de armazenamento&gt;
    ...
    Filtre, selecione o recurso e pressione **aplicar**. Para obter detalhes sobre os recursos e as métricas com suporte, consulte [monitorar métricas dos serviços de mídia](monitor-media-services-data-reference.md).
...
- [Crie, exiba e gerencie alertas de métrica usando Azure monitor](https://docs.microsoft.com/azure/azure-monitor/alerts/alerts-metric.md).
