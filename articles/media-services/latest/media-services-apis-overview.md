...
Como desenvolvedor, você pode usar a [API REST](https://docs.microsoft.com/rest/api/media/) dos Serviços de Mídia ou bibliotecas de clientes que permitem interagir com a API REST para criar, gerenciar e manter fluxos de trabalho de mídia personalizados com facilidade. A API [dos serviços de mídia v3](https://aka.ms/ams-v3-rest-sdk) é baseada na especificação openapi (anteriormente conhecida como Swagger).
