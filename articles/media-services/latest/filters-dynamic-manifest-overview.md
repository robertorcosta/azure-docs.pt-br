...
- Os clientes precisam baixar manualmente o manifesto e analisar o carimbo de data/hora de início exato e a escala de tempo.
    ...
    - A fórmula para definir as propriedades de carimbo de data/hora do filtro de ativos é: <br/>startTimestamp = &lt;hora de início no&gt;de manifesto  +  &lt;tempo de início de filtro esperado em segundos&gt; * escala de tempo
