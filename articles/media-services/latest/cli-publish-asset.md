---
title: Exemplo de Script da CLI do Azure – Publicar um ativo
description: Este artigo demonstra como usar o script da CLI do Azure para publicar um ativo.
