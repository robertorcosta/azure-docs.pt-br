---
title: Guia de início rápido de codificação básica de Serviços de Mídia e do Python
description: Este guia de início rápido mostrará de que modo executar uma codificação básica usando o Python e os Serviços de Mídia do Azure.
...
ms.locfileid: "102500828"
---
# <a name="media-services-basic-encoding-with-python"></a>Codificação básica de Serviços de Mídia usando o Python

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

## <a name="introduction"></a>Introdução

Este guia de início rápido mostrará de que modo executar uma codificação básica usando o Python e os Serviços de Mídia do Azure. Ele usará a API do Serviço de Mídia v3 de 01/05/2020.

## <a name="prerequisites"></a>Pré-requisitos

- Se você não tiver uma assinatura do Azure, crie uma [conta gratuita](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) antes de começar.
- Criar um grupo de recursos para ser usado com este guia de início rápido.
- Criar uma conta de Serviços de Mídia v3.
- Obter uma chave de conta de armazenamento.
- Criar uma entidade de serviço e uma chave.

## <a name="get-the-sample"></a>Obter o exemplo

Crie uma bifurcação e clone um exemplo localizado no [repositório de exemplos do Python](https://github.com/Azure-Samples/media-services-v3-python). Neste guia de início rápido, trabalharemos com o exemplo BasicEncoding.

## <a name="create-the-env-file"></a>Criar um arquivo .env

Obtenha os valores de sua conta para criar um arquivo *.env*. Salve somente a extensão, sem o nome.  Use *sample.env* como um modelo e salve o arquivo *.env* na pasta BasicEncoder do clone local.

## <a name="try-the-code"></a>Experimente o código

O código abaixo terá comentários detalhados.  Use o script inteiro ou partes dele em um script próprio.

Neste exemplo, um número aleatório será gerado para nomear alguns itens. Desse modo, será possível identificá-los como um grupo criado em conjunto durante a execução do script.  O número aleatório é opcional. Além disso, ele poderá ser removido quando você terminar de testar o script.

Neste exemplo, não estamos usando a URL SAS para o ativo de entrada.
...
Após concluir o guia de início rápido, exclua os recursos criados no grupo de recursos.

## <a name="next-steps"></a>Próximas etapas

Conheça o [SDK do Python dos Serviços de Mídia](https://docs.microsoft.com/python/api/azure-mgmt-media/)