...
## <a name="offline-fairplay-questions"></a>Perguntas Fairplay offline

Consulte [perguntas de Fairplay offline](questions-collection.md#why-does-only-audio-play-but-not-video-during-offline-mode).
