---
title: Perguntas frequentes sobre os Serviços de Mídia do Azure
description: Este artigo fornece respostas às perguntas frequentes sobre os Serviços de Mídia do Azure.
...
ms.locfileid: "103013373"
---
# <a name="media-services-v2-frequently-asked-questions"></a>Perguntas frequentes sobre os Serviços de Mídia v2
...
A: as unidades reservadas são as mesmas para tarefas de codificação e indexação. Siga as instruções em [Como dimensionar unidades reservadas de codificação](media-services-scale-media-processing-overview.md). **Observação** o desempenho do indexador não é afetado pelo tipo de unidade reservada.
