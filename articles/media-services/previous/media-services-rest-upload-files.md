...
2. Pressione **Enviar** .
    ...
    ![Captura de tela que mostra "localizador-criar S um localizador" selecionado no menu "coleções" e o botão "enviar" selecionado.](./media/media-services-rest-upload-files/postman-create-sas-locator.png)
