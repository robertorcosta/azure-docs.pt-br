...
Dependendo do tipo de entidade e do estado em que está, você pode atualizar as propriedades nesta entidade por meio de um PATCH, PUT ou  solicitações HTTP MERGE. Para obter mais informações sobre essas operações, consulte [PATCH, PUT, MERGE](/openspecs/windows_protocols/ms-odata/59d5abd3-7b12-490a-a0e2-9d9324b91893).
