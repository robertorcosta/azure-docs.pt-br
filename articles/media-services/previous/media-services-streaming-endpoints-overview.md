...
Se seu ponto de extremidade de streaming **versão “1.0”** tiver unidades de streaming (SU) premium maiores ou iguais a 1, ele será um ponto de extremidade de streaming premium e oferecerá todos os recursos do AMS (assim como o tipo **Standard/Premium**) sem etapas adicionais de configuração.
