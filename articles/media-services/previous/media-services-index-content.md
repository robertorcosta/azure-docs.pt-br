...
* Arquivos de legendas fechados nos seguintes formatos: **TTML**e **WebVTT**.
...
<!-- __ -->
### <a name="output-files"></a><a id="output_files"></a>Arquivos de saída
...
Quando houver mais de um arquivo de mídia de entrada, o Indexador irá gerar um arquivo de manifesto para saídas do trabalho, nomeado 'JobResult.txt'. Para cada arquivo de mídia de entrada, os arquivos TTML, WebVTT e palavras-chave resultantes são numerados sequencialmente e nomeados usando o "Alias".

| Nome do arquivo | Descrição |
| --- | --- |
| **InputFileName.ttml**<br/>**InputFileName.vtt** |Arquivos de Legenda Fechada (CC) nos formatos TTML e WebVTT.<br/><br/>Eles podem ser usados para tornar os arquivos de áudio e vídeo acessíveis para pessoas com deficiência auditiva.<br/><br/>Arquivos de legenda oculta incluem uma marca chamada <b>Recognizability</b>, que classifica um trabalho de indexação com base no quanto a fala é reconhecível no vídeo de origem.  Você pode usar o valor de <b>Reconhecimento</b> para mostrar os arquivos de saída na tela e facilitar o uso. Uma baixa pontuação significaria resultados de indexação fraca devido a qualidade do áudio. |
...
## <a name="supported-languages"></a><a id="supported_languages"></a>Idiomas suportados
