...
Você pode transmitir um conjunto de MP4 com taxa de bits adaptável ao criar um localizador de streaming sob demanda e criar uma URL de transmissão. O artigo [codificando um ativo](media-services-rest-encode-asset.md) mostra como codificar para um conjunto de MP4 de taxa de bits adaptável. Se o seu conteúdo for criptografado, configure a política de entrega de ativos (conforme descrito [neste](media-services-rest-configure-asset-delivery-policy.md) artigo) antes de criar um localizador. 
...
Este tópico mostra como criar um localizador de streaming sob demanda para publicar seu ativo e compilar um Smooth, MPEG DASH e URLs de streaming do HLS. Ele também mostra como construir URLs de download progressivos.
...
>[!NOTE]
>Depois de se conectar com êxito a https://media.windows.net, você receberá um redirecionamento 301 especificando outro URI dos Serviços de Mídia do Azure. Você deve fazer chamadas subsequentes para o novo URI.
...
[Visão geral das operações de Serviços de Mídia REST API](media-services-rest-how-to-use.md)
