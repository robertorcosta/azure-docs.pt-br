...
Salve o JSON definido no artigo [H264 Taxas de Bits Múltiplas 720p](media-services-mes-preset-H264-Multiple-Bitrate-720p.md) em algum arquivo com a extensão .json. Por exemplo, **CustomPreset_JSON.json**.
