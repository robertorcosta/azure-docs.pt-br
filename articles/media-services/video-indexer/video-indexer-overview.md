...
* **Transcrição de áudio**: Converte a fala em texto em 12 idiomas e permite extensões. Os idiomas suportados incluem inglês, espanhol, francês, alemão, italiano, mandarim chinês, japonês, árabe, russo, português brasileiro, hindi e coreano.
* **Detecção automática de idioma**: identifica automaticamente o idioma falado dominante. Os idiomas suportados incluem inglês, espanhol, francês, alemão, italiano, mandarim chinês, japonês, russo e português brasileiro. Se o idioma não pode ser identificado com confiança, o Video Indexer assume que a língua falada é o inglês. Para obter mais informações, consulte [o modelo de identificação de idiomas](language-identification-model.md).
