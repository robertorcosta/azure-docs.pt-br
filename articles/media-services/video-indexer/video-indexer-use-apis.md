...
1. Entre no [Portal do Desenvolvedor do Video Indexer](https://api-portal.videoindexer.ai/).
   ...
   > * Pode haver apenas uma conta ativa por email. Se um usuário tentar entrar user@gmail.com no LinkedIn e posterior com user@gmail.com para o Google, o último exibirá uma página de erro, dizendo que o usuário já existe.
