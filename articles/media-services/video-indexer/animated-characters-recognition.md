...
|Number of animation models|Um|Up to 100 models per account (Custom Vision limitation).|
...
1. Tag and train the model.
    ...
    1. Depois de digitar o novo nome, clique no ícone de verificação ao lado do novo nome. This saves the new name in the model in Video Indexer.
