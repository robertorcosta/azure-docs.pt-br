...
**Diretrizes**: Azure cloud Shell é uma experiência de linha de comando baseada em navegador que usa a mesma autorização usada para acessar o portal do Azure, nesse caso, qualquer MFA necessária para se conectar ao portal do Azure também será necessária para Cloud Shell. 
