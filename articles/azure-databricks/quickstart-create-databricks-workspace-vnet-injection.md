...
2. Em **serviço Azure Databricks**, aplique as seguintes configurações:
    ...
    |Camada de preços|Escolha entre o cluster Standard e o Premium.|Para obter mais informações sobre tipos de preço, consulte a [página de preços do databricks](https://azure.microsoft.com/pricing/details/databricks/).|
