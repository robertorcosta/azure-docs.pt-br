...
7. Adicione uma regra para abrir a porta 22 para SSH. Use as configurações a seguir:
    ...
    |Endereços IP de destino|<o IP público da VM\>|Insira o endereço IP público da máquina virtual. Você pode encontrá-lo na página **visão geral** de sua máquina virtual.|
