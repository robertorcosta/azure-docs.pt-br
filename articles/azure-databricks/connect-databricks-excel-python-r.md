...
* Para saber mais sobre as fontes de onde você pode importar dados para o Azure Databricks, consulte [Fontes de dados para o Azure Databricks](/azure/databricks/data/data-sources/index)
