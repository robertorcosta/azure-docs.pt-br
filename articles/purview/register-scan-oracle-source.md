...
4.  Você precisará baixar manualmente um driver do Oracle JDBC denominado "oracle.jdbc.driver.OracleDriver\' em sua máquina virtual em que o runtime de integração auto-hospedada está em execução.
