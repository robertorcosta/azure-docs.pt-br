...
* Ponto de extremidade do Atlas:
  ...
  * Selecione **Visão geral**, encontre **Ponto de Extremidade do Atlas** e escolha o ícone **Copiar para a área de transferência** para salvar o valor dele. Remova a parte *https://* da cadeia de caracteres ao usá-la mais tarde.
* Nome da conta:
