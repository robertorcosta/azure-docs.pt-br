...
* **Uma conta do Azure Data Lake armazenamento Gen1**. Para obter instruções sobre como criar uma, consulte [Introdução ao Azure Data Lake Storage Gen1](data-lake-store-get-started-portal.md)
* **Cluster Azure HDInsight** com acesso a uma conta do Azure Data Lake Storage Gen1. Ver [criar um cluster de HDInsight com Data Lake armazenamento Gen1](data-lake-store-hdinsight-hadoop-use-portal.md). Certifique-se de habilitar a área de trabalho remota para o cluster.
...
* **Examine as diretrizes de ajuste de desempenho para data Lake Storage Gen1**. Para ver os conceitos gerais de desempenho, consulte [Data Lake armazenamento Gen1 desempenho diretrizes de ajuste](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-performance-tuning-guidance)
