---
title: Gerenciar conta de Azure Data Lake Storage Gen1-CLI do Azure
...
* **CLI do Azure** – Confira [Instalar a CLI do Azure](/cli/azure/install-azure-cli) para obter instruções.
