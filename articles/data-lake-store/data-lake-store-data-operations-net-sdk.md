...
* **Conta do Azure Data Lake Storage Gen1**. Para obter instruções sobre como criar uma conta, consulte Introdução [ao Azure data Lake Storage Gen1](data-lake-store-get-started-portal.md).
