...
Neste artigo, você aprenderá a executar operações de gerenciamento de conta no Azure Data Lake armazenamento Gen1 usando a API REST. As operações de gerenciamento de contas incluem a criação de uma conta Data Lake Storage Gen1, a exclusão de uma conta Data Lake Storage Gen1, etc. Para obter instruções sobre como executar operações de sistema de arquivos no Data Lake Storage Gen1 usando a API REST, consulte [as operações do Sistema de Arquivos no Data Lake Storage Gen1 usando a API REST](data-lake-store-data-operations-rest-api.md).
...
Use o comando cURL a seguir. Substitua seu ** \<>de nome storagegen1name** com o nome Data Lake Storage Gen1.
...
Use o comando cURL a seguir para excluir uma conta do Data Lake armazenamento Gen1. Substitua seu ** \<>de nome de armazenamentogen1com** o nome da conta Data Lake Storage Gen1.
