...
O Data Lake Storage Gen1 fornece uma ferramenta de linha de comando, [a AdlCopy,](https://www.microsoft.com/download/details.aspx?id=50358)para copiar dados das seguintes fontes:

* De blobs de armazenamento Azure para Data Lake Storage Gen1. Você não pode usar o AdlCopy para copiar dados do Data Lake Storage Gen1 para blobs de armazenamento Azure.
* Entre duas contas Data Lake Storage Gen1.
...
* **Azure Storage blobs** contêiner com alguns dados.
...
* **Conta data lake analytics (opcional)** - [Consulte Comece com o Azure Data Lake Analytics](../data-lake-analytics/data-lake-analytics-get-started-portal.md) para obter instruções sobre como criar uma conta data lake analytics.
...
| Padrão |Especifica um padrão regex que indica quais blobs ou arquivos copiar. O AdlCopy usa correspondência que diferencia maiúsculas de minúsculas. O padrão padrão quando nenhum padrão é especificado é copiar todos os itens. Não é possível especificar diversos padrões para os arquivos. |
