---
title: 'Tutorial: Migre o MongoDB offline para a API do Azure Cosmos DB para MongoDB'
titleSuffix: Azure Database Migration Service
description: Aprenda a migrar do MongoDB no local para a API DB do Azure Cosmos para o MongoDB offline usando o Azure Database Migration Service.
services: dms
author: pochiraju
ms.author: rajpo
manager: craigg
...
---
# <a name="tutorial-migrate-mongodb-to-azure-cosmos-dbs-api-for-mongodb-offline-using-dms"></a>Tutorial: Migre o MongoDB para a API do Azure Cosmos DB para MongoDB offline usando DMS
