...
* [Crie um banco de dados em um Banco de Dados SQL do Azure, no portal do Azure](https://docs.microsoft.com/azure/sql-database/sql-database-get-started-portal) ou [Crie um banco de dados em uma Instância Gerenciada de SQL](https://docs.microsoft.com/azure/sql-database/sql-database-managed-instance-get-started) e, depois, crie um banco de dados vazio chamado **AdventureWorks2012**. 
...
* Para obter informações sobre o Serviço de Migração de Banco de Dados, confira o artigo [O que é o Serviço de Migração de Banco de Dados?](https://docs.microsoft.com/azure/dms/dms-overview).
* Para obter informações sobre o Banco de Dados SQL, confira o artigo [O que é o serviço Banco de Dados SQL?](https://docs.microsoft.com/azure/sql-database/sql-database-technical-overview).
* Para obter informações sobre as Instâncias Gerenciada de SQL, confira o artigo [O que é a Instância Gerenciada de SQL](https://docs.microsoft.com/azure/azure-sql/managed-instance/sql-managed-instance-paas-overview).
