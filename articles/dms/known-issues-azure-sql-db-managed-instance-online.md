...
- **Backups com soma de verificação**
    ...
    [Habilitar ou desabilitar as somas de verificação de backup durante o backup ou a restauração (SQL Server)](https://docs.microsoft.com/sql/relational-databases/backup-restore/enable-or-disable-backup-checksums-during-backup-or-restore-sql-server?view=sql-server-2017)
