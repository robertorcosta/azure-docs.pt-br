...
Você precisa implantar um agente em um computador Linux dedicado (VM ou local) para dar suporte à comunicação entre F5 e o Azure Sentinel. O diagrama a seguir descreve a configuração no caso de uma VM do Linux no Azure.
...
## <a name="step-2-configure-your-f5-to-send-cef-messages"></a>ETAPA 2: configurar o F5 para enviar mensagens CEF
