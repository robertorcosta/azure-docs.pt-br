...
| `plugin_flush_interval` | número | Campo opcional. Defina para definir o intervalo máximo (em segundos) entre as transmissões de mensagem para Log Analytics. O padrão é 5. |
    | `amount_resizing` | booleano | Verdadeiro ou falso. Habilitar ou desabilitar o mecanismo de dimensionamento automático, que ajusta o tamanho do buffer de mensagens de acordo com o volume de dados de log recebidos. |
