...
- Aqui está outra consulta de exemplo, uma que o alertaria quando um número anormal de recursos for criado na [atividade do Azure](../azure-monitor/essentials/activity-log.md).
