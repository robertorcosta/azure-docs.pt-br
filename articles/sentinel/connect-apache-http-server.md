...
Configure o local dos arquivos de log do Apache HTTP Server para encaminhar dados para o espaço de trabalho do Azure por meio do agente de Log Analytics.
