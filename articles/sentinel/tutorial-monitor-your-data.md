...
1. Para alternar entre pastas de trabalho em seu espaço de trabalho, **Open** ![você pode selecionar abrir](./media/tutorial-monitor-data/switch.png)as pastas de trabalho do comutador no painel superior de qualquer pasta de trabalho. Na janela que é aberta à direita, alterne entre pastas de trabalho.
