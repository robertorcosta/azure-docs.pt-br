...
The following table displays roles and allowed actions in Azure Sentinel. Um X indica que a ação é permitida para essa função.
...
> [!NOTE]
> - Recomendamos que você atribua a função menos permissiva necessária para os usuários realizarem suas tarefas. For example, assign the Azure Sentinel contributor role only to users who need to create rules or dashboards.
...
* [Azure Sentinel Blog](https://aka.ms/azuresentinelblog). Encontre postagens no blog sobre a conformidade e segurança do Azure.
