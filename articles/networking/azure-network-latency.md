...
## <a name="january-2020-round-trip-latency-figures"></a>Números de latência de ida e volta de janeiro de 2020

Os tempos médios de ida e volta mensais entre as regiões do Azure para os últimos 31 dias (terminando em 31 de janeiro de 2020) são mostrados abaixo. As medidas a seguir são alimentadas por [ThousandEyes](https://thousandeyes.com).
