...
A documentação de referência da API REST de renderização remota pode ser encontrada [aqui](https://docs.microsoft.com/rest/api/mixedreality/2021-01-01preview/remoterendering)e as definições do Swagger [aqui](https://github.com/Azure/azure-rest-api-specs/tree/master/specification/mixedreality/data-plane/Microsoft.MixedReality).
