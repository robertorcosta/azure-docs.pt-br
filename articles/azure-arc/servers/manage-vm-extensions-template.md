...
## <a name="deploy-the-dependency-agent"></a>Implantar o Dependency Agent
...
* Você pode implantar e remover uma extensão usando o CLI do Azure ou o PowerShell.
