...
- O cluster kubernetes deve ter [Armazenamento remoto compartilhado](https://docs.microsoft.com/en-us/azure/azure-arc/data/storage-configuration#factors-to-consider-when-choosing-your-storage-configuration) 
