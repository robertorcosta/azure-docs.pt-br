...
ms.locfileid: "90933780"
---
# <a name="install-client-tools-for-deploying-and-managing-azure-arc-enabled-data-services"></a>Instalar as ferramentas de cliente para implantar e gerenciar serviços de dados habilitados para Arc do Azure
...
| Azure Data Studio | Sim | Ferramenta de experiência avançada para conectar e consultar uma variedade de bancos de dados, incluindo Azure SQL, SQL Server, PostrgreSQL e MySQL. As extensões para Azure Data Studio fornecem uma experiência de administração para os serviços de dados habilitados para o Azure Arc. | [Instalar](https://aka.ms/getazuredatastudio) |
...
| Extensão PostgreSQL no Azure Data Studio | No | A extensão PostgreSQL para Azure Data Studio que fornece recursos de gerenciamento para PostgreSQL. | <!--{need link} [Install](../azure-data-studio/data-virtualization-extension.md) --> Instale a partir da Galeria de extensões no Azure Data Studio.|
...
<sup>3</sup> se você estiver usando o PowerShell, a rotação será um alias para o cmdlet Invoke-WebRequest.
