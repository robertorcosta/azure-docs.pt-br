...
### <a name="lets-delete-the-server-group-used-in-this-example"></a>Vamos excluir o grupo de servidores usado neste exemplo:
```console
...
>**Observação** Como indicado, não excluir os PVCs pode eventualmente obter o cluster kubernetes em uma situação em que ele gerará erros. Alguns desses erros podem incluir não conseguir fazer logon no cluster kubernetes com azdata, pois o pods pode ser removido dele devido a esse problema de armazenamento (comportamento normal de kubernetes).
>
