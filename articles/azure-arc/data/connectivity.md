...
Atualmente, na visualização, há suporte apenas para o modo indiretamente conectado. 
...
|**Backup e restauração**|Ambiente do cliente-> ambiente do cliente|Necessária|Não|Direta ou indireta|O serviço de backup e restauração pode ser configurado para apontar para classes de armazenamento local. |
...
### <a name="azure-resource-manager-apis"></a>APIs de Azure Resource Manager
