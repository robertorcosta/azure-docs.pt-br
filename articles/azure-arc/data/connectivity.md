...
|**Serviços de segurança do Azure defender**|Ambiente do cliente-> ambiente do cliente do Azure >|Opcional|Yes|Somente direto|**Disponibilidade pendente do modo conectado diretamente**|
