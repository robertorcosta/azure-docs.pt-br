...
Não há nenhum custo para analisar dados de monitoramento que são coletados por padrão. Incluem os itens a seguir:
...
![Visões](media/monitor-azure-resource/insights.png)
