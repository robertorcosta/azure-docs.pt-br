---
title: Monitorar o cluster de Data Explorer do Azure com Azure Monitor para o Azure Data Explorer (versão prévia) | Microsoft Docs
...
ms.locfileid: "97901664"
---
# <a name="monitoring-your-azure-data-explorer-cluster-with-azure-monitor-for-azure-data-explorer-preview"></a>Monitorando o cluster de Data Explorer do Azure com Azure Monitor para Azure Data Explorer (versão prévia)
...
![Captura de tela da experiência de visão geral com vários grafos](./media/data-explorer-insights/insights-hub.png)
...
![Captura de tela da guia desempenho de consulta](./media/data-explorer-insights/query-performance.png)
...
[![Captura de tela da guia desempenho de ingestão](./media/data-explorer-insights/ingestion-performance.png)](./media/data-explorer-insights/ingestion-performance.png#lightbox)
...
![Captura de tela do botão azul que exibe o texto "Habilitar logs para monitoramento"](./media/data-explorer-insights/enable-logs.png)
...
[![Captura de tela da exibição de um recurso de cluster Data Explorer do Azure](./media/data-explorer-insights/overview.png)](./media/data-explorer-insights/overview.png#lightbox)
...
[![Captura de tela da exibição de falhas](./media/data-explorer-insights/key-metrics.png)](./media/data-explorer-insights/key-metrics.png#lightbox)
...
[![Captura de tela do modo de exibição de operações com gráficos de rosca do aplicativo principal por contagem de comando e consulta, principais principais por contagem de comando e consulta e comandos principais por tipos de comando](./media/data-explorer-insights/usage.png)](./media/data-explorer-insights/usage.png#lightbox)

[![Captura de tela do modo de exibição de operações com gráficos de linhas de contagem de consultas por aplicativo, memória total por aplicativo e total de CPU por aplicativo](./media/data-explorer-insights/usage-2.png)](./media/data-explorer-insights/usage-2.png#lightbox)
...
[![Captura de tela de detalhes do cache](./media/data-explorer-insights/cache-tab.png)](./media/data-explorer-insights/cache-tab.png#lightbox)
...
![Captura de tela do ícone de fixação selecionado](./media/data-explorer-insights/pin.png)
...
![Captura de tela do botão Personalizar](./media/data-explorer-insights/customize.png)
...
![Captura de tela da galeria da pasta de trabalho](./media/data-explorer-insights/gallery.png)
...
### <a name="i-have-already-enabled-logs-for-my-azure-data-explorer-cluster-why-am-i-still-unable-to-see-my-data-under-commands-and-queries"></a>Já habilitei logs para meu cluster de Data Explorer do Azure, por que ainda não consigo ver meus dados em comandos e consultas
