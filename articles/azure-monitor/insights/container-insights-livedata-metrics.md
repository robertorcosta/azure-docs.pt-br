...
Esse gráfico de desempenho é mapeado para um equivalente de invocar `kubectl get pods –all-namespaces` e mapeia a coluna de **status** o gráfico agrupado por tipos de status.
