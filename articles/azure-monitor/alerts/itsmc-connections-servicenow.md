...
![Captura de tela de caixas e opções para adicionar uma conexão do ServiceNow.](media/itsmc-connections-servicenow/itsm-connection-servicenow-connection-latest.png)
