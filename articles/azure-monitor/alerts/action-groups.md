...
### <a name="itsm"></a>ITSM
Ação de ITSM exige uma Conexão de ITSM. Saiba como criar uma [Conexão de ITSM](../platform/itsmc-overview.md).
...
* Saiba mais sobre [conector ITSM](../platform/itsmc-overview.md).
