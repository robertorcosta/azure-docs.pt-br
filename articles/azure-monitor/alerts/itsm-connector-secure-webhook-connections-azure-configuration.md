...
Essa etapa pode ser feita por meio dos mesmos [comandos do PowerShell](../alerts/action-groups.md#secure-webhook-powershell-script).
...
Para saber mais sobre grupos de ações, veja [Criar e gerenciar grupos de ações no portal do Azure](../alerts/action-groups.md).
...
3. Selecione [Adicionar grupo de ações](../alerts/action-groups.md#create-an-action-group-by-using-the-azure-portal) e preencha os campos.
...
6. Selecione estes detalhes:
   ...
   ![Captura de tela que mostra uma ação de webhook segura.](media/itsm-connector-secure-webhook-connections-azure-configuration/secure-webhook.png)
