---
title: Criar relatórios interativos com Azure Monitor pastas de trabalho | Parâmetros de tempo | Microsoft docs
...
2. A maioria dos controles de pasta de trabalho oferece suporte a um seletor de escopo de _intervalo_ Abra a lista suspensa _intervalo de tempo_ e selecione o `{TimeRange}` no grupo de parâmetros de intervalos de tempo na parte inferior.
