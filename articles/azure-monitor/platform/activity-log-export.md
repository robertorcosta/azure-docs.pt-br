...
> [!IMPORTANT]
> O método para enviar o log de atividades do Azure para o armazenamento do Azure e hubs de eventos do Azure foi alterado para [configurações de diagnóstico](diagnostic-settings.md). Este artigo descreve o método herdado que está no processo de ser preterido. Consulte atualizar para [coletar e analisar o log de atividades do Azure em Azure monitor](activity-log-collect.md) para obter uma comparação.
