...
Adicione a marca '-forceDelete ' para excluir permanentemente seu espaço de trabalho:
...
3. Clique em **Recuperar** no menu superior esquerdo para abrir uma página com espaço de trabalhos no estado de exclusão reversível que podem ser recuperados.
   ...
   ![Recuperar o espaço de trabalho](media/delete-workspace/recover-menu.png)

4. Selecione o espaço de trabalho e clique em **Recuperar** para recuperá-lo.

   ![Recuperar o espaço de trabalho](media/delete-workspace/recover-workspace.png)
