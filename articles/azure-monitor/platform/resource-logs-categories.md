...
Custo para exportar: pago conforme descrito na seção de logs da plataforma da [página de preços Azure monitor.](https://azure.microsoft.com/pricing/details/monitor/) 
