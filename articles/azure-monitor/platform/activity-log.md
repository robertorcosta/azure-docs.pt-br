...
## <a name="send-to-log-analytics-workspace"></a>Enviar para o workspace do Log Analytics
 Envie o log de atividades para um espaço de trabalho Log Analytics para habilitar os recursos de [logs de Azure monitor](data-platform-logs.md) que incluem o seguinte:
