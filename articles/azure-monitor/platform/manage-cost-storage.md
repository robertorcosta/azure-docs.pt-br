...
O limite diário pode ser configurado por meio do ARM definindo o `dailyQuotaGb` parâmetro sob `WorkspaceCapping` conforme descrito [aqui](/rest/api/loganalytics/workspaces/createorupdate#workspacecapping). 
