---
title: Um guia de referência para os azulejos View Designer no Monitor Azure | Microsoft Docs
...
---
# <a name="reference-guide-to-view-designer-tiles-in-azure-monitor"></a>Guia de referência para exibir azulejos de designer no Monitor Azure
...
> [!NOTE]
> As telhas em exibições são [baseadas](../log-query/log-query-overview.md) em consultas de log no espaço de trabalho do Log Analytics. No momento, eles não [suportam consultas cruzadas de recursos](../log-query/cross-workspace-query.md) para recuperar dados do Application Insights.
...
* Saiba mais sobre [consultas de log](../log-query/log-query-overview.md) para suportar as consultas em telhas.
* Adicione [peças de visualização](view-designer-parts.md) à sua exibição personalizada.
