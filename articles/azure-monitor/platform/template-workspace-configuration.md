...
3. Criar função salva. O eTag deve ser adicionado à função de substituição e manter a idempotência.
...
11. Colete registros personalizados do computador Windows
