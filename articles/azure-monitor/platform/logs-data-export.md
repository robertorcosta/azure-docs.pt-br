...
| Atualização | Suporte parcial – alguns dos dados são ingeridos por meio de serviços internos que não têm suporte para exportação. Esta parte está ausente na exportação no momento. |
| UpdateRunProgress |  |
| UpdateSummary |  |
| Uso |  |
| Watchlist |  |
