...
Para dados de log de recursos disponíveis por meio de Azure Monitor, encaminhe os dados para Log Analytics e use um alerta de consulta de log. O Log Analytics agora usa o [novo método de alerta](../../azure-monitor/platform/alerts-overview.md) 
