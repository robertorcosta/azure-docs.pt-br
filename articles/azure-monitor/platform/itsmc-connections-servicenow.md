...
As versões com suporte do ServiceNow incluem Orlando, Nova York, Madri, Londres, Kingston, Jacarta, Istambul, Helsinque e Geneva.
...
4. Forneça as informações conforme descrito na tabela a seguir e selecione **OK**.
   ...
   | **URL do servidor**   | Insira a URL da instância do ServiceNow que você deseja conectar ao ITSMC. A URL deve apontar para uma versão de SaaS com suporte com o sufixo *. servicenow.com*.|
