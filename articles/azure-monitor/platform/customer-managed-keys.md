...
O  [modelo de preços de clusters do Log Analytics](./manage-cost-storage.md#log-analytics-dedicated-clusters)  usa reservas de capacidade que começam no nível de 1000 GB/dia.
