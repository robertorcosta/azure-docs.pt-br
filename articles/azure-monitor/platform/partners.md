---
title: Parceiros que se integram ao Azure Monitor
...
![Logotipo da AlertLogic](./media/partners/alertlogic.png)
...
![Logotipo atlassiano](./media/partners/atlassian.png)
...
O Circonus é o especialista em inteligência de dados de máquinas, fornecendo a única plataforma de inteligência de dados de máquina capaz de lidar com bilhões de fluxos métricos em tempo real para gerar insights e valor de negócios sem precedentes. Use o Circonus para coletar, rastrear e visualizar as principais métricas relacionadas à sua configuração do Microsoft Azure. Obtenha visibilidade em todo o sistema na utilização de recursos do Azure, desempenho do aplicativo e saúde operacional.

[Vá para a documentação.][circonus-doc]

## <a name="cloudhealth"></a>CloudHealth

![Logotipo da CloudHealth](./media/partners/cloudhealth.png)


Reúna e automatize sua nuvem com uma plataforma criada para poupar tempo e dinheiro. CloudHealth proporciona visibilidade, otimização intuitiva e práticas de governança bastante sólidas para o gerenciamento de nuvem. A plataforma CloudHealth permite que empresas e MSPs maximizem o retorno dos investimentos em nuvem. Tome decisões confiantes sobre custo, uso, desempenho e segurança.

[Saiba mais][cloudhealth-doc]

## <a name="cloudmonix"></a>CloudMonix

![Logotipo da CloudMonix](./media/partners/cloudmonix.png)
...
![Logotipo influxData](./media/partners/Influxdata.png)
...
O&reg; LogicMonitor é a principal plataforma de monitoramento de desempenho baseada em SaaS para infra-estrutura de TI complexa. Com a cobertura para milhares de tecnologias, LogicMonitor fornece visibilidade granular sobre desempenho do aplicativo e infraestrutura. O monitoramento abrangente do Azure da LM Cloud permite que os usuários correlacionam o desempenho da nuvem do Azure, dos recursos on-premises e da nuvem híbrida -- tudo a partir de uma única plataforma. Detecção automática de recursos, incorporada em modelos de monitoramento, limites de alerta pré-configurado e painéis personalizados são combinados para fornecer à TI a velocidade, flexibilidade e visibilidade necessárias para ser bem-sucedida.

[Vá para a documentação.][logicmonitor-doc]

## <a name="logrhythm"></a>LogRhythm

![Logotipo logrhythm](./media/partners/logrhythm.png)

A LogRhythm, líder no NextGen SIEM, capacita organizações em seis continentes a reduzir mensuravelmente o risco, detectando, respondendo e neutralizando ameaças cibernéticas rapidamente. O fluxo de trabalho TLM (Threat Lifecycle Management, gerenciamento do ciclo de vida de ameaças) da LogRhythm é a base para os centros de operações de segurança, ajudando os clientes a proteger suas infra-estruturas de nuvem, físicas e virtuais para ambientes de TI e OT. Se você é um cliente LogRhythm e está pronto para iniciar sua jornada no Azure, você precisará instalar e configurar a integração LogRhythm Open Collector e EventHub. Mais detalhes, incluindo a documentação da configuração do Monitor Azure e do Coletor Aberto, podem ser encontrados [aqui](https://logrhythm.com/six-tips-for-securing-your-azure-cloud-environment/). 
...
O Microfocus **ArcSight** tem um conector inteligente para hubs de eventos do Azure Monitor.
...
A Microfocus **Operations Bridge** monitora automaticamente todos os recursos de TI híbridos – qualquer dispositivo, sistema operacional, banco de dados, aplicativo ou serviço, independentemente de onde ele é executado e aplica AIOps a todos os tipos de dados – eventos, métricas, logs e dependências. Ele fornece uma combinação única de qualidade de monitoramento de serviços, juntamente com análises profundas de saúde de aplicativos, e inclui monitoramento abrangente de desempenho e disponibilidade dos serviços do Microsoft Azure. Operations Bridge permite que os clientes forneçam um único painel de vidro, disponível em qualquer dispositivo com um navegador, de maneiras que tanto os stakeholders de NEGÓCIOS quanto de TI possam entender.

Saiba mais
- [Visão geral do OB Suite](https://www.microfocus.com/products/operations-bridge-suite/overview)
- [Download](https://marketplace.microfocus.com/itom/content/obm-management-pack-for-microsoft-azure)
- [SiteScope](https://docs.microfocus.com/itom/SiteScope:2019.05/MSAzureMonitor) - SiteScope é um componente da Operations Bridge Suite.
...
![Logotipo newrelic](./media/partners/newrelic.png)

[Saiba mais.][newrelic-doc]

## <a name="opsgenie"></a>OpsGenie

![Logotipo opsGenie](./media/partners/opsgenie.png)
...
![Logotipo da ScienceLogic](./media/partners/sciencelogic.png)

A ScienceLogic proporciona plataforma de garantia de serviço de TI de última geração para gerenciamento de qualquer tecnologia, em qualquer lugar. A ScienceLogic proporciona escala, segurança, automação e resiliência necessárias para simplificar as tarefas de gerenciar recursos de TI, serviços e aplicativos. A plataforma ScienceLogic usa APIs do Azure para fazer interface com o Microsoft Azure. ScienceLogic oferece visibilidade em tempo real de recursos e serviços do Azure. Então você sabe quando algo não está funcionando e você pode corrigi-lo mais rápido. Você também pode gerenciar o Azure com outros serviços e sistemas de datacenter e nuvens.

[Saiba mais.][sciencelogic-doc]

## <a name="serverless360"></a>Serverless360

![Logotipo sem servidor360](./media/partners/serverless360.png)

Serverless360 é uma ferramenta de uma plataforma para operar, gerenciar e monitorar componentes sem servidor do Azure. A capacidade de gerenciamento é um dos principais desafios com implementações sem servidor. Centenas de pequenos e discretos serviços sem servidor estão espalhados em vários lugares – gerenciar e operar tais soluções é complexo. O Serverless360 resolve esses desafios com um rico conjunto de ferramentas sofisticadas. Ele pode monitorar serviços sem servidor como Funções do Azure, Aplicativos lógicos, grades de eventos, filas de ônibus de serviço, tópicos, relés, hubs de eventos, filas de armazenamento, arquivos, blob e tabelas. Serverless360 está disponível no Azure Marketplace. Esses recursos estão disponíveis tanto no SaaS quanto na hospedagem privada (hospedada em seu próprio ambiente).  
...
Reduza incidentes e MTTR com a plataforma NOW AIOps para eliminar ruídos, priorizar, identificar detecção de causas básicas usando ML e remediar com fluxos de trabalho ITX.  Entenda o estado atual de seus serviços Iaas/PaaS/FaaS do Azure e crie mapas de serviço a partir de tags para construir o contexto de serviço de aplicativos para a análise de impacto nos negócios.    
...
SignalFx é líder em inteligência operacional em tempo real para DevOps controladas por dados. O serviço detecta e coleta métricas em todos os componentes na nuvem. Ele substitui as ferramentas de ponto tradicionais e fornece visibilidade em tempo real para os ambientes dinâmicos atuais. Potenciando a plataforma de SignalFx altamente escalonável, a plataforma de SaaS é otimizada para o contêiner e arquiteturas baseadas em microsserviços e fornece visualização avançada, alertas proativos e recursos de triagem de colaboração entre organizações de todos os tamanhos. O SignalFx integra-se diretamente ao Azure Monitor, bem como através de conectores de código aberto, como *Telegraf,* *statsD,* e *coletados* para fornecer o melhor em painéis de classe, análises e alertas para o Azure.
...
![Logotipo squaredUp](./media/partners/squaredup.png)

SquaredUp for Azure torna a visualização de seus aplicativos Azure muito simples. Ele lhe dá em tempo real, painéis interativos. Você pode detalhar assinaturas, grupos de recursos, tags e recursos individuais para ver métricas como CPU, a maioria das conexões de entrada, tempo de resposta do Application Insights, custo total e status de saúde sumário e perfurar para ver dados relacionados, como alertas, eventos do Log Analytics, métricas mais detalhadas ou para ver dados relacionados de outras ferramentas que você usa – como ServiceNow, Dynatrace, PagerDuty ou Pingdom, por exemplo.  Você pode personalizar seus próprios dashboards, publicá-los e compartilhá-los com indivíduos ou em páginas de intranet. 

[Saiba mais.](https://squaredup.com/)

## <a name="sumo-logic"></a>Lógica Sumo

![Logotipo da Lógica do Sumô](./media/partners/SumoLogic.png)
...
![Logotipo turbonômico](./media/partners/Turbonomic.png)
...
- [Fluxo de logs de recursos para um serviço não-Microsoft](../../azure-monitor/platform/resource-logs-stream-event-hubs.md)
...
[influxdata-doc]: ./../../azure-monitor/platform/collect-custom-metrics-linux-telegraf.md "Azure Monitor Influx dados Integração Telegraf."
...
[serverless360-doc]: https://docs.serverless360.com/docs/ "Documentação sem servidor360."
