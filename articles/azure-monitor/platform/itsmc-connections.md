---
title: Conector de Gerenciamento de Serviços de TI em Azure Monitor
...
O script cria um aplicativo Web usando o nome especificado (junto com algumas cadeias de caracteres adicionais para torná-la exclusiva). Ele gera a **URL do aplicativo Web**, a **ID do cliente** e o **segredo do cliente**.
...
> [!NOTE]
> O ITSMC dá suporte apenas à oferta de SaaS oficial do serviço agora. Não há suporte para implantações particulares do serviço agora. 
...
> [!NOTE]
> Como parte da definição do "configurar o OAuth", recomendamos:
>
> 1) **Atualize a vida útil do token de atualização para 90 dias (7.776.000 segundos):** Como parte da configuração do [OAuth](https://nam06.safelinks.protection.outlook.com/?url=https%3A%2F%2Fdocs.servicenow.com%2Fbundle%2Fnewyork-platform-administration%2Fpage%2Fadminister%2Fsecurity%2Ftask%2Ft_SettingUpOAuth.html&data=02%7C01%7CNoga.Lavi%40microsoft.com%7C2c6812e429a549e71cdd08d7d1b148d8%7C72f988bf86f141af91ab2d7cd011db47%7C1%7C0%7C637208431696739125&sdata=Q7mF6Ej8MCupKaEJpabTM56EDZ1T8vFVyihhoM594aA%3D&reserved=0) na fase 2: [crie um ponto de extremidade para os clientes acessarem a instância](https://nam06.safelinks.protection.outlook.com/?url=https%3A%2F%2Fdocs.servicenow.com%2Fbundle%2Fnewyork-platform-administration%2Fpage%2Fadminister%2Fsecurity%2Ftask%2Ft_CreateEndpointforExternalClients.html&data=02%7C01%7CNoga.Lavi%40microsoft.com%7C2c6812e429a549e71cdd08d7d1b148d8%7C72f988bf86f141af91ab2d7cd011db47%7C1%7C0%7C637208431696749123&sdata=hoAJHJAFgUeszYCX1Q%2FXr4N%2FAKiFcm5WV7mwR2UqeWA%3D&reserved=0) após a definição do ponto de extremidade, na pesquisa de lâmina do ServiceNow para System OAuth do que selecionar o registro do aplicativo. Escolha o nome do OAuth que foi definido e atualize o campo de vida útil do token de atualização para 7.776.000 (90 dias em segundos).
> No final, clique em atualizar.
> 2) **É recomendável estabelecer um procedimento interno para garantir que a conexão permaneça ativa:** De acordo com a vida útil do token de atualização para atualizar o token. Certifique-se de executar as seguintes operações antes do token de atualização esperado tempo de expiração (alguns dias antes de a vida útil do token de atualização expirar, recomendamos):
>
>>  1) [Concluir um processo de sincronização manual para configuração do conector de ITSM](https://docs.microsoft.com/azure/azure-monitor/platform/itsmc-resync-servicenow)
 >> 2) Revogue para o token de atualização antigo, pois não é recomendável manter chaves antigas por motivos de segurança. Em pesquisa de lâmina do ServiceNow para o sistema OAuth do que selecione Gerenciar tokens. Escolha o token antigo na lista de acordo com o nome OAuth e a data de validade. Clique em revogar acesso e em revogar.
...
| **Senha**   | Digite a senha associada a esse nome de usuário. **Observação**: o nome de usuário e a senha são usados para gerar somente tokens de autenticação e não são armazenados em nenhum lugar no serviço ITSMC.  |
