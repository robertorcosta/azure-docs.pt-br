...
|**IsEnabled**|Boolean. Veja a descrição em outro lugar nesta página.|  
...
> [!NOTE]
> A definição pública de Azure Monitor de configuração do coletor tem duas propriedades, *PrincipalId* e *segredo*. Só são necessárias para os serviços de nuvem clássico e VMs clássicas. Essas propriedades não devem ser usadas para outros recursos.
