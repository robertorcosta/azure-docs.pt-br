...
Para obter mais detalhes sobre consultas de log no Azure Monitor, confira [Visão geral de consultas de log no Azure Monitor](../logs/log-query-overview.md).
