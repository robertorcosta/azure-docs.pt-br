...
* *Dados personalizados*: O Log Analytics permite a coleta em uma variedade de métodos: logs personalizados e campos personalizados, a [API do Coletor de Dados HTTP](../logs/data-collector-api.md) e dados personalizados coletados como parte dos logs de eventos do sistema. Todos são suscetíveis a conter dados privados e devem ser examinados para verificar se esses dados existem.
...
- Para saber mais sobre como os dados do Log Analytcs são coletados, processados e protegidos, veja [Segurança de dados do Log Analytics](../logs/data-security.md).
