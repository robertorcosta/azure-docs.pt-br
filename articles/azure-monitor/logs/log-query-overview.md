...
- [Painéis do Azure](../learn/tutorial-logs-dashboards.md). Fixe os resultados de qualquer consulta em um painel do Azure que permita que você visualize dados de log e de métrica juntos e, opcionalmente, compartilhe com outros usuários do Azure.
...
* [recurso ()](../log-query/resource-expression.md)
