...
O exemplo de script de exemplo a seguir cria um workspace e configura várias fontes de dados. Essas fontes de dados só serão necessárias se você estiver monitorando máquinas virtuais usando o [agente Log Analytics](../agents/log-analytics-agent.md).
