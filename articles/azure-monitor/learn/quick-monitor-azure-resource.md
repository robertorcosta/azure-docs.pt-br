...
> [Enviar o log de atividades do Azure para o workspace do Log Analytics](https://docs.microsoft.com/azure/azure-monitor/learn/quick-collect-activity-log-portal)
