---
title: Consultas de log em Azure Monitor
...
- [Pastas de trabalho](../platform/workbooks-overview.md). Inclua os resultados das consultas de log usando visualizações diferentes em relatórios visuais interativos no portal do Azure.
...
- [Aplicativos lógicos](../platform/logicapp-flow-connector.md).  Use os resultados de uma consulta de log em um fluxo de trabalho automatizado usando aplicativos lógicos.
...
- [Consultas de exemplo](example-queries.md) – descrição das consultas de exemplo disponíveis no log Analytics. Você pode usar as consultas sem modificação ou usá-las como exemplos para aprender a KQL.
