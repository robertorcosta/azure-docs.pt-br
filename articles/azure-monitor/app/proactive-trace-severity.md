---
title: Degradação na razão de gravidade do rastreamento - Azure Application Insights
description: Monitore os rastreamentos dos aplicativos com o Azure Application Insights para padrões incomuns na telemetria de rastreamento com detecção inteligente .
ms.topic: conceptual
ms.date: 11/27/2017
...
Você pode receber esse tipo de notificação se a razão entre traços "bons" (traços registrados com um nível de *Informações* ou *Verbose)* e traços "ruins" (traços registrados com um nível de *Aviso,* *Erro*ou *Fatal)* for degradante em um dia específico, em comparação com uma linha de base calculada nos últimos sete dias.
