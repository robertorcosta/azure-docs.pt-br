...
> [!IMPORTANT]
> Há suporte para as seguintes versões do ASP.NET Core: ASP.NET Core 2,1 e 3,1. As versões 2,0, 2,2 e 3,0 foram desativadas e não têm mais suporte.
