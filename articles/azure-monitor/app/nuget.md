...
- Monitore o [ASP.NET Core](./asp-net-core.md).
- Crie o perfil de [aplicativos Web ASP.NET Core Azure Linux](./profiler-aspnetcore-linux.md).
- Depure [instantâneos](./snapshot-debugger.md) do ASP.NET.
