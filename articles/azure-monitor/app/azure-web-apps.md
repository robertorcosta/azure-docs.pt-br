...
description: Monitoramento do desempenho de aplicativos para serviços de aplicativos do Azure. Chart load and response time, dependency information, and set alerts on performance.
...
2. Depois de especificar qual recurso usar, você pode escolher como deseja que o Application Insights colete dados por plataforma para seu aplicativo. ASP.NET app monitoring is on-by-default with two different levels of collection.
...
|Problem Value|Explicação|Correção
|---- |----|---|
