...
Adicione a seguinte configuração:
  ...
  ```
> [!IMPORTANT] 
> Para ver todas as configurações necessárias para habilitar a correlação, consulte a [documentação de correlação do JavaScript](/app/javascript.md#enable-correlation).
