...
* Log e consultas estão desabilitadas-para exibir consultas e logs recomendados, você deve rotear seus logs de diagnóstico para Log Analytics. Leia [este documento](./diagnostic-settings.md) para saber como fazer isso. 
