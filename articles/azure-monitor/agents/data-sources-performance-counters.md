...
Configure contadores de desempenho [no menu dados em configurações avançadas](../agents/agent-data-sources.md#configuring-data-sources) para o espaço de trabalho log Analytics.
