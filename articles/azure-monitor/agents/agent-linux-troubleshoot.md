...
| 4 | Proxy inválido fornecido ao script omsadmin. Verifique o proxy e consulte nossa [documentação para usar um proxy HTTP ](../platform/log-analytics-agent.md#firewall-requirements). |
