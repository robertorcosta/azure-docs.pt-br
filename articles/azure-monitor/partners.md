...
Assine a visualização de "integração do Datadog com o Azure" disponível no [Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/datadog1591740804488.dd_liftr_v2?tab=Overview)
...
[Integração do Grafana Azure Monitor](visualize/grafana-plugin.md)
...
[Azure Monitor integração de Telegraf de dados de influxo](essentials/collect-custom-metrics-linux-telegraf.md) 
...
- [Acessar métricas usando a API REST](essentials/rest-api-walkthrough.md)
- [Transmitir o Log de Atividades para um serviço que não seja da Microsoft](essentials/activity-log.md#legacy-collection-methods)
- [Transmitir logs de recursos para um serviço que não seja da Microsoft](essentials/resource-logs.md#send-to-azure-event-hubs)
