...
## <a name="enable-for-new-azure-red-hat-openshift-v3-cluster"></a>Habilitar para o novo cluster do Red Hat OpenShift no Azure v3
...
## <a name="enable-for-existing-azure-red-hat-openshift-v3-cluster"></a>Habilitar para o cluster existente do Red Hat OpenShift no Azure v3
...
* [Saiba mais sobre o Azure Monitor para contêineres](../insights/container-insights-overview.md).
