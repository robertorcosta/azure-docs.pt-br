...
A amostra a seguir cria uma [regra de alerta de número de resultados](../platform/alerts-unified-log.md#count-of-the-results-table-rows).
...
A amostra a seguir cria uma [regra de alerta com medição métrica](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
