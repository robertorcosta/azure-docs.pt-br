...
A amostra a seguir adiciona a coleção de [eventos do Windows](../platform/data-sources-windows-events.md) a um workspace existente.
...
A amostra a seguir adiciona a coleção de [eventos do syslog](../platform/data-sources-syslog.md) a um workspace existente.
...
A amostra a seguir adiciona a coleção de [contadores de desempenho do Windows](../platform/data-sources-performance-counters.md) a um workspace existente.
...
A amostra a seguir adiciona a coleção de [contadores de desempenho do Linux](../platform/data-sources-performance-counters.md) a um workspace existente.
...
A amostra a seguir adiciona a coleção de [logs personalizados](../platform/data-sources-custom-logs.md) a um workspace existente.

### <a name="notes"></a>Observações

- A configuração de delimitadores e extrações pode ser complexa. Para obter ajuda, você pode definir um log personalizado usando o portal do Azure e recuperar sua configuração usando [Get-AzOperationalInsightsDataSource](https://docs.microsoft.com/powershell/module/az.operationalinsights/get-azoperationalinsightsdatasource?view=azps-3.8.0) com **-Kind** definido como **CustomLog**.
...
A amostra a seguir adiciona a coleção de [logs do IIS](../platform/data-sources-iis-logs.md) a um workspace existente.
...
* [Saiba mais sobre os workspaces do Log Analytics](../learn/quick-create-workspace.md).
* [Saiba mais sobre as fontes de dados do agente](../platform/agent-data-sources.md).