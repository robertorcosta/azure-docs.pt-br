...
Este artigo fornece exemplos de como usar os [modelos do Azure Resource Manager](../../azure-resource-manager/templates/template-syntax.md) para configurar [regras de alerta de métrica](../platform/alerts-metric-near-real-time.md) no Azure Monitor. Cada amostra inclui um arquivo de modelo e um arquivo de parâmetros com valores de amostra para fornecer ao modelo.
