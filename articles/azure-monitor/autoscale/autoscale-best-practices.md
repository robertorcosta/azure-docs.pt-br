...
* Todas as falhas de dimensionamento automático são registradas no log de atividades. Você pode configurar um [alerta do log de atividades](../alerts/activity-log-alerts.md) para que você possa ser notificado por email, SMS, webhook, sempre que houver uma falha de dimensionamento automático.
