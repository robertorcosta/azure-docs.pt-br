...
No Linux, se você entrar na mensagem de erro abaixo, instale os pacotes necessários executando os dois comandos a seguir.
   ...
   :::image type="content" source="./media/set-up-pyspark-interactive-environment/install-libkrb5-package.png" alt-text="Instalar o pacote libkrb5 para Python" border="true":::
