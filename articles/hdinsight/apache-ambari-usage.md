...
Para verificar qual cabeçalho está ativo, uma delas é o ssh para um dos nós no cluster e, em seguida, execute `ping headnodehost` e compare o IP com aquele dos dois cabeçalho.
