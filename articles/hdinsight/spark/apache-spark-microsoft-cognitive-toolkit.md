...
1. Execute um script customizado para instalar o [Microsoft Cognitive Toolkit](https://docs.microsoft.com/cognitive-toolkit/) em um cluster do Azure HDInsight Spark.
