...
Saiba como usar ações de script para configurar um cluster [Apache Spark](https://spark.apache.org/) no HDInsight para usar pacotes **Python** externos e contribuídos pela Comunidade que não estão incluídos de forma integrada no cluster.
