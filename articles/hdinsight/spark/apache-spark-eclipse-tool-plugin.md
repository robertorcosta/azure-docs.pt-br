...
* Oracle Java Development Kit versão 8, que é usado para o runtime do IDE do Eclipse. Você pode baixá-lo do [site da Oracle](https://aka.ms/azure-jdks).
