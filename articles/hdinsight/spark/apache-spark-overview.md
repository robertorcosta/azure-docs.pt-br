...
| Escalabilidade | O HDInsight permite alterar o número de nós de cluster dinamicamente com o recurso de dimensionamento automático. Confira [Escalar automaticamente os clusters do Azure HDInsight](../hdinsight-autoscale-clusters.md). Além disso, os clusters Spark podem ser removidos sem perda de dados, pois todos os dados ficam armazenados no Armazenamento do Azure ou no Data Lake Storage. |
