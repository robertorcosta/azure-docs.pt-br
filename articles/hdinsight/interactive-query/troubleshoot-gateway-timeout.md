...
* Verifique o valor do **tamanho do heap HiveServer2** de Ambari. Navegue até **Hive** > **configuração** > **Settings**configurações > do hive**otimização**. Verifique se o valor é maior que 10 GB. Ajuste conforme necessário para otimizar o desempenho.
