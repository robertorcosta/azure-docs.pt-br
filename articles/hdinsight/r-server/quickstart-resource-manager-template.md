...
![A captura de tela mostra um cluster do HDInsight com o grupo de recursos a ser excluído.](./media/quickstart-resource-manager-template/azure-portal-delete-rserver.png)
