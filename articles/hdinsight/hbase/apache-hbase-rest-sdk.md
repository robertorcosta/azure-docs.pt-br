...
:::image type="content" source="./media/apache-hbase-rest-sdk/hdinsight-table-roles.png" alt-text="Saída de dados de exemplo do Apache HBase" border="true":::
