...
Para obter os nomes de host para diferentes tipos de nós em seu cluster, use a [API Ambari REST](hdinsight-hadoop-manage-ambari-rest-api.md#get-the-fqdn-of-cluster-nodes).
