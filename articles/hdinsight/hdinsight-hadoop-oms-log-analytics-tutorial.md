...
* Se estiver usando o PowerShell, você precisará do [Az Module](https://docs.microsoft.com/powershell/azure/). Verifique se você tem a versão mais recente. Se for necessário, execute `Update-Module -Name Az`.
