...
1. Em **3 Armazenamento**, especifique se prefere o Armazenamento do Azure ou o Azure Data Lake Storage como o armazenamento padrão. Para obter mais informações, confira a tabela a seguir.
