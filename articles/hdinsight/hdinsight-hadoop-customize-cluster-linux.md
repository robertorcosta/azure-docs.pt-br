...
Para usar esses comandos do PowerShell, você precisa do [módulo AZ](https://docs.microsoft.com/powershell/azure/). O seguinte exemplo mostra como aplicar uma ação de script a um cluster em execução:
