---
title: Versões desativadas do Azure HDInsight
description: Saiba mais sobre as versões desativadas no Azure HDInsight.
...
ms.locfileid: "101744129"
---
# <a name="retired-hdinsight-versions"></a>Versões do HDInsight desativadas

Neste artigo, você aprenderá sobre as versões desativadas no HDInsight.

## <a name="retired-version-list"></a>Lista de versões desativadas

A tabela a seguir lista as versões desativadas do HDInsight.
...
- [Componentes e versões do Apache com suporte no HDInsight](./hdinsight-component-versioning.md)
