...
Saiba como gerenciar clusters HDInsight usando o [SDK do .NET do HDInsight](/dotnet/api/overview/azure/hdinsight).
...
* Apache Storm
  ...
  * Ferramenta CLI (interface de linha de comando)
    ...
    :::image type="content" source="./media/hdinsight-administer-use-powershell/hdinsight-portal-scale-cluster-storm-rebalance.png" alt-text="Rebalanceamento de escala do HDInsight Storm":::
...
* [Documentação de referência do SDK do .NET do HDInsight](/dotnet/api/overview/azure/hdinsight)
