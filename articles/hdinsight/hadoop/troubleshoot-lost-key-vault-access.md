...
Veja [a disponibilidade e a redundância do Azure Key Vault e](../../key-vault/key-vault-disaster-recovery-guidance.md) a página de status do Azure para obter mais detalheshttps://status.azure.com/
