...
Veja [Azure Key Vault disponibilidade e redundância](../../key-vault/key-vault-disaster-recovery-guidance.md) e a página de status do Azure para obter mais detalhes https://status.azure.com/
