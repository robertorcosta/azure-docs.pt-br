...
O log do Apache yarn é agregado no formato `IndexFile`, que não tem suporte do analisador de arquivos.

## <a name="resolution"></a>Resolução

1. Em um navegador da Web, navegue até `https://CLUSTERNAME.azurehdinsight.net`, em que `CLUSTERNAME` é o nome do cluster.

1. Na interface do usuário do amAmbari, navegue até **YARN** > **configurações** > **avançado** > **avançado yarn-site**.
