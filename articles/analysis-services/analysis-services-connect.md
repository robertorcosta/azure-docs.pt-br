...
> [!NOTE]
> As bibliotecas de clientes não podem se conectar aos Serviços de Análise do Azure através de servidores proxy que requerem um nome de usuário e senha. 
