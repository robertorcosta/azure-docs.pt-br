...
> [!TIP]
> Antes de implantar, verifique se que você pode processar os dados nas tabelas. No Visual Studio, clique em processo de**processo** > de **modelo** > **tudo**. Se houver falha no processamento, você não poderá implantar com êxito.
> 
> 
...
1. No Visual Studio > **Gerenciador de soluções**, clique com o botão direito do mouse no projeto > **Propriedades**. Em seguida, no**servidor** de **implantação** > , Cole o nome do servidor.   
