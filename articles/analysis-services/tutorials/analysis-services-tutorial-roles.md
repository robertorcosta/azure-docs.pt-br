...
description: Saiba como configurar as funções de administrador e usuário do Azure Analysis Services usuário usando o portal do Azure ou o SQL Server Management Studio.
author: minewiskan
