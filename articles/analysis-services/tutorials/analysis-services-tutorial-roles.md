---
title: Tutorial – Configurar funções de usuário e administrador do Azure Analysis Services | Microsoft Docs
description: Saiba como configurar as funções do Azure Analysis Services.
author: minewiskan
