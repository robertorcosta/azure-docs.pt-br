...
ms.locfileid: "91854765"
---
# <a name="enable-update-management-from-a-runbook"></a>Habilitar o Gerenciamento de Atualizações de um runbook

Este artigo descreve como você pode usar um runbook para habilitar o recurso de [Gerenciamento de Atualizações](update-mgmt-overview.md) para VMs em seu ambiente. Para habilitar as VMs do Azure em escala, você deve habilitar uma VM existente com Gerenciamento de Atualizações.
...
3. Selecione o workspace do Log Analytics e clique em **Habilitar**. Enquanto Gerenciamento de Atualizações está sendo habilitado, uma faixa é mostrada.
    ...
    ![Habilitar Gerenciamento de Atualizações](media/update-mgmt-enable-runbook/enable-update-management.png)
...
3. Escolha a VM na lista e clique em **habilitar** para configurar a VM para gerenciamento.
   ...
   ![Habilitar o Gerenciamento de Atualizações para a VM](media/update-mgmt-enable-runbook/enable-update-management-vm.png)
