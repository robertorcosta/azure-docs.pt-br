...
![Selecionar scripts](./media/update-mgmt-pre-post-scripts/select-scripts.png)
...
![Itens selecionados](./media/update-mgmt-pre-post-scripts/selected-items.png)
...
![Atualizar resultados](./media/update-mgmt-pre-post-scripts/update-results.png)
...
![Resultados da execução da implantação](./media/update-mgmt-pre-post-scripts/deployment-run.png)
...
* Para obter detalhes sobre o gerenciamento de atualizações, consulte [gerenciar atualizações e patches para suas VMs](update-mgmt-manage-updates-for-vm.md).
