...
![Atualizações Ausentes](./media/update-mgmt-view-update-assessments/automation-view-update-assessments-missing-updates.png)
...
A próxima fase do processo é [implantar atualizações](update-mgmt-deploy-updates.md) em computadores não compatíveis e examinar os resultados da implantação.
