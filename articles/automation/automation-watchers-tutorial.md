...
1. Clique no botão **Procurar galeria.**
...
1. Selecione **Configurar ação** e selecione o manual de execução "Process-NewFile".
...
1. Clique **em OK**e selecione para retornar à página do observador.
