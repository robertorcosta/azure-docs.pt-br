...
Neste exemplo, usamos um modelo ARM (Automation Resource Manager) que cria uma nova agenda de trabalho. Para obter informações gerais sobre este modelo para gerenciar agendas de trabalho de automação, consulte [referência de modelo Microsoft. Automation automationAccounts/jobSchedules](/templates/microsoft.automation/automationaccounts/jobschedules#quickstart-templates).
