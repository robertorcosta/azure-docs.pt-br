...
O exemplo a seguir mostram como criar uma variável de tipo complexo e recuperar as suas propriedades. Neste caso, é usado um objeto máquina virtual de [Get-AzVM](/powershell/module/Az.Compute/Get-AzVM).
