...
2. Verifique se o agente baixou corretamente a solução De Automação. Ele deve ter uma pasta chamada **AzureAutomationFiles** in **C:\Program Files\Microsoft Monitoring Agent\Agent**. 
