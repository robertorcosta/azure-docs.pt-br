...
* Para detalhes do gerenciamento de atualizações, confira [Gerenciar atualizações e patches para as VMs do Azure](automation-tutorial-update-management.md).