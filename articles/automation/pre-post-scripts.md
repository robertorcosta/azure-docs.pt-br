...
Para que um runbook seja usado como pré ou pós-script, o runbook deve ser importado para sua conta de Automação e publicado. Para saber mais sobre esse processo, consulte [Publicar um runbook](manage-runbooks.md#publishing-a-runbook).
