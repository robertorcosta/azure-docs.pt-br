...
Aqui estão as maneiras como você pode habilitar Controle de Alterações e inventário e selecionar os computadores a serem gerenciados:

* [De uma máquina virtual do Azure](enable-from-vm.md).
* [De navegar por várias máquinas virtuais do Azure](enable-from-portal.md).
* [De uma conta de automação do Azure](enable-from-automation-account.md).
* Para servidores habilitados para ARC ou computadores não Azure, instale o agente de Log Analytics de servidores habilitados para Arc do Azure usando a [extensão de VM](../../azure-arc/servers/manage-vm-extensions.md) e, em seguida, [habilite os computadores no espaço de trabalho](enable-from-automation-account.md#enable-machines-in-the-workspace) para controle de alterações e inventário.
* [Usando um runbook de automação](enable-from-runbook.md).
