...
**Solução:** Consulte a [lista de clientes com suporte](automation-update-management.md#supported-client-types).
...
* Remova o [agente do Log Analytics para Windows](../azure-monitor/learn/quick-collect-windows-computer.md#clean-up-resources) ou o [agente do Log Analytics para Linux](../azure-monitor/learn/quick-collect-linux-computer.md#clean-up-resources).
