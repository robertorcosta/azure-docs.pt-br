...
ms.locfileid: "82996045"
---
# <a name="forward-state-configuration-reporting-data-to-azure-monitor-logs"></a>Encaminhar os dados de relatório do State Configuration para os logs do Azure Monitor
