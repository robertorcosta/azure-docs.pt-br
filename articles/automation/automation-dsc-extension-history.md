...
Este artigo fornecerá informações sobre cada versão da extensão DSC da VM do Azure, os ambientes compatíveis, além de comentários e observações sobre novos recursos ou alterações.
...
- **Data de lançamento:**
  - 9 de maio de 2018 (Azure) | 21 de junho de 2018 (Azure China, Azure Governamental)
- **Suporte a SO:**
  - Windows Server 2016
...
> [!WARNING]
> As versões de 2,4 a 2,13 usam o WMF 5,0 visualização pública cujos certificados de autenticação expiraram em agosto
...
- **Suporte a WMF:** WMF 5.1 Versão Prévia, WMF 5.0 RTM, Atualização do WMF 4.0, WMF 4.0
- **Ambiente:** Azure
- **Comentários:** essa versão usa o DSC como incluído no Windows Server 2016 Technical Preview; para outros sistemas operacionais Windows, ela instala o [Windows Management Framework 5.0 RTM](https://devblogs.microsoft.com/powershell/windows-management-framework-wmf-5-0-rtm-is-now-available-via-the-microsoft-update-catalog/) (a instalação do WMF requer uma reinicialização).
- **Novos recursos:**
...
- **Ambiente:** Azure, Azure China, Azure Governamental
- **Comentários:** essa versão usa o DSC como incluído no Windows Server 2016 Technical Preview; para outros sistemas operacionais Windows, ela instala o [Windows Management Framework 5.0 RTM](https://devblogs.microsoft.com/powershell/windows-management-framework-wmf-5-0-rtm-is-now-available-via-the-microsoft-update-catalog/) (a instalação do WMF requer uma reinicialização).
- **Novos recursos:**
  - A extensão DSC agora está integrada ao Azure China. Esta versão contém principalmente correções para executar a Extensão no Azure China.
