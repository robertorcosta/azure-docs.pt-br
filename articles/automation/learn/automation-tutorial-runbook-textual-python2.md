...
description: Tutorial mostrando como criar, testar e publicar um runbook simples do Python.
services: automation
...
Quando você publica um runbook, substitui a versão Publicada existente pela versão de rascunho.
