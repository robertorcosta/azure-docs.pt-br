...
Você pode adicionar um runbook à automação do Azure [criando um novo](#creating-a-runbook) ou [importando um existente](#importing-a-runbook) de um arquivo ou da [Galeria de runbooks](automation-runbook-gallery.md). Este artigo oferece informações sobre a criação e a importação de runbooks de um arquivo. Você pode obter todos os detalhes de como acessar runbooks e módulos da Comunidade em [galerias de runbook e de módulo para a automação do Azure](automation-runbook-gallery.md).
...
## <a name="scheduling-a-runbook-in-the-azure-portal"></a>Agendando um runbook no portal do Azure
