...
Para obter mais informações, consulte [gerenciar a sincronização de perfil de usuário no SharePoint Server](/SharePoint/administration/manage-profile-synchronization).
