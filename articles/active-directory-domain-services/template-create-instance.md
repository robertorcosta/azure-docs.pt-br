...
Este artigo mostra como habilitar o Azure AD DS usando um modelo do Azure Resource Manager. Os recursos de suporte são criados usando o Azure PowerShell.
