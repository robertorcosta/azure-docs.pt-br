...
* **Restrições de prefixo de domínio:** Você não pode criar um domínio gerenciado com um prefixo com mais de 15 caracteres. O prefixo do nome de domínio especificado (por exemplo, *contoso* no nome de domínio *contoso.com*) deve conter até 15 caracteres.
