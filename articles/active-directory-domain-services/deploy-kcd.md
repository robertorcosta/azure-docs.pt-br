...
Neste cenário, vamos supor que você tenha um aplicativo Web que é executado no computador chamado *contoso-webapp.aaddscontoso.com*. O aplicativo Web precisa acessar uma API da Web que é executada no computador chamado *contoso-API.aaddscontoso.com* no contexto de usuários do domínio. Conclua as seguintes etapas para configurar este cenário:
