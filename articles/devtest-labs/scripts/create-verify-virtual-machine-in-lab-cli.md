...
| [az lab vm create](/cli/azure/lab/vm#az_lab_vm_create) | Cria uma VM (máquina virtual) em um laboratório. |
| [az lab vm show](/cli/azure/lab/vm#az_lab_vm_show) | Exibe o status da VM em um laboratório. |
