...
As conexões VPN do Microsoft Azure fornecem conectividade segura entre os locais do cliente e o Microsoft Azure. Este tutorial aborda itens básicos da implantação de gateway VPN do Azure como criar e gerenciar um gateway de VPN.
...
> [Conexões VPN site a site](vpn-gateway-howto-site-to-site-resource-manager-portal.md)
