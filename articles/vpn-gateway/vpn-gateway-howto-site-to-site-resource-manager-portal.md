---
title: 'Conecte a rede local à rede virtual do Azure: VPN site-to-site: Portal'
...
### <a name="example-values"></a><a name="values"></a>Exemplos de valores
...
* **Faixa de endereço da sub-rede do Gateway:** 10.1.255.0/27
...
## <a name="2-create-the-vpn-gateway"></a><a name="VNetGateway"></a>2. Crie o gateway VPN
...
* **Detalhes de exemplo > Região:** Leste dos EUA
* **Rede Virtual > Rede Virtual:** VNet1
* **Detalhes de exemplo > Nome:** VNet1GW
* **Detalhes de exemplo > tipo gateway:** Vpn
* **Detalhes da ocorrência > tipo de VPN:** Baseado em rotas
* **Rede Virtual > faixa de endereço gateway:** 10.1.255.0/27
* **Endereço IP público > nome de endereço IP público:** VNet1GWpip
...
## <a name="3-create-the-local-network-gateway"></a><a name="LocalNetworkGateway"></a>3. Crie o gateway de rede local
...
## <a name="4-configure-your-vpn-device"></a><a name="VPNDevice"></a>4. Configure seu dispositivo VPN
...
- O endereço IP público do seu gateway de rede virtual. Você pode exibir o endereço IP público usando o portal do Azure, o PowerShell ou a CLI. Para encontrar o endereço IP público do seu gateway VPN usando o portal Azure, navegue até **gateways de rede virtuais**e clique no nome do seu gateway.

[!INCLUDE [Configure a VPN device](../../includes/vpn-gateway-configure-vpn-device-include.md)]

## <a name="5-create-the-vpn-connection"></a><a name="CreateConnection"></a>5. Crie a conexão VPN

Crie a conexão VPN Site a Site entre o gateway de rede virtual e o dispositivo VPN local.

[!INCLUDE [Add a site-to-site connection](../../includes/vpn-gateway-add-site-to-site-connection-portal-include.md)]

## <a name="6-verify-the-vpn-connection"></a><a name="VerifyConnection"></a>6. Verifique a conexão VPN
