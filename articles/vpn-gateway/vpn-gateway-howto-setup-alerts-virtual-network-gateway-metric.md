...
description: Saiba como configurar alertas em métricas de gateway de VPN do Azure. Use Azure Monitor para configurar alertas para gateways de rede virtual do tipo de VPN.
