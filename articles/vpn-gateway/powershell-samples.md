---
title: Amostras do Azure PowerShell para o Gateway de VPN
description: Use esses scripts do Azure PowerShell para criar gateways de VPN, criar conexões site a site e Vnet para Vnet e baixar modelos de dispositivo VPN.
...
| [Criar conexões de rede virtual a rede virtual](./scripts/vpn-gateway-sample-vnet-vnet-powershell.md) | Criar conexões de rede virtual a rede virtual. |
| [Baixar modelo do dispositivo VPN](./scripts/vpn-gateway-sample-site-to-site-download-devicescript-powershell.md) | Baixar modelo do dispositivo VPN. |
