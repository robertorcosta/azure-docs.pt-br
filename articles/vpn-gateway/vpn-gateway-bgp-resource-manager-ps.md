...
## <a name="part-1---configure-bgp-on-the-azure-vpn-gateway"></a><a name ="enablebgp"></a>Parte 1 - Configurar o BGP no Gateway de VPN do Azure
...
* Instale os cmdlets do PowerShell do Azure Resource Manager. Para saber mais sobre como instalar os cmdlets do PowerShell, consulte [Como instalar e configurar o Azure PowerShell](/powershell/azure/). 
...
Para usar os cmdlets do Gerenciador de Recursos, alterne para o modo do PowerShell. Para obter mais informações, consulte [Usando o Windows PowerShell com o Gerenciador de Recursos](../azure-resource-manager/management/manage-resources-powershell.md).
...
## <a name="part-2---establish-a-cross-premises-connection-with-bgp"></a><a name ="crossprembbgp"></a>Parte 2 - Estabelecer uma conexão entre instalações com BGP
...
## <a name="part-3---establish-a-vnet-to-vnet-connection-with-bgp"></a><a name ="v2vbgp"></a>Parte 3 - Estabelecer uma conexão VNet para VNet com BGP

Esta seção adiciona uma conexão de VNet para VNet com BGP, conforme mostrado neste diagrama:

![Diagrama que mostra uma conexão de V net a V net.](./media/vpn-gateway-bgp-resource-manager-ps/bgp-vnet2vnet.png)
