...
3. Na coluna **nome** , selecione uma das conexões para exibir mais informações. Quando dados começarem a fluir, você verá valores de **Entrada de dados** e de **Saída de dados**.
   ...
   ![Captura de tela mostra um grupo de recursos que tem valores de entrada e saída de dados.](./media/vpn-gateway-howto-vnet-vnet-resource-manager-portal/status.png "Status")
