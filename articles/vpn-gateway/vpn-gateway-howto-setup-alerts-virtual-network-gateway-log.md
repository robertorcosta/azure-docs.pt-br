...
description: Saiba como configurar alertas com base em eventos de log de recursos do gateway de VPN do Azure usando Azure Monitor Log Analytics e os logs de recursos disponíveis no Azure.
