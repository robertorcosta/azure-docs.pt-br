...
4. Na página **Criar rede virtual (clássico)**, defina as configurações da VNet. Nessa página, você adiciona o primeiro espaço de endereço e um único intervalo de endereços da sub-rede. Depois de criar a VNet, você pode voltar e adicionar mais sub-redes e espaços de endereço.
...
6. Clique em **Grupo de recursos** e selecione um grupo de recursos existente ou crie um novo digitando um nome. Para obter mais informações sobre grupos de recursos, visite [Azure Resource Manager visão geral](../azure-resource-manager/management/overview.md#resource-groups).
...
## <a name="2-add-additional-address-space"></a><a name="additionaladdress"></a>2. adicionar espaço de endereço adicional
...
## <a name="3-specify-a-dns-server"></a><a name="dns"></a>3. especificar um servidor DNS
...
## <a name="4-configure-the-local-site"></a><a name="localsite"></a>4. configurar o site local
...
4. Clique em **Site local - Definir configurações necessárias** para abrir a página **Site local**. Defina as configurações e, em seguida, clique em **OK** para salvar as configurações.
   ...
   ![Captura de tela que mostra as janelas "nova conexão VPN e" site local ".](./media/vpn-gateway-howto-site-to-site-classic-portal/localnetworksite.png)

Clique em **OK** para fechar a página site local. **Não clique em OK para fechar a página nova conexão VPN**.

## <a name="5-configure-the-gateway-subnet"></a><a name="gatewaysubnet"></a>5. configurar a sub-rede de gateway
...
## <a name="6-specify-the-sku-and-vpn-type"></a><a name="sku"></a>6. especificar o tipo de SKU e VPN
...
## <a name="7-configure-your-vpn-device"></a><a name="vpndevice"></a>7. configurar seu dispositivo VPN
...
## <a name="8-create-the-connection"></a><a name="CreateConnection"></a>8. criar a conexão
...
Você deve executar esses comandos localmente usando o módulo de gerenciamento de serviços do PowerShell. 
