...
description: Saiba como configurar o protocolo OpenVPN no gateway de VPN do Azure para um ambiente de ponto a site de trabalho. Se necessário, você pode criar uma VPN ponto a site.
