...
description: Saiba como configurar gateways de VPN do Azure para atender aos requisitos de criptografia para túneis de VPN S2S entre locais e conexões de VNet para VNet no Azure.
