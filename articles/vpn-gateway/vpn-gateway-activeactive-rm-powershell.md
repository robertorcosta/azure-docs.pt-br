---
title: Configure conexões ativas do S2S Azure VPN Gateway
...
#### <a name="1-create-the-public-ip-addresses-and-gateway-ip-configurations"></a>1. Crie os endereços IP públicos e as configurações IP do gateway
...
#### <a name="2-create-the-vpn-gateway-with-active-active-configuration"></a>2. Crie o gateway VPN com configuração ativa
...
#### <a name="3-obtain-the-gateway-public-ip-addresses-and-the-bgp-peer-ip-address"></a>3. Obtenha os endereços IP públicos de gateway e o endereço IP do Peer BGP
...
#### <a name="2-create-the-local-network-gateway-for-site5"></a>2. Crie o gateway de rede local para o Site5
...
#### <a name="2-create-the-testvnet1-to-site5-connection"></a>2. Crie a conexão TestVNet1 para O Site5
...
#### <a name="3-vpn-and-bgp-parameters-for-your-on-premises-vpn-device"></a>3. Parâmetros de VPN e BGP para o seu dispositivo VPN no local
...
#### <a name="1-create-the-second-local-network-gateway-for-site5"></a>1. Crie o segundo gateway de rede local para o Site5
...
#### <a name="3-vpn-and-bgp-parameters-for-your-second-on-premises-vpn-device"></a>3. Parâmetros de VPN e BGP para o seu segundo dispositivo VPN no local
...
#### <a name="3-create-the-active-active-vpn-gateway-for-testvnet2"></a>3. Crie o gateway VPN ativo para TestVNet2
Solicite dois endereços IP públicos para serem alocados ao gateway que você criará para sua VNet. Você também definirá as configurações de IP e sub-rede necessárias.
...
#### <a name="2-create-both-connections"></a>2. Crie ambas as conexões
...
#### <a name="2-create-the-public-ip-address-then-add-the-second-gateway-ip-configuration"></a>2. Crie o endereço IP público e adicione a segunda configuração IP do gateway
...
#### <a name="3-enable-active-active-mode-and-update-the-gateway"></a>3. Habilite o modo ativo e atualize o gateway
