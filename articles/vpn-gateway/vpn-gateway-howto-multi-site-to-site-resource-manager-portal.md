---
title: 'Adicione várias conexões de gateway VPN de site para site a um Portal VNet: Azure'
...
Este artigo se aplica a VNets do Gerenciador de Recursos que têm um gateway de VPN RouteBased. Essas etapas não se aplicam às novas configurações de conexão coexistente ExpressRoute/Site-to-Site. No entanto, se você estiver apenas adicionando uma nova conexão VPN a uma configuração coexistente já existente, você pode usar essas etapas. Confira [Conexões coexistentes ExpressRoute/S2S](../expressroute/expressroute-howto-coexist-resource-manager.md) para obter informações sobre conexões coexistentes.
...
* Você não está configurando uma nova configuração coexistente do ExpressRoute e do VPN Gateway.
...
## <a name="part-2---add-a-local-network-gateway"></a><a name="part2"></a>Parte 2 - Adicionar um gateway de rede local
...
## <a name="part-3---add-the-shared-key-and-create-the-connection"></a><a name="part3"></a>Parte 3 - Adicionar a chave compartilhada e criar a conexão
...
## <a name="part-4---verify-the-vpn-connection"></a><a name="part4"></a>Parte 4 - Verificar a conexão VPN
