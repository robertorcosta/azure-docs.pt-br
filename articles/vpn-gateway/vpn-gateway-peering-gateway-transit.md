...
description: Saiba como configurar o tráfego de gateway para o emparelhamento de rede virtual, que conecta diretamente duas redes virtuais do Azure.
