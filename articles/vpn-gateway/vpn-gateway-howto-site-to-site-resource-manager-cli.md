---
title: 'Conecte redes locais a uma rede virtual: VPN site-to-site: CLI'
...
## <a name="2-create-a-resource-group"></a><a name="rg"></a>2. Crie um grupo de recursos
...
## <a name="3-create-a-virtual-network"></a><a name="VNet"></a>3. Crie uma rede virtual
...
## <a name="4-create-the-gateway-subnet"></a>4. <a name="gwsub"> </a>Crie a sub-rede gateway
...
## <a name="5-create-the-local-network-gateway"></a><a name="localnet"></a>5. Crie o gateway de rede local
...
* O *endereço --gateway-ip* é o endereço IP do seu dispositivo VPN no local.
...
## <a name="6-request-a-public-ip-address"></a><a name="PublicIP"></a>6. Solicite um endereço IP público
...
## <a name="7-create-the-vpn-gateway"></a><a name="CreateGateway"></a>7. Crie o gateway VPN
...
* O *tipo de gateway* para uma configuração site-to-site é *vpn*. O tipo de gateway é sempre específico para a configuração que você está implementando. Para obter mais informações, consulte [os tipos de Gateway](vpn-gateway-about-vpn-gateway-settings.md#gwtype).
...
* Selecione a SKU de Gateway que você deseja usar. Há limitações de configuração para alguns SKUs. Para obter mais informações, consulte [Gateway SKUs](vpn-gateway-about-vpn-gateway-settings.md#gwsku).
...
## <a name="8-configure-your-vpn-device"></a><a name="VPNDevice"></a>8. Configure seu dispositivo VPN
...
## <a name="9-create-the-vpn-connection"></a><a name="CreateConnection"></a>9. Crie a conexão VPN
...
## <a name="10-verify-the-vpn-connection"></a><a name="toverify"></a>10. Verifique a conexão VPN
