...
Uma instância do Blockchain Data Manager monitora um nó de transação do Azure Blockchain Service. Uma instância captura todos os dados brutos de bloqueio e de transação provenientes do nó de transação.
