...
| . | Descrição | obrigatórios |
|-----------|-------------|:--------:|
| name | The name of the Blockchain Service member that you want to retrieve details about. When a name is entered, it returns the member's details. When a name is omitted, it returns a list of all consortium members. | Não |
| Membros | Members object obtained from Import-ConsortiumManagementContracts | SIM |
| Web3Client | Web3Client object obtained from New-Web3Connection | SIM |
...
| . | Descrição | obrigatórios |
|-----------|-------------|:--------:|
| name | Member name to remove | SIM |
| Membros | Members object obtained from Import-ConsortiumManagementContracts | SIM |
...
| . | Descrição | obrigatórios |
|-----------|-------------|:--------:|
| name | Name of the blockchain member | SIM |
