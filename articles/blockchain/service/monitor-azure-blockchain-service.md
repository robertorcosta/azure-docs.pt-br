...
| Codificar   | Códigos de erro HTTP. Geralmente, 4XX e 5XX são condições de erro.  |
...
| Porcentagem de uso da memória     | Percentual   | Média  |  A porcentagem da memória usada na média em todos os nós.       |
