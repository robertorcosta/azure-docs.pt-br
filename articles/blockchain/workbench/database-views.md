...
| UploadedByUserExternalId         | nvarchar (255) | Não          | O identificador externo para o usuário que carregou o aplicativo. By default, this ID is the user from the Azure Active Directory for the consortium.                                                                                                |
...
| UserExternalId             | nvarchar (255) | Não          | O identificador externo para o usuário que está associado à função. By default, this ID is the user from the Azure Active Directory for the consortium.                                                                     |
...
| UserExternalId           | nvarchar (255) | Não          | O identificador externo para o usuário que está associado à conexão. By default, this ID is the user from the Azure Active Directory for the consortium. |
| UserProvisioningStatus   | int           | Não          |Identifica o status atual do processo de provisionamento para o usuário. Os valores possíveis são: <br />0 – o usuário foi criado pela API<br />1 – uma chave foi sido associada ao usuário no banco de dados<br />2 – o usuário está totalmente provisionado |
...
| ContractDeployedByUserId                 | int            | Não          | Um identificador externo para o usuário que implantou o contrato. By default, this ID is the guid representing the Azure Active Directory ID for the user.                                                                                                          |
| ContractDeployedByUserExternalId         | nvarchar (255)  | Não          | Um identificador externo para o usuário que implantou o contrato. By default, this ID is the guid representing the Azure Active Directory ID for the user.                                                                                                         |
...
| ContractDeployedByUserFirstName          | nvarchar (50)  | SIM         | O primeiro nome do usuário que implantou o contrato |
| ContractDeployedByUserLastName           | nvarchar (255) | SIM         | O sobrenome do usuário que implantou o contrato |
| ContractDeployedByUserExternalId         | nvarchar (255) | Não          | O identificador externo do usuário que implantou o contrato. By default, this ID is the guid that represents their identity in the consortium Azure Active Directory.                                                                                                                                                |
| ContractDeployedByUserEmailAddress       | nvarchar (255) | SIM         | O endereço de email do usuário que implantou o contrato |
...
| ContractActionExecutedByUserExternalId   | nvarchar (255) | SIM         | Identificador externo do usuário que executou a ação do contrato. By default, this ID is the guid that represents their identity in the consortium Azure Active Directory. |
...
| StateName                          | nvarchar (50)  | SIM         | If this property contains the state of the contract, it is the display name for the state. Se não estiver associado ao estado, o valor será nulo. |
| StateDisplayName                   | nvarchar (255) | Não          | If this property contains the state, it is the display name for the state. Se não estiver associado ao estado, o valor será nulo. |
| StateValue                         | nvarchar (255) | SIM         | If this property contains the state, it is the state value. Se não estiver associado ao estado, o valor será nulo. |
...
| StateName                          | nvarchar (50)  | SIM         | If this property contains the state, it the display name for the state. Se não estiver associado ao estado, o valor será nulo. |
| StateDisplayName                   | nvarchar (255) | Não          | If this property contains the state, it is the display name for the state. Se não estiver associado ao estado, o valor será nulo. |
| StateValue                         | nvarchar (255) | SIM         | If this property contains the state, it is the state value. Se não estiver associado ao estado, o valor será nulo. |
...
| ExternalId         | nvarchar (255) | Não          | Um identificador externo de um usuário. By default, this ID is the guid representing the Azure Active Directory ID for the user. |
...
Esta exibição representa os detalhes dos metadados do fluxo de trabalho de núcleo bem como as funções e parâmetros do fluxo de trabalho. Designed for reporting, it also contains metadata about the application associated with the workflow. Essa exibição contém dados de várias tabelas subjacentes para facilitar a emissão de relatórios sobre fluxos de trabalho. Para cada fluxo de trabalho, essa exibição contém os seguintes dados:
...
| WorkflowStartStateStyle           | int           | Não          | The value of the state |
