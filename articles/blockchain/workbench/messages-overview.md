...
| transações | Contém [informações sobre a transação](#transaction-information) de uma coleção para o bloco |
...
| local | URL na qual o arquivo de código de contrato está localizado |
