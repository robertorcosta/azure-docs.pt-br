...
Inicialização de EFI/servidor do convidado/UEFI | -Com suporte para Windows Server 2012 ou posterior, SLES SP4 e RHEL 8,0 <br/> -Não há suporte para o tipo de inicialização UEFI segura. 
