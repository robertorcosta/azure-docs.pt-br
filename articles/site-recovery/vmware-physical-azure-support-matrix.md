...
**Versão com suporte** | **Versão do serviço de mobilidade** | **Versão do kernel** |
--- | --- | --- |
14, 4 LTS | [9,28][9.28 UR]| 3.13.0-24-Generic para 3.13.0-170-Generic,<br/>3.16.0-25-Generic para 3.16.0-77-Generic,<br/>3.19.0-18-Generic para 3.19.0-80-Generic,<br/>4.2.0-18-Generic para 4.2.0-42-Generic,<br/>4.4.0-21-Generic para 4.4.0-148-Generic,<br/>4.15.0-1023-Azure para 4.15.0-1045-Azure |
...
**Versão com suporte** | **Versão do serviço de mobilidade** | **Versão do kernel** |
--- | --- | --- |
Debian 7 | [9,25][9.25 UR],[9,26][9.26 UR], [9,27][9.27 UR], [9,28][9.28 UR]| 3.2.0-4-AMD64 para 3.2.0-6-AMD64, 3.16.0-0. BPO. 4-AMD64 |
|||
...
Dispositivos de e/s de bloco de várias filas | Sem suporte.
Servidores físicos com o controlador de armazenamento HP CCISS | Sem suporte.
...
Contagem do disco do sistema operacional | 1 | A verificação falhará se não houver suporte.
...
VHD compartilhado | Sem suporte. | A verificação falhará se não houver suporte.
Disco FC | Sem suporte. | A verificação falhará se não houver suporte.
Pelo | Sem suporte. | O BitLocker deve ser desabilitado antes de habilitar a replicação para um computador. |
Nome da VM | De 1 a 63 caracteres.<br/><br/> Restrito a letras, números e hifens.<br/><br/> O nome do computador deve começar e terminar com uma letra ou número. |  Atualize o valor nas propriedades da máquina em Site Recovery.
...
A tabela a seguir fornece os limites de Azure Site Recovery. 
...
**Destino de replicação** | **Tamanho médio de e/s do disco de origem** |**Variação média de dados do disco de origem** | **Total de rotatividade de dados do disco de origem por dia**
---|---|---|---
...
---|---
Variação média de dados por VM| 25 MB/s
...
- Esses são números médios supondo uma sobreposição de e/s de 30%.
- Site Recovery é capaz de lidar com a taxa de transferência mais alta com base na taxa de sobreposição, tamanhos de gravação maiores e comportamento de e/s de carga de trabalho real.
