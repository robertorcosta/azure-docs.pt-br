...
**Versão** | **Versão de serviço de mobilidade** | **Versão do kernel** |
--- | --- | --- |
SUSE Linux Enterprise Server 15 e 15 SP1 | [9.32](https://support.microsoft.com/help/4550047/) | Todos os sUSE 15 e 15 núcleos de estoque são suportados. </br></br> 4.12.14-5.5-azure para 4.12.14-8.22-azure
