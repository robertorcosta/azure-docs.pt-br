...
> [!TIP]
> Agora você deve usar o serviço Azure Migrate para migrar VMs e servidores para o Azure, em vez do serviço de recuperação do site Do Azure. [Saiba mais](../migrate/migrate-services-overview.md).
