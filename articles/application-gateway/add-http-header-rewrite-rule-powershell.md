...
Este artigo descreve como usar Azure PowerShell para configurar uma instância de [SKU v2 do gateway de aplicativo](<https://docs.microsoft.com/azure/application-gateway/application-gateway-autoscaling-zone-redundant>) para regravar os cabeçalhos HTTP em solicitações e respostas.
