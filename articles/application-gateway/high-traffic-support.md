...
## <a name="autoscaling-for-application-gateway-v2-sku-standard_v2waf_v2-sku"></a>Dimensionamento automático para SKU v2 do Gateway de Aplicativo (SKU Standard_v2/WAF_v2)
