...
**Diretrizes**: o compartilhamento de dados do Azure dá suporte à autenticação SSO com o Azure Active Directory (AD do Azure). Reduza o número de identidades e credenciais que os usuários devem gerenciar habilitando o SSO para o serviço com as identidades preexistentes de sua organização.
...
**Orientação**: habilitar a autenticação multifator do Azure AD e seguir as recomendações de acesso e identidade da central de segurança do Azure.
...
**Diretrizes**: Use identidades gerenciadas para fornecer aos serviços do Azure uma identidade gerenciada automaticamente no Azure Active Directory (Azure AD). Identidades gerenciadas permitem que você se autentique em qualquer serviço que ofereça suporte à autenticação do Azure AD, incluindo Key Vault, sem nenhuma credencial em seu código.
