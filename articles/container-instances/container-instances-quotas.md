---
title: Cotas de serviços e disponibilidade da região
...
A disponibilidade de recursos de computação, memória e armazenamento para instâncias de contêineres do Azure varia de acordo com a região e o sistema operacional. Para obter detalhes, consulte [a disponibilidade de recursos para instâncias de contêiner do Azure](container-instances-region-availability.md).
