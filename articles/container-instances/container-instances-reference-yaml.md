...
> [!NOTE]
> Essa referência se aplica a arquivos YAML para a versão da API REST de instâncias de contêiner do Azure `2018-10-01` .
...
|  Nome | Tipo | Obrigatório | Valor |
|  ---- | ---- | ---- | ---- |
|  path | Cadeia de caracteres | No | O caminho para investigação. |
