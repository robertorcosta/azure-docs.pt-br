---
title: Torne os recursos mais seguros com o Azure Advisor | Microsoft Docs
...
Para obter mais informações sobre as recomendações de segurança, consulte [Gerenciando recomendações de segurança na Central de Segurança do Azure](https://azure.microsoft.com/documentation/articles/security-center-recommendations/).
