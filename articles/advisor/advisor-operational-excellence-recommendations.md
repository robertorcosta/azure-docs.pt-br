...
O Azure Policy é um serviço no Azure que você pode usar para criar, atribuir e gerenciar políticas. Essas políticas impõem diferentes regras e efeitos sobre seus recursos. Abaixo estão as recomendações de política do Azure para ajudá-lo a obter o excellency operacional: 
