...
Crie duas interfaces de rede com [az network nic create](/cli/azure/network/nic#az-network-nic-create) e associe-as ao endereço IP público e o grupo de segurança de rede. 
