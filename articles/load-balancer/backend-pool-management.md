...
Todo o gerenciamento de pools de back-end é feito diretamente no objeto de pool de back-end, conforme realçado nos exemplos abaixo.
  ...
  >[!IMPORTANT] 
  >Atualmente, este recurso está em versão prévia e tem as seguintes limitações:
...
### <a name="resource-manager-template"></a>Modelo do Resource Manager
Criar o balanceador de carga e o pool de back-end e preencher o pool de back-end com endereços de back-end:
```
{
...
Crie uma máquina virtual e um adaptador de rede anexado. Defina o endereço IP do adaptador de rede com um dos endereços de back-end:
```
{
