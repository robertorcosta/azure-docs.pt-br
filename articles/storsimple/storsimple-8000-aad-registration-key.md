...
| Atualização 5 ou posterior e o dispositivo online.| nenhuma ação será necessária.                                       |
...
1. No **StorSimple Device Manager**, vá para **Gerenciamento &gt;** **chaves**. Também use a barra de pesquisa para pesquisar _Chaves_.
