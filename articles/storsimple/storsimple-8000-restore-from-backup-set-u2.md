...
* **É necessário colocar o volume offline** – Coloque o volume offline no host e no dispositivo antes de iniciar a operação de restauração. Embora a operação de restauração coloque automaticamente o volume online no dispositivo, você deve colocar o dispositivo online manualmente no host. Você pode colocar o volume online no host, assim que o volume estiver online no dispositivo. (Você não precisa aguardar até que a operação de restauração seja concluída.) Para procedimentos, vá para [colocar um volume offline](storsimple-8000-manage-volumes-u2.md#take-a-volume-offline).
...
* **Política** ou **volume** de backup – a política de backup ou o volume associado a este conjunto de backup.
