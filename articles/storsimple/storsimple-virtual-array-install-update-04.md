...
description: Descreve como usar a interface do usuário da Web do StorSimple virtual array para aplicar a atualização 0,4 usando o método portal do Azure e Hot Fix.
services: storsimple
