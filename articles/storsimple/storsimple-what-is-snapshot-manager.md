...
* **Instantâneos na nuvem** – Instantâneos na nuvem são cópias pontuais de dados de volume que ficam armazenados na nuvem. Um instantâneo de nuvem é equivalente a um instantâneo duplicado em um sistema de armazenamento externo diferente. Instantâneos de nuvem são particularmente úteis em cenários de recuperação de desastres.
...
* **Tipo** – O tipo de política de backup: sejam instantâneos locais ou na nuvem.
