...
**Q.**  Qual é o tamanho máximo de um volume localmente afixado que posso criar em dispositivos da série 8000?
...
**Q.** Atualizei recentemente o dispositivo 8100 para a Atualização 3.0 e, quando tento criar um volume fixado localmente, o tamanho máximo disponível é de apenas 6 TB, não de 8,5 TB. Por que não consigo criar um volume de 8,5 TB?
...
**Q.**  Por que a criação de um volume localmente afixado é uma operação demorada?
...
**Q.**  Quanto tempo leva para criar um volume localmente afixado?
...
**Q.**  Desejo criar um volume localmente afixado. Existem práticas recomendadas que preciso conhecer?
...
**Q.**  Posso criar vários volumes localmente afixados ao mesmo tempo?
...
**Q.**  Exclui um volume localmente afixado. Por que não vejo o espaço recuperado refletido no espaço disponível ao tentar criar um novo volume?
...
**Q.**  Os volumes localmente afixados são compatíveis com o dispositivo de nuvem?
...
**Q.**  Posso usar os cmdlets do Azure PowerShell para criar e gerenciar volumes localmente afixados?
...
**Q.**  Há suporte a instantâneos locais de volumes localmente afixados?
...
**Q.**  Há diretrizes para o gerenciamento de instantâneos locais para volumes localmente afixados?
...
**Q.**  Recebi um alerta informando que meus instantâneos locais de volumes localmente afixados podem ser invalidados. Quando isso acontece?
...
**Q.**  Tenho observado uma certa lentidão no dispositivo durante a conversão de um volume em camadas em um volume localmente afixado. Por que isso está acontecendo?
...
**Q.**  O que acontecerá com o volume se a operação de conversão falhar?
...
**Q.**  Os volumes localmente afixados são restaurados instantaneamente?
...
**Q.**  Quanto tempo leva para restaurar um volume localmente afixado?
...
**Q.**  Preciso restaurar meu volume localmente afixado existente para um instantâneo mais antigo (obtido quando o volume era em camadas). Nesse caso, o volume será restaurado em camadas?
...
**Q.**  Estendi meu volume localmente afixado recentemente, mas agora preciso restaurar os dados para uma hora em que o volume tinha tamanho menor. A restauração redimensionará o volume atual e precisarei estender o tamanho do volume após a restauração ser concluída?
...
**Q.**  Posso alterar o tipo de um volume durante a restauração?
...
**Q.**  Preciso restaurar um volume localmente afixado, mas escolhi um ponto incorreto no instantâneo de tempo. Posso cancelar a operação de restauração atual?
...
**Q.**  Comecei uma operação de restauração em um de meus volumes localmente afixados e agora há um instantâneo no catálogo de lista de pendências que não me lembro de ter criado. Para que isso é usado?
...
**Q.**  Posso clonar um volume localmente afixado?

**A.**  Sim, pode. No entanto, o volume localmente afixado será clonado como um volume em camadas por padrão. Mais informações sobre como [clonar um volume fixado localmente](storsimple-8000-clone-volume-u2.md)
...
**Q.**  Preciso fazer failover de um dispositivo para outro dispositivo físico. O failover será feito nos volumes localmente afixados como localmente afixados ou em camadas?
...
**Q.**  Os volumes localmente afixados são restaurados instantaneamente durante a RD (recuperação de desastre)?
...
**Q.** Vejo que o trabalho de failover foi concluído. Como posso acompanhar o andamento do volume localmente afixado que está sendo restaurado no dispositivo de destino?
...
**Q.**  Posso alterar o tipo de um volume durante o failover?
...
**Q.**  Posso fazer o failover em um contêiner de volume com volumes localmente afixados para o dispositivo de nuvem?
