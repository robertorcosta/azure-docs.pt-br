---
title: Termos de suporte simples do StorSimple
...
* Gravidade A: perda ou degradação de serviços significativa


* Gravidade B: perda ou degradação moderada, mas o trabalho pode continuar de maneira prejudicada


* Gravidade C: funcionando com menor ou nenhuma impedimentos da funcionalidade do sistema
...
Além do inglês, o suporte ao idioma local é fornecido nos seguintes idiomas durante o horário comercial: espanhol, português, japonês, coreano, taiwanês e chinês tradicional.
...
Clientes ASAP + podem alternar para o modelo de assinatura em que o suporte padrão está incluído. Use a Calculadora de preços do StorSimple para obter o valor da assinatura e entre em contato SSSupOps@microsoft.com para tirar dúvidas. Comutação é a única forma do ASAP+ para Assinatura.
