...
* **Tls 1,2** -esta atualização do StorSimple impedirá o TLS 1,2 em todos os clientes. Esta é uma atualização obrigatória para todos os dispositivos StorSimple da série 8000.
