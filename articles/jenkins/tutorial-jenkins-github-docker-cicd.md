---
title: Tutorial – Criar um pipeline de desenvolvimento no Azure com o Jenkins
...
![Adicione um webhook do GitHub ao seu repositório bifurcado](media/tutorial-jenkins-github-docker-cicd/github-webhook.png)
...
![Executar o aplicativo Node.js](media/tutorial-jenkins-github-docker-cicd/running-nodejs-app.png)
...
![Executar o aplicativo Node.js após outra confirmação do GitHub](media/tutorial-jenkins-github-docker-cicd/another-running-nodejs-app.png)
...
> [Implantar aplicativos com o Jenkins e o Azure DevOps Services](tutorial-build-deploy-jenkins.md)