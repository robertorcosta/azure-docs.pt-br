---
title: Exemplos de uma política do Atestado do Azure
description: Exemplos de política do Atestado do Azure.
...
## <a name="signed-policy-for-an-sgx-enclave-with-policyformatjwt"></a>Política assinada para um enclave do SGX com PolicyFormat=JWT
