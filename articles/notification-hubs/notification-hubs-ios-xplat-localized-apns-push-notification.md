---
title: Envie notificações push localizadas para iOS usando hubs de notificação do Azure | Microsoft Docs
...
Em `MainStoryboard_iPhone.storyboard`seu , adicione um Controle Segmentado com os três idiomas: inglês, francês e mandarim.
...
1. Em `Notification.h`seu , `retrieveLocale` adicione o método e modifique a loja e subscrete métodos como mostrado no código a seguir:
...
>[Notificações por push para usuários específicos](notification-hubs-aspnet-backend-ios-apple-apns-notification.md)
...
[Usar hubs de notificação para enviar notícias recentes]: notification-hubs-ios-xplat-segmented-apns-push-notification.md
