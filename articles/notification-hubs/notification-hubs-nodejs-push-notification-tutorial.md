...
Para obter mais informações sobre o formato da carga, consulte a [documentação da carga](https://payload.readthedocs.io/en/latest/).
...
Para obter mais informações sobre o formato da carga, consulte a seção **conteúdo de notificação** do [guia usernotifications](https://developer.apple.com/documentation/usernotifications).
