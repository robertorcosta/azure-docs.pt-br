...
[![Baixar Exemplo](./media/notification-hubs-backend-service-xamarin-forms/download.png) Baixar o exemplo](https://github.com/xamcat/mobcat-samples/tree/master/notification_hub_backend_service)  
...
* [Microsoft Azure](https://portal.azure.com) e [Enviar notificações por push para aplicativos iOS usando os Hubs de Notificação do Azure](ios-sdk-get-started.md).
