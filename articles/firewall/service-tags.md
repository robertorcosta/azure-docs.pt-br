...
Consulte [grupos de segurança](../virtual-network/security-overview.md#service-tags) para obter uma lista de tags de serviço disponíveis para uso nas regras da rede de firewall do Azure.
