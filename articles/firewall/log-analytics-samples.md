...
ms.locfileid: "94659549"
---
# <a name="azure-monitor-logs-for-azure-firewall"></a>Logs de Azure Monitor para o Firewall do Azure

Os exemplos de logs de Azure Monitor a seguir podem ser usados para analisar os logs de firewall do Azure. O arquivo de exemplo é criado no designer de exibição no Azure Monitor, o [Designer de exibição no artigo Azure monitor](../azure-monitor/platform/view-designer.md) tem mais informações sobre o conceito de design de exibição.
...
O Firewall do Azure registra os dados abaixo de AzureDiagnostics com a categoria como **AzureFirewallApplicationRule** ou **AzureFirewallNetworkRule**. Os dados que contêm os detalhes são armazenados no campo msg_s. Usando o operador [parse](/azure/kusto/query/parseoperator), podemos extrair várias propriedades interessantes do campo msg_s. As consultas a seguir extraem as informações para ambas as categorias.
...
:::image type="content" source="media/log-analytics-samples/log1.png" alt-text="Captura de tela de uma entrada de log. Vários valores são visíveis, como um carimbo de data/hora, um protocolo, um número de porta, uma ação, uma coleção de regras e uma regra." border="false":::

:::image type="content" source="media/log-analytics-samples/log2.png" alt-text="Captura de tela de uma entrada de log. Vários valores são visíveis, como um carimbo de data/hora, um protocolo, origem e destino I endereços P e uma ação." border="false":::

:::image type="content" source="media/log-analytics-samples/log3.png" alt-text="Captura de tela de uma entrada de log. Vários valores são visíveis, como um carimbo de data/hora, um protocolo, origem e destino I endereços e portas e uma mensagem." border="false":::
## <a name="next-steps"></a>Próximas etapas

Para saber mais sobre diagnóstico e monitoramento do Firewall do Azure, confira [Tutorial: Monitorar métricas e logs do Firewall do Azure](./firewall-diagnostics.md).