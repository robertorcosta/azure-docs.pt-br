...
2. Selecione **Avançar: Endereços IP** .
3. Em **Espaço de endereços IPv4** , digite **10.5.0.0/16** .
6. Em **Nome da sub-rede** , selecione **padrão** .
7. Em **Nome** , digite **AzureFirewallSubnet** . O firewall estará nessa sub-rede e o nome da sub-rede **precisa** ser AzureFirewallSubnet.
8. Em **Intervalo de endereços** , digite **10.5.0.0/26** . 
9. Clique em **Salvar** .
...
4. Em **Espaço de endereços IPv4** , digite **10.6.0.0/16** .
6. Em **Nome da sub-rede** , selecione **padrão** .
7. Em **Nome** , digite **SN-Workload** .
8. Em **Intervalo de endereços** , digite **10.6.0.0/24** . 
9. Clique em **Salvar** .
10. Selecione **Examinar + criar** .
11. Selecione **Criar** .
...
2. Em **Região** , selecione **EUA (Leste dos EUA)** .
3. Selecione **Avançar: Endereços IP**
4. Em **Espaço de endereços IPv4** , digite **192.168.0.0/16** .
5. Em **Nome da sub-rede** , selecione **padrão** .
7. Em **Nome** , digite **SN-Corp** .
8. Em **Intervalo de endereços** , digite **192.168.1.0/24** . 
9. Clique em **Salvar** .
10. Selecione **Examinar + criar** .
11. Selecione **Criar** .
