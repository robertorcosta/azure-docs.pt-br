...
2. Selecione a guia **Varejo** e escolha **Criar aplicativo**, em **Gerenciamento de estoque inteligente**
...
**Gateway offline**: essa regra será disparada, se o gateway não enviar relatórios à nuvem por um período prolongado. O gateway pode ficar sem resposta devido ao modo de bateria fraca, à perda de conectividade e à integridade do dispositivo.

**Marcas desconhecidas**: é essencial rastrear todas as marcas de BLE e RFID associadas a um ativo. Se o gateway estiver detectando muitas marcas desconhecidas, significa que há problemas de sincronização com os aplicativos que fornecem as marcas.
