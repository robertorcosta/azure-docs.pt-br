...
Agora você tem uma visão geral das etapas para implantar e usar o modelo de aplicativo de análise de vídeo, consulte [criar um aplicativo de análise de vídeo n no Azure IOT central](tutorial-video-analytics-create-app.md) para começar.
