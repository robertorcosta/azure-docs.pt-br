...
Identifique rapidamente os dispositivos que precisam de atenção criando [regras personalizadas](tutorial-create-telemetry-rules.md) com base no estado e na telemetria do dispositivo. Configure ações para notificar as pessoas certas garantindo que as medidas corretivas ocorram em tempo hábil.

## <a name="jobs"></a>Trabalhos 
Os [trabalhos](../core/howto-run-a-job.md?toc=/azure/iot-central/preview/toc.json&bc=/azure/iot-central/preview/breadcrumb/toc.json) permitem que você execute atualizações únicas ou em massa nas propriedades, configurações e comandos do dispositivo. 

## <a name="user-roles-and-permissions"></a>Funções e permissões de usuário
[Funções e permissões](howto-manage-users-roles.md) oferecem a capacidade de personalizar a experiência de cada usuário. Crie funções diretamente por meio da interface do usuário e atribua facilmente as permissões apropriadas. 
