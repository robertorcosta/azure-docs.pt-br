---
title: Criar e gerenciar regras no aplicativo Azure IoT Central | Microsoft Docs
description: As regras do Azure IoT Central permitem monitorar os dispositivos quase em tempo real e invocar ações automaticamente, como enviar um email, quando a regra é disparada.
author: dominicbetts
ms.author: dobett
ms.date: 10/24/2019
ms.topic: tutorial
