...
- Examine um exemplo de código que mostra como usar tokens SAS em [Tutorial: criar e conectar um aplicativo cliente ao aplicativo de IoT Central do Azure (tutorial – Connect-Device-nodejs.md)
