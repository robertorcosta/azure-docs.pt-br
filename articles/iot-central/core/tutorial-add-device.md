---
title: 'Tutorial: Adicionar um dispositivo real a um aplicativo do Azure IoT Central'
description: 'Tutorial: Saiba como adicionar e configurar um dispositivo real no aplicativo do Azure IoT Central. Saiba mais também sobre o código no dispositivo real.'
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
