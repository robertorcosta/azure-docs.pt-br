---
title: 'Tutorial: Personalizar os modos de exibição do operador no Azure IoT Central'
description: 'Tutorial: Como um construtor, personalize os modos de exibição do operador em seu aplicativo do Azure IoT Central.'
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
...
1. Para editar o modelo de dispositivo **Ar-condicionado Conectado**, escolha **Modelos de Dispositivo** no painel à esquerda:
