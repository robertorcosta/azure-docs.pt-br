...
description: Este tutorial mostra a você, como um construtor, como definir um novo tipo de dispositivo no seu aplicativo Azure IoT Central. Você define a telemetria, o estado, as propriedades e as configurações de seu tipo.
author: dominicbetts
ms.author: dobett
ms.date: 11/13/2019
ms.topic: tutorial
...
Para concluir este tutorial, você precisa de um aplicativo do Azure IoT Central criado com base no modelo de **Aplicativo personalizado**. Se não tiver um aplicativo, conclua o início rápido [Criar um aplicativo do Azure IoT Central](quick-deploy-iot-central.md) escolhendo o modelo de **Aplicativo personalizado**.
...
Para adicionar um novo modelo de dispositivo ao aplicativo, você precisará acessar a página **Modelos de Aplicativo**. Para fazer isso, selecione **Modelos de Dispositivo** no painel esquerdo.
