...
Para obter mais informações, confira [Criar e conectar um aplicativo cliente Node.js](./tutorial-connect-device-nodejs.md) ou [Criar e conectar um aplicativo cliente Python](./tutorial-connect-device-python.md).
