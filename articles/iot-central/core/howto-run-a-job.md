...
| Failed (Falha)               | O número de dispositivos nos quais o trabalho falhou ao ser executado.       |
...
| Failed (Falha)               | A execução do trabalho falhou neste dispositivo. A mensagem de erro mostra mais informações.  |
