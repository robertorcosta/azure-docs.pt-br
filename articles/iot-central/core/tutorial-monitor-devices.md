...
description: Este tutorial mostra a você como, na condição de operador, é possível usar o seu aplicativo Azure IoT Central para monitorar seus dispositivos.
author: dominicbetts
ms.author: dobett
ms.date: 11/13/2019
ms.topic: tutorial
