...
Selecione **copiar**. Na caixa de diálogo, insira os detalhes do novo aplicativo de pagamento Conforme o Uso. Em seguida, selecione **copiar** para confirmar que deseja continuar. Para saber mais sobre os campos no formulário, consulte o guia de início rápido [criar um aplicativo](quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) .

![Página de configurações do aplicativo](media/howto-use-app-templates-pnp/appcopy2.png)
...
![Página de configurações do aplicativo](media/howto-use-app-templates-pnp/appcopy3a.png)
...
![Criar um modelo de aplicativo](media/howto-use-app-templates-pnp/create-template.png)
...
![Criar um aplicativo com base em um modelo](media/howto-use-app-templates-pnp/create-app.png)
...
Agora que você aprendeu a usar modelos de aplicativos, a próxima etapa sugerida é aprender a [gerenciar IOT central da portal do Azure](howto-manage-iot-central-from-portal.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
