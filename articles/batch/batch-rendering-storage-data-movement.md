...
* Armazenamento do Azure como um sistema de arquivos usando [blobfuse](../storage/blobs/storage-how-to-mount-container-linux.md):
...
* Sistema de arquivos ou compartilhamento de arquivos:
  * Dependendo do sistema operacional da VM e requisitos de desempenho/escala, em seguida, as opções incluem [arquivos do Azure](../storage/files/storage-files-introduction.md), usando uma VM com discos anexados for NFS, usando várias VMs com discos anexados para um sistema de arquivos distribuído como GlusterFS, ou usando uma oferta de terceiros.
...
[Sincronização de Arquivos do Azure](../storage/files/storage-sync-files-planning.md) está disponível para sincronizar automaticamente os arquivos entre um sistema de arquivos local e um compartilhamento de arquivos do Azure.
...
* [Arquivos do Azure](../storage/files/storage-files-introduction.md)
