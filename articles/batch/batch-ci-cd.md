...
* Uma pasta **HPC-Application** , que é a versão do Windows 64 bits do [ffmpeg 4.3.1](https://www.gyan.dev/ffmpeg/builds/packages/ffmpeg-4.3.1-2020-10-01-essentials_build.7z).
