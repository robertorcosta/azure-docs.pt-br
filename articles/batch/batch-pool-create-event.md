...
|`imageType`|Cadeia de caracteres|O método de implantação para a imagem. Os valores com `virtualMachineConfiguration` suporte são ou`cloudServiceConfiguration`|
...
|`nodeAgentId`|Cadeia de caracteres|O SKU do agente do nó do lote provisionado em nós de computação.|
...
|Nome do elemento|Type|Observações|
|------------------|----------|-----------|
|`publisher`|Cadeia de caracteres|Especifica o editor da imagem.|
|`offer`|Cadeia de caracteres|A oferta da imagem.|
