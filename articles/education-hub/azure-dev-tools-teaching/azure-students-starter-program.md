---
title: Sobre o programa Azure for Students Starter (Hub de Educação do Azure)
description: Saiba mais sobre o programa Azure for Students Starter.
author: tfosmark
ms.author: rymend
ms.topic: overview
ms.date: 06/30/2020
...
- Azure DevOps Server (antigo Visual Studio Team Services)
...
Não é necessário ter um cartão de crédito para aproveitar a oferta do Azure for Students Starter. No entanto, você pode atualizá-la a qualquer momento para uma assinatura paga conforme o uso para obter acesso a todos os serviços do Azure, usando o [portal de Contas do Azure](https://account.azure.com/).

## <a name="next-steps"></a>Próximas etapas
- [Obter ajuda com erros de logon](troubleshoot-login.md)
- [Baixar o software (Azure for Students Starter)](download-software.md)
- [Programa Azure for Students](azure-students-program.md)
