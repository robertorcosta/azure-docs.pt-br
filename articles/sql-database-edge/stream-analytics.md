...
A borda do banco de dados SQL do Azure expõe `module twin's desired properties` dois parâmetros opcionais por meio da opção do módulo IOT Edge:
...
4. Atualize a configuração do módulo de borda do banco de dados SQL para incluir o URI de acesso compartilhado para o pacote de DAC. Para atualizar o módulo de borda do banco de dados SQL, siga estas etapas:
    ...
    6. No painel **IOT Edge módulos personalizados** , selecione **definir propriedades desejadas do módulo**. Atualize as propriedades desejadas para incluir o URI `SQLPackage` para a opção, conforme mostrado no exemplo a seguir.
...
6. No painel **IOT Edge módulos personalizados** , selecione **definir propriedades desejadas do módulo**. Atualize as propriedades desejadas para incluir o URI `ASAJobInfo` para a opção, conforme mostrado no exemplo a seguir.
