...
| --- | --- |
| `Name` | O nome de exibição da função. |
...
| `AssignableScopes` | Uma matriz de cadeias de caracteres que especifica os escopos que a função está disponível para atribuição. |
