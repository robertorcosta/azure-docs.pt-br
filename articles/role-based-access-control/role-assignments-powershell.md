...
description: Learn how to manage access to Azure resources for users, groups, and applications using role-based access control (RBAC) and Azure PowerShell. Isso inclui como listar o acesso, conceder o acesso e remover o acesso.
...
> [!IMPORTANT]
> A preview version is provided without a service level agreement, and it's not recommended for production workloads. Alguns recursos podem não ter suporte ou podem ter restrição de recursos.
