...
Se você precisar adicionar uma atribuição de função no nível de um recurso, defina a `scope` Propriedade na atribuição de função como o nome do recurso.
