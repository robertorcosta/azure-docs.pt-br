...
ms.locfileid: "78373028"
---
# <a name="threat-protection-in-azure-security-center"></a>Proteção contra ameaças na Central de Segurança do Azure

Esta página descreve brevemente as fontes dos alertas de segurança exibidos pela central de segurança do Azure para os usuários no tipo de preço Standard.

Quando a central de segurança detecta uma ameaça em qualquer uma das áreas do seu ambiente listadas abaixo, ela gera um alerta. Esses alertas descrevem os detalhes dos recursos afetados, as etapas de correção sugeridas e, em alguns casos, uma opção para disparar um aplicativo lógico em resposta.

Se um alerta for gerado pela central de segurança ou recebido pela central de segurança de um produto de segurança diferente, você poderá exportá-lo. Para exportar seus alertas para o Azure Sentinel (ou um SIEM de terceiros) ou quaisquer outros locais externos, siga as instruções em [exportando alertas e recomendações](continuous-export.md). 




## Proteção contra ameaças para computadores Windows<a name="windows-machines"></a>
...
## Proteção contra ameaças para computadores Linux<a name="linux-machines"></a>
...
## Proteção contra ameaças para o serviço Azure App<a name="app-services"></a>
...
## Proteção contra ameaças para contêineres do Azure<a name="azure-containers"></a>
...
## Proteção contra ameaças para a camada de rede do Azure<a name="network-layer"></a>
...
## Proteção contra ameaças para Azure Key Vault (versão prévia)<a name="azure-keyvault"></a>
...
## Proteção contra ameaças para banco de dados SQL e SQL Data Warehouse<a name="data-sql"></a>
...
## Proteção contra ameaças para o armazenamento do Azure<a name="azure-storage"></a>
...
## Proteção contra ameaças para Azure Cosmos DB<a name="cosmos-db"></a>
...
## Proteção contra ameaças para a camada de gerenciamento do Azure (Azure Resource Manager) (visualização)<a name ="management-layer"></a>
...
## Alertas de segurança de outros serviços da Microsoft<a name="alerts-other"></a>

### Proteção contra ameaças para o Azure WAF<a name="azure-waf"></a>
...
### Proteção contra ameaças para a proteção contra DDoS do Azure<a name="azure-ddos"></a>
