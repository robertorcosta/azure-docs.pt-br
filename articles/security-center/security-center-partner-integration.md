...
Consulte o artigo a seguir para obter a lista de [Siems com suporte](../azure-monitor/platform/stream-monitoring-data-event-hubs.md#partner-tools-with-azure-monitor-integration).
