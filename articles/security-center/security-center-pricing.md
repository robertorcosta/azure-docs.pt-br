...
|API REST|[API de Preços](https://docs.microsoft.com/rest/api/securitycenter/pricings)|
|CLI do Azure|[az security pricing](https://docs.microsoft.com/cli/azure/security/pricing)|
