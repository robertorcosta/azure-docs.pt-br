...
* Para obter informações sobre sistemas operacionais suportados, consulte [o Azure Security Center com freqüência (FAQ)](faq-vms.md). 
...
* [FAQ - Máquinas Virtuais](faq-vms.md) - Encontre perguntas frequentes sobre o uso do serviço.