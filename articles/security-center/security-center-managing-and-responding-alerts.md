...
- [O módulo Microsoft Learn sobre como usar os recursos de alerta do Azure Security Center para observar e responder a ameaças](https://docs.microsoft.com/learn/modules/resolve-threats-with-azure-security-center/)
