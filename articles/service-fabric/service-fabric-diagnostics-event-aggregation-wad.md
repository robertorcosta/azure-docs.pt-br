---
title: Agregação de Eventos com o Windows Azure Diagnostics
...
Uma maneira de fazer upload e coletar logs é utilizar a extensão WAD (Diagnóstico do Windows Azure) que faz upload dos logs no Armazenamento do Azure e, além disso, possui a opção de enviar os logs para o Azure Application Insights ou Hubs de Evento. Você também pode usar um processo externo para ler os eventos do armazenamento e colocá-los em um produto de plataforma de análise, como [logs do Monitor Do Azure](../log-analytics/log-analytics-service-fabric.md) ou outra solução de análise de log.
...
* [Gerente de Recursos do Azure](../azure-resource-manager/management/overview.md)
* [Azure PowerShell](/powershell/azure/overview)
* [Modelo de Gerenciador de recursos do Azure](../virtual-machines/windows/extensions-diagnostics-template.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
...
Agora que você está agregando eventos no Azure Storage, [configure os logs do Azure Monitor](service-fabric-diagnostics-oms-setup.md) para obter insights e queconheclá-los no portal de logs do Monitor do Azure
...
* Canal Operacional - Base: Habilitado por padrão, operações de alto nível realizadas pela Service Fabric e pelo cluster, incluindo eventos para um nó chegando, um novo aplicativo sendo implantado ou uma reversão de upgrade, etc. Para obter uma lista de eventos, consulte [Operational Channel Events](https://docs.microsoft.com/azure/service-fabric/service-fabric-diagnostics-event-generation-operational).
...
Existem duas maneiras principais de enviar dados do WAD para o Azure Application Insights, que é conseguido adicionando um dissipador de Insights de aplicativo à configuração WAD, através do portal Azure ou através de um modelo do Azure Resource Manager.
...
* [Análise e visualização de eventos com registros do Monitor do Azure](service-fabric-diagnostics-event-analysis-oms.md)
* [Visualização e Análise de Eventos com o Application Insights](service-fabric-diagnostics-event-analysis-appinsights.md)
* [Análise e visualização de eventos com registros do Monitor do Azure](service-fabric-diagnostics-event-analysis-oms.md)
