...
---
# <a name="configure-managed-identity-support-in-an-existing-service-fabric-cluster"></a>Configure o suporte de identidade gerenciado em um cluster de malha de serviço existente
