---
title: 'Proteger comunicações remotas de serviço com C #'
...
Como próxima etapa, leia [API Web com OWIN no Reliable Services](./service-fabric-reliable-services-communication-aspnetcore.md).
