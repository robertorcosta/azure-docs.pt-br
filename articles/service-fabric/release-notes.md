...
- **Visualização** : [ **referência de keyvault para aplicativos Service Fabric dá suporte **apenas a segredos com versão** . Não há suporte para segredos sem versões.**](https://docs.microsoft.com/azure/service-fabric/service-fabric-keyvault-references)
...
- O [**suporte à governança de recursos foi aprimorado**](https://docs.microsoft.com/azure/service-fabric/service-fabric-resource-governance): permitindo as especificações de solicitações e limites para recursos de CPU e memória.
