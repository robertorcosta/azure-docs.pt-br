...
| select | Se conecta a um ponto de extremidade do cluster do Service Fabric. |
...
| atualização | Começar a realizar os upgrades da versão do código ou configuração de um cluster do Service Fabric. |
