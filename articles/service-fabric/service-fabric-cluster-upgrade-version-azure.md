---
title: Atualize a versão de malha de serviço do Azure de um cluster
...
> [!NOTE]
> Certifique-se de manter o cluster sempre executando uma versão do Fabric com suporte. Quando anunciamos o lançamento de uma nova versão do Service Fabric, a versão anterior é programada para encerrar seu tempo de vida após um mínimo de 60 dias a partir da data desse anúncio. Os novos lançamentos são anunciados [no blog da equipe de fabric de serviço](https://blogs.msdn.microsoft.com/azureservicefabric/). Então, a nova versão está disponível para escolha. 
> 
> 
