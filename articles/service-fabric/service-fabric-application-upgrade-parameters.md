...
| Parâmetro | Descrição |
| --- | --- |
default-service-health-policy | Especificação codificada em [JSON](https://docs.microsoft.com/rest/api/servicefabric/sfclient-model-servicetypehealthpolicy) da política de integridade usada por padrão para avaliar a integridade de um tipo de serviço. O mapa está vazio por padrão. |
