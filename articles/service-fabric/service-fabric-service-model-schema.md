---
title: Descrições do esquema XML do modelo de malha de serviço do Azure
description: Uma descrição do esquema XML do modelo de serviço Service Fabric, incluindo localização e um resumo dos componentes.
ms.topic: reference
ms.date: 12/10/2018
