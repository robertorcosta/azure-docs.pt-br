---
title: Descrições do esquema XML do modelo do serviço de Service Fabric do Azure
description: Uma descrição do esquema XML do modelo de serviço Service Fabric, incluindo o local e um resumo dos componentes.
ms.topic: reference
ms.date: 12/10/2018
