...
Esse modelo está sendo preterido. Recomenda-se usar o gMSA conforme descrito acima. O arquivo de configuração *ClusterConfig. Windows. Multimachine. JSON* de exemplo baixado com o pacote de cluster autônomo [Microsoft. Azure. WindowsServer.\<versão >. zip](https://go.microsoft.com/fwlink/?LinkId=730690) contém um modelo para configurar a segurança do Windows.  A segurança do Windows é configurada na seção **Propriedades** : 
