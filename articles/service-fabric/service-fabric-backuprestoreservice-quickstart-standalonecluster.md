...
* Service Fabric cluster with Fabric version 6.4 or above. Consulte o [artigo](service-fabric-cluster-creation-for-windows-server.md) para ver as etapas para baixar o pacote necessário.
