...
![][ZipApplication] de aplicativo zip  
...
![carregar o pacote do aplicativo][UploadAppPkg]
...
1) Obtenha a ID do recurso para o aplicativo usando [Get-AzResource](https://docs.microsoft.com/powershell/module/az.resources/get-azresource?view=azps-2.5.0):
...
* [Práticas recomendadas](https://docs.microsoft.com/azure/service-fabric/service-fabric-best-practices-infrastructure-as-code)
