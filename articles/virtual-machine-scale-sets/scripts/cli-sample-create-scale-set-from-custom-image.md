...
description: Este script da CLI do Azure cria um conjunto de dimensionamento de máquinas virtuais que usa uma imagem de VM personalizada como a origem para as instâncias de VM.
author: axayjo
ms.author: akjosh
ms.topic: sample
