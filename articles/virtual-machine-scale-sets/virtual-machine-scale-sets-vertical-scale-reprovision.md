...
Este artigo descreve como dimensionar verticalmente os [Conjuntos de Escala de Máquina Virtual](https://azure.microsoft.com/services/virtual-machine-scale-sets/) do Azure com ou sem reprovisionamento. 
...
> 
> | Membro do par dimensionamento de tamanhos de VM | Membro |
> | --- | --- |
> | Basic_A0 |Basic_A4 |
...
* [Exemplos do PowerShell do Azure Monitor](../azure-monitor/powershell-samples.md)
* [Exemplos da CLI de plataforma cruzada do Azure Monitor](../azure-monitor/cli-samples.md)
