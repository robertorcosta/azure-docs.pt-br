---
title: Use o Azure DNS com outros serviços do Azure
description: Neste caminho de aprendizado, comece a usar o Azure DNS para resolver nomes de outros serviços do Azure
services: dns
...
| --- | --- | --- |
| Gateway de Aplicativo do Azure |[IP público front-end](dns-custom-domain.md#public-ip-address) |Você pode criar um registro CNAME ou DNS A. |
| Azure Load Balancer |[IP público front-end](dns-custom-domain.md#public-ip-address) |Você pode criar um registro CNAME ou DNS A. O Load Balancer pode ter um endereço IP público IPv6 que é atribuído dinamicamente. Crie um registro CNAME para um endereço IPv6. |
