...
Para comparar seu próprio gráfico Dockerfile ou Helm com uma versão existente que funciona com Azure Dev Spaces, examine os arquivos gerados no guia de [início rápido][quickstart-cli].
