...
Clique em *Depurar* e, em seguida, *Parar Depuração* para parar o depurador. Click on the Azure Dev Spaces status bar to disconnect from the AKS cluster.
