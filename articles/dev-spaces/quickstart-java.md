---
title: 'Depurar e iterar no Kubernetes: Visual Studio Code e Java'
...
- As extensões [Azure Dev Spaces](https://marketplace.visualstudio.com/items?itemName=azuredevspaces.azds) e [Depurador Java para Azure Dev Spaces](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-debugger-azds) para o Visual Studio Code.
...
Abra o Visual Studio Code, selecione **Arquivo**, **Abrir** e, em seguida, navegue até o diretório *dev-spaces/samples/java/getting-started/webfrontend* e selecione **Abrir**.
...
Selecione o ícone **Depurar** à esquerda e selecione **Iniciar Programa do Java (AZDS)** na parte superior.
...
Navegue de volta até a exibição **Explorer** selecionando **Exibir** e, em seguida, **Explorer**. Abra *src/main/java/com/ms/sample/webfrontend/Application.java* e clique em algum lugar na linha 19 para colocar o cursor ali. Para definir um ponto de interrupção, pressione **F9** ou selecione **Depurar** e, em seguida, **Alternar Ponto de Interrupção**.

Abra o serviço em um navegador e observe que nenhuma mensagem foi exibida. Retorne ao Visual Studio Code e observe a linha 19 realçada. O ponto de interrupção definido colocou o serviço em pausa na linha 19. Para retomar o serviço, pressione **F5** ou selecione **Depurar** e, em seguida, **Continuar**. Volte para o navegador e observe que agora a mensagem foi exibida.
...
Salve o arquivo. Selecione **Depurar** e, em seguida, **Reiniciar depuração** ou, na **barra de ferramentas Depurar**, selecione o botão **Reiniciar depuração**.
