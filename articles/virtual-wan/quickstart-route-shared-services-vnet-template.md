---
title: 'Início rápido: rotear para serviços compartilhados usando um modelo do ARM'
titleSuffix: Azure Virtual WAN
description: Este início rápido mostra como configurar rotas para acessar uma VNet de serviço compartilhado com uma carga de trabalho que você deseja que toda VNet e Branch acessem usando um modelo do ARM (Modelo do Azure Resource Manager).
...
ms.locfileid: "102444078"
---
# <a name="quickstart-route-to-shared-services-vnets-using-an-arm-template"></a>Início rápido: rotear para VNets de serviços compartilhados usando um modelo do ARM
...
[![Implantar no Azure](../media/template-deployments/deploy-to-azure.svg)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3a%2f%2fraw.githubusercontent.com%2fAzure%2fazure-quickstart-templates%2fmaster%2f301-virtual-wan-with-route-tables%2fazuredeploy.json)
...
1. A conclusão da implantação leva cerca de 75 minutos. Veja o progresso na página **Visão geral** do modelo. Se você fechar o portal, a implantação continuará.
   ...
   :::image type="content" source="./media/quickstart-route-shared-services-template/template.png" alt-text="Exemplo de implantação concluída":::
...
1. Selecione o grupo de recursos criado na seção anterior. Na página **Visão geral**, você verá algo semelhante a este exemplo: :::image type="content" source="./media/quickstart-route-shared-services-template/resources.png" alt-text="Exemplo de recursos" lightbox="./media/quickstart-route-shared-services-template/resources.png":::
...
1. Clique na WAN virtual para ver os hubs. Na página da WAN virtual, clique em cada hub para ver as conexões e outras informações do hub.
   :::image type="content" source="./media/quickstart-route-shared-services-template/hub.png" alt-text="Exemplos de hubs" lightbox="./media/quickstart-route-shared-services-template/hub.png":::
