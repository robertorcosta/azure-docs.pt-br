...
* **Autenticação Azure Active Directory:** Obtenha a ID do aplicativo corporativo de VPN do Azure registrada em seu locatário do Azure AD, [o emissor](https://sts.windows.net/your-Directory-ID/)e [o locatário do Azure ad](https://login.microsoftonline.com/your-Directory-ID).
