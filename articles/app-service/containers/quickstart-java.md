...
> [!NOTE]
>
> A mesma coisa também pode ser feita usando IDEs populares, como o IntelliJ, Eclipse e VS Code. Confira nossos documentos semelhantes em [Início Rápido: Azure Toolkit for IntelliJ](/azure/developer/java/toolkit-for-intellij/create-hello-world-web-app), [Início Rápido: Azure Toolkit for Eclipse](/azure/developer/java/toolkit-for-eclipse/create-hello-world-web-app) ou [Início Rápido do VS Code](https://code.visualstudio.com/docs/java/java-webapp).
>
