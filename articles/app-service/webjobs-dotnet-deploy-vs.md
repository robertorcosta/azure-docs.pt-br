...
### <a name="the-add-azure-webjob-dialog"></a><a id="configure"></a>A caixa de diálogo Adicionar trabalho Web do Azure
...
É possível editar esse arquivo diretamente, e o Visual Studio fornece o IntelliSense. O esquema de arquivo é armazenado em [https://schemastore.org](http://schemastore.org/schemas/json/webjobs-list.json) e pode ser exibido lá.

### <a name="deploy-a-webjobs-project"></a><a id="deploy"></a>Implantar um projeto de Trabalhos Web
Um projeto de Trabalhos Web vinculado a um projeto Web é implantado automaticamente com o projeto Web. Para obter informações sobre a implantação de projeto Web, consulte **guias de instruções**de  >  **implantação de aplicativo** no painel de navegação esquerdo.
