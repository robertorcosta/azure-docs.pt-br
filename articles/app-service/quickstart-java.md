...
Abra `pom.xml` para ver a configuração atualizada.
...
> [!div class="nextstepaction"]
> [Encontrei um problema](https://www.research.net/r/javae2e?quickstart-java&step=deploy)
