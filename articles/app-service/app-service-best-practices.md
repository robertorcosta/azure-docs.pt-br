...
description: Aprenda as melhores práticas e os cenários comuns de solução de problemas para o seu aplicativo em execução no Azure App Service.
...
Para obter mais informações sobre aplicativos "stateful" vs "stateless" você pode assistir a este vídeo: [Planejando um aplicativo multi-nível escalável no Azure App Service](https://channel9.msdn.com/Events/TechEd/NorthAmerica/2014/DEV-B414#fbid=?hashlink=fbid). Para saber mais sobre como as opções de colocação em escala e dimensionamento automático, veja [Dimensionar um aplicativo Web no Serviço de Aplicativo do Azure](manage-scale-up.md).  
