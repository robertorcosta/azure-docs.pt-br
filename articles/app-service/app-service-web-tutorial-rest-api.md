...
No Cloud Shell, habilite o CORS para URL do cliente usando o comando [`az webapp cors add`](/cli/azure/webapp/cors#az_webapp_cors_add). Substitua o espaço reservado _&lt;app-name>_ .
