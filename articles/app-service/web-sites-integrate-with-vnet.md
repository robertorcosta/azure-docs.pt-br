...
> [!NOTE]
> Se a folha "Rede" estiver desabilitada (esmaecida) no menu dos aplicativos do Linux, isso indicará que o recurso não está disponível no momento.
>
