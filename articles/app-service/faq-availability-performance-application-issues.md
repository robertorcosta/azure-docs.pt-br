...
Para obter informações sobre cotas e limites, consulte [limites de Serviço de Aplicativo](../azure-resource-manager/management/azure-subscription-service-limits.md#app-service-limits). 
