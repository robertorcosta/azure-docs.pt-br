...
- Para configurar o CI/CD com **Azure pipelines**, consulte [implantar um contêiner de aplicativo Web do Azure do Azure pipelines](/devops/pipelines/targets/webapp-on-container-linux).
