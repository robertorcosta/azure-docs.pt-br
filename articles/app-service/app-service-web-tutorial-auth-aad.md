...
> [!NOTE]
> Salve as URLs dos repositórios remotos Git para os aplicativos front-end e de back-end que são mostradas na saída de `az webapp create`.
>
