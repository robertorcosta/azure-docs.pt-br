...
Para implantar a imagem em um contêiner personalizado no serviço de aplicativo, use a `azure/webapps-container-deploy@v2` ação. Esta ação tem cinco parâmetros:
