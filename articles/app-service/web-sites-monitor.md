...
| **E/S de Outras Operações por Segundo** | A taxa na qual o processo do aplicativo está emitindo operações de e/s que não são operações de leitura ou de gravação.|
