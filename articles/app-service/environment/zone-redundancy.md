...
A única alteração necessária em um modelo ARM para especificar um ASE ILB de zona é a nova propriedade ***Zones** _. A propriedade _ *_Zones_** deve ser definida com um valor de "1", "2" ou "3", dependendo da zona de disponibilidade lógica em que o ase ILB deve ser fixado.
