...
description: Descrição do fluxo de criação para um ambiente de serviço de aplicativo v1. Este doc é fornecido apenas para clientes que usam o Legado v1 ASE.
author: ccompy
