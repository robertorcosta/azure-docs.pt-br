...
3. O certificado SSL carregado é atribuído ao ASE ILB como seu certificado SSL “padrão”.  Este certificado é usado para tráfego SSL para aplicativos no ILB ASE quando eles usam o domínio `https://someapp.mycustomrootdomain.com`raiz comum atribuído ao ASE (por exemplo, ).
...
* **Nome alternativo do assunto**: Este atributo deve incluir **.your-root-domain-here.com* e **.scm.your-root-domain-here.com*. Conexões SSL para o site SCM/Kudu associados a cada aplicativo usam um endereço no formato *nome-do-seu-aplicativo.scm.seu-domínio-raiz-aqui.com*.
