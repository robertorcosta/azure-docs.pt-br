...
O snippet de código do Powershell abaixo mostra um exemplo de como gerar um certificado autoassinado, exportar o certificado como um arquivo .pfx, converter o arquivo .pfx em uma cadeia de caracteres codificada em base64 e salvar essa cadeia de caracteres em um arquivo separado.  O código do PowerShell para codificação Base64 foi adaptado do [blog scripts do PowerShell][examplebase64encoding].
...
* *pfxBlobString*: a representação de cadeia de caracteres codificada em base 64 do arquivo .pfx.  Usando o snippet de código mostrado anteriormente, copie a cadeia de caracteres contida no "exportedcert.pfx.b64" e cole-a como o valor do atributo *pfxBlobString*.
