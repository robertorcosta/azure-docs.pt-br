...
Normalmente, o tamanho do lote que definimos para Machine Learning funções não será exatamente divisível pelo número de eventos retornados por cada trabalho de Stream Analytics "pull". Quando isso ocorre, o serviço Web do Machine Learning é chamado com lotes "parciais". O uso de lotes parciais evita a incorrência de sobrecarga de latência de trabalho adicional na União de eventos de pull para pull.
