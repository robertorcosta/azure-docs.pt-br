...
|UseSystemAssignedIdentity|boolean|Não|Defina true para permitir que esse trabalho se comunique com outros serviços do Azure usando uma identidade de Azure Active Directory gerenciada.|
