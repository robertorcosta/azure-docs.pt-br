...
Se um site permitir vários dispositivos, uma matriz de IDs de dispositivo poderá ser definida no `AllowedDeviceID` e uma função definida pelo usuário poderá ser usada na cláusula `WHERE` para verificar se a ID do dispositivo de fluxo corresponde a qualquer ID de dispositivo nessa lista. Para obter mais informações, veja o tutorial do [JavaScript UDF](stream-analytics-javascript-user-defined-functions.md) para trabalhos de [ C# ](stream-analytics-edge-csharp-udf.md) nuvem e o tutorial do UDF para trabalhos do Edge.
...
|ID|FromLocation|ToLocation|TripRequestedTime|
|------|------------|----------|-----------------|
...
|3D|"POINT (-74.00741090068288 40.71615626755086)"|"POINT (-73.97999843120539 40.73477895807408)"|"2019-03-12T07:03:00Z"|
