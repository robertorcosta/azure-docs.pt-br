...
|-------------|--------------|----------|
|[Azure Data Lake Storage Gen 1](azure-data-lake-storage-gen1-output.md)|Usuário do Active Directory do Azure </br> MSI|
...
|[Azure Synapse Analytics (versão prévia)](azure-synapse-analytics-output.md)|Não|Autenticação de usuário do SQL|
