...
* [Proteção contra ameaças para a camada de serviço do Azure na central de segurança do Azure](https://docs.microsoft.com/azure/security-center/threat-protection)
...
* [Azure Stream Analytics fornece logs de diagnóstico e dados de atividade para análise](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-job-diagnostic-logs)
...
* [Entender as entradas para o Azure Stream Analytics](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-add-inputs)

* [Entender as saídas do Azure Stream Analytics](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-define-outputs)
...
* [Proteção de dados no Azure Stream Analytics](https://docs.microsoft.com/azure/stream-analytics/data-protection)
...
* [Definições de política interna do Azure Policy](https://docs.microsoft.com/azure/governance/policy/samples/built-in-policies)
...
* [Fazer a rotação de credenciais de logon para entradas e saídas de um trabalho do Stream Analytics](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-login-credentials-inputs-outputs)
...
* [Autenticar Stream Analytics para Azure Data Lake Storage Gen1 usando identidades gerenciadas](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-managed-identities-adls)

* [Usar identidade gerenciada para autenticar seu trabalho de Azure Stream Analytics para a saída do armazenamento de BLOBs do Azure](https://docs.microsoft.com/azure/stream-analytics/blob-output-managed-identity)
...
* [Proteção de dados no Azure Stream Analytics](https://docs.microsoft.com/azure/stream-analytics/data-protection#private-data-assets-that-are-stored)
...
* [Gerenciar o ciclo de vida de armazenamento de BLOBs do Azure](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts)
