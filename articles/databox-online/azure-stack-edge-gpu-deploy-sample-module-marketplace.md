...
ms.locfileid: "89082970"
---
# <a name="deploy-a-gpu-enabled-iot-module-from-azure-marketplace-on-azure-stack-edge-device"></a>Implantar um módulo IoT habilitado para GPU do Azure Marketplace no dispositivo Azure Stack Edge
...
- Você configurou a computação neste dispositivo. 
    - Siga as etapas em [tutorial: configurar a computação em seu dispositivo de Azure Stack Edge](azure-stack-edge-gpu-deploy-configure-compute.md).
    - Certifique-se de 
