...
|                                   | <li>Pelo menos 1 X 1-cabo de rede RJ-45 de GbE para a porta 1 </li><li> Pelo menos 1 X 25-GbE SFP + cabo de cobre para a porta 3, porta 4, porta 5 ou porta 6</li>| O cliente precisa adquirir esses cabos.<br>Para obter uma lista completa de cabos de rede, comutadores e transceptores com suporte para placas de rede do dispositivo, consulte [matriz de interoperabilidade da série Cavium FastlinQ 41000.](https://www.marvell.com/documents/xalflardzafh32cfvi0z/)                                                                          | 
| Conexão do dispositivo pela primeira vez      | A porta 1 tem um IP fixo (192.168.100.10/24) para a conexão inicial. <li>Exigir um laptop para conexão direta com a porta 1, com um endereço IP na rede 192.168.100.0/24.</li><li> Use a interface do usuário local do dispositivo em: `https://192.168.100.10` para configuração adicional.</li>|                                                                                                                   |
