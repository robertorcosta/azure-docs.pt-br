---
title: Lista de verificação de pré-implantação para implantar Azure Stack dispositivo de GPU pro de borda | Microsoft Docs
description: Este artigo descreve as informações que podem ser coletadas antes de implantar o dispositivo Azure Stack Edge pro GPU.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
Este artigo descreve as informações que podem ser coletadas à frente da implantação real do dispositivo Azure Stack Edge pro. 

Use a lista de verificação a seguir para garantir que você tenha essas informações depois de ter colocado um pedido para um dispositivo Azure Stack Edge pro e antes de receber o dispositivo. 

## <a name="deployment-checklist"></a>Lista de verificação para implantação 

| Estágio                             | Parâmetro                                                                                                                                                                                                                           | Detalhes                                                                                                           |
|-----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| Gerenciamento de dispositivo               | <li>Assinatura Microsoft Azure</li><li>API do Graph do Active Directory do Azure</li><li>Conta de Armazenamento do Microsoft Azure</li>|<li>Habilitado para Azure Stack Edge pro/Gateway do Data Box, permissões de colaborador</li><li>Garantir o acesso de administrador ou usuário</li><li>Precisa de credenciais de acesso</li> |
...
Prepare-se para implantar seu [dispositivo Azure Stack Edge pro](azure-stack-edge-gpu-deploy-prep.md).
