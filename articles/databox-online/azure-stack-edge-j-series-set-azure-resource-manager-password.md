...
1. Na portal do Azure, vá para o recurso de borda do Azure Stack que você criou para gerenciar seu dispositivo. Acesse **serviços de borda > gateway de armazenamento em nuvem**.
...
3. Na folha **Redefinir senha do usuário do EdgeArm** , forneça uma senha para se conectar às APIs locais do dispositivo por meio do Azure Resource Manager. Confirme a senha e selecione **Redefinir**.
    ...
    ![Redefinir senha de usuário do EdgeARM 3](media/azure-stack-edge-j-series-set-azure-resource-manager-password/set-edgearm-password-3.png)
