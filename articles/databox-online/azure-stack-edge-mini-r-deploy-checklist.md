...
| Configurações de rede de computação     | <li>Exigir dois IPs gratuitos, estáticos e contíguos para nós kubernetes e um IP estático para o serviço IoT Edge.</li><li>Exija 1 IP adicional para cada serviço extra ou módulo que você implantará.</li>| Somente a configuração IPv4 estática tem suporte.|
