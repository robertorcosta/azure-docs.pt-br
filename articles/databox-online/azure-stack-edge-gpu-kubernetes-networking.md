...
- [Expor um aplicativo sem estado externamente em seu Azure Stack Edge pro via kuebctl](./azure-stack-edge-gpu-deploy-stateless-application-kubernetes.md).