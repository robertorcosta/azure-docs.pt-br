...
O Azure Spring Cloud oferece um plano de serviço durante o período de versão prévia.  Uma implantação do Spring Cloud contém 16 núcleos de vCPU e 32 GB de memória.  O limite superior para cada instância de microserviço em uma implantação é de 4 núcleos de vCPU com 8 GB de memória.
