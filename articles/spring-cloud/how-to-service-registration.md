...
Para obter informações sobre como configurar o registro de serviço para um aplicativo Steeltoe, consulte [preparar um aplicativo Spring Java para implantação no Azure Spring Cloud](how-to-prepare-app-deployment.md).
::: zone-end
