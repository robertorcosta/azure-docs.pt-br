...
O Azure Spring Cloud permite que você execute facilmente um aplicativos de microsserviços baseado no Spring Boot no Azure.  Antes de executar este exemplo, experimente o [guia de início rápido básico](spring-cloud-quickstart.md).
...
3. Navegue até a URL fornecida pelo comando anterior para executar o aplicativo PiggyMetrics.
    ![PiggyMetrics em execução](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. Selecione **Gateway**
    ...
    ![Navegação do PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. Encontre a URL na página **Visão geral do gateway** ![Navegação do PiggyMetrics 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
