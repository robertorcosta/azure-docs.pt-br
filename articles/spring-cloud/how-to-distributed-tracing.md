...
Para seguir esses procedimentos, você precisa de um aplicativo Steeltoe que já esteja [preparado para implantação no Azure Spring Cloud](how-to-prepare-app-deployment.md).
...
1. Ignore esta etapa caso tenha seguido nosso [guia para preparar um aplicativo do Azure Spring Cloud](how-to-prepare-app-deployment.md). Caso contrário, acesse o ambiente de desenvolvimento local e edite o arquivo pom.xml para incluir a seguinte dependência do Spring Cloud Sleuth:
...
Neste artigo, você aprendeu a habilitar e entender o rastreamento distribuído no Azure Spring Cloud. Para saber como associar serviços a um aplicativo, confira [Associar um banco de dados do Azure Cosmos DB a um aplicativo do Azure Spring Cloud](spring-cloud-howto-bind-cosmos.md).