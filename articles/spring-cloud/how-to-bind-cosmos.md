...
ms.locfileid: "104877724"
---
# <a name="tutorial-bind-an-azure-cosmos-db-database-to-your-azure-spring-cloud-application"></a>Tutorial: associar um banco de dados Azure Cosmos DB ao seu aplicativo Azure Spring Cloud
