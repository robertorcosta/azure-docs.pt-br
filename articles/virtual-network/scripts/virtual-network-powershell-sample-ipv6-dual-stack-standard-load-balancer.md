---
title: Amostra de script do Azure PowerShell - Configure frontend IPv6 com Standard Load Balancer(visualização)
...
---
# <a name="configure-ipv6-frontend-in-virtual-network-script-sample-with-standard-load-balancerpreview"></a>Configure o frontend IPv6 na amostra de script de rede virtual com o Standard Load Balancer(visualização)
