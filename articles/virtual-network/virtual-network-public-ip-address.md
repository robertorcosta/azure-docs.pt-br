...
Para obter detalhes adicionais sobre os atributos específicos de um endereço IP público durante a criação, consulte a tabela a seguir.
   ...
   |Subscription|Yes|Deve existir na mesma [assinatura](../azure-glossary-cloud-terminology.md?toc=%2fazure%2fvirtual-network%2ftoc.json#subscription) que o recurso ao qual você associará os IPs públicos.|
   |Grupo de recursos|Yes|Pode existir no mesmo [grupo de recursos](../azure-glossary-cloud-terminology.md?toc=%2fazure%2fvirtual-network%2ftoc.json#resource-group) , ou diferente, que o recurso ao qual você associará os IPs públicos.|
