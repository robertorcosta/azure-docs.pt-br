...
Crie o Standard Load Balancer com [AZ Network lb Create](/cli/azure/network/lb) chamado **dsLB** que inclui um pool de front-end chamado **dsLbFrontEnd_v4**, um pool de back-end chamado **dsLbBackEndPool_v4** que está associado ao endereço IP público IPv4 **dsPublicIP_v4** que você criou na etapa anterior. 
