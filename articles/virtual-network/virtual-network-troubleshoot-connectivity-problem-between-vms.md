...
description: Saiba como solucionar problemas e resolver os problemas de conectividade que podem ocorrer entre as VMs do Azure.
...
### <a name="step-3-check-whether-network-traffic-is-blocked-by-vm-firewall"></a>Etapa 3: verificar se o tráfego de rede está bloqueado por firewall de VM
