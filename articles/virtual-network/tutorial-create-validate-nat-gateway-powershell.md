...
```
Combine as definições de configuração para criar uma VM chamada **myVMsource** com [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) em **myResourceGroupNAT**.
...
```
Combine as definições de configuração para criar uma VM chamada **myVMdestination** com [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) em **myResourceGroupNAT**.
