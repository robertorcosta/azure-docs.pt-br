---
title: Notas de versão do Gateway do Azure Data Box 1905 | Microsoft Docs
description: Descreve problemas e resoluções críticos em aberto para o Gateway do Azure Data Box 1905 executando a versão de disponibilidade geral.
services: databox
author: alkohli
ms.service: databox
...
ms.locfileid: "96581500"
---
# <a name="azure-data-box-edge-and-azure-data-box-gateway-1905-release-notes"></a>Notas de versão do Azure Data Box Edge e Gateway do Azure Data Box 1905

## <a name="overview"></a>Visão geral

As notas de versão a seguir identificam os problemas críticos abertos e os problemas resolvidos para a versão 1905 para Azure Data Box Edge e Gateway do Azure Data Box.
...
- **Gateway do Data Box 1905 (1.6.887.626)**
- **Data Box Edge 1905 (1.6.887.626)**

> [!NOTE]
> A atualização 1905 pode ser aplicada somente a dispositivos Data Box Edge que estão executando a versão GA do software.

## <a name="whats-new"></a>Novidades

- **Aprimoramentos no log de FPGA (Reprogramable Gate Array)** – nesta versão, fizemos o log e os aprimoramentos de alerta relacionados ao FPGA. Essa é uma atualização necessária para Data Box Edge se você estiver usando o recurso de computação de borda com o FPGA. Para obter mais informações, consulte como [transformar dados com a computação de borda em seu data Box Edge](../databox-online/azure-stack-edge-deploy-configure-compute-advanced.md).
