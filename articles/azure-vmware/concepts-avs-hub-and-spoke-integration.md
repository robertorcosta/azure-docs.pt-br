...
Examine o artigo específico da solução Azure VMware no [Gateway de aplicativo](./protect-avs-web-apps-with-app-gateway.md) para obter os detalhes e os requisitos.
