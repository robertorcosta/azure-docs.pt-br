...
Neste tutorial, você cria uma máquina virtual do Windows para uma caixa de salto no grupo de recursos criado no tutorial anterior, [Tutorial: Configurar a rede para sua nuvem privada do VMWare no Azure](tutorial-configure-networking.md) e entra no vCenter. Essa VM fica na mesma rede virtual que você criou e fornece acesso ao vCenter e ao NSX Manager. 
