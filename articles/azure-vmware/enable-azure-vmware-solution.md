---
title: Solicitar a cota de host e habilitar a solução Azure VMware
...
---
# <a name="request-host-quota-and-enable-azure-vmware-solution"></a>Solicitar a cota de host e habilitar a solução Azure VMware
