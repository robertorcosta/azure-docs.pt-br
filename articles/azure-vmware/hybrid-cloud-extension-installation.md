...
| NSX    | Para a Extensão de Rede HCX de comutadores lógicos na fonte: NSXv 6.2+ ou NSX-T 2.4+   | NSXv 6.2+ ou NSX-T 2.4+<br/><br/>Para roteamento de proximidade de HCX: NSXv 6.4 + (roteamento de proximidades sem suporte com o NSX-T) |
...
* O alcance global deve ser configurado entre os circuitos de ER do SDDC local e AVS.
