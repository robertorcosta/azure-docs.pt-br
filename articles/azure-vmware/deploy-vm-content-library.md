---
title: Criar uma biblioteca de conteúdo para implantar VMs na AVS (Solução VMware no Azure)
...
ms.locfileid: "86014204"
---
# <a name="create-a-content-library-to-deploy-vms-in-azure-vmware-solution-avs"></a>Criar uma biblioteca de conteúdo para implantar VMs na AVS (Solução VMware no Azure)
...
Um segmento de comutador lógico do NSX-T e um serviço DHCP gerenciado são necessários para concluir este tutorial.  Confira [Como gerenciar o DHCP na versão prévia da AVS (Solução VMWare no Azure)](manage-dhcp.md) para obter detalhes.
