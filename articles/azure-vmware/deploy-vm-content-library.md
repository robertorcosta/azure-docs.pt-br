...
Se você planeja usar o VMware HCX para migrar cargas de trabalho de VM para sua nuvem privada, use o procedimento [implantar e configurar o VMware HCX](tutorial-deploy-vmware-hcx.md) .
