...
É necessário ter uma nuvem privada da Solução VMware no Azure com acesso às interfaces de gerenciamento do vCenter e do NSX-T Manager para concluir este tutorial. Confira o [Tutorial: Configurar a rede para a sua nuvem privada da VMware no Azure](tutorial-configure-networking.md).
...
1. No NSX-T Manager da sua nuvem privada, selecione **Rede**.
   ...
   :::image type="content" source="media/nsxt/nsxt-network-overview.png" alt-text="No NSX-T Manager da sua nuvem privada, selecione Rede":::.
...
1. Na página de visão geral Segmentos do NSX-T, selecione **ADICIONAR SEGMENTO**. Três segmentos são criados como parte do provisionamento de nuvem privada e não podem ser usados para VMs.  Você precisará adicionar um novo segmento de rede para essa finalidade.
   ...
   :::image type="content" source="media/nsxt/nsxt-segments-overview.png" alt-text="Na página de visão geral Segmentos do NSX-T, selecione ADICIONAR SEGMENTO.":::
