---
title: Visão geral da documentação de referência dos Serviços de Comunicação do Azure
...
ms.locfileid: "93325846"
---
# <a name="reference-documentation-overview"></a>Visão geral da documentação de referência

[!INCLUDE [Public Preview Notice](../includes/public-preview-include.md)]

A seguinte tabela fornece detalhes sobre os pacotes de Serviços de Comunicação disponíveis juntamente com a documentação de referência correspondente:
...
| Chamando        | [npm](https://www.npmjs.com/package/@azure/communication-calling)         | -      | -      | -     | [GitHub](https://github.com/Azure/Communication/releases/tag/v1.0.0-beta.2) ([docs](https://docs.microsoft.com/objectivec/communication-services/calling/))     | [Maven](https://search.maven.org/artifact/com.azure.android/azure-communication-calling/)            | -                              |
