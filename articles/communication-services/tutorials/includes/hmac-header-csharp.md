...
Para este exemplo, assinaremos uma solicitação para criar uma identidade usando a API de Autenticação dos Serviços de Comunicação (versão `2020-07-20-preview2`)
