...
### <a name="poco-plain-old-clr-objecthttpsenwikipediaorgwikiplain_old_clr_object-queue-messages"></a>Mensagens de fila POCO [(Objeto Plain Old CLR](https://en.wikipedia.org/wiki/Plain_Old_CLR_Object))
