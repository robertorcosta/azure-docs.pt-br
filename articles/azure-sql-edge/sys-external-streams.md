---
title: sys.external_streams (Transact-SQL) - Azure SQL Edge (Versão Prévia)
description: Saiba mais sobre como usar o sys.external_streams no SQL do Azure no Edge (Versão Prévia)
