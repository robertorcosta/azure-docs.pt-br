---
title: sys.external_streaming_jobs (Transact-SQL) - SQL do Azure no Edge (Versão Prévia)
description: Saiba mais sobre como usar sys.external_streaming_jobs no SQL do Azure no Edge (Versão Prévia)
