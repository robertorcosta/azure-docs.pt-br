...
Em implantações em que **alguma perda de dados** pode ser tolerada ou em dispositivos de borda com armazenamento lento, a durabilidade atrasada pode ser usada para otimizar a ingestão de dados e a limpeza baseada em retenção de dados. Para obter mais informações, veja [Controlar a durabilidade da transação](https://docs.microsoft.com/sql/relational-databases/logs/control-transaction-durability).


### <a name="linux-os-configurations"></a>Configurações do SO Linux 

Considere o uso das seguintes definições de [configuração do sistema operacional Linux](https://docs.microsoft.com/sql/linux/sql-server-linux-performance-best-practices#linux-os-configuration) para experimentar o melhor desempenho para uma instalação do SQL.
