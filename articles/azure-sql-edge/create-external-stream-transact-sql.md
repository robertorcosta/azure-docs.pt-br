...
O Azure SQL Edge atualmente dá suporte apenas às entradas e saídas de fluxo a seguir.

**Entrada de fluxo**: define as conexões com uma fonte de dados na qual ler o fluxo de dados
- Hub do Edge
- Kafka (o suporte para entradas de Kafka está disponível atualmente apenas nas versões Intel/AMD64 do Azure SQL Edge.)

**Saída de fluxo**: define as conexões com uma fonte de dados na qual gravar o fluxo de dados. 
- Hub do Edge
