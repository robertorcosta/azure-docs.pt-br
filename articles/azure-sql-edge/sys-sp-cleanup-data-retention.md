...
description: Saiba mais sobre como usar sys. sp_cleanup_data_retention (Transact-SQL) no Azure SQL Edge
keywords: sys. sp_cleanup_data_retention (Transact-SQL), borda do SQL
services: sql-edge
ms.service: sql-edge
ms.topic: reference
author: SQLSourabh
