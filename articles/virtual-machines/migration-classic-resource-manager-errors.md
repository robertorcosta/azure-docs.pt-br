---
title: Erros comuns durante a migração do Clássico para o Azure Resource Manager
description: Este artigo cataloga os erros e as atenuações mais comuns durante a migração de recursos de IaaS do gerenciamento de serviços do Azure para Azure Resource Manager.
author: tanmaygore
manager: vashan
...
Depois de concluir o processo de migração, talvez você queira mover a VM para outra assinatura. No entanto, se você tiver um segredo/certificado na VM que faça referência a um recurso do Key Vault, a movimentação atualmente não tem suporte. As instruções abaixo lhe permitirão contornar o problema. 
