...
```
#### <a name="azure-cli-sample-for-installing-lad-30-extension-on-the-vmss-instance"></a>CLI do Azure exemplo para instalar a extensão LAD 3,0 na instância VMSS
