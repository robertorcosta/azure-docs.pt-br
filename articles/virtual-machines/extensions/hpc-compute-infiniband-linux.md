...
As instruções sobre a instalação manual dos drivers do OFED estão disponíveis [aqui](https://docs.microsoft.com/azure/virtual-machines/workloads/hpc/enable-infiniband#manually-install-mellanox-ofed).
