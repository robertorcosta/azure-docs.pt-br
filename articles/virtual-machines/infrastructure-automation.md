...
- [Criar uma infraestrutura de desenvolvimento em uma VM Linux no Azure com Jenkins, GitHub e Docker](/azure/developer/jenkins/pipeline-with-github-and-docker).
