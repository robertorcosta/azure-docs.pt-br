...
Para verificar se há atualizações pendentes para um host dedicado (ADH). Neste exemplo, a saída é formatada como uma tabela para facilitar a leitura. Substitua os valores dos recursos pelos seus próprios.
