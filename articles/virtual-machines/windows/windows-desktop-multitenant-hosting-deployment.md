...
Usando o [centro de administração da Microsoft](/microsoft-365/admin/admin-overview/about-the-admin-center), você pode confirmar se uma licença com suporte do Windows 10 foi atribuída a um usuário.
