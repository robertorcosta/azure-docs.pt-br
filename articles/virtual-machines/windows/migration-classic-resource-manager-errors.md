...
description: Saiba mais sobre os erros e as atenuações mais comuns que ocorrem durante a migração de recursos de IaaS do gerenciamento de serviços do Azure para a pilha de Azure Resource Manager.
author: tanmaygore
manager: vashan
