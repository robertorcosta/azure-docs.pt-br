...
Você também pode generalizar uma VM Linux usando `sudo waagent -deprovision+user` e depois o PowerShell para capturar a VM. Para obter informações sobre o uso da CLI para capturar uma VM, confira [Como generalizar e capturar uma máquina virtual do Linux usando a CLI do Azure](../linux/capture-image.md).
