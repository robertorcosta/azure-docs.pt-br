---
title: Crie uma VM do Windows a partir de um modelo no Azure
...
Aprenda a criar uma máquina virtual do Windows usando um modelo do Azure Resource Manager e o Azure PowerShell a partir do shell do Azure Cloud. O modelo usado neste artigo implanta uma única máquina virtual executando o Windows Server em uma nova rede virtual com uma única sub-rede. Para criar uma máquina virtual Linux, consulte [Como criar uma máquina virtual Linux com modelos do Azure Resource Manager](../linux/create-ssh-secured-vm-from-template.md).
...
O exemplo a seguir cria uma VM a partir de [um modelo Azure Quickstart](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/101-vm-simple-windows/azuredeploy.json). Veja uma cópia do modelo:
...
O último comando PowerShell do script anterior mostra o nome da máquina virtual. Para se conectar à máquina virtual, consulte [Como conectar e assinar em uma máquina virtual do Azure executando o Windows](./connect-logon.md).
