...
O PowerShell a seguir cria um cluster de failover para o **Windows Server 2008-2016**. Atualize o script com os nomes dos nós (os nomes das máquinas virtuais) e um endereço IP da VNET do Azure:
