...
1. Altere o nome do nome do grupo de trabalho para que seja algo significativo, como `AGWORKGROUP`: 
...
1. Use o **Explorador de arquivos** para ir para `c:\windows\system32\drivers\etc`. 
...
1. No final do arquivo, adicione uma entrada para cada nó, o grupo de disponibilidade e o ouvinte na forma de `IP Address, DNS Suffix #comment` como: 
...
Nesta etapa, crie certificados que um logon do SQL usa no ponto de extremidade criptografado. Crie uma pasta em cada nó para manter os backups de certificado, como `c:\certs`. 

Para configurar o primeiro nó, siga estas etapas: 

1. Abra **SQL Server Management Studio** e conecte-se ao seu primeiro nó, como `AGNode1`. 
...
1. Use o **Explorador de arquivos** para ir até o local do arquivo onde está o certificado, como `c:\certs`. 
