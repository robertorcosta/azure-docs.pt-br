...
1. No **Gerenciador do Servidor**, clique em **Ferramentas**. Abra o **Gerenciamento do computador**.
...
1. No primeiro SQL Server em **Gerenciador do Servidor**, clique em **Ferramentas**. Abra o **Gerenciamento do computador**.
