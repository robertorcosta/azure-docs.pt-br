...
Este artigo descreve como registrar em massa seu SQL Server VM (máquina virtual) no Azure com o provedor de recursos de VM do SQL usando o cmdlet do PowerShell ' Register-SqlVMs '.
