...
14. Revise as configurações na página **Resumo** e, então, clique em **Concluir**.
15. O processo de provisionamento tem início. Quando o assistente for concluído com êxito, clique em **Fechar** para sair do assistente.
