---
title: Cálculo de pontuações de benchmark para VMs do Windows do Azure
...
ms.locfileid: "77651042"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>Pontuações de parâmetro de comparação de computação de VMs do Windows
As pontuações de benchmark do SPECInt a seguir mostram o desempenho da computação para VMs selecionados que executam o Windows Server. As pontuações de parâmetro de comparação de computação também estão disponíveis para [VMs do Linux](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).


## <a name="av2---general-compute"></a>Av2 - Computação Geral
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa Básica de Avg | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
SPEC Int é um teste bastante longo que normalmente esgota créditos de estouro disponíveis.  Portanto, os números acima estão mais próximos do desempenho da linha de base da VM (embora possam refletir algum tempo de explosão acumulado entre as corridas).  Para o desempenho curto, estourado, as cargas de trabalho (típicas da Série B) normalmente serão mais próximas da Série Dv3..
...
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa Básica de Avg | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_NC6s_v3 | 6 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 6 | 230.2 | 1.6 | 
| Standard_NC12s_v3 | 12 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 7 | 425.0 | 3.6 | 
| Standard_NC24rs_v3 | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 2 | 811.0 | 4.2 | 
| Standard_NC24s_v3 | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 3 | 809.3 | 2.3 | 

## <a name="ncsv2---gpu-enabled"></a>NCSv2 - GPU Ativado
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa Básica de Avg | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_NC6s_v2 | 6 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 11 | 227.0 | 6.2 | 
| Standard_NC12s_v2 | 12 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 9 | 427.3 | 1,3 | 
| Standard_NC24rs_v2 | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 12 | 811.0 | 5.4 | 
| Standard_NC24s_v2 | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 11 | 811.5 | 4.4 | 

## <a name="nc---gpu-enabled"></a>NC - GPU Ativado
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa Básica de Avg | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_NC6 | 6 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 27 | 209.6 | 4.4 | 
| Standard_NC12 | 12 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 28 | 394.4 | 3.8 | 
| Standard_NC24 | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 28 | 751.7 | 3,5 | 
| Standard_NC24r | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 27 | 752.9 | 3.4 | 

## <a name="nds--gpu-enabled"></a>NDs- GPU Ativado
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa Básica de Avg | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_ND6s | 6 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 8 | 230.1 | 1.2 | 
| Standard_ND12s | 12 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 11 | 426.5 | 1.4 | 
| Standard_ND24rs | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 10 | 811.4 | 3,5 | 
| Standard_ND24s | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 11 | 812.6 | 4.4 | 

## <a name="nv---gpu-enabled"></a>NV - GPU Ativado
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa Básica de Avg | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_NV6 | 6 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 28 | 210.5 | 6.1 | 
| Standard_NV12 | 12 | 1 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 28 | 394.5 | 2.3 | 
| Standard_NV24 | 24 | 2 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 26 | 752.2 | 4.4 | 
