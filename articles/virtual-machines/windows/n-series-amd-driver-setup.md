...
| -------- |------------- |
| Windows 10 Enterprise Multi-Session-compilação 1903 <br/><br/>Windows 10 - Build 1809<br/><br/>Windows Server 2016<br/><br/>Windows Server 2019 | [20. Q1. Hotfix](https://download.microsoft.com/download/d/e/f/def0fb44-15ab-4b83-959a-8094eb9d0dfe/AMD-Azure-NVv4-Driver-20Q1-Hotfix3.exe) (. exe) |
...
<br />
![Status do dispositivo GPU](./media/n-series-amd-driver-setup/device-manager.png)
...
<br />
![Propriedades da GPU](./media/n-series-amd-driver-setup/dxdiag-output-new.png)
