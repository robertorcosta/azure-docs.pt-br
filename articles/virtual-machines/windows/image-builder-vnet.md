...
Agora que a compilação foi concluída, você pode criar uma VM a partir da imagem. Use os exemplos da [documentação New-AzVM do PowerShell](/powershell/module/az.compute/new-azvm#description).
