---
title: Pontuação de benchmark de cálculo para VMs Azure Linux
...
(15/03/2019 12:06:55 M pbi 3897709)
...
Nota: As VMs da série Av2 podem ser implantadas em uma variedade de tipos de hardware e processadores (como visto acima). As VMs da série Av2 têm as configurações de desempenho e memória da CPU mais adequadas para cargas de trabalho de nível de entrada, como desenvolvimento e teste. O tamanho é acelerado para oferecer desempenho relativamente consistente do processador para a instância em execução, independentemente do hardware em que ele é implantado; no entanto, o software que aproveita as otimizações específicas do processador pode ver uma variação mais significativa entre os tipos de processadores.

## <a name="b---burstable"></a>B - Explodivel
(15/03/2019 12:27:08 M pbi 3897709)
...
Nota: As VMs da série B são para cargas de trabalho com requisitos de desempenho explodidos. As instâncias vM acumulam créditos ao usar menos do que sua linha de base. Quando a VM tem crédito acumulado, a VM pode estourar acima da linha de base usando até 100% para atender aos requisitos curtos de estouro da CPU. O tempo de estouro depende dos créditos disponíveis, que é uma função do tamanho e do tempo da VM.  

CoreMark é um teste de execução curta que normalmente completa dentro de créditos de estouro disponíveis.  Portanto, os números acima normalmente representam o desempenho de explosão da VM, refletindo o que o desempenho curto, estourado, cargas de trabalho (típico sinuoso na Série B) normalmente verá.

## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - Computação Geral + Armazenamento Premium
(3/12/2019 18:52:03 pbi 3897709)
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - Opção de memória + Armazenamento Premium (isolado)
...
(3/12/2019 18:52:13 pbi 3897709)
...
(3/12/2019 18:51:35 pbi 3897709)
...
(15/03/2019 12:12:51 M pbi 3897709)
...
| Tamanho da VM | CPU | vCPUs | Nós NUMA | Memória (GiB) | Pontuação Média | StdDev | StdDev% | #Execuções |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | Processador AMD EPYC 7551 de 32 Núcleos | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | Processador AMD EPYC 7551 de 32 Núcleos | 16 | 2 | 125.9 | 154,829 | 3,708 | 2,40% | 119 |
| Standard_L32s_v2 | Processador AMD EPYC 7551 de 32 Núcleos | 32 | 4 | 251.9 | 310,811 | 7,751 | 2,49% | 119 |
| Standard_L64s_v2 | Processador AMD EPYC 7551 de 32 Núcleos | 64 | 8 | 503.9 | 595,140 | 14,572 | 2,45% | 112 |
| Standard_L80s_v2 | Processador AMD EPYC 7551 de 32 Núcleos | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |
...
## <a name="ncsv3---gpu-enabled"></a>NCSv3 - GPU Ativado
(21/03/2019 17:48:37 pm pbi 3897709)

| Tamanho da VM | CPU | vCPUs | Nós NUMA | Memória (GiB) | Pontuação Média | StdDev | StdDev% | #Execuções |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v3 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 6 | 1 | 110.2 | 106,929 | 353 | 0.33% | 49 |
| Standard_NC12s_v3 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 12 | 1 | 220.4 | 213,585 | 875 | 0.41% | 42 |
| Standard_NC24rs_v3 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 403,554 | 6,705 | 1.66% | 42 |
| Standard_NC24s_v3 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 403,874 | 7,603 | 1.88% | 42 |

## <a name="ncsv2---gpu-enabled"></a>NCSv2 - GPU Ativado
(3/12/2019 11:19:19 PM pbi 3897709)

| Tamanho da VM | CPU | vCPUs | Nós NUMA | Memória (GiB) | Pontuação Média | StdDev | StdDev% | #Execuções |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 6 | 1 | 110.2 | 107,115 | 321 | 0.30% | 63 |
| Standard_NC12s_v2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 12 | 1 | 220.4 | 213,814 | 656 | 0.31% | 63 |
| Standard_NC24rs_v2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 401,728 | 6,995 | 1,74% | 63 |
| Standard_NC24s_v2 | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 402,808 | 7,923 | 1.97% | 63 |

## <a name="nc---gpu-enabled"></a>NC - GPU Ativado
(12/03/2019 11:08:03 PBI 3897709)

| Tamanho da VM | CPU | vCPUs | Nós NUMA | Memória (GiB) | Pontuação Média | StdDev | StdDev% | #Execuções |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 6 | 1 | 55.0 | 102,211 | 658 | 0.64% | 259 |
| Standard_NC12 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 12 | 1 | 110.2 | 203,523 | 2,293 | 1,13% | 259 |
| Standard_NC24 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 24 | 2 | 220.4 | 382,897 | 8,712 | 2,28% | 259 |
| Standard_NC24r | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 24 | 2 | 220.4 | 383,171 | 9,166 | 2.39% | 259 |

## <a name="nds--gpu-enabled"></a>NDs- GPU Ativado
(3/12/2019 11:19:10 pbi 3897709)

| Tamanho da VM | CPU | vCPUs | Nós NUMA | Memória (GiB) | Pontuação Média | StdDev | StdDev% | #Execuções |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_ND6s | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 6 | 1 | 110.2 | 107,095 | 353 | 0.33% | 63 |
| Standard_ND12s | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 12 | 1 | 220.4 | 212,298 | 3,457 | 1,63% | 63 |
| Standard_ND24rs | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 402,749 | 7,838 | 1.95% | 56 |
| Standard_ND24s | Cpu Intel(R) Xeon(R) E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 401,822 | 7,776 | 1,94% | 63 |

## <a name="nv---gpu-enabled"></a>NV - GPU Ativado
(12/03/2019 11:08:13 pbi 3897709)

| Tamanho da VM | CPU | vCPUs | Nós NUMA | Memória (GiB) | Pontuação Média | StdDev | StdDev% | #Execuções |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NV6 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 6 | 1 | 55.0 | 101,728 | 2,094 | 2,06% | 259 |
| Standard_NV12 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 12 | 1 | 110.2 | 203,903 | 1,724 | 0.85% | 252 |
| Standard_NV24 | Cpu Intel(R) Xeon(R) E5-2690 v3 @ 2.60GHz | 24 | 2 | 220.4 | 379,879 | 8,737 | 2,30% | 259 |
