...
1. Execute o cmdlet [Set-AzVMDiskEncryptionExtension](/powershell/module/az.compute/set-azvmdiskencryptionextension?view=azps-3.8.0) do Azure PowerShell com -EncryptFormatAll para criptografar esses discos.
