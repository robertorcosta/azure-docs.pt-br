...
* [Série SL](https://docs.microsoft.com/azure/virtual-machines/linux/sizes-previous-gen#ls-series) e [Série Lsv2](../lsv2-series.md)
...
Se você estiver criando uma VM com o Windows Server 2012 como o SO, então você selecionará a geração 1 (BIOS) ou a geração 2 (UEFI) VM SKU, que se parecem com isso:
