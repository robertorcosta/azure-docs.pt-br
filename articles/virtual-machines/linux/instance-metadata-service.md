...
| `tags` | [Marcas](../../azure-resource-manager/management/tag-resources.md) para a sua Máquina Virtual  | 2017-08-01
...
| `zone` | [Zona de Disponibilidade](../../availability-zones/az-overview.md) da máquina virtual | 2017-12-01
...
#### <a name="sample-5-retrieve-network-information"></a>Exemplo 5: recuperar informações de rede
...
#### <a name="sample-6-retrieve-public-ip-address"></a>Exemplo 6: recuperar o endereço IP público
...
1. Despeje sua tabela de roteamento local e procure a entrada IMDS. Por exemplo:         
    ```console
      ...
      ... (continues) ...
    ```
1. Verifique se existe uma rota para `169.254.169.254` e anote a interface de rede correspondente (exemplo, `172.16.69.7` ).
