---
title: Opções de disponibilidade do Azure para VMs Linux
description: Saiba mais sobre os recursos de disponibilidade para executar máquinas virtuais do Linux no Azure
