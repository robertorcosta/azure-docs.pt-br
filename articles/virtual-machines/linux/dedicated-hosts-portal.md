---
title: Implantar hosts dedicados do Azure usando o portal Azure
description: Implante VMs para hosts dedicados usando o portal Azure.
author: cynthn
...
1. De > acordo com as regras de **entrada,****as portas de entrada públicas,** escolha Permitir **portas selecionadas** e, em seguida, selecione **SSH (22)** a partir da queda. 
...
Você pode adicionar uma VM de saída a um host dedicado, mas a VM deve primeiro ser Stop\Deallocated. Antes de mover uma VM para um host dedicado, certifique-se de que a configuração da VM seja suportada:
...
- Você também pode implantar um host dedicado usando o [Azure CLI](dedicated-hosts-cli.md).
