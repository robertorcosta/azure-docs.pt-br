...
Conceda permissão do construtor de imagem para criar recursos no grupo de recursos de imagem. O `--assignee` valor é a ID de registro do aplicativo para o serviço do construtor de imagem. 
