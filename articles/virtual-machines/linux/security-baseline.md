---
title: Linha de base de segurança do Máquinas Virtuais do Linux para o benchmark de segurança do Azure
...
ms.locfileid: "86530914"
---
# <a name="linux-virtual-machines-security-baseline-for-azure-security-benchmark"></a>Linha de base de segurança do Máquinas Virtuais do Linux para o benchmark de segurança do Azure
...
* [Redes virtuais e máquinas virtuais no Azure](../windows/network-overview.md)
...
* [Instruções para integração de servidores Linux à central de segurança do Azure](../../security-center/quick-onboard-linux-computer.md)
...
**Diretrizes**: Máquinas Virtuais do Linux e Azure Active Directory não têm o conceito de senhas padrão. Cliente responsável por aplicativos de terceiros e serviços do Marketplace que podem usar senhas padrão.
...
**Orientação**: os dados em trânsito para, de e entre as máquinas virtuais (VM) que executam o Linux são criptografados de várias maneiras, dependendo da natureza da conexão, como ao se conectar a uma VM em uma sessão RDP ou SSH.
...
* [Funções internas para recursos do Azure](../../role-based-access-control/built-in-roles.md#virtual-machine-contributor)
...
* [Informações sobre como baixar o modelo de VM](../windows/download-template.md)
...
* [Como configurar e gerenciar a política do Azure](../../governance/policy/tutorials/create-and-manage.md)
