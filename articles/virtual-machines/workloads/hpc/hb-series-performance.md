---
title: HB-series VM tamanho performance - Azure Máquinas Virtuais | Microsoft Docs
description: Conheça os resultados dos testes de desempenho para tamanhos VM da série HB no Azure.
...
ms.locfileid: "79534194"
---
# <a name="hb-series-virtual-machine-sizes"></a>Tamanhos de máquinas virtuais da série HB

Vários testes de desempenho foram executados em tamanhos da série HB. A seguir, alguns dos resultados deste teste de desempenho.


| Carga de trabalho                                        | HB                    |
|-------------------------------------------------|-----------------------|
| Tríade DO CÓRREGO                                    | ~260 GB/s (32-33 GB/s por CCX)  |
| Linpack de alto desempenho (HPL)                  | ~1.000 GigaFLOPS (Rpeak), ~860 GigaFLOPS (Rmax) |
| Latência RDMA & largura de banda                        | 2.35usec, 96.5 Gb/s   |
| FIO em SSD NVMe local                           | ~1,7 GB/s lê, ~1,0 GB/s grava      |  
| IOR em 4 * SSD Premium Azure (Discos Gerenciados P30, RAID0)**  | ~725 MB/s lê, ~780 MB/writes   |
...
|  #bytes         | #iterations     | t_min[microsegundo]     | t_max[microssegundos]     | t_typical[microsegundo] | t_avg[microsegundo]     | t_stdev[microsegundo]   |
|-----------------|-----------------|-----------------|-----------------|-----------------|-----------------|
...
Teste de latência OSU MPI v5.4.3.
...
| #bytes  | Latência [microssegundo] (MPICH 3.3 + CH4) | Latência [microssegundo] (OpenMPI 4.0.0) | Latência [microssegundo] (MVAPICH2 2.3) | Latência [microssegundo] (Intel MPI 2019) |
|------|----------|----------|----------|----------|
