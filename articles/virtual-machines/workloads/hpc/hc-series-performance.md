---
title: Hc-series VM tamanho desempenho - Azure Virtual Machines | Microsoft Docs
description: Saiba mais sobre os resultados dos testes de desempenho para tamanhos de VM da série HC no Azure.
...
Vários testes de desempenho foram executados em tamanhos da série HC. A seguir, alguns dos resultados deste teste de desempenho.

| Carga de trabalho                                        | HB                    |
|-------------------------------------------------|-----------------------|
| Tríade DO CÓRREGO                                    | ~190 GB/s (Intel MLC AVX-512)  |
| Linpack de alto desempenho (HPL)                  | ~3520 GigaFLOPS (Rpeak), ~2970 GigaFLOPS (Rmax) |
| Latência RDMA & largura de banda                        | Microssegundos de 1,80, 96,3 Gb/s   |
| FIO em SSD NVMe local                           | ~1,3 GB/s lê, ~900 MB/s grava |  
| IOR em 4 SSD Premium Azure (Discos Gerenciados P30, RAID0)**  | ~780 MB/s lê, ~780 MB/writes |
