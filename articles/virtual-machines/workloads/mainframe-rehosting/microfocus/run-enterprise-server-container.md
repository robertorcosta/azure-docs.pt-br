...
8. Para iniciar o aplicativo acctdemo, digite **Acct**. A tela inicial do aplicativo é exibida.
     ...
     ![Captura de tela da demonstração da conta](./media/run-image-7.png)
...
9. Experimente os tipos de conta de exibição. Por exemplo, digite **D** para a solicitação e **11111** para a **conta**. Outros números de conta a serem experimentados são 22222, 33333 e assim por diante.
    ...
    ![Captura de tela da demonstração da conta](./media/run-image-8.png)
...
-   [Instalar o micro Focus Enterprise Server 5,0 e o desenvolvedor Enterprise 5,0 no Azure](https://docs.microsoft.com/azure/virtual-machines/workloads/mainframe-rehosting/microfocus/set-up-micro-focus-azure)
