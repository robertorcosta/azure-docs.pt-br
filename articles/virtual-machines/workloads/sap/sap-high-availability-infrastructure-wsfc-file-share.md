...
* [Implante as VMs][sap-high-availability-infrastructure-wsfc-shared-disk].

* [Criar e configurar o Azure Load Balancer para SAP ASCS][sap-high-availability-infrastructure-wsfc-shared-disk-default-ascs-ilb-rules].

* [Se estiver usando o ERS2 (Enqueue Replication Server 2), execute a configuração de Azure Load Balancer para ERS2 ][sap-high-availability-infrastructure-wsfc-shared-disk-default-ascs-ilb-rules]. 
