...
ms.locfileid: "77617257"
---
# <a name="available-skus-for-hli"></a>SKUs disponíveis para HLI

O serviço SAP HANA on Azure (Grandes Instâncias) com base nos selos da Revisão 3 está disponível em várias configurações nas regiões do Azure de:
...
O serviço SAP HANA on Azure (Grandes Instâncias) com base nos selos da Revisão 4 está disponível em várias configurações nas regiões do Azure de:
...
| --- | SAP HANA no Azure S224<br /> – 4 x Processador Xeon ® Intel®® Platinum (também conhecido como Lago cascata)<br /> 112 núcleos de CPU e 224 threads de CPU |  3,0 TB |  6,3 TB | Disponível nos selos Revision3 e Revision4  |
| --- | SAP HANA no Azure S384<br /> – 8 x processadores Intel® Xeon® E7-8890 v4<br /> 192 núcleos de CPU e 384 threads de CPU |  4,0 TB |  16 TB | Disponível em selos Revision4 |
...
| --- | SAP HANA no Azure S224m<br /> – 4 x Processador Xeon ® Intel®® Platinum (também conhecido como Lago cascata)<br /> 112 núcleos de CPU e 224 threads de CPU |  6,0 TB |  10,5 TB | Disponível nos selos Revision3 e Revision4  |
|---| SAP HANA no Azure S384m<br /> – 8 x processadores Intel® Xeon® E7-8890 v4<br /> 192 núcleos de CPU e 384 threads de CPU |  6,0 TB |  18 TB | Disponível em selos Revision4|
|---| SAP HANA no Azure S384xm<br /> – 8 x processadores Intel® Xeon® E7-8890 v4<br /> 192 núcleos de CPU e 384 threads de CPU |  8,0 TB |  22 TB |  Disponível em selos Revision4 |
|---| SAP HANA no Azure S576m<br /> – 12 x processadores Intel® Xeon® E7-8890 v4<br /> 288 núcleos de CPU e 576 threads de CPU |  12,0 TB |  28 TB | Disponível em selos Revision4|
|---| SAP HANA no Azure S768m<br /> – 16 x processadores Intel® Xeon® E7-8890 v4<br /> 384 núcleos de CPU e 768 threads de CPU |  16,0 TB |  36 TB | Disponível em selos Revision4|
|---| SAP HANA no Azure S960m<br /> – 20 x processadores Intel® Xeon® E7-8890 v4<br /> 480 núcleos de CPU e 960 threads de CPU |  20,0 TB |  46 TB | Disponível em selos Revision4|


Em SAP HANA TDIv5, o SAP permite o dimensionamento específico do cliente e projetos específicos do cliente, o que pode levar a configurações de servidores, que não estão listados como certificados em:
...
Em muitos casos, essas configurações de servidor específicas para o cliente carregam mais memória do que as unidades de servidor certificadas com SAP. Ao trabalhar com a SAP, os clientes têm a possibilidade de obter suporte SAP e certificar suas configurações de servidor de tamanho específico do cliente. No Azure, as SKUs padrão HANA Large Instance estão disponíveis e na lista de preços da Microsoft para tais projetos de dimensionamento específicos do cliente TDIv5.

| SKU|CPU | Memória | Armazenamento | Disponibilidade |
| ---| --- | --- | --- | --- |
| S96 | SAP HANA no Azure S96<br /> – 2 x processadores Intel® Xeon® E7-8890 v4<br /> 48 núcleos de CPU e 96 threads de CPU |  768 GB |  3 TB | Disponível nos selos Revision3 e Revision4|
...
| S384xm pode ser estendido para | SAP HANA no Azure S384xxm<br /> – 8 x processadores Intel® Xeon® E7-8890 v4<br /> 192 núcleos de CPU e 384 threads de CPU |  12,0 TB |  28 TB | Disponível em selos Revision4 |
| S576m pode ser estendido para | SAP HANA no Azure S576xm<br /> – 12 x processadores Intel® Xeon® E7-8890 v4<br /> 288 núcleos de CPU e 576 threads de CPU |  18,0 TB |  41 TB | Disponível em selos Revision4|
| S768m pode ser estendido para | SAP HANA no Azure S768xm<br /> – 16 x processadores Intel® Xeon® E7-8890 v4<br /> 384 núcleos de CPU e 768 threads de CPU |  24,0 TB |  56 TB | Disponível em selos Revision4 |
...
- S72, S72m, S96, S144, S144m, S192, S192m, S192xm, S224 e S224m que são referidos como a "classe Tipo I" de SKUs.
- S384, S384m, S384xm, S384xxm, S576m, S576xm S768m, S768xm e S960m, que são referidos como a "classe Tipo II" dos SKUs.
- Se você estiver interessado em outras SKUs S224 oferecendo de 4,5 TB a 9TB com optane, entre em contato com sua equipe de conta da Microsoft para obter mais informações. 
