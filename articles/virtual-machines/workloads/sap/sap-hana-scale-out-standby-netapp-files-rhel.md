...
5. Implante Azure NetApp Files volumes seguindo as instruções em [criar um volume de NFS para Azure NetApp files](https://docs.microsoft.com/azure/azure-netapp-files/azure-netapp-files-create-volumes).  
   ...
   Enquanto estiver implantando os volumes, certifique-se de selecionar a versão **nfsv 4.1** . Implante os volumes na [sub-rede](https://docs.microsoft.com/rest/api/virtualnetwork/subnets)Azure NetApp files designada. 
...
3. **[A]** adicionar uma rota de rede, para que a comunicação com o Azure NetApp files seja por meio da interface de rede de armazenamento.  
   ...
   Neste exemplo, usará `Networkmanager` para configurar a rota de rede adicional. As instruções a seguir pressupõem que a interface de rede de armazenamento está `eth1`.  
...
5. **[A]** ajuste as configurações de SunRPC, conforme recomendado na [SAP Hana no guia de configuração de sistemas AFF NetApp com NFS](https://www.netapp.com/us/media/tr-4435.pdf).  
...
6. **[A]** configuração do Red Hat para Hana.
    ...
    > [!NOTE]
    > Se estiver instalando o HANA 2,0 SP04, será necessário instalar o pacote `compat-sap-c++-7` conforme descrito em nota SAP [2593824], antes de instalar SAP Hana. 
