...
1. Defina os seguintes parâmetros
   ...
   1. Chave de Admin Username, a senha de administrador ou SSH  
      Um novo usuário é criado que pode ser usado para fazer login na máquina.
   1. ID da Sub-rede  
...
Você primeiro precisa criar as máquinas virtuais para este cluster. Depois, você cria um balanceador de carga e usa as máquinas virtuais no pool de backend.
