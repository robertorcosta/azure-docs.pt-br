...
Saiba mais sobre:
- [arquitetura e topologia de VM](./workloads/hpc/hbv2-series-overview.md),
- [pilha de software](./workloads/hpc/hbv2-series-overview.md#software-specifications) com suporte, incluindo o sistema operacional com suporte e
