...
A série M oferece uma alta contagem de vCPU (até 128 vCPUs) e uma grande quantidade de memória (até 3,8 TiB). Também é ideal para bancos de dados extremamente grandes ou outros aplicativos que se beneficiam de altas contagens de vCPU e grandes quantidades de memória. Os tamanhos da série M são&reg; suportados&reg; tanto na CPU Intel Xeon E7-8890&reg; v3&reg; @ 2.50GHz quanto no Intel Xeon Platinum 8280M 2.7GHz (Cascade Lake).

M-series VM's&reg; recurso Intel Hyper-Threading Technology.
