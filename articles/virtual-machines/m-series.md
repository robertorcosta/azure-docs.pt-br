...
ms.locfileid: "77493664"
---
# <a name="m-series"></a>Série M

A série M oferece uma contagem alta de vCPU (até 128 vCPUs) e uma grande quantidade de memória (até 3,8 TiB). Ele também é ideal para bancos de dados muito grandes ou outros aplicativos que se beneficiam de contagens vCPUs altas e grandes quantidades de memória. Os tamanhos da série M são baseados no Intel® Xeon® CPU E7-8890 v3 @ 2,50 GHz

O recurso da VM da série M Intel® tecnologia Hyper-Threading
