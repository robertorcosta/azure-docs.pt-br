...
Saiba mais sobre a [arquitetura](./workloads/hpc/hb-series-overview.md)subjacente e o [desempenho](./workloads/hpc/hb-series-performance.md) esperado da VM da série HB.
