...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Adicione uma extensão de VM à máquina virtual. Nesta amostra, a extensão do Docker é usada para configurar o Docker e executar um contêiner do Docker NGINX. |
