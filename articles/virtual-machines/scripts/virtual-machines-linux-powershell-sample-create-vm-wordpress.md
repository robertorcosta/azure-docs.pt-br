---
title: Amostra de Script do Azure PowerShell – WordPress
...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Adicione a extensão de Script personalizado para a máquina virtual, que invoca um script para instalar o WordPress. |
