---
title: Exemplo de script do Azure PowerShell – Criar uma VM do Windows totalmente configurada
description: Exemplo de script do Azure PowerShell – Criar uma VM do Windows totalmente configurada.
