...
4. Há suporte para quais cenários na API de migração?  Examine os [recursos e as configurações sem suporte](migration-classic-resource-manager-overview.md).
...
- Pressuposto de que a API de migração com suporte na plataforma considerará todos os cenários. Leia [recursos e configurações sem suporte](migration-classic-resource-manager-overview.md) para entender para quais cenários há suporte.
