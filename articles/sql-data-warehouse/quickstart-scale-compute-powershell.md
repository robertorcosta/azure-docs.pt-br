---
title: 'Início Rápido: computação de escala – PowerShell '
...
Dimensionar a computação no SQL Data Warehouse do Azure usando o Azure PowerShell. [Escale horizontalmente a computação](sql-data-warehouse-manage-compute-overview.md) para melhorar o desempenho ou reduza a escala da computação para economizar custos.
...
Este início rápido pressupõe que você já tenha um SQL Data Warehouse que possa ser dimensionado. Se precisar, use [Criar e conectar – portal](create-data-warehouse-portal.md) para criar um data warehouse chamado **mySampleDataWarehouse**.
