...
* Executar ações de aplicativo recorrentes: por exemplo, colete periodicamente dados do Twitter em um feed.
...
* [Criar agendas complexas e recorrência avançada com o Agendador do Azure](scheduler-advanced-complexity.md)
