...
- Para saber como o ajuste automático funciona nos bastidores, consulte [indexação automática de milhões de bancos de dados em banco de dados SQL do Microsoft Azure](https://www.microsoft.com/en-us/research/uploads/prod/2019/02/autoindexing_azuredb.pdf).
