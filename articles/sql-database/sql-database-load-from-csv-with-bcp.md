...
## <a name="1-create-a-destination-table"></a>1. Crie uma tabela de destino
...
## <a name="2-create-a-source-data-file"></a>2. Crie um arquivo de dados de origem
