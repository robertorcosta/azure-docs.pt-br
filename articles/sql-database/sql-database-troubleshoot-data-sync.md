...
### <a name="i-see-this-message-cannot-insert-the-value-null-into-the-column-column-column-does-not-allow-nulls-what-does-this-mean-and-how-can-i-fix-it"></a><a name="sync-nulls"></a> Esta imagem é exibida: "Não é possível inserir o valor NULL na coluna \<column>. A coluna não permite valores nulos”. O que isso significa e como posso corrigir o erro? 
