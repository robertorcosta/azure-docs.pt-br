...
description: Script de exemplo do Azure PowerShell para criar um pool elástico do Banco de Dados SQL do Azure, adicioná-lo a um grupo de failover e testar o failover.
