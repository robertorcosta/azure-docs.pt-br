...
ms.locfileid: "73827042"
---
# <a name="quickstart-use-java-to-connect-to-and-query-an-azure-sql-database"></a>Início Rápido: Usar o Java para se conectar a um banco de dados SQL do Azure e consultá-lo
