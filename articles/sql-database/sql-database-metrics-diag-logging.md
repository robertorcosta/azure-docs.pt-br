...
> [!NOTE]
> Para habilitar o fluxo de log de auditoria da telemetria de segurança, consulte [Configurar auditoria para seu banco de dados](sql-database-auditing.md#setup-auditing) e registros de auditoria nos registros do Monitor Do [Azure e do Azure Event Hubs](https://techcommunity.microsoft.com/t5/Azure-SQL-Database/SQL-Audit-logs-in-Azure-Log-Analytics-and-Azure-Event-Hubs/ba-p/386242).
