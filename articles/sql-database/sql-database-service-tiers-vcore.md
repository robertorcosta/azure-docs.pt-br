...
||**Propósito geral**|**Comercialmente crítico**|**Hiperescala**|
|---|---|---|---|
...
A série M só tem suporte na camada de Comercialmente Crítico e não oferece suporte à redundância de zona.
