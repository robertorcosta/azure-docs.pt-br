...
Depois que **replicationstate** é `2`, conecte-se a cada banco de dados ou subconjunto de bancos de `<fog-name>.secondary.database.windows.net` dado usando o ponto de extremidade secundário e execute qualquer consulta em relação aos bancos de dados para garantir a conectividade, a configuração de segurança adequada e a replicação do dado. 
