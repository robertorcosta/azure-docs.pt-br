---
title: 'Criar e gerenciar trabalhos de banco de dados elástico do SQL Azure usando Transact-SQL (T-SQL) '
...
### <a name="target_groups_members-view"></a>target_groups_members exibição
