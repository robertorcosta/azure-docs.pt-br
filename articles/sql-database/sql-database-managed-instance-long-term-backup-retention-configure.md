...
description: Saiba como armazenar e restaurar backups automatizados em contêineres de armazenamento do Azure Blob separados para uma instância gerenciada do Banco de Dados SQL do Azure usando o PowerShell.
...
ms.locfileid: "83769931"
---
# <a name="manage-azure-sql-database-managed-instance-long-term-backup-retention-powershell"></a>Gerenciar a retenção de backup de longo prazo da instância gerenciada do Banco de Dados SQL do Azure (PowerShell)

Na instância gerenciada do Banco de dados SQL do Azure, você pode configurar uma política de [retenção de backup de longo prazo](sql-database-long-term-retention.md#managed-instance-support) (LTR) como uma versão prévia do recurso pública limitada. Isso permite que você mantenha automaticamente backups de banco de dados em contêineres do armazenamento do Azure Blob separados por até 10 anos. Em seguida, você pode recuperar um banco de dados usando os backups com o PowerShell.
