---
title: Vídeo do aplicativo SaaS SQL
...
- [4. Aplicativo web multi-inquilino, 0:05:05](#anchor-image-wtip-min00505)
- [5. Formulário web do aplicativo em ação, 0:05:55](#anchor-image-wtip-min00555)
- [6. Custo por inquilino (escala, isolamento, recuperação), 0:09:31](#anchor-image-wtip-min00931)
- [7. Modelos de banco de dados para multi-inquilino: prós e contras, 0:11:59](#anchor-image-wtip-min01159)
...
- [11. Demonstração de banco de dados por inquilino e híbrido ST/MT, 0:20:08](#anchor-image-wtip-min02008)
...
- [14. Exemplo de uso da piscina elástica MYOB, 0:29:40](#anchor-image-wtip-min02940)
- [15. Aprendendo com MYOB e outros ISVs, 0:31:36](#anchor-image-wtip-min03136)
- [16. Padrões compõem no cenário E2E SaaS, 0:43:15](#anchor-image-wtip-min04315)
- [17. Aplicativo SaaS híbrido canônico, 0:47:33](#anchor-image-wtip-min04733)
- [18. Wingtip SaaS aplicativo de amostra, 0:48:10](#anchor-image-wtip-min04810)
...
- [23. Inquilinos de provisão e onboarding, 0:57:44](#anchor-image-wtip-min05744)
- [24. Provisionamento de inquilinos e conexão de aplicativo, 0:58:58](#anchor-image-wtip-min05858)
- [25. Demonstração de scripts de gerenciamento provisionando um único inquilino, 0:59:43](#anchor-image-wtip-min05943)
- [26. PowerShell para provisão e catálogo, 1:00:02](#anchor-image-wtip-min10002)
- [27. T-SQL SELECT * DE InquilinosEstendido, 1:03:30](#anchor-image-wtip-min10330)
- [28. Gerenciamento de cargas de trabalho imprevisíveis de inquilinos, 1:04:36](#anchor-image-wtip-min10436)
- [29. Monitoramento de piscina elástica, 1:06:39](#anchor-image-wtip-min10639)
...
- [32. Consulta distribuída entre bancos de dados de inquilinos, 1:12:21](#anchor-image-wtip-min11221)
- [33. Demonstração da geração de bilhetes, 1:12:32](#anchor-image-wtip-min11232)
- [34. SSMS análise adhoc, 1:12:46](#anchor-image-wtip-min11246)
- [35. Extrair dados do inquilino em SQL DW, 1:16:32](#anchor-image-wtip-min11632)
- [36. Gráfico da distribuição diária de venda, 1:16:48](#anchor-image-wtip-min11648)
...
*Aprendendo com o MYOB: padrões para aplicativos SaaS no Banco de Dados SQL do Azure - BRK3120*

[![Slide de boas-vindas][image-wtip-min00003-brk3120-whole-welcome]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1)

- Título: Aprendendo com o MYOB: Padrões para aplicativos SaaS no Banco de Dados SQL do Azure - BRK3120
...
#### <a name="4-multi-tenant-web-app-00500"></a>4. Aplicativo web multi-inquilino, 0:05:00
...
#### <a name="5-app-web-form-in-action-00539"></a>5. Formulário web do aplicativo em ação, 0:05:39
...
#### <a name="7-database-models-for-multi-tenant-pros-and-cons-00952"></a>7. Modelos de banco de dados para multi-inquilino: prós e contras, 0:09:52
[![Modelos de banco de dados para multilocatários: prós e contras][image-wtip-min01159-db-models-pros-cons]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=592)
...
[![Modelo híbrido combina benefícios do MT/ST][image-wtip-min01301-hybrid]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=749)
...
#### <a name="11-demo-of-database-per-tenant-and-hybrid-stmt-01959"></a>11. Demonstração de banco de dados por inquilino e híbrido ST/MT, 0:19:59
[![Demonstração de banco de dados por inquilino e ST/MT híbrido][image-wtip-min02008-demo-st-hybrid]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1199)
...
#### <a name="14-myob-elastic-pool-usage-example-02930"></a>14. Exemplo de uso da piscina elástica MYOB, 0:29:30
[![Exemplo de uso de piscina elástica MYOB][image-wtip-min02940-myob-elastic]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1770)
...
#### <a name="16-patterns-compose-into-e2e-saas-scenario-03142"></a>16. Padrões compõem no cenário E2E SaaS, 0:31:42
...
#### <a name="17-canonical-hybrid-multi-tenant-saas-app-04604"></a>17. Aplicativo SaaS híbrido canônico, 0:46:04
...
#### <a name="18-wingtip-saas-sample-app-04801"></a>18. Wingtip SaaS aplicativo de amostra, 0:48:01
...
#### <a name="23-provisioning-tenants-and-onboarding-05619"></a>23. Inquilinos de provisão e onboarding, 0:56:19
[![Provisionamento de inquilinos e onboarding][image-wtip-min05744-provisioning-tenants-onboarding-1]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3379)


&nbsp; <a name="anchor-image-wtip-min05858"/>
#### <a name="24-provisioning-tenants-and-application-connection-05752"></a>24. Provisionamento de inquilinos e conexão de aplicativo, 0:57:52
[![Provisionamento de inquilinos e conexão de aplicativos][image-wtip-min05858-provisioning-tenants-app-connection-2]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3472)


&nbsp; <a name="anchor-image-wtip-min05943"/>
#### <a name="25-demo-of-management-scripts-provisioning-a-single-tenant-05936"></a>25. Demonstração de scripts de gerenciamento provisionando um único inquilino, 0:59:36
[![Demonstração de scripts de gerenciamento provisionando um único inquilino][image-wtip-min05943-demo-management-scripts-st]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3576)
...
#### <a name="27-t-sql-select--from-tenantsextended-10325"></a>27. T-SQL SELECT * DE InquilinosEstendido, 1:03:25
...
#### <a name="28-managing-unpredictable-tenant-workloads-10334"></a>28. Gerenciamento de cargas de trabalho imprevisíveis de inquilinos, 1:03:34
...
#### <a name="29-elastic-pool-monitoring-10632"></a>29. Monitoramento de piscina elástica, 1:06:32
...
#### <a name="32-distributed-query-across-tenant-databases-11118"></a>32. Consulta distribuída entre bancos de dados de inquilinos, 1:11:18
[![Consulta distribuída em bancos de dados de inquilinos][image-wtip-min11221-distributed-query]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4278)
...
[![Análise adhoc do SSMS][image-wtip-min11246-ssms-adhoc-analytics]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4355)
...
#### <a name="36-graph-of-daily-sale-distribution-11638"></a>36. Gráfico da distribuição diária de venda, 1:16:38
[![Gráfico de distribuição diária de vendas][image-wtip-min11648-graph-daily-sale-distribution]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4598)
...
[image-wtip-min00505-web-app]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min00505-wingtip-saas-app-mt-web.png "Aplicativo de SaaS Wingtip: aplicativo Web multilocatário"

[image-wtip-min00555-app-web-form]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min00555-app-form-contoso-concert-hall-night-opera.png "Formulário do aplicativo da Web em ação, 0:05:55"
...
[image-wtip-min05018-demo-tutorials-github]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min05018-demo-saas-tutorials-github-repo.png "Demonstração de tutoriais e repo do GitHub"
...
[image-wtip-min10330-sql-select-tenantsextended]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min10330-ssms-tenantcatalog.png "T-SQL SELECT * DE TenantsExpanded"
...
[image-wtip-min10639-elastic-pool-monitoring]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min10639-elastic-pool-monitoring.png "Monitoramento de piscinas elásticas"
