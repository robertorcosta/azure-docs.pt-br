...
ms.locfileid: "80346278"
---
# <a name="resource-limits-for-elastic-pools-using-the-vcore-purchasing-model"></a>Limites de recursos para piscinas elásticas usando o modelo de compra vCore

Este artigo fornece os limites de recursos detalhados para os grupos elásticos do Banco de Dados Azure SQL e bancos de dados agrupados usando o modelo de compra vCore.

Para os limites do modelo de compra do DTU, consulte [os limites de recursos do SQL Database DTU - pools elásticos](sql-database-dtu-resource-limits-elastic-pools.md).
...
## <a name="general-purpose---provisioned-compute---gen4"></a>Propósito geral - computação provisionada - Gen4

> [!IMPORTANT]
> As novas bases de dados Gen4 não são mais suportadas nas regiões Leste da Austrália ou Sul do Brasil.

### <a name="general-purpose-service-tier-generation-4-compute-platform-part-1"></a>Nível de serviço de uso geral: Plataforma de computação da Geração 4 (parte 1)
...
|Tamanho dos dados máximos do TempDB (GB)|32|64|96|128|160|192|
...
|IOPS de dados máximos por pool <sup>2</sup> |400|800|1200|1600|2000|2400|
|Taxa máxima de log por pool (MBps)|4.7|9.4|14.1|18.8|23.4|28,1|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup> |210|420|630|840|1.050|1260|
|Máximo de logins simultâneos por pool <sup>3</sup> |210|420|630|840|1.050|1260|
...
<sup>2</sup> O valor máximo para tamanhos de IO variando entre 8 KB e 64 KB. O IOPS real depende da carga de trabalho. Para obter detalhes, consulte [Governança do Data IO](sql-database-resource-limits-database-server.md#resource-governance).

<sup>3</sup> Para os trabalhadores simultâneos máximos (solicitações) para qualquer banco de dados individual, consulte [Limites de recursos de banco de dados único](sql-database-vcore-resource-limits-single-databases.md). Por exemplo, se o pool elástico estiver usando gen5 e o max vCore por banco de dados for definido em 2, então o valor máximo dos trabalhadores simultâneos é de 200.  Se o max vCore por banco de dados estiver definido como 0,5, então o valor máximo dos trabalhadores simultâneos é de 50, já que no Gen5 há um máximo de 100 trabalhadores simultâneos por vCore. Para outras configurações de máximo de vCore por banco de dados que sejam menores que 1 vCore, o número máximo de trabalhos simultâneos é redimensionado de forma semelhante.

### <a name="general-purpose-service-tier-generation-4-compute-platform-part-2"></a>Nível de serviço de uso geral: Plataforma de computação da Geração 4 (parte 2)
...
|Número máximo de DBs por pool <sup>1</sup>|500|500|500|500|500|500|
|Suporte de columnstore|Sim|Sim|Sim|Sim|Sim|Sim|
|Armazenamento OLTP na memória (GB)|N/D|N/D|N/D|N/D|N/D|N/D|
|Tamanho máximo de dados (GB)|2.048|2.048|2.048|2.048|3584|4096|
|Tamanho máximo de log (GB)|614|614|614|614|1075|1229|
|Tamanho dos dados máximos do TempDB (GB)|224|256|288|320|512|768|
|Tipo de armazenamento|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|
|Latência de E/S (aproximada)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|
|IOPS de dados máximos por pool <sup>2</sup>|2800|3200|3600|4000|6400|9600|
|Taxa máxima de log por pool (MBps)|32.8|37.5|37.5|37.5|37.5|37.5|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup>|1.470|1680|1.890|2.100|3360|5040|
|Pool de logins simultâneos Max (solicitações) <sup>3</sup>|1.470|1680|1.890|2.100|3360|5040|
|Máximo de sessões simultâneas|30,000|30,000|30,000|30,000|30,000|30,000|
...
## <a name="general-purpose---provisioned-compute---gen5"></a>Propósito geral - computação provisionada - Gen5

### <a name="general-purpose-service-tier-generation-5-compute-platform-part-1"></a>Nível de serviço de uso geral: Plataforma de computação geração 5 (parte 1)
...
|Número máximo de DBs por pool <sup>1</sup>|100|200|500|500|500|500|500|
...
|Tamanho dos dados máximos do TempDB (GB)|64|128|192|256|320|384|448|
...
|IOPS de dados máximos por pool <sup>2</sup>|800|1600|2400|3200|4000|4800|5600|
|Taxa máxima de log por pool (MBps)|9.4|18.8|28,1|37.5|37.5|37.5|37.5|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup>|210|420|630|840|1.050|1260|1.470|
|Máximo de logins simultâneos por pool (solicitações) <sup>3</sup>|210|420|630|840|1.050|1260|1.470|
...
### <a name="general-purpose-service-tier-generation-5-compute-platform-part-2"></a>Nível de serviço de uso geral: Plataforma de computação geração 5 (parte 2)
...
|Número máximo de DBs por pool <sup>1</sup>|500|500|500|500|500|500|500|
|Suporte de columnstore|Sim|Sim|Sim|Sim|Sim|Sim|Sim|
|Armazenamento OLTP na memória (GB)|N/D|N/D|N/D|N/D|N/D|N/D|N/D|
|Tamanho máximo de dados (GB)|2.048|3072|3072|3072|4096|4096|4096|
|Tamanho máximo de log (GB)|614|922|922|922|1229|1229|1229|
|Tamanho dos dados máximos do TempDB (GB)|512|576|640|768|1024|1280|2560|
|Tipo de armazenamento|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|Armazenamento Premium (remoto)|
|Latência de E/S (aproximada)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|5-7 ms (gravação)<br>5-10 ms (leitura)|
|IOPS de dados máximos por pool <sup>2</sup> |6.400|7.200|8,000|9.600|12.800|16.000|32.000|
|Taxa máxima de log por pool (MBps)|37.5|37.5|37.5|37.5|37.5|37.5|37.5|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup>|1680|1.890|2.100|2520|3360|4200|8400|
|Máximo de logins simultâneos por pool (solicitações) <sup>3</sup>|1680|1.890|2.100|2520|3360|4200|8400|
|Máximo de sessões simultâneas|30,000|30,000|30,000|30,000|30,000|30,000|30,000|
...
## <a name="general-purpose---provisioned-compute---fsv2-series"></a>Propósito geral - computação provisionada - Série Fsv2
...
|vCores|72|
|Memória (GB)|136.2|
|Número máximo de DBs por pool <sup>1</sup>|500|
...
|Tamanho dos dados máximos do TempDB (GB)|333|
|Tipo de armazenamento|Armazenamento Premium (remoto)|
|Latência de E/S (aproximada)|5-7 ms (gravação)<br>5-10 ms (leitura)|
|IOPS de dados máximos por pool <sup>2</sup>|16.000|
|Taxa máxima de log por pool (MBps)|37.5|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup>|3780|
|Máximo de logins simultâneos por pool (solicitações) <sup>3</sup>|3780|
...
## <a name="business-critical---provisioned-compute---gen4"></a>Business critical - computação provisionada - Gen4

> [!IMPORTANT]
> As novas bases de dados Gen4 não são mais suportadas nas regiões Leste da Austrália ou Sul do Brasil.

### <a name="business-critical-service-tier-generation-4-compute-platform-part-1"></a>Nível de serviço crítico de negócios: plataforma de computação geração 4 (parte 1)
...
|Tamanho dos dados máximos do TempDB (GB)|64|96|128|160|192|
...
|IOPS de dados máximos por pool <sup>2</sup>|9.000|13,500|18.000|22,500|27,000|
|Taxa máxima de log por pool (MBps)|20|30|40|50|60|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup>|420|630|840|1.050|1260|
|Máximo de logins simultâneos por pool (solicitações) <sup>3</sup>|420|630|840|1.050|1260|
...
### <a name="business-critical-service-tier-generation-4-compute-platform-part-2"></a>Nível de serviço crítico de negócios: plataforma de computação geração 4 (parte 2)
...
|vCores|7|8|9|10|16|24|
|Memória (GB)|49|56|63|70|112|159.5|
|Número máximo de DBs por pool <sup>1</sup>|100|100|100|100|100|100|
...
|IOPS de dados máximos por pool <sup>2</sup>|31,500|36,000|40,500|45,000|72,000|96,000|
|Taxa máxima de log por pool (MBps)|70|80|80|80|80|80|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup>|1.470|1680|1.890|2.100|3360|5040|
|Máximo de logins simultâneos por pool (solicitações) <sup>3</sup>|1.470|1680|1.890|2.100|3360|5040|
|Máximo de sessões simultâneas|30,000|30,000|30,000|30,000|30,000|30,000|
|Opções mínimas/máximas de vCore do pool elástico por banco de dados|0, 0,25, 0,5, 1…7|0, 0,25, 0,5, 1…8|0, 0,25, 0,5, 1…9|0, 0,25, 0,5, 1…10|0, 0,25, 0,5, 1…10, 16|0, 0,25, 0,5, 1…10, 16, 24|
...
## <a name="business-critical---provisioned-compute---gen5"></a>Business critical - computação provisionada - Gen5

### <a name="business-critical-service-tier-generation-5-compute-platform-part-1"></a>Nível de serviço crítico de negócios: Plataforma de computação geração 5 (parte 1)
...
|Número máximo de DBs por pool <sup>1</sup>|50|100|100|100|100|100|
|Suporte de columnstore|Sim|Sim|Sim|Sim|Sim|Sim|
...
|Tamanho dos dados máximos do TempDB (GB)|128|192|256|320|384|448|
|Tipo de armazenamento|SSD Local|SSD Local|SSD Local|SSD Local|SSD Local|SSD Local|
|Latência de E/S (aproximada)|1-2 ms (gravação)<br>1-2 ms (leitura)|1-2 ms (gravação)<br>1-2 ms (leitura)|1-2 ms (gravação)<br>1-2 ms (leitura)|1-2 ms (gravação)<br>1-2 ms (leitura)|1-2 ms (gravação)<br>1-2 ms (leitura)|1-2 ms (gravação)<br>1-2 ms (leitura)|
|IOPS de dados máximos por pool <sup>2</sup>|18.000|27,000|36,000|45,000|54.000|63,000|
|Taxa máxima de log por pool (MBps)|60|90|120|120|120|120|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup>|420|630|840|1.050|1260|1.470|
|Máximo de logins simultâneos por pool (solicitações) <sup>3</sup>|420|630|840|1.050|1260|1.470|
|Máximo de sessões simultâneas|30,000|30,000|30,000|30,000|30,000|30,000|
...
### <a name="business-critical-service-tier-generation-5-compute-platform-part-2"></a>Nível de serviço crítico de negócios: Plataforma de computação geração 5 (parte 2)
...
|vCores|16|18|20|24|32|40|80|
|Memória (GB)|83|93.4|103.8|124.6|166.1|207.6|415.2|
|Número máximo de DBs por pool <sup>1</sup>|100|100|100|100|100|100|100|
|Suporte de columnstore|Sim|Sim|Sim|Sim|Sim|Sim|Sim|
...
|IOPS de dados máximos por pool <sup>2</sup>|72,000|81,000|90.000|108,000|144,000|180,000|256,000|
...
## <a name="business-critical---provisioned-compute---m-series"></a>Business critical - provisioned compute - Série M

### <a name="m-series-compute-generation-preview"></a>Geração de computação da série M (visualização)
...
|vCores|128|
|Memória (GB)|3767.1|
|Número máximo de DBs por pool <sup>1</sup>|100|
|Suporte de columnstore|Sim|
|Armazenamento OLTP na memória (GB)|1768|
|Tamanho máximo de dados (GB)|4096|
|Tamanho máximo de log (GB)|2.048|
|Tamanho dos dados máximos do TempDB (GB)|4096|
|Tipo de armazenamento|SSD Local|
|Latência de E/S (aproximada)|1-2 ms (gravação)<br>1-2 ms (leitura)|
|IOPS de dados máximos por pool <sup>2</sup>|200.000|
|Taxa máxima de log por pool (MBps)|333|
|Trabalhadores simultâneos máximos por piscina (solicitações) <sup>3</sup>|13,440|
|Máximo de logins simultâneos por pool (solicitações) <sup>3</sup>|13,440|
|Máximo de sessões simultâneas|30,000|
