---
title: Exibir e configurar a telemetria de proteção contra DDoS
...
ms.locfileid: "92905097"
---
# <a name="view-and-configure-ddos-protection-telemetry"></a>Exibir e configurar a telemetria de proteção contra DDoS
...
Para simular um ataque de DDoS para validar a telemetria, consulte [Validar detecção de DDoS](test-through-simulations.md).
