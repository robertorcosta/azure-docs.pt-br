...
|`required`|Booliano|Se o cabeçalho é necessário.|  
|`readOnly`|Booliano|Se o cabeçalho é somente leitura.|  
...
|`ShowAll`|Booliano|Se todos os resultados devem ser mostrados em uma única página.|  
...
|`required`|Booliano|Especifica se o parâmetro é necessário ou não.|  
...
|`AllowMultipleSubscriptions`|Booliano|Especifica se um usuário pode ter várias assinaturas para este produto ao mesmo tempo.|  
...
|`CanBeCancelled`|Booliano|Se a assinatura puder ser cancelada pelo usuário atual.|  
|`IsAwaitingApproval`|Booliano|Se a assinatura está aguardando aprovação.|  
...
|`CanBeRenewed`|Booliano|Se a assinatura pode ser renovada pelo usuário atual.|  
|`HasExpired`|Booliano|Se a assinatura expirou.|  
|`IsRejected`|Booliano|Se a solicitação de assinatura foi negada.|  
...
|`IsBasicAccount`|Booliano|True se essa conta foi registrada usando o email e a senha, false se a conta foi registrada usando um provedor.|  
...
|`RememberMe`|Booliano|Se deve salvar as informações do usuário atual.|  
|`RegistrationEnabled`|Booliano|Se o registro está habilitado.|  
|`DelegationEnabled`|Booliano|Se a entrada delegada está habilitada.|  
...
|`UserRegistrationTermsEnabled`|Booliano|Se os termos estão habilitados.|  
...
|Propriedade|Type|Descrição|  
|--------------|----------|-----------------|  
|`PasswordConfirm`|Booliano|Valor usado pelo controle [sign-up](api-management-page-controls.md#sign-up).|  
|`Password`|string|Senha da conta de usuário.|  
...
|`ConsentAccepted`|Booliano|Valor usado pelo controle [sign-up](api-management-page-controls.md#sign-up).|  
|`Email`|string|Endereço de email. Não deve estar vazio e deve ser exclusivo dentro da instância do serviço. O comprimento máximo é de 254 caracteres.|  
|`FirstName`|string|Nome. Não deve ficar vazio. O comprimento máximo é de 100 caracteres.|  
|`LastName`|string|Sobrenome. Não deve ficar vazio. O comprimento máximo é de 100 caracteres.|  
