...
description: Saiba como gerenciar contas de desenvolvedor usando grupos no gerenciamento de API do Azure. Crie grupos e associe-os a produtos ou desenvolvedores.
...
Além desses grupos de sistema, os administradores podem criar grupos personalizados ou [aproveitar grupos externos em locatários do Active Directory do Azure][leverage external groups in associated Azure Active Directory tenants]. Grupos personalizados e externos podem ser usados juntamente com grupos de sistema oferecendo visibilidade aos desenvolvedores e acesso a produtos de API. Por exemplo, você poderia criar um grupo personalizado para os desenvolvedores associados a uma organização parceira específica e conceder acesso às APIs de um produto que contém apenas as APIs relevantes. Um usuário pode ser um membro de mais de um grupo.
...
Além de criar e gerenciar grupos no portal do editor, você pode criar e gerenciar seus grupos usando a entidade [Group](/rest/api/apimanagement/apimanagementrest/azure-api-management-rest-api-group-entity) da API REST do Gerenciamento de API.
...
4. Clique em **+ Adicionar grupo**.
    ...
    ![Captura de tela que realça o botão Adicionar grupo.](./media/api-management-howto-create-groups/groups002.png)
5. Selecione o grupo que deseja adicionar.

    ![Captura de tela que mostra o grupo selecionado e realça o botão de seleção.](./media/api-management-howto-create-groups/groups003.png)
...
## <a name="associate-groups-with-developers"></a><a name="associate-group-developer"> </a>Associar grupos a desenvolvedores
...
3. Pressione **+Adicionar** e selecione um membro.
    ...
    ![Captura de tela que realça o botão Adicionar, o usuário selecionado e o botão Selecionar.](./media/api-management-howto-create-groups/groups006.png)
