...
|NOME|DESCRIÇÃO|obrigatórios|
|----------|-----------------|--------------|
|json-to-xml|Elemento raiz.|sim|

### <a name="attributes"></a>Atributos

|NOME|DESCRIÇÃO|obrigatórios|Padrão|
|----------|-----------------|--------------|-------------|
...
|NOME|DESCRIÇÃO|obrigatórios|Padrão|
|----------|-----------------|--------------|-------------|
|from|A cadeia a ser pesquisada.|sim|N/D|
...
|Atributo|DESCRIÇÃO|obrigatórios|Padrão|
|---------------|-----------------|--------------|-------------|
