...
-   [Gerenciamento de API do Azure: fazendo backup e restaurando a configuração](https://docs.microsoft.com/archive/blogs/stuartleeks/azure-api-management-backing-up-and-restoring-configuration) 
