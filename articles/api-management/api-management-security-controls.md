...
description: Examine uma lista de verificação de controles de segurança para avaliar o gerenciamento de API. Isso inclui controles de rede, identidade e proteção de dados.
