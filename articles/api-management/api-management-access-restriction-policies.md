...
| renewal-period | O comprimento em segundos da janela deslizante durante o qual o número de solicitações permitidas deve ou não exceder o valor especificado em `calls` .                                              | Sim      | N/D     |
