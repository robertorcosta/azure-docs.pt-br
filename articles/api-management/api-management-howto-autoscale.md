...
> [!NOTE]
> O serviço de gerenciamento de API no nível **de consumo** é dimensionado automaticamente com base no tráfego - sem qualquer configuração adicional necessária.
...
7. Defina uma nova regra de escala horizontal.
   ...
   Por exemplo, uma regra de escala horizontal pode disparar uma adição de uma unidade do Gerenciamento de API do Azure, quando a métrica de capacidade média nos últimos 30 minutos exceder 80%. A tabela a seguir fornece a configuração para essa regra.
    ...
    | Tempo de resfriamento (minutos)   | 60                | Leva pelo menos 20 minutos para que o serviço de gerenciamento de API do Azure seja dimensionado. Na maioria dos casos, o período de resfriamento de 60 minutos impede de desencadear muitas escalas.                                                                                                  |
