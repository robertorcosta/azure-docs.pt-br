...
|`canChangePassword`|Booliano|Se o usuário atual pode alterar sua senha.|  
|`isSystemUser`|Booliano|Se o usuário atual é membro de um dos [grupos](api-management-key-concepts.md#groups) internos.|  
