...
* **API APIM**/Frontend**API** - Uma API APIM não hospeda APIs, cria fachadas para suas APIs a fim de personalizar a fachada de acordo com suas necessidades sem tocar na API back-end. Para obter mais informações, consulte [Importar e publicar uma API](import-and-publish.md).
