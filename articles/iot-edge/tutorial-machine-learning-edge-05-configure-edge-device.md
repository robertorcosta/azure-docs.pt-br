...
description: 'Tutorial: Configure uma Máquina Virtual do Azure executando o Linux como um dispositivo do Azure IoT Edge que atua como um gateway transparente.'
author: kgremban
manager: philmea
ms.author: kgremban
ms.date: 11/11/2019
