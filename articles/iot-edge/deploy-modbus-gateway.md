...
9. Volte para a página de detalhes do dispositivo e selecione **Atualizar**. Você deve ver o novo módulo `ModbusTCPModule` em execução junto com o IoT Edge Runtime.
