...
No portal do Azure, pesquise "Azure IoT Edge" e selecione **Ubuntu Server 16.04 LTS + runtime do Azure IoT Edge** para iniciar o fluxo de trabalho de criação de VM. Em seguida, conclua as etapas 3 e 4 nas instruções "Implantar do Azure Marketplace" acima.
