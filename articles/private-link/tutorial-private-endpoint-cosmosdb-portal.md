...
description: Comece a usar o ponto de extremidade privado do Azure para se conectar a uma conta do Azure Cosmos em modo privado.
author: asudbring
ms.author: allensu
...
12. No Gerenciador de Armazenamento, clique com o botão direito do mouse em **Contas do Cosmos DB** e selecione **Conectar-se ao Cosmos DB**.
