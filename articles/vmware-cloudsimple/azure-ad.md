---
title: Soluções VMware do Azure (AVS) – usar o Azure AD como fonte de identidade na nuvem privada de AVS
description: Descreve como adicionar o Azure AD como um provedor de identidade na sua nuvem privada de AVS para autenticar usuários que acessam a AVS do Azure
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/15/2019
ms.topic: article
...
ms.locfileid: "77015916"
---
# <a name="use-azure-ad-as-an-identity-provider-for-vcenter-on-avs-private-cloud"></a>Usar o Azure AD como um provedor de identidade para o vCenter na nuvem privada da AVS

Você pode configurar seu vCenter de nuvem privada de AVS para autenticar com o Azure Active Directory (Azure AD) para que seus administradores do VMware acessem o vCenter. Depois que a fonte de identidade de logon único é configurada, o usuário **cloudowner** pode adicionar usuários da origem de identidade ao vCenter.  
...
2. [Como configurar uma fonte de identidade no vCenter privado de nuvem privada da AVS](#set-up-an-identity-source-on-your-avs-private-cloud-vcenter)
...
## <a name="set-up-an-identity-source-on-your-avs-private-cloud-vcenter"></a>Configurar uma fonte de identidade no vCenter privado de nuvem privada da AVS

1. [Escalonar privilégios](escalate-private-cloud-privileges.md) para seu vCenter de nuvem privada da AVS.
2. Colete os parâmetros de configuração necessários para configurar a origem da identidade.
    ...
    | **Escolher certificado** | Se você quiser usar LDAPs com o servidor LDAP Active Directory ou a origem de identidade do servidor OpenLDAP, um botão **escolher certificado** aparecerá depois de digitar `ldaps://` na caixa de texto URL. Uma URL secundária não é necessária. |
...
3. Entre em seu vCenter de nuvem privada de AVS após os privilégios serem escalados.
