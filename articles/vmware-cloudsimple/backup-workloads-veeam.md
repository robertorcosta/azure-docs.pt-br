...
| Servidor de Backup <br> *Required for deploying Veeam Backup & Replication components* | Backup Proxy  | TCP/UDP  | 135, 137 to 139 and 445 |
    | Servidor de Backup   | DNS  | UDP  | 53  | 
    | Servidor de Backup   | Veeam Update Notification Server  | TCP  | 80  | 
    | Servidor de Backup   | Veeam License Update Server  | TCP  | 443  | 
