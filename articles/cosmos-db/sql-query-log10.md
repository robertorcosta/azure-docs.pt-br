---
title: LOG10 no idioma de consulta do Azure Cosmos DB
description: Saiba mais sobre a função do sistema Log10 SQL no Azure Cosmos DB para retornar o logaritmo base-10 da expressão numérica especificada
author: ginamr
