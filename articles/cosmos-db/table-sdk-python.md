...
|**Documentação da API**|[Documentação de referência da API do Python](/python/api/overview/azure/cosmosdb?preserve-view=true&view=azure-python)|
