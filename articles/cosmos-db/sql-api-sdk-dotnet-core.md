...
> [!NOTE]
> Se você estiver usando o .NET Core, consulte a versão mais recente 3. x do[ .NET SDK](sql-api-sdk-dotnet-standard.md), que tem como alvo .NET Standard.
