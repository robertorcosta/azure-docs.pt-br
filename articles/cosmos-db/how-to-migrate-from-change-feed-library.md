...
1. Defina `processorName` ativado `GetChangeFeedProcessorBuilder` para corresponder ao valor configurado em `ChangeFeedProcessorOptions.LeasePrefix`ou use `string.Empty` o contrário.
