...
Para automatizar a lista, consulte [usar a API de descoberta de marca de serviço (visualização pública)](../virtual-network/service-tags-overview.md#use-the-service-tag-discovery-api-public-preview).
