...
> 1. Instale o [runtime mínimo com suporte para Java, JDK 8](/java/azure/jdk/) para poder usar o SDK.
...
|**Documentação da API** | [Documentação de referência de API Java](/java/api/overview/azure/cosmosdb/client) |
