---
title: Amostras do Azure PowerShell para o Azure Cosmos DB – API de Tabela
...
| | |
|---|---|
|[Criar uma conta e uma tabela](scripts/powershell/table/ps-table-create.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Cria uma conta e uma tabela do Azure Cosmos. |
|[Listar ou obter tabelas](scripts/powershell/table/ps-table-list-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Liste ou obtenha tabelas. |
|[Obter RU/s](scripts/powershell/table/ps-table-ru-get.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Obtenha as RU/s de uma tabela. |
|[Atualizar RU/s](scripts/powershell/table/ps-table-ru-update.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Atualize as RU/s para uma tabela. |
