...
description: Saiba tudo sobre o Spring data Azure Cosmos DB v2 para API do SQL, incluindo datas de lançamento, datas de desativação e alterações feitas entre cada versão do SDK do Java assíncrono do SQL Azure Cosmos DB.
author: anfeldma-ms
...
> [!IMPORTANT]  
> Estas notas de versão são para a v2 de Azure Cosmos DB de dados Spring. Você pode encontrar notas de versão v3 [aqui](sql-api-sdk-java-spring-v3.md). 
>
