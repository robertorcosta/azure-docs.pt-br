...
description: Saiba tudo sobre o Azure Cosmos DB API de Tabela para Java, incluindo datas de lançamento, datas de desativação e alterações feitas entre cada versão.
