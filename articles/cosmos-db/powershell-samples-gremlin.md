...
description: Obtenha os exemplos de Azure PowerShell para executar várias tarefas comuns em contas da API do Gremlin do Azure Cosmos DB
author: markjbrown
...
|[Bloquear recursos da exclusão](scripts/powershell/gremlin/powershell-gremlin-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Impedir que os recursos sejam excluídos com bloqueios de recursos. |
|||
