...
O Azure Cosmos DB é um serviço fundamental no Azure, e, por padrão, está sempre disponível em todas as regiões, onde o Azure está disponível. Atualmente, o Azure está disponível em [54 regiões](https://azure.microsoft.com/global-infrastructure/regions/) em todo o mundo. 
...
* **O Azure China 21Vianet** está disponível por meio de uma parceria exclusiva entre a Microsoft e a 21Vianet, uma das maiores provedoras de internet do país na China.
