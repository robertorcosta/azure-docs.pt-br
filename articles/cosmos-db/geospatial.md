...
Aqui está um exemplo de uma consulta LINQ que localiza todos os documentos no contêiner Cosmos do Azure cujo valor de "local" está dentro de um raio de 30 km do ponto especificado usando LINQ.
