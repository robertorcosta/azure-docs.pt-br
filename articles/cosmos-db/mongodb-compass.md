...
Para se conectar à sua conta Cosmos DB usando o MongoDB Compass, você deve:
...
> [!NOTE]
> Atualmente, a API do Azure Cosmos DB para o MongoDB Server versão 3.2 é suportada com o MongoDB Compass.
