...
[![Exibindo o número de](./media/partition-data/view-partitions-zoomed-out.png) partições físicas](./media/partition-data/view-partitions-zoomed-in.png#lightbox)
