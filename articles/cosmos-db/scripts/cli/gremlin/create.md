---
title: Criar um banco de dados e um grafo Gremlin para Azure Cosmos DB
description: Criar um banco de dados e um grafo Gremlin para Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "94562926"
---
# <a name="create-an-azure-cosmos-gremlin-api-account-database-and-graph-using-azure-cli"></a>Criar uma conta, um banco de dados e um grafo da API do Gremlin do Azure Cosmos DB usando a CLI do Azure
