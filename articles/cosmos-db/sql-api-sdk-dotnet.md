---
title: 'Azure Cosmos DB: API SQL .NET, SDK & recursos'
...
| |  |
|---|---|
|**Download do SDK**|[Nuget](https://www.nuget.org/packages/Microsoft.Azure.DocumentDB/)|
|**Documentação de API**|[Documentação de referência da API .NET](/dotnet/api/overview/azure/cosmosdb?view=azure-dotnet)|
|**Amostras**|[.NET amostras de código](https://github.com/Azure/azure-cosmos-dotnet-v2/tree/master/samples)|
...
> [!NOTE]
> Se você estiver usando o .NET Framework, consulte a versão mais recente 3.x do [.NET SDK](sql-api-sdk-dotnet-standard.md), que tem como alvo o .NET Standard. 
