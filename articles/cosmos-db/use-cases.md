...
:::image type="content" source="./media/use-cases/apps-with-global-reach.png" alt-text="Arquitetura de referência de aplicativo Web do Azure Cosmos DB" border="false":::
