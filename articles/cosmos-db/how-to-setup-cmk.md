...
- Troque a chave usada atualmente por uma que seja totalmente diferente, atualizando a `keyVaultKeyUri` propriedade da sua conta. Veja como fazer isso no PowerShell:
