...
- No menu suspenso "permissões de chave", selecione "obter", "desencapsular chave" e "chave de encapsulamento":

    ![Selecionando as permissões corretas](./media/how-to-setup-cmk/portal-akv-add-ap-perm2.png)

- Em "selecionar entidade", clique em "nenhum selecionado", procure e selecione a entidade de segurança "Azure Cosmos DB" e, em seguida, clique em "selecionar" na parte inferior (se a entidade de segurança "Azure Cosmos DB" não puder ser encontrada, talvez seja necessário registrar novamente o recurso "Microsoft. DocumentDB" provedor na etapa 2):

    ![Selecionando a entidade de Azure Cosmos DB](./media/how-to-setup-cmk/portal-akv-add-ap.png)

- Clique em "Adicionar" para adicionar a nova política de acesso
...
- Forneça um nome para a nova chave, selecione um tamanho de chave RSA (um mínimo de 3072 é recomendado para obter a melhor segurança) e clique em "criar":
...
Ao criar uma nova conta de Azure Cosmos DB da portal do Azure, escolha "chave gerenciada pelo cliente" na etapa "criptografia". No campo "URI de chave", passe o URI da chave de Azure Key Vault copiada da etapa 4:
...
- Passe o URI da chave de Azure Key Vault copiada da etapa 4 na propriedade "keyVaultKeyUri" no objeto "Properties"
- Certifique-se de usar "2019-12-12" como a versão da API
