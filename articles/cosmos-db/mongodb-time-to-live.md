...
:::image type="content" source="./media/mongodb-ttl/mongodb_portal_ttl.png" alt-text="Captura de tela da ativação do recurso de TTL por documento no Portal":::
