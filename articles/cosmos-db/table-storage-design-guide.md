...
![Gráfico da entidade de funcionário][2]
...
![Diagrama mostrando a entidade de clientes e a entidade de funcionário][4]
...
![Diagrama dos padrões de design de tabela][5]
...
![Gráfico da entidade de funcionário][6]
...
![Gráfico mostrando a entidade de funcionário com diferentes valores RowKey][7]
...
* Você não precisa necessariamente duplicar todas as propriedades da entidade. Por exemplo, se as consultas que pesquisam as entidades usando o endereço de email em `RowKey` nunca precisarem da idade do funcionário, essas entidades podem ter a seguinte estrutura:
  ...
  ![Gráfico da entidade de funcionário][8]
...
![Gráfico da entidade de funcionário][9]
...
![Gráfico mostrando a entidade de funcionário com o índice primário e a entidade de funcionário com o índice secundário][10]
...
* Você não precisa necessariamente duplicar todas as propriedades da entidade. Por exemplo, se as consultas que pesquisam as entidades usando o endereço de email em `RowKey` nunca precisarem da idade do funcionário, essas entidades podem ter a seguinte estrutura:
  ...
  ![Gráfico mostrando a entidade de funcionário com o índice secundário][11]
...
![Gráfico da entidade de funcionário][13]
...
![Gráfico mostrando a entidade de funcionário com a cadeia de caracteres que contém uma lista de IDs de funcionário com o mesmo sobrenome][14]
...
![Gráfico mostrando a entidade de funcionário com a cadeia de caracteres que contém uma lista de IDs de funcionário com o mesmo sobrenome][15]
...
![Gráfico das entidade de departamento e de funcionário][16]
...
![Gráfico da entidade de departamento desnormalizada e combinada][17]
...
![Gráfico da entidade de funcionário][18]
...
![Gráfico da entidade de revisão de funcionário][19]
...
![Gráfico da entidade de funcionário com chave composta][20]
...
![Gráfico mostrando a entidade de estatísticas de mensagem com Rowkey 01 e entidade de estatísticas de mensagem com Rowkey 02][24]
...
![Gráfico mostrando a entidade de funcionário com a cadeia de caracteres para a Foto que aponta para o armazenamento de Blobs][25]
...
![Gráfico da entidade de funcionário][26]
...
![Gráfico mostrando a entidade de funcionário com RowKey que consiste em Ano, Mês, Dia, Hora e ID de Evento][27]
