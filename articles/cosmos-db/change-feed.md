...
| **Drivers do cliente** | **Azure CLI** | **SQL API** | **AA DO Azure Cosmos DB para Cassandra** | **API do Azure Cosmos DB para MongoDB** | **Gremlin API**|**API de tabela** |
| --- | --- | --- | --- | --- | --- | --- |
