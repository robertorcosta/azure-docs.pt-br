...
Você usará a biblioteca [Microsoft.Azure.Services.AppAuthentication](https://www.nuget.org/packages/Microsoft.Azure.Services.AppAuthentication) para obter o token de identidade gerenciado atribuído pelo sistema. Para saber outras maneiras de obter `Microsoft.Azure.Service.AppAuthentication` o token e mais informações sobre a biblioteca, consulte o artigo [De Autenticação serviço para serviço.](../key-vault/service-to-service-authentication.md)
