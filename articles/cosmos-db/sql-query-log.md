---
title: LOG no idioma de consulta do Azure Cosmos DB
description: Saiba mais sobre a função do sistema LOG SQL no Azure Cosmos DB para retornar o logaritmo natural da expressão numérica especificada
author: ginamr
