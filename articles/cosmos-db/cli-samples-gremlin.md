---
title: Exemplos de CLI do Azure para a API do Gremlin do Azure Cosmos DB
description: Exemplos de CLI do Azure para a API do Gremlin do Azure Cosmos DB
author: markjbrown
