...
## <a name="step-2-clone-the-github-project"></a><a id="GitClone"></a>Etapa 2: Clonar o projeto do GitHub
...
![Captura de tela do portal do Azure usado pelo tutorial do NoSQL para criar um aplicativo de console Java. Mostra uma conta do Azure Cosmos DB com o hub ATIVO realçado, o botão CHAVES realçado na folha da conta do Azure Cosmos DB e os valores de URI, de CHAVE PRIMÁRIA e de CHAVE SECUNDÁRIA realçados na folha Chaves][keys]
...
## <a name="step-5-create-a-collection"></a><a id="CreateColl"></a>Etapa 5: Criar uma coleção
> [!WARNING]
...
## <a name="step-6-create-json-documents"></a><a id="CreateDoc"></a>Etapa 6: Criar documentos JSON
...
## <a name="step-8-replace-json-document"></a><a id="ReplaceDocument"></a>Etapa 8: Substituir o documento JSON
...
## <a name="step-9-delete-json-document"></a><a id="DeleteDocument"></a>Etapa 9: Excluir o documento JSON
...
## <a name="step-11-run-your-java-console-application-all-together"></a><a id="Run"></a>Etapa 11: Execute o aplicativo de console Java de uma só vez!
