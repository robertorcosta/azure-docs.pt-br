...
| Grupos | Limite padrão |
| --- | --- |
| Maximum execution time for a single operation (like a stored procedure execution or a single query page retrieval)| 5 segundos |
...
| Maximum execution time for MongoDB operations| 30 s |
