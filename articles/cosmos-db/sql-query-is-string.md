---
title: IS_STRING no idioma de consulta do Azure Cosmos DB
...
## <a name="examples"></a>Exemplos
  ...
  O exemplo a seguir verifica objetos de JSON Boolean, número, string, `IS_STRING` nulo, objeto, matriz e tipos indefinidos usando a função.  
