...
--- | ---
Tipo de conteúdo | O formato da solicitação (Content-Type: Application/<format>). Para APIs de Hub de dados FarmBeats, o formato é JSON. Content-Type: application/json
