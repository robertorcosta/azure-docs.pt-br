...
1. Vá para https://linkedinselectedusermigration.azurewebsites.net/. Você verá uma lista de usuários que estão selecionados para conexões de conta do LinkedIn.
...
1. Crie um Objeto de Política de Grupo com a configuração a seguir: **Configuração de Usuário** > **Modelos Administrativos** > **Microsoft Office 2016** > **Diversos** > **Mostrar recursos do LinkedIn em aplicativos do Office**.
