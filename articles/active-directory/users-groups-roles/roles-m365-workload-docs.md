...
Microsoft Cloud App Security | [Controle de acesso baseado em função](https://docs.microsoft.com/cloud-app-security/manage-admins) | [Reference API](https://docs.microsoft.com/cloud-app-security/api-tokens) 
