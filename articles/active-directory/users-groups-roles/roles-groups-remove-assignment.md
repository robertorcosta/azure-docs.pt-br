...
1. Selecione **funções e administradores**  >  ***nome da função***.

1. Selecione o grupo do qual você deseja remover a atribuição de função e selecione **remover atribuição**.

   ![Remover uma atribuição de função de um grupo selecionado.](./media/roles-groups-remove-assignment/remove-assignment.png)
