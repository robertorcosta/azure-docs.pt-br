...
1. Na página ***nome da função*** , selecione > **Adicionar atribuição**.

   ![Adicionar a nova atribuição de função](./media/roles-groups-assign-role/add-assignment.png)

1. Selecione o grupo. Somente os grupos que podem ser atribuídos às funções do Azure AD são exibidos.

    [![Somente os grupos que são atribuíveis são mostrados para uma nova atribuição de função.](media/roles-groups-assign-role/eligible-groups.png "Somente os grupos que são atribuíveis são mostrados para uma nova atribuição de função.")](media/roles-groups-assign-role/eligible-groups.png#lightbox)
