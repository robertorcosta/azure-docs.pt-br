...
description: Como migrar de licenças individuais de usuário para licenciamento em grupo usando o Azure Active Directory
...
Você pode ter licenças existentes implantadas para usuários nas organizações por meio de atribuição direta; ou seja, usando scripts PowerShell ou outras ferramentas para atribuir licenças individuais ao usuário. Antes de começar a usar o licenciamento baseado em grupo para gerenciar licenças em sua organização, você pode usar esse plano de migração para substituir perfeitamente as soluções existentes por um licenciamento baseado em grupo.
...
Considere remover as atribuições diretas originais. Recomendamos que você faça isso gradualmente, e monitore o resultado em um subconjunto de usuários primeiro. Se você pudesse deixar as atribuições diretas originais nos usuários, mas quando os usuários deixam seus grupos licenciados, eles retêm as licenças diretamente atribuídas, o que pode não ser o que você deseja.
...
1. Usando o portal Azure, atribua a licença Office 365 E3 ao grupo **Todos os usuários** no Azure AD.

1. Confirme que a atribuição da licença foi concluída para todos os usuários. Vá para a página de visão geral do grupo, selecione **Licenças**e verifique o status de processamento na parte superior da lâmina **Licenças.**
...
1. Verifique alguns usuários para ver se eles têm as licenças diretas ou de grupo aplicadas. Acesse a página de perfil de um usuário, selecione **Licenças**e examine o estado das licenças.
   ...
   - Este é o estado do usuário esperado durante a migração:
     ...
     Isso confirma que o usuário tem licenças diretas e herdadas. Vemos que o Office 365 E3 foi designado.

   - Selecione cada licença para ver quais serviços estão habilitados. Para verificar se as licenças direta satisfaz exatamente os mesmos serviços para o usuário, **selecione Atribuições**.
...
Saiba mais sobre outros cenários para o gerenciamento de licenças de grupo:
