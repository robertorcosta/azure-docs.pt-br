...
Para obter mais detalhes, consulte [criar e atribuir uma função personalizada](roles-create-custom.md) e [atribuir funções personalizadas com o escopo de recurso usando o PowerShell](roles-assign-powershell.md).
...
Crie uma função personalizada usando o exemplo fornecido na API Microsoft Graph. Para obter mais detalhes, consulte [criar e atribuir uma função personalizada](roles-create-custom.md) e [atribuir funções de administrador personalizadas usando a API de Microsoft Graph](roles-assign-graph.md).
