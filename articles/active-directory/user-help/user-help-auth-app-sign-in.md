---
title: Faça login usando o aplicativo Microsoft Authenticator - Azure AD
...
O aplicativo Microsoft Authenticator ajuda você a entrar em suas contas se você usar a verificação de dois fatores. A verificação de dois fatores ajuda você a acessar suas contas com mais segurança, especialmente durante a exibição de informações confidenciais. Como as senhas podem ser esquecidas, roubadas ou comprometidas, a verificação de dois fatores é uma etapa adicional de segurança que ajuda a proteger sua conta, dificultando que ela seja invadida por outras pessoas.
...
Abra o aplicativo Microsoft Authenticator, vá para sua conta de trabalho ou escola e ative o login do telefone.
...
- **Se você já estiver usando o aplicativo para verificação de dois fatores.** Se você já estiver usando o aplicativo e a verificação de dois fatores, você pode selecionar a seta ao lado do nome da conta e, em seguida, selecionar **Ativar login de telefone**.
...
- **Quando você toca no bloco da conta,** a conta é aberta em uma exibição em tela cheia da conta. Se você vir **o login do telefone ativado,** isso significa que você está totalmente configurado para fazer login sem a sua senha. Se você vir **Ativar o login do telefone,** toque-o para ativar o login do telefone.
- **Se você já estiver usando o aplicativo para verificação de dois fatores,** você pode tocar no bloco da conta, que se expande para uma exibição em tela cheia da conta. Em seguida, **toque em Ativar** o login do telefone para ativar o login do telefone.
- **Se você não conseguir encontrar sua conta de trabalho ou escola** na tela **contas** do aplicativo, significa que você ainda não adicionou ao aplicativo. Adicione sua conta corporativa ou de estudante seguindo as etapas do artigo Adicionar sua conta corporativa ou de estudante.
...
- **Se este ícone é exibido ![ícone mostrando que você realizou a configuração](media/user-help-auth-app-sign-in/icon.png).** Se este ícone aparecer ao lado do nome da sua conta pessoal da Microsoft, significa que você já configurou o login do telefone para a conta. Talvez você precise adicionar notificações por push à sua conta, de modo a ser notificado sobre solicitações de autenticação fora do aplicativo.
- **Se você usa o aplicativo para a verificação de dois fatores.** Se você já estiver usando o aplicativo e a verificação de dois fatores, você pode selecionar a seta ao lado do nome da conta e, em seguida, selecionar **Ativar login de telefone**.
- **Se você não consegue encontrar sua conta corporativa ou de estudante.** Se você não consegue encontrar sua conta na tela **Contas** do aplicativo, isso significa que você ainda não a adicionou ao aplicativo. Adicione sua conta seguindo as etapas do artigo [Adicionar contas pessoais da Microsoft.](user-help-auth-app-add-personal-ms-account.md)

Em um dispositivo iOS:

- **Quando você toca no bloco da conta,** a conta é aberta em uma exibição em tela cheia da conta. Se você vir **o login do telefone ativado,** isso significa que você está totalmente configurado para fazer login sem a sua senha. Se você vir **Ativar o login do telefone,** toque-o para ativar o login do telefone.
- **Se você já estiver usando o aplicativo para verificação de dois fatores,** você pode tocar no bloco da conta, que se expande para uma exibição em tela cheia da conta. Em seguida, **toque em Ativar** o login do telefone para ativar o login do telefone.
- **Se você não conseguir encontrar sua conta** na tela **contas** do aplicativo, significa que você ainda não a adicionou ao aplicativo. Adicione sua conta pessoal da Microsoft seguindo as etapas do artigo [Adicionar contas pessoais da Microsoft.](user-help-auth-app-add-personal-ms-account.md)
...
O método padrão de verificação de dois fatores exige que você insira seu nome de usuário e senha no dispositivo em que você está fazendo login. Em seguida, você abre o aplicativo Microsoft Authenticator e digita o código gerado aleatoriamente para sua conta na caixa **de código Enter.** Em um dispositivo Android, esses códigos de verificação podem ser encontrados na tela **contas.** Em um dispositivo iOS, esses códigos de verificação podem ser encontrados na tela **contas** ou na exibição em tela cheia de uma conta, dependendo do tipo de conta. Você pode ativar a verificação de dois fatores para sua conta como parte do processo de adicionar a conta ao aplicativo Microsoft Authenticator.
