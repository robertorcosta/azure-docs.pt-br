...
- Vá para o [Portal **meus grupos**](https://account.activedirectory.windowsazure.com/r#/groups)
- Vá para o [Portal **minha conta**](https://myaccount.microsoft.com/)
...
1. Em um navegador da Web com suporte, vá para https://myapps.microsoft.com ou use o link fornecido pela sua organização se direcionar você para uma página personalizada, como `https://myapps.microsoft.com/contoso.com` .
...
## <a name="access-and-use-the-my-apps-portal-on-mobile-edge"></a>Acessar e usar o portal meus aplicativos no Mobile Edge

Exiba e use os aplicativos da sua organização da versão móvel do navegador Edge em seus dispositivos.

1. Em seu dispositivo móvel, baixe e instale o aplicativo de navegador do Mobile Edge na Apple App Store e o Google Play Store.

1. Abra o navegador do Mobile Edge e vá para https://myapps.microsoft.com , ou use o link fornecido pela sua organização se o direcionar para uma página personalizada, como https://myapps.microsoft.com/contoso.com .
...
- Criar, atualizar e remover contas de aplicativo. Para obter mais informações, consulte [Editar ou revogar permissões de aplicativo](my-applications-portal-permissions-saved-accounts.md).
- Acesse [**minha conta**](my-account-portal-overview.md) no portal **meus aplicativos** para o gerenciamento de conta:
  
  - Verificando atividade de entrada incomum
  - Gerenciando sua senha
  - Gerenciando dispositivos conectados, assinaturas, organizações e aplicativos do Office

>[!NOTE]
>Se você não vê nenhuma coleção ou categoria disponível, isso significa que o administrador não configurou nem compartilhou nenhuma delas com você. Entre em contato com o suporte técnico de sua organização para obter assistência adicional ou permissões para ver as coleções compartilhadas.
