...
2. Insira as informações necessárias:
    ...
    - **Tipo de grupo:**
        ...
        - **Office 365.** Fornece oportunidades de colaboração, oferecendo acesso de membros a uma caixa de correio compartilhada, calendário, arquivos, site do SharePoint e muito mais. Com essa opção, você também pode permitir o acesso ao grupo a pessoas fora de sua organização.
...
3. Se você adicionou um membro por engano ou se um membro saiu da sua organização, você pode remover o membro selecionando **Remover membro** ao lado do nome do membro na página de * &lt;group_name&gt; * .
...
Você pode ingressar ou deixar um grupo já existente na página **grupos** .
