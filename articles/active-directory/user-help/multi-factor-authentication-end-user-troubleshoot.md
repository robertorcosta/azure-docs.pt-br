...
Desabilitar aplicativos de segurança de terceiros | Se você tiver um aplicativo que protege mensagens de texto ou chamadas telefônicas para minimizar chamadores desconhecidos, eles poderão impedir que o código de verificação seja recebido. Tente desabilitar qualquer aplicativo de segurança de terceiros em seu telefone e, em seguida, solicite a envio de outro código de verificação.
