...
| Name | Obrigatório/repetição | Type | Observações |
| --- | --- | --- | --- |
...
**Descrição:** Substitui valores em uma cadeia de caracteres. Ela funciona de maneira diferente dependendo dos parâmetros fornecidos:
