...
|----|--------------------------------------|---------------------|-------------------------------------------------------------------------------|
| 1  | Dados pessoais                        | Yes                 | WD: Worker \_ Data/WD: \_ dados pessoais                                             |
| 2  | Dados de emprego                      | Yes                 | WD: Worker \_ Data/WD: dados de emprego \_                                           |
| 3  | Dados de trabalho adicionais                  | Yes                 | WD: Worker \_ Data/WD: empregos de trabalho \_ /WD: \_ trabalho de dados do trabalho de trabalho \_ \[ @wd:Primary \_ = 0\]|
| 4  | Dados da organização                    | Yes                 | WD: Worker \_ Data/WD: dados da organização \_                                         |
| 5  | Dados da cadeia de gerenciamento                | Yes                 | WD: Worker \_ Data/WD: \_ dados da cadeia de gerenciamento \_                                    |
| 6  | Organização de supervisão             | Yes                 | SUPERVISÃO                                                                 |
| 7  | Empresa                              | Yes                 | CORPORATIVA                                                                     |
| 8  | Unidade de negócios                        | No                  | ' unidade de negócios \_ '                                                              |
| 9  | Hierarquia de unidade de negócios              | No                  | ' hierarquia de unidades de negócios \_ \_ '                                                   |
| 10 | Hierarquia da empresa                    | No                  | ' hierarquia da empresa \_ '                                                          |
| 11 | Centro de Custo                          | Não                  | ' centro de custo \_ '                                                                |
| 12 | Hierarquia do centro de custo                | No                  | ' hierarquia do centro de custo \_ \_ '                                                     |
| 13 | Fundo                                 | No                  | FUNDO                                                                        |
| 14 | Hierarquia de fundos                       | No                  | ' hierarquia de fundos \_ '                                                             |
| 15 | Gift                                 | No                  | Gift                                                                        |
| 16 | Hierarquia de presentes                       | No                  | ' hierarquia de presentes \_ '                                                             |
| 17 | Conceder                                | No                  | CONCEDER                                                                       |
| 18 | Hierarquia de concessão                      | No                  | ' conceder \_ hierarquia '                                                            |
| 19 | Hierarquia de sites de negócios              | No                  | ' hierarquia de site da empresa \_ \_ '                                                   |
| 20 | Organização da matriz                  | No                  | TABELA                                                                      |
| 21 | Grupo de pagamento                            | No                  | ' grupo de pagamento \_ '                                                                  |
| 22 | Programas                             | No                  | SUPLEMENTA                                                                    |
| 23 | Hierarquia do programa                    | No                  | ' hierarquia de programas \_ '                                                          |
| 24 | Região                               | No                  | ' hierarquia de região \_ '                                                           |
| 25 | Hierarquia de localização                   | No                  | ' hierarquia de localização \_ '                                                         |
| 26 | Dados de provisionamento de conta            | No                  | WD: Worker \_ Data/WD: dados de provisionamento de conta \_ \_                                |
| 27 | Dados de verificação em segundo plano                | No                  | WD: Worker \_ Data/WD: \_ dados de verificação em segundo plano \_                                    |
| 28 | Dados de qualificação do benefício             | No                  | WD: Worker \_ Data/WD: \_ dados de qualificação do benefício \_                                 |
| 29 | Dados de registro do benefício              | No                  | WD: Worker \_ Data/WD: \_ dados de registro do benefício \_                                  |
| 30 | Dados de carreira                          | No                  | WD: Worker \_ Data/WD: dados de carreira \_                                               |
| 31 | Dados de compensação                    | No                  | WD: Worker \_ Data/WD: dados de compensação \_                                         |
| 32 | Dados de autoridade de imposto de trabalho contingente | No                  | WD: Worker \_ Data/WD: \_ dados de \_ \_ tipo de \_ formulário da autoridade de \_ imposto do trabalhador \_ contingente       |
| 33 | Dados do item de desenvolvimento                | No                  | WD: Worker \_ Data/WD: \_ dados do item de desenvolvimento \_                                    |
| 34 | Dados de contratos de funcionários              | No                  | WD: Worker \_ Data/WD: \_ dados de contratos de funcionários \_                                  |
| 35 | Dados de revisão do funcionário                 | No                  | WD: Worker \_ Data/WD: \_ dados de revisão do funcionário \_                                     |
| 36 | Dados recebidos de comentários               | No                  | WD: Worker \_ Data/WD: comentários \_ recebidos \_ dados                                   |
| 37 | Dados de meta do trabalhador                     | No                  | WD: Worker \_ Data/WD: \_ dados de meta do trabalhador \_                                         |
| 38 | Dados de foto                           | No                  | WD: Worker \_ Data/WD: dados de foto \_                                                |
| 39 | Dados de qualificação                   | No                  | WD: Worker \_ Data/WD: dados de qualificação \_                                        |
| 40 | Dados de pessoas relacionadas                 | No                  | WD: Worker \_ Data/WD: \_ dados de pessoas relacionadas \_                                     |
| 41 | Dados da função                            | No                  | WD: Worker \_ Data/WD: dados da função \_                                                 |
| 42 | Dados de habilidade                           | No                  | WD: Worker \_ Data/WD: dados de habilidade \_                                                |
| 43 | Dados do perfil de sucessão              | No                  | WD: Worker \_ Data/WD: dados do \_ perfil de sucesso \_                                  |
| 44 | Dados de avaliação de talento               | No                  | WD: Worker \_ Data/WD: \_ dados de avaliação de talento \_                                   |
| 45 | Dados da conta de usuário                    | No                  | WD: Worker \_ Data/WD: \_ dados da conta de usuário \_                                        |
| 46 | Dados de documentos de trabalho                 | No                  | WD: Worker \_ Data/WD: \_ dados de documentos do trabalhador \_                                     |
