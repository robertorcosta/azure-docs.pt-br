...
* [Usando o sistema para o SCIM (gerenciamento de identidades entre domínios) para provisionar automaticamente usuários e grupos de Azure Active Directory para aplicativos](../app-provisioning/use-scim-to-provision-users-and-groups.md)
