...
* Se ***SkipOutOfScopeDeletions** _ for definido como 1 (true), as contas que saem do escopo não serão desabilitadas no destino. Esse sinalizador é definido no nível _Provisioning aplicativo * e pode ser configurado usando o API do Graph. 
