...
| 59 | EmpJob\.empresa                        | company                      | Ler           |
| 60 | EmpJob\.empresa                        | companyId                    | Ler           |
| 61 | EmpJob\.empresa\.CountryOfRegistration | twoCharCountryCode           | Ler           |
...
| 71 | EmpJob\.local                       | LocalName                 | Ler           |
| 72 | EmpJob\.local                       | officeLocationAddress        | Ler           |
| 73 | EmpJob\.local                       | officeLocationCity           | Ler           |
| 74 | EmpJob\.local                       | officeLocationCustomString4  | Ler           |
| 75 | EmpJob\.local                       | officeLocationZipCode        | Ler           |
