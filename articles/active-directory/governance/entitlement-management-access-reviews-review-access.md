...
1. Se você não tiver o email, poderá encontrar suas revisões de acesso pendentes navegando diretamente https://myaccess.microsoft.compara.  (Para o governo dos EUA `https://myaccess.microsoft.us` , use em vez disso.)
