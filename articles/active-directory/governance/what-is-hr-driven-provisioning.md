...
Para obter informações sobre o Microsoft Identity Manager e os sistemas aos quais ele dá suporte, confira a documentação [Microsoft Identity Manager](https://docs.microsoft.com/microsoft-identity-manager/microsoft-identity-manager-2016).
...
- [O que é o provisionamento de diretório?](what-is-inter-directory-provisioning.md)