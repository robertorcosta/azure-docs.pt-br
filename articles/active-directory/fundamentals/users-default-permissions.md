...
Membros podem convidar | Os membros podem convidar a configuração dessa opção para Sim permite que membros não-administradores do seu diretório convidem convidados. Confira [delegar convites para colaboração B2B](../external-identities/delegate-invitations.md#configure-b2b-external-collaboration-settings) para saber mais.
