...
- **conta Microsoft.** Use seu conta Microsoft pessoal para obter acesso ao Azure e a todos os produtos e serviços de nuvem da Microsoft voltados ao consumidor, como Outlook (Hotmail), Messenger, OneDrive, MSN, Xbox LIVE ou Microsoft 365. A inscrição para uma caixa de correio do Outlook.com cria automaticamente uma conta da Microsoft. Para obter mais informações, consulte [Visão geral da conta Microsoft](https://account.microsoft.com/account).

- **Conta corporativa ou de estudante.** Use sua conta relacionada ao trabalho ou à escola para obter acesso a todos os serviços de nuvem pequenos, médios e empresariais da Microsoft, como o Azure, Microsoft Intune ou Microsoft 365. Após inscrever-se em um desses serviços como uma organização, o Azure AD provisiona automaticamente um diretório baseado em nuvem que representa a organização. Para obter mais informações, consulte [Gerenciar seu diretório do Azure AD](./active-directory-whatis.md).
...
- [Usar sua infraestrutura de identidade local na nuvem](../hybrid/whatis-hybrid-identity.md)
