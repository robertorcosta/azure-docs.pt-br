...
Em um futuro próximo, os usuários com contas Ad do Azure não poderão mais se cadastrar e gerenciar aplicativos convergentes usando o Portal de Registro de Aplicativos (apps.dev.microsoft.com), ou registrar e gerenciar aplicativos nos registros do App (legado) experiência no portal Azure.
