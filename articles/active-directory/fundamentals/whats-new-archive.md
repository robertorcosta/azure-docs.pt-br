...
Para obter mais informações, consulte [What happens during provisioning?](https://docs.microsoft.com/azure/active-directory/manage-apps/how-provisioning-works) (O que acontece durante o provisionamento?)
