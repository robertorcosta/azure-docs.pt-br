...
1. Procure a opção **Configurações** no menu de navegação.
    ...
    ![Configuração](./media/visibly-tutorial/settings.png)

1. Clique em **Integrações** em Configurações.

    ![Configuração](./media/visibly-tutorial/integrations.png)

1. Em **Integrações**, selecione **SSO**.

    ![Configuração](./media/visibly-tutorial/sso.png)

1. Execute as etapas abaixo na página a seguir.

    ![Configuração](./media/visibly-tutorial/configuration.png)
...
Ao clicar no bloco do Visibly no Painel de Acesso, você deverá ser conectado automaticamente ao Visibly, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
