...
* Você pode permitir que seus usuários entrem automaticamente no UltiPro (logon único) com suas contas do Azure AD.
...
* Assinatura do UltiPro habilitada para logon único
...
4. Na caixa de pesquisa, digite **UltiPro** , selecione **UltiPro** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do UltiPro.
...
2. **[Configurar o logon único do UltiPro](#configure-ultipro-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do UltiPro](#create-ultipro-test-user)** – para ter um equivalente de Brenda Fernandes no UltiPro que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **UltiPro** , selecione **Logon único** .
...
### <a name="configure-ultipro-single-sign-on"></a>Configurar o logon único do UltiPro
...
1. No portal do Azure, escolha **Aplicativos empresariais** , escolha **Todos os aplicativos** e, em seguida, escolha **UltiPro** .

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, digite e escolha **UltiPro** .

    ![O link do UltiPro na lista de aplicativos](common/all-applications.png)
...
Ao clicar no bloco do UltiPro no Painel de Acesso, você deverá ser conectado automaticamente ao UltiPro no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
