...
## <a name="adding-vmware-horizon---unified-access-gateway-from-the-gallery"></a>Como adicionar o VMware Horizon – Unified Access Gateway por meio da galeria
...
Nesta seção, você criará um usuário chamado B.Fernandes no VMware Horizon – Unified Access Gateway. Trabalhe com  [a equipe de suporte do VMware Horizon – Unified Access Gateway](mailto:support@vmware.com) para adicionar os usuários à plataforma VMware Horizon – Unified Access Gateway. Os usuários devem ser criados e ativados antes de usar o logon único.
