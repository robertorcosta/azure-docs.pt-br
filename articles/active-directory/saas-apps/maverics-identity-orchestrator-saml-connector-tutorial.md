...
1. [Crie um cofre de chaves](../../key-vault/secrets/quick-create-portal.md#create-a-vault).
...
1. Abra a [CLI do Azure](/cli/azure/install-azure-cli?view=azure-cli-latest) e digite o seguinte comando:
