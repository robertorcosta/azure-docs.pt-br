...
Para obter mais instruções de instalação e configuração, acesse o [site do Strata](https://strata.io/docs).
...
Para começar a instalação do Maverics Identity Orchestrator, confira as [instruções de instalação](https://strata.io/docs).
...
1. [Crie um cofre de chaves](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal#create-a-vault).
1. [Adicione os segredos ao cofre de chaves](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal#add-a-secret-to-key-vault).
1. [Registre um aplicativo no Azure AD](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal#create-an-azure-active-directory-application).
1. [Autorize um aplicativo a usar um segredo](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal#add-a-secret-to-key-vault).

**Usar a CLI do Azure**

1. Abra a [CLI do Azure](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest) e digite o seguinte comando:
