...
## <a name="configure-and-test-azure-ad-single-sign-on-for-idc"></a>Configurar e testar logon único do Azure AD para o IDC
...
Para configurar e testar o SSO do Azure AD com o IDC, conclua os seguintes blocos de construção:
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **IDC**, localize a seção **Gerenciar** e selecione **logon único**.
...
1. Na seção **Configuração Básica do SAML**, caso deseje configurar o aplicativo no modo iniciado por **IDP**, digite os valores dos seguintes campos:
    ...
    a. No **identificador** caixa de texto, digite uma URL usando o seguinte padrão: `urn:idc:authentication:saml2:entity:cas:prod-2016:<ClientCode>`
...
1. Clique em **Definir URLs adicionais** e execute as seguintes etapas caso deseje configurar o aplicativo no modo iniciado por **SP**:
    ...
    > [!NOTE]
    > Esses valores não são reais. Atualize esses valores com o Identificador e a URL de Resposta reais. Entre em contato com a equipe de suporte ao cliente do IDC para obter esses valores. Você também pode consultar os padrões exibidos na seção **Configuração Básica de SAML** no portal do Azure.
...
Para configurar o logon único no lado do **IDC**, é necessário enviar o **XML de Metadados de Federação** baixado e as URLs apropriadas copiadas do portal do Azure para a equipe de suporte do IDC. O IDC define essa configuração para que a conexão de SSO do SAML seja definida corretamente em ambos os lados.
...
Ao clicar no bloco do IDC no Painel de Acesso, você deverá ser conectado automaticamente ao IDC no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Experimente o IDC com o Azure AD](https://aad.portal.azure.com/)
