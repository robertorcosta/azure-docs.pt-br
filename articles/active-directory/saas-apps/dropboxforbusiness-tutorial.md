...
## <a name="add-dropbox-business-from-the-gallery"></a>Adicionar o Dropbox Business por meio da galeria
...
## <a name="configure-and-test-azure-ad-sso-for-dropbox-business"></a>Configurar e testar o SSO do Azure AD para Dropbox Business
...
Para configurar e testar o SSO do Azure AD com o Dropbox Business, execute as seguintes etapas:
...
1. No portal do Azure, na página de integração de aplicativos do **Dropbox Business**, localize a seção **Gerenciar** e escolha **Logon único**.
...
Nesta seção, você permitirá que B.Fernandes use o logon único do Azure permitindo a ela acesso ao Dropbox Business.
...
8. Na seção **Conexão única**, execute as seguintes etapas:  
    ...
    ![Configurar Logon Único](./media/dropboxforbusiness-tutorial/sso.png "Configurar o logon único")
...
* Clique em **Testar este aplicativo** no portal do Azure. Isso redirecionará você para a URL de Logon do Dropbox Business, na qual você poderá iniciar o fluxo de logon. 
