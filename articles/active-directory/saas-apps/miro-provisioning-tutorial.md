...
1.  Para recuperar o **token secreto** necessário contate a equipe de suporte support@miro.comdo Miro em. Esse valor será inserido no campo token secreto na guia provisionamento do seu aplicativo Miro no portal do Azure.
