...
Ao clicar no bloco do Planview Enterprise One no Painel de Acesso, você deverá ser conectado automaticamente ao Planview Enterprise One, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
