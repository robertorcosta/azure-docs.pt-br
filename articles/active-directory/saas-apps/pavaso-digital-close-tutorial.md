...
Nesta seção, você cria um usuário chamada Brenda Fernandes no Pavaso Digital Close. Trabalhe com a [equipe de suporte do Pavaso Digital Close](mailto:support@pavaso.com) para adicionar os usuários na plataforma do Pavaso Digital Close. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Pavaso Digital Close no Painel de Acesso, você será conectado automaticamente ao Pavaso Digital Close no qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
