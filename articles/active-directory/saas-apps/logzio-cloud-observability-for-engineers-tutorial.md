...
Ao clicar no bloco do Logz.io – Azure AD Integration no Painel de Acesso, você deverá ser conectado automaticamente ao Logz.io – Azure AD Integration para o qual você configurou um SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Como proteger o Logz.io – Azure AD Integration com visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
