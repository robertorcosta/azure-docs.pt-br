...
* Você pode permitir que seus usuários entrem automaticamente no Halosys (Logon Único) usando suas contas do Azure AD.
...
* Assinatura do Halosys habilitada para logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O Halosys é compatível com SSO iniciado por **IDP**
...
4. Na caixa de pesquisa, digite **Halosys**, selecione **Halosys** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![Halosys na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Halosys.
...
2. **[Configurar o logon único do Halosys](#configure-halosys-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Halosys](#create-halosys-test-user)** – para ter um equivalente de Brenda Fernandes no Halosys que esteja vinculado à representação de usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **Halosys**, selecione **Logon único**.
...
4. Na página **Configurar Logon Único com SAML**, execute as seguintes etapas:
    ...
    ![Informações de logon único de Domínio e URLs do Halosys](common/idp-intiated.png)

    a. No **identificador** caixa de texto, digite uma URL usando o seguinte padrão: `https://<company-name>.halosys.com`
...
6. Na seção **Configurar o Halosys**, copie as URLs apropriadas de acordo com suas necessidades.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Halosys**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Halosys**.

    ![O link do Halosys na lista de Aplicativos](common/all-applications.png)
...
Ao clicar no bloco do Halosys no Painel de Acesso, você deverá ser conectado automaticamente ao Halosys, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
