...
5. Na seção **Configuração Geral**, execute as etapas a seguir:
...
6. Na seção **Resposta e Configuração da Autenticação**, realize as etapas seguintes:
    ...
    a. Como **Provedor de Identidade**, selecione **Microsoft ADFS**.

    b. Como **Tipo de Identificador**, selecione **Endereço de Email**. 

    c. Na caixa de texto **Atributo do Email**, digite **emailaddress**.
...
7. Execute as seguintes etapas para concluir a configuração:
    ...
    a. Como **Criação do usuário na entrada**, selecione **Criar um novo usuário em seu site quando eles entrarem**.

    b. Como **Configurações de Entrada**, selecione **Usar o botão SAML na tela "Entrar"**.
...
Ao clicar no bloco do Igloo Software no Painel de Acesso, você deverá ser conectado automaticamente ao Igloo Software para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
