...
Nesta seção, você criará um usuário chamado B.Fernandes no SmartKargo. Entre em contato com a [equipe de suporte da plataforma do SmartKargo](https://www.smartkargo.com/company/contact-2/) para adicionar os usuários na plataforma do SmartKargo. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do SmartKargo no Painel de Acesso, você será conectado automaticamente ao SmartKargo para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Como proteger o SmartKargo com visibilidade e controles avançados](/cloud-app-security/proxy-intro-aad)