...
> * [Logon único](https://docs.microsoft.com/azure/active-directory/saas-apps/alertmedia-tutorial) para o AlertMedia (recomendado)
...
3. Determine quais dados serão [mapeados entre o Azure AD e o AlertMedia](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
