...
## <a name="configure-and-test-azure-ad-single-sign-on-for-e-days"></a>Configurar e testar logon único do Azure AD para o E-days
...
Para configurar e testar o SSO do Azure AD com o E-days, conclua os seguintes blocos de construção:
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **E-days**, localize a seção **Gerenciar** e escolha **logon único**.
...
Nesta seção, você criará um usuário com o nome B.Fernandes no E-days. Trabalhe com a [equipe de suporte do E-days](https://support.e-days.com) para adicionar os usuários à plataforma do E-days. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do E-days no Painel de Acesso, você deverá ser conectado automaticamente ao E-days, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Experimentar o E-days com o Azure AD](https://aad.portal.azure.com/)
