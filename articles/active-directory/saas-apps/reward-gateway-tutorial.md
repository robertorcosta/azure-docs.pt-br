...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Reward Gateway. Trabalhe com a [equipe de suporte do Reward Gateway](mailto:clientsupport@rewardgateway.com) para adicionar os usuários à plataforma Reward Gateway. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Reward Gateway no Painel de Acesso, você deverá ser conectado automaticamente ao Reward Gateway, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
