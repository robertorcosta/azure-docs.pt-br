...
## <a name="adding-zoho-one-china-from-the-gallery"></a>Como adicionar o Zoho One China da galeria
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-zoho-one-china"></a>Configurar e testar o logon único do Azure AD para o Zoho One China
...
Para configurar e testar o SSO do Azure AD com o Zoho One China, conclua os seguintes blocos de construção:
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Zoho One China** , localize a seção **Gerenciar** e selecione **Logon único**.
...
Quando você clicar no bloco do Zoho One China no Painel de Acesso, deverá ser conectado automaticamente ao Zoho One China para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Avaliar o Zoho One China com o Azure AD](https://aad.portal.azure.com/)

- [O que é controle de sessão no Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Como proteger o Zoho One China com visibilidade e controles avançados](/cloud-app-security/proxy-intro-aad)