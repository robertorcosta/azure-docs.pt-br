...
1. Clique em **Integração > SSO** e execute as seguintes etapas:
    ...
    b. Abra seu certificado codificado com a base 64 no bloco de notas, copie o conteúdo dele para a sua área de transferência e cole-o na caixa de texto **Certificado X.509**

    c. Na caixa de texto **URL de Logoff Para**, cole o valor da **URL de Logoff** copiado do portal do Azure.

    d. Na caixa de texto **Sua URL do Kudos**, digite o nome da sua empresa.
...
1. Clique em **Administrador do Usuário**.
...
1. Na seção **Adicionar um Usuário**, execute as etapas a seguir:

    ![Adicionar um Usuário](./media/kudos-tutorial/ic787810.png "Adicionar um Usuário")

    a. Digite **Nome**, **Sobrenome**, **Email** e outros detalhes de uma conta válida do Active Directory do Azure que você deseja provisionar em caixas de texto relacionadas.

    b. Clique em **Criar Usuário**.

> [!NOTE]
> É possível usar qualquer outra ferramenta de criação da conta de usuário do Kudos ou APIs fornecidas pelo Kudos para provisionar as contas de usuário do Azure AD.

### <a name="test-single-sign-on"></a>Testar logon único

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Kudos no Painel de Acesso, você deverá ser conectado automaticamente ao Kudos, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
