...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    > [!NOTE]
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Contate a [equipe de suporte ao Cliente do Gigya](https://developers.gigya.com/display/GD/Opening+A+Support+Incident) para obter esses valores. Você também pode consultar os padrões exibidos na seção **Configuração Básica de SAML** no portal do Azure.
...
3. Na seção **Logon do SAML**, execute as etapas a seguir:
...
1. Faça logon no site da empresa **Gigya** como um administrador.
...
3. Na caixa de diálogo Convidar Usuários, execute as seguintes etapas:
    ...
    a. Na caixa de texto **Email**, digite o alias de email do da conta do Active Directory do Azure que deseja provisionar.
    
    b. Clique em **Convidar Usuários**.
...
Ao clicar no bloco do Gigya no Painel de Acesso, você deverá ser conectado automaticamente ao Gigya no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
