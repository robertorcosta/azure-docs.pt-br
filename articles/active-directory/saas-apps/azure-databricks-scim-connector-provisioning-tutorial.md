...
* Atualmente, obter solicitações Azure Databricks em relação à API SCIM ' para usuários diferenciam maiúsculas de minúsculas e, portanto, se for USER@contoso.com consultada, isso resultará em 0 resultados à medida que armazená-los como. user@contoso.com
