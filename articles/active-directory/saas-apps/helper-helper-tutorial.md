---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Helper Helper   Microsoft Docs'
...
Ao selecionar o bloco do Helper Helper no Painel de Acesso, você deverá entrar automaticamente no Helper Helper para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
