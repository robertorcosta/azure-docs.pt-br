...
Nesta seção, você criará um usuário com o nome Brenda Fernandes no SSO do OrgVitality. Trabalhe com a [equipe de suporte do SSO do OrgVitality](https://orgvitality.com/contact-us/) para adicionar os usuários na plataforma de SSO do OrgVitality. Os usuários devem ser criados e ativados antes de usar o logon único.
