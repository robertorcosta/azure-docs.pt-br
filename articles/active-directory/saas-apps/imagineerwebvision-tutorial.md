...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Imagineer WebVision. Trabalhe com a [equipe de suporte do Imagineer WebVision](mailto:support@itgny.com) para adicionar os usuários à plataforma Imagineer WebVision. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Quando clicar no bloco do Imagineer WebVision no Painel de Acesso, você deverá ser automaticamente conectado ao aplicativo Imagineer WebVision para o qual você configurar o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
