...
* Assinatura habilitada para SSO (logon único) do TravelPerk.
...
1. Na seção **Configuração Básica do SAML**, insira os valores para os seguintes campos:
    ...
    > [!NOTE]
    > Esses valores não são reais. Atualize esses valores com a URL de Logon, a URL de Resposta e o Identificador reais. Entre em contato com a [equipe de suporte ao Cliente do TravelPerk](mailto:trex@travelperk.com) para obter esses valores. Você também pode consultar os padrões exibidos na seção **Configuração Básica de SAML** no portal do Azure.

1. O aplicativo TravelPerk espera obter declarações SAML em um formato específico, o que exige que você adicione mapeamentos de atributo personalizados à sua configuração de atributos de token SAML. A captura de tela a seguir mostra a lista de atributos padrão, em que **emailaddress** é mapeado com **user.mail**. O aplicativo TravelPerk espera que **emailaddress** seja mapeado com **user.userprincipalname**, portanto, será necessário editar o mapeamento de atributos clicando no ícone **Editar** e alterar o mapeamento de atributos.
...
3. Use o Painel de Acesso da Microsoft. Ao clicar no bloco TravelPerk no Painel de Acesso, você será redirecionado para a URL de Logon do TravelPerk. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
