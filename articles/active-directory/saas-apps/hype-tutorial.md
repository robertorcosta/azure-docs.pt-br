---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Hype | Microsoft Docs'
...
ms.locfileid: "92460571"
---
# <a name="tutorial-integrate-hype-with-azure-active-directory"></a>Tutorial: Integrar o Hype ao Azure Active Directory
...
Ao clicar no bloco do Hype no Painel de Acesso, você deverá entrar automaticamente no Hype no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
