...
Nesta seção, você criará um usuário chamado B.Fernandes no mindWireless. Trabalhe com [equipe de suporte do mindWireless](mailto:sdulloor@mindwireless.com) para adicionar os usuários na plataforma do mindWireless. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do mindWireless no Painel de Acesso, você deverá ser conectado automaticamente ao mindWireless no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
