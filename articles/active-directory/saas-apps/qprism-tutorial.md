...
Ao clicar no bloco do QPrism no Painel de Acesso, você deverá ser conectado automaticamente ao QPrism com SSO configurado. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
