...
Nesta seção, você criará uma usuária chamada B.Fernandes no JOSA. Trabalhe com a [equipe de suporte do JOSA](mailto:hr@alldialogue.com) para adicionar os usuários à plataforma do JOSA. Os usuários devem ser criados e ativados antes de usar o logon único.
