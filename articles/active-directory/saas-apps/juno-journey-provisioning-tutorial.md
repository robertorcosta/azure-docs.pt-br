---
title: 'Tutorial: configurar o Juno Journey para o provisionamento automático de usuário com o Azure Active Directory | Microsoft Docs'
description: Saiba como provisionar e desprovisionar automaticamente as contas de usuário do Azure AD para o Juno Journey.
...
> * [Logon único](https://docs.microsoft.com/azure/active-directory/saas-apps/juno-journey-tutorial) no Juno Journey (recomendado)
...
*  Um [locatário de jornada Juno](https://www.junojourney.com/getstartedwithjuno).
...
3. Determine quais dados [mapeados entre o Azure AD e o Juno Journey](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
1. Para **token secreto** e **URL de locatário** , entre em contato com support@the-juno.coma equipe de suporte do Juno Journey em. Esse valor será inserido nos campos de **token secreto** e **URL do locatário** , respectivamente na guia provisionamento do seu aplicativo Juno Journey na portal do Azure. 
...
Adicione o Juno Journey da Galeria de aplicativos do Azure AD para começar a gerenciar o provisionamento para o Juno Journey. Se você tiver configurado anteriormente o Juno Journey for SSO, poderá usar o mesmo aplicativo. No entanto, é recomendável que você crie um aplicativo separado ao testar a integração inicialmente. Saiba mais sobre como adicionar um aplicativo da Galeria [aqui](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
## <a name="step-5-configure-automatic-user-provisioning-to-juno-journey"></a>Etapa 5. Configurar o provisionamento automático de usuário para o Juno Journey 
...
5. Na seção **credenciais de administrador** , insira o valor da URL do locatário recuperado anteriormente na **URL do locatário**. Insira o valor do token secreto recuperado anteriormente no **token secreto**. Clique em **testar conexão** para garantir que o Azure ad possa se conectar ao Juno Journey. Se a conexão falhar, verifique se sua conta do Juno Journey tem permissões de administrador e tente novamente.
...
8. Na seção **mapeamentos** , selecione **sincronizar Azure Active Directory usuários para o Journey Juno**.

9. Examine os atributos de usuário que são sincronizados do Azure AD para o Journey Juno na seção de **mapeamento de atributo** . Os atributos selecionados como propriedades **correspondentes** são usados para corresponder as contas de usuário no Journey Juno para operações de atualização. Se você optar por alterar o [atributo de destino correspondente](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes), será necessário garantir que a API de jornada Juno suporte a filtragem de usuários com base nesse atributo. Selecione o botão **Salvar** para confirmar as alterações.
   ...
   |nome. MiddleName|Cadeia de caracteres|
   ...
   urn: IETF: params: SCIM: schemas: Extension: Enterprise: 2.0: User: Manager|Cadeia de caracteres|
...
11. Para habilitar o serviço de provisionamento do Azure AD para o Journey Juno, altere o **status de provisionamento** para **ativado** na seção **configurações** .

    ![Status do provisionamento ativado](common/provisioning-toggle-on.png)

12. Defina os usuários e/ou grupos que você deseja provisionar para o Journey Juno escolhendo os valores desejados no **escopo** na seção **configurações** .
