...
Para saber mais sobre a integração de aplicativos SaaS ao Azure AD, confira [O que é logon único?](https://docs.microsoft.com/azure/active-directory/manage-apps/what-is-single-sign-on).
...
Ao selecionar o bloco do Cloud Academy – SSO no Painel de Acesso, você deverá ser conectado automaticamente à instância do Cloud Academy – SSO para a qual você configurou o SSO. Para obter mais informações, confira [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Como proteger o Cloud Academy – SSO usando visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)