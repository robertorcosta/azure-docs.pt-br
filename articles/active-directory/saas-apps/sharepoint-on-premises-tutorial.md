...
1. Crie um provedor de identidade confiável no SharePoint Server 2016.
    ...
    > [!TIP]
    > Se você for novo no uso do PowerShell ou se quiser saber mais sobre como funciona o PowerShell, veja [PowerShell do SharePoint](/powershell/sharepoint/overview?view=sharepoint-ps).
