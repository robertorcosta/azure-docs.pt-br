...
Ao clicar no bloco do Salesforce Sandbox no Painel de Acesso, você deverá ser conectado automaticamente ao Salesforce Sandbox no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [O que é controle de sessão no Microsoft Cloud App Security?](/cloud-app-security/protect-salesforce)

- [Configurar Provisionamento de Usuário](salesforce-sandbox-provisioning-tutorial.md)

- [Como proteger o Salesforce Sandbox com visibilidade e controles avançados](/cloud-app-security/proxy-intro-aad)