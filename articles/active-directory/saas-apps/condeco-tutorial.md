...
* Você pode permitir que seus usuários entrem automaticamente no Condeco (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Condeco
...
4. Na caixa de pesquisa, digite **Condeco**, selecione **Condeco** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Condeco.
...
2. **[Configurar o logon único do Condeco](#configure-condeco-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Condeco](#create-condeco-test-user)** – para ter um equivalente de Brenda Fernandes no Condeco que esteja vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Condeco**, clique em **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único em Domínio e URLs do Condeco](common/sp-signonurl.png)
...
### <a name="configure-condeco-single-sign-on"></a>Configurar o logon único do Condeco
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, selecione **Condeco**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Condeco**.

    ![O link do Condeco na lista de Aplicativos](common/all-applications.png)
...
Ao clicar no bloco do Condeco no Painel de Acesso, você deverá ser conectado automaticamente ao Condeco no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
