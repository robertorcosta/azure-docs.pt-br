...
* Você pode controlar no Azure AD quem tem acesso ao Klue.
* Você pode permitir que os usuários sejam conectados automaticamente ao Klue (logon único) com suas contas do Azure AD.
...
Nesta seção, você configurará e testará o logon único do Azure AD com o Klue, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Klue.
...
2. **[Configurar o logon único do Klue](#configure-klue-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Klue](#create-klue-test-user)** – para ter um equivalente de Brenda Fernandes no Klue que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Klue**, selecione **Logon único**.
...
9. Na seção **Configurar o Klue**, copie as URLs apropriadas de acordo com suas necessidades.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Klue**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Klue**.

    ![O link do Klue na lista Aplicativos](common/all-applications.png)
...
Nesta seção, um usuário chamado Brenda Fernandes será criado no Klue. O Klue dá suporte ao o provisionamento de usuário just-in-time, que está habilitado por padrão. Não há itens de ação para você nesta seção. Se um usuário ainda não existir no Klue, um novo será criado após a autenticação.
