---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Foodee | Microsoft Docs'
...
ms.locfileid: "92451916"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-foodee"></a>Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Foodee
...
* O Foodee dá suporte ao SSO iniciado por **SP e IdP**
* O Foodee dá suporte ao provisionamento de usuário **Just-In-Time**
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-foodee"></a>Configurar e testar o logon único do Azure AD para o Foodee
...
1. **[Configurar o SSO do Foodee](#configure-foodee-sso)** – para definir as configurações de logon único no lado do aplicativo.
...
Nesta seção, você permitirá que B.Fernandes use o logon único do Azure permitindo acesso ao Foodee.
...
### <a name="configure-foodee-sso"></a>Configurar o SSO do Foodee

1. Para automatizar a configuração no Foodee, é necessário instalar a **extensão do navegador Entrada Segura dos Meus Aplicativos** clicando em **Instalar a extensão**.

    ![Extensão Meus Aplicativos](common/install-myappssecure-extension.png)

2. Após a adição da extensão ao navegador, um clique em **Configurar o Foodee** direcionará você ao aplicativo Foodee. Nele, forneça as credenciais de administrador para entrar no Foodee. A extensão do navegador configurará automaticamente o aplicativo e automatizará as etapas de 3 a 4.

    ![Configuração da instalação](common/setup-sso.png)

3. Caso deseje configurar o Foodee manualmente, abra uma nova janela do navegador da Web, entre em seu site de empresa do Foodee como administrador e execute as seguintes etapas:
...
Ao clicar no bloco do Foodee no Painel de Acesso, você deverá ser conectado automaticamente ao Foodee, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Experimentar o Foodee com o Azure AD](https://aad.portal.azure.com/)