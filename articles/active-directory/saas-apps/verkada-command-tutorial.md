...
Ao clicar no bloco do Verkada Command no Painel de Acesso, você deverá ser automaticamente conectado ao Verkada Command, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
