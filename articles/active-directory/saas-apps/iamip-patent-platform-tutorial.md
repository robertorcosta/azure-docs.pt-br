...
* Controlar no Azure AD quem tem acesso ao IamIP Patent Platform.
...
* Assinatura habilitada para SSO (logon único) do IamIP Patent Platform.

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o SSO do Azure AD em um ambiente de teste.

* O IamIP Patent Platform dá suporte ao SSO iniciado por **SP e IdP**
...
## <a name="adding-iamip-patent-platform-from-the-gallery"></a>Como adicionar o IamIP Patent Platform por meio da galeria
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-iamip-patent-platform"></a>Configurar e testar o logon único do Azure AD para o IamIP Patent Platform

Configure e teste o SSO do Azure AD com o IamIP Patent Platform usando um usuário de teste chamado **B.Fernandes**. Para que o SSO funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no IamIP Patent Platform.

Para configurar e testar o SSO do Azure AD com o IamIP Patent Platform, conclua os seguintes blocos de construção:

1. **[Configurar o SSO do Azure AD](#configure-azure-ad-sso)** – para permitir que os usuários usem esse recurso.
    * **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** para testar o logon único do Azure AD com B.Fernandes.
    * **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que B.Fernandes use o logon único do Azure AD.
1. **[Configurar o SSO do IamIP Patent Platform](#configure-iamip-patent-platform-sso)** : para definir as configurações de logon único no lado do aplicativo.
    * **[Criar um usuário de teste do IamIP Patent Platform](#create-iamip-patent-platform-test-user)** : para ter um equivalente de B.Fernandes no IamIP Patent Platform que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **IamIP Patent Platform**, localize a seção **Gerenciar** e selecione **Logon único**.
...
1. Clique em **Definir URLs adicionais** e execute o passo seguinte se quiser configurar a aplicação no modo **SP** iniciado:
    ...
    Na caixa de texto **URL de Logon**, digite a URL: `https://patents.iamip.com/login-user`
...
Nesta seção, você permitirá que B.Fernandes use o logon único do Azure permitindo acesso ao IamIP Patent Platform.
...
Para configurar o logon único no lado do **IamIP Patent Platform**, é necessário enviar o **Certificado (Bruto)** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do IamIP Patent Platform](mailto:info@iamip.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.

### <a name="create-iamip-patent-platform-test-user"></a>Criar um usuário de teste do IamIP Patent Platform

Nesta seção, você criará um usuário chamado B.Fernandes no IamIP Patent Platform. Trabalhe com a [equipe de suporte do IamIP Patent Platform](mailto:info@iamip.com) para adicionar os usuários à plataforma IamIP Patent Platform. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do IamIP Patent Platform no Painel de Acesso, você deverá ser conectado automaticamente ao IamIP Patent Platform, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
