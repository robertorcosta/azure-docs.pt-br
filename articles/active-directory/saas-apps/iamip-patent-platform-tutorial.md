...
Trabalhe com a equipe de suporte do [IamIP Patent Platform](mailto:info@iamip.com) para adicionar um usuário chamado B.Fernandes ao IamIP Patent Platform. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO

Nesta seção, você testará sua configuração de SSO do Azure AD usando o Painel de Acesso.

Ao selecionar o bloco do IamIP Patent Platform no Painel de Acesso, você deverá ser conectado automaticamente à instância do IamIP Patent Platform para a qual configurou o SSO. Para saber mais sobre o Painel de Acesso, confira [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
