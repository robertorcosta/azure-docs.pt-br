...
description: Saiba como provisionar e desprovisionar automaticamente as contas de usuário do Azure AD para o Zapier.
...
Este tutorial descreve as etapas que você precisa executar tanto no Zapier quanto no Azure Active Directory (Azure AD) para configurar o provisionamento automático de usuário. Quando configurado, o Azure AD provisiona e desprovisiona automaticamente usuários e grupos para [Zapier](https://zapier.com/pricing) usando o serviço de provisionamento do Azure AD. Para detalhes importantes sobre o que esse serviço faz, como funciona e as perguntas frequentes, consulte [Automatizar o provisionamento e desprovisionamento de usuários para aplicativos SaaS com o Azure Active Directory](../manage-apps/user-provisioning.md). 


## <a name="capabilities-supported"></a>Funcionalidades com suporte
> [!div class="checklist"]
> * Criar usuários no Zapier
> * Remover usuários no Zapier quando eles não exigem mais acesso
> * Manter os atributos de usuário sincronizados entre o Azure AD e o Zapier
> * Provisionar grupos e associações de grupo no Zapier
...
3. Determine quais dados [mapeados entre o Azure AD e o Zapier](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
1. Entre no console do [administrador do Zapier](https://zapier.com/app/login/). Navegue até **configurações** na ID do locatário.
...
3. Copie a **URL base scim** e o **token de portador scim**. Esses valores serão inseridos nos campos URL do locatário e token secreto, respectivamente, na guia provisionamento do aplicativo Zapier na portal do Azure.

    ![Zapier criar token](media/zapier-provisioning-tutorial/token.png)

## <a name="step-3-add-zapier-from-the-azure-ad-application-gallery"></a>Etapa 3. Adicionar o Zapier da Galeria de aplicativos do Azure AD

Adicione o Zapier da Galeria de aplicativos do Azure AD para começar a gerenciar o provisionamento no Zapier. Se você tiver configurado anteriormente o Zapier para SSO, poderá usar o mesmo aplicativo. No entanto, é recomendável que você crie um aplicativo separado ao testar a integração inicialmente. Saiba mais sobre como adicionar um aplicativo da Galeria [aqui](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
## <a name="step-5-configure-automatic-user-provisioning-to-zapier"></a>Etapa 5. Configurar o provisionamento automático de usuário para o Zapier 
...
### <a name="to-configure-automatic-user-provisioning-for-zapier-in-azure-ad"></a>Para configurar o provisionamento automático de usuário para Zapier no Azure AD:
...
2. Na lista de aplicativos, selecione **Zapier**.
   ...
   ![O link do Zapier na lista de aplicativos](common/all-applications.png)
...
8. Na seção **mapeamentos** , selecione **sincronizar Azure Active Directory usuários para Zapier**.

9. Examine os atributos de usuário que são sincronizados do Azure AD para o Zapier na seção de **mapeamento de atributo** . Os atributos selecionados como propriedades **correspondentes** são usados para corresponder as contas de usuário no Zapier para operações de atualização. Se você optar por alterar o [atributo de destino correspondente](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes), será necessário garantir que a API Zapier dê suporte à filtragem de usuários com base nesse atributo. Selecione o botão **Salvar** para confirmar as alterações.
...
10. Na seção **mapeamentos** , selecione **sincronizar grupos de Azure Active Directory para Zapier**.

11. Examine os atributos de grupo que são sincronizados do Azure AD para o Zapier na seção de **mapeamento de atributo** . Os atributos selecionados como propriedades **correspondentes** são usados para corresponder os grupos no Zapier para operações de atualização. Selecione o botão **Salvar** para confirmar as alterações.
...
13. Para habilitar o serviço de provisionamento do Azure AD para o Zapier, altere o **status de provisionamento** para **ativado** na seção **configurações** .

    ![Status do provisionamento ativado](common/provisioning-toggle-on.png)

14. Defina os usuários e/ou grupos que você deseja provisionar para o Zapier escolhendo os valores desejados no **escopo** na seção **configurações** .
