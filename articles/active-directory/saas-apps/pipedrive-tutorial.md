...
1. Clique em **Perfil do Usuário** e selecione **Configurações**.
    ...
    ![Configuração do Pipedrive](./media/pipedrive-tutorial/configure1.png)

1. Role para baixo até a central de segurança e selecione **Logon único**.

    ![Configuração do Pipedrive](./media/pipedrive-tutorial/configure2.png)

1. Na seção **Configuração SAML para Pipedrive**, execute as seguintes etapas:

    ![Configuração do Pipedrive](./media/pipedrive-tutorial/configure3.png)
...
1. Role para baixo até empresa e selecione **gerenciar usuários**.
    ...
    ![Configuração do Pipedrive](./media/pipedrive-tutorial/user1.png)

1. Clique em **Adicionar usuários**.
    
    ![Configuração do Pipedrive](./media/pipedrive-tutorial/user2.png)
...
Ao clicar no bloco do Pipedrive no Painel de Acesso, você será conectado automaticamente ao aplicativo Pipedrive para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
