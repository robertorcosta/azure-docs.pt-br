...
4. Clique em **Admin**.
    ...
    ![A captura de tela mostra Administrador selecionado no site do XaitPorter.](./media/xaitporter-tutorial/user1.png)

5. Selecione **Gerenciar Logon Único** na lista suspensa **Configuração do Sistema**.

    ![A captura de tela mostra a opção Gerenciar Logon Único selecionada em Configurações do Sistema.](./media/xaitporter-tutorial/user2.png)

6. Na seção **GERENCIAR LOGON ÚNICO**, execute as seguintes etapas:

    ![A captura de tela mostra a seção GERENCIAR LOGON ÚNICO na qual você pode executar essas etapas.](./media/xaitporter-tutorial/user3.png)
...
Ao clicar no bloco do XaitPorter no Painel de Acesso, você deverá ser conectado automaticamente ao XaitPorter no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
