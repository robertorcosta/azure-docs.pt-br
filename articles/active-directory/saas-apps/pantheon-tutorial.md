---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Pantheon | Microsoft Docs'
...
ms.locfileid: "92506523"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-pantheon"></a>Tutorial: Integração do SSO (logon único) do Azure Active Directory com o Pantheon

Neste tutorial, você aprenderá a integrar o Pantheon ao Azure AD (Azure Active Directory). Ao integrar o Pantheon ao Azure AD, você pode:

* Controle no Azure AD quem tem acesso ao Pantheon.
* Permitir que os usuários sejam conectados automaticamente ao Pantheon com suas contas do Azure AD.
...
* Assinatura do Pantheon habilitada para SSO (logon único).
...
1. Na seção **Adicionar da por meio da galeria** , digite **Pantheon** na caixa de pesquisa.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-pantheon"></a>Configurar e testar logon único do Azure AD para o Pantheon

Configure e teste o SSO do Azure AD com o Pantheon com um usuário de teste chamado **B.Fernandes** . Para que o SSO funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Pantheon.
...
1. **[Configurar o SSO do Pantheon](#configure-pantheon-sso)** – para definir as configurações de logon único no lado do aplicativo.
    1. **[Criar um usuário de teste do Pantheon](#create-pantheon-test-user)** – para ter um equivalente de B.Fernandes no Pantheon que esteja vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Pantheon** , localize a seção **Gerenciar** e selecione **Logon único** .
...
1. Na seção **Configurar o Pantheon** , copie as URLs apropriadas de acordo com suas necessidades.
...
Nesta seção, você permitirá que B.Fernandes use o logon único do Azure concedendo a ela acesso ao Pantheon.
...
Nesta seção, você criará um usuário chamado B.Fernandes no Pantheon. Siga as etapas a seguir para adicionar o usuário ao Pantheon. 
...
Ao clicar no bloco do Pantheon no Painel de Acesso, você será conectado automaticamente ao aplicativo Pantheon para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Avaliar o Pantheon com o Azure AD](https://aad.portal.azure.com/)