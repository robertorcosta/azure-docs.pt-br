...
3. Determine quais dados [mapear entre o treinamento de reconhecimento de segurança do Azure AD e o Webroot](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
Adicione treinamento de reconhecimento de segurança do Webroot da Galeria de aplicativos do Azure AD para começar a gerenciar o provisionamento para o treinamento de reconhecimento de segurança do Webroot. Saiba mais sobre como adicionar um aplicativo da galeria [aqui](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
9. Examine os atributos de usuário que são sincronizados do Azure AD para treinamento de reconhecimento de segurança do Webroot na seção de **mapeamento de atributos** . Os atributos selecionados como propriedades **correspondentes** são usados para corresponder as contas de usuário no treinamento de reconhecimento de segurança do Webroot para operações de atualização. Se você optar por alterar o [atributo de destino correspondente](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes), será necessário garantir que a API de treinamento de reconhecimento de segurança do Webroot dê suporte à filtragem de usuários com base nesse atributo. Selecione o botão **Salvar** para confirmar as alterações.
