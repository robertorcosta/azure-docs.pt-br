---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Blink | Microsoft Docs'
...
ms.locfileid: "92457003"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-blink"></a>Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Blink
...
Ao clicar no bloco do Blink no Painel de Acesso, você deverá ser conectado automaticamente ao Blink em que configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
