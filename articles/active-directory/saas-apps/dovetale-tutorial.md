---
title: 'Tutorial: Integração do Azure Active Directory ao Dovetale | Microsoft Docs'
...
ms.locfileid: "73157282"
---
# <a name="tutorial-azure-active-directory-integration-with-dovetale"></a>Tutorial: Integração do Azure Active Directory ao Dovetale
...
* Você pode permitir que os usuários sejam conectados automaticamente ao Dovetale (logon único) com suas contas do Azure AD.
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Dovetale.
...
2. **[Configurar o logon único do Dovetale](#configure-dovetale-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Dovetale](#create-dovetale-test-user)** – para ter um equivalente de Brenda Fernandes no Dovetale que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Dovetale**, selecione **Logon único**.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Dovetale**.
