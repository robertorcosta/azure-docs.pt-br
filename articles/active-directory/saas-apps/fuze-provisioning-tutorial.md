...
> * [Logon único](./fuze-tutorial.md) no Fuze (recomendado)
...
3. Determine quais dados [mapeados entre o Azure AD e o Fuze](../app-provisioning/customize-application-attributes.md). 
