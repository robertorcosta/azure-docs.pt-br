---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Vtiger CRM (SAML) | Microsoft Docs'
...
ms.locfileid: "92519275"
---
# <a name="tutorial-integrate-vtiger-crm-saml-with-azure-active-directory"></a>Tutorial: Integrar o Vtiger CRM (SAML) ao Azure Active Directory
...
Ao selecionar o bloco Vtiger CRM (SAML) no Painel de Acesso, você deve ser conectado automaticamente ao Vtiger CRM (SAML) para o qual configurou o logon único. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
