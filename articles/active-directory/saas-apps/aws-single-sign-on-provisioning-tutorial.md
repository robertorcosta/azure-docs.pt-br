...
> * [Logon único]() para AWS único Sign-On
...
3. Determine quais dados [mapear entre o Azure AD e o logon único do AWS](../app-provisioning/customize-application-attributes.md). 
