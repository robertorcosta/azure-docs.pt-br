...
5. Na seção **credenciais de administrador** , insira a **URL do locatário&token secreto** de Velpic. (Você pode encontrar esses valores em sua conta do Velpic: **gerenciar** > **Integration** > **plug-in** > de integração**scim**)
