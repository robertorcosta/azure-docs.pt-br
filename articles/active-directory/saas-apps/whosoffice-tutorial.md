...
## <a name="configure-and-test-azure-ad-single-sign-on-for-whosoffice"></a>Configurar e testar o logon único do Azure AD para o WhosOffice
...
Para configurar e testar o SSO do Azure AD com o WhosOffice, conclua os seguintes blocos de construção:
...
1. **[Configurar o SSO do WhosOffice](#configure-whosoffice-sso)** : para definir as configurações de logon único no lado do aplicativo.
    * **[Criar um usuário de teste do WhosOffice](#create-whosoffice-test-user)** – para ter um equivalente de B.Fernandes no WhosOffice que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **WhosOffice**, localize a seção **Gerenciar** e selecione **Logon único**.
...
1. Clique em **Configurações** e selecione **Empresa**.
    ...
    ![Configuração do WhosOffice](./media/whosoffice-tutorial/configuration1.png)

1. Clique em **Aplicativos/Integrações**.

    ![Configuração do WhosOffice](./media/whosoffice-tutorial/configuration2.png)

1. Selecione **Microsoft Azure** na lista suspensa de provedores e clique em **Ativar Provedor de Logon**.

    ![Configuração do WhosOffice](./media/whosoffice-tutorial/configuration3.png)

1. Carregue o arquivo de metadados de federação baixado do portal do Azure clicando na opção **Carregar**.
    
    ![Configuração do WhosOffice](./media/whosoffice-tutorial/configuration4.png)
...
1. Clique em **Configurações** e selecione **Usuários**.
    ...
    ![Configuração do WhosOffice](./media/whosoffice-tutorial/user1.png)

1. Selecione **Criar Usuário**.

    ![Configuração do WhosOffice](./media/whosoffice-tutorial/user2.png)

1. Forneça os detalhes necessários do usuário de acordo com o requisito da sua organização.

    ![Configuração do WhosOffice](./media/whosoffice-tutorial/user3.png)

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do WhosOffice no Painel de Acesso, você deverá ser conectado automaticamente ao WhosOffice, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Experimentar o WhosOffice com o Azure AD](https://aad.portal.azure.com/)
