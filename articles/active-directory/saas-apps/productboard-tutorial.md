---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao productboard | Microsoft Docs'
...
Neste tutorial, você aprenderá a integrar o productboard ao Azure AD (Azure Active Directory). Ao integrar o productboard ao Azure AD, você poderá:

* Controlar no Azure AD quem tem acesso ao productboard.
* Permitir que os usuários sejam conectados automaticamente ao productboard com suas contas do Azure AD.
...
* O productboard dá suporte ao SSO iniciado por **SP e IdP**
* O productboard dá suporte ao provisionamento de usuário **just-in-time**

## <a name="adding-productboard-from-the-gallery"></a>Como adicionar o productboard por meio da galeria

Para configurar a integração do productboard ao Azure AD, você precisará adicionar o productboard por meio da galeria à lista de aplicativos SaaS gerenciados.

1. Entre no [portal do Azure](https://portal.azure.com) usando uma conta corporativa ou de estudante ou uma conta pessoal da Microsoft.
1. No painel de navegação esquerdo, escolha o serviço **Azure Active Directory**.
1. Navegue até **Aplicativos Empresariais** e, em seguida, escolha **Todos os Aplicativos**.
1. Para adicionar um novo aplicativo, escolha **Novo aplicativo**.
1. Na seção **Adicionar por meio da galeria**, digite **productboard** na caixa de pesquisa.
...
Configure e teste o SSO do Azure AD com o productboard usando um usuário de teste chamado **B.Fernandes**. Para que o SSO funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do productboard.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **productboard**, localize a seção **Gerenciar** e selecione **Logon único**.
...
Nesta seção, você permitirá que B.Fernandes use o logon único do Azure permitindo a ela acesso ao productboard.
...
Ao clicar no bloco do productboard no Painel de Acesso, você deverá ser conectado automaticamente ao productboard, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
