...
## <a name="configure-and-test-azure-ad-sso-for-elium"></a>Configurar e testar o SSO do Azure AD para o Elium
...
1. No portal do Azure, na página de integração de aplicativos do **Elium**, localize a seção **Gerenciar** e selecione **logon único**.
...
1. Clique no **Perfil do usuário** no canto superior direito e selecione **Configurações**.

    ![Configurar o logon único do Elium 01](./media/elium-tutorial/elium-01.png)

1. Selecione **Segurança** em **Avançado**.

    ![Configurar o logon único do Elium 02](./media/elium-tutorial/elium-02.png)

1. Role até a seção **Logon único (SSO)** e execute as seguintes etapas:

    ![Configurar o logon único do Elium 03](./media/elium-tutorial/elium-03.png)
    ...
    ![Configurar o logon único do Elium 04](./media/elium-tutorial/elium-04.png)
    ...
    ![Configurar o logon único do Elium 05](./media/elium-tutorial/elium-05.png)
...
* Clique em **Testar este aplicativo** no portal do Azure. Isso redirecionará você para a URL de Logon do Elium, na qual poderá iniciar o fluxo de logon.  
 
* Acesse a URL de Logon do Elium diretamente e inicie o fluxo de logon nela.
 
#### <a name="idp-initiated"></a>Iniciado por IdP:
 
* Clique em **Testar este aplicativo** no portal do Azure e entre automaticamente no Elium, para o qual configurou o SSO 
 
Use também o Painel de Acesso da Microsoft para testar o aplicativo em qualquer modo. Quando você clicar no bloco Elium no Painel de Acesso, se ele estiver configurado no modo SP, você será redirecionado para a página de logon do aplicativo para iniciar o fluxo de logon e, se ele estiver configurado no modo IDP, você será conectado automaticamente ao Elium para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Próximas etapas

Depois de configurar o Elium, você poderá impor o controle de sessão, que protege contra exfiltração e infiltração de dados confidenciais de sua organização em tempo real. O controle da sessão é estendido do acesso condicional. [Saiba como impor o controle de sessão com o Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).