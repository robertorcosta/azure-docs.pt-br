...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **SurveyMonkey Enterprise** , localize a seção **Gerenciar** e selecione **Logon único** .
...
Ao clicar no bloco do SurveyMonkey Enterprise no Painel de Acesso, você deverá ser conectado automaticamente ao SurveyMonkey Enterprise, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Experimentar o SurveyMonkey Enterprise com o Azure AD](https://aad.portal.azure.com/)