...
Nesta seção, você criará um usuário chamado Brenda Fernandes no GTNexus SSO System. Trabalhe com a [equipe de suporte do GTNexus SSO System](mailto:support@gtnexus.com) para adicionar os usuários à plataforma do GTNexus SSO System. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do GTNexus SSO System no Painel de Acesso, você deverá ser conectado automaticamente ao GTNexus SSO System, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
