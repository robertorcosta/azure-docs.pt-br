...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Cyara CX Assurance Platform. Trabalhe com a equipe de suporte do [Cyara CX Assurance Platform](mailto:support@cyara.com) para adicionar os usuários à plataforma do Cyara CX Assurance Platform. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco Cyara CX Assurance Platform no Painel de Acesso, você deverá entrar automaticamente no Cyara CX Assurance Platform para a qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Como proteger o Cyara CX Assurance Platform com visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)