...
Para obter mais informações sobre a integração de aplicativo SaaS ao Azure AD, confira [Logon único em aplicativos no Azure AD](../manage-apps/what-is-single-sign-on.md).
