...
> * [Logon único](./iprova-tutorial.md) no iProva (recomendado)
...
3. Determine quais dados [mapeados entre o Azure AD e o iProva](../app-provisioning/customize-application-attributes.md). 
