---
title: 'Tutorial: Integração do Azure Active Directory ao ProNovos Ops Manager | Microsoft Docs'
...
Ao clicar no bloco do ProNovos Ops Manager no Painel de Acesso, você deverá entrar automaticamente no ProNovos Ops Manager para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
