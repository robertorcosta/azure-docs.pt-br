...
1. Na página **Configurar o Logon Único com SAML** , na seção **Certificado de Autenticação SAML** , localize **XML de Metadados de Federação** e clique em **Baixar** para baixar o certificado e salvá-lo no computador.
...
Ao clicar no bloco do Land Gorilla no Painel de Acesso, você deverá ser conectado automaticamente ao Land Gorilla no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
