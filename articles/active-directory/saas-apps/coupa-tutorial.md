...
Neste tutorial, você aprenderá a integrar o Coupa ao Azure AD (Azure Active Directory). Ao integrar o Coupa ao Azure AD, você poderá:

* Controlar no Azure AD quem tem acesso ao Coupa.
* Permitir que os usuários sejam conectados automaticamente ao Coupa com as respectivas contas do Azure AD.
...
## <a name="add-coupa-from-the-gallery"></a>Adicionar o Coupa por meio da galeria
...
1. Na seção **Adicionar por meio da galeria**, digite **Coupa** na caixa de pesquisa.
1. Selecione **Coupa** no painel de resultados e adicione o aplicativo. Aguarde alguns segundos enquanto o aplicativo é adicionado ao seu locatário.

## <a name="configure-and-test-azure-ad-sso-for-coupa"></a>Configurar e testar o SSO do Azure AD para o Coupa

Configure e teste o SSO do Azure AD com o Coupa usando um usuário de teste chamado **B.Fernandes**. Para que o SSO funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no Coupa.

Para configurar e testar o SSO do Azure AD com o Coupa, execute as seguintes etapas:

1. **[Configurar o SSO do Azure AD](#configure-azure-ad-sso)** – para permitir que os usuários usem esse recurso.
    1. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** para testar o logon único do Azure AD com B.Fernandes.
    1. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que B.Fernandes use o logon único do Azure AD.
1. **[Configurar o SSO do Coupa](#configure-coupa-sso)** : para definir as configurações de logon único no lado do aplicativo.
...
1. No portal do Azure, na página de integração de aplicativos do **Coupa**, localize a seção **Gerenciar** e selecione **Logon único**.
...
1. Entre no site da empresa do **Coupa** como administrador.
...
* Clique em **Testar este aplicativo** no portal do Azure. Isso redirecionará você para a URL de Logon do Coupa, na qual poderá iniciar o fluxo de logon. 
