...
* Você pode permitir que os usuários sejam conectados automaticamente ao SSO de SAML do Insignia (logon único) com as respectivas contas do Azure AD.
...
* Assinatura do SSO de SAML do Insignia habilitada para logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O SSO de SAML do Insignia é compatível com SSO iniciado por **SP**
...
Nesta seção, você configurará e testará o logon único do Azure AD com o SSO de SAML do Insignia, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do SSO de SAML do Insignia.
...
2. **[Configurar o logon único do SSO de SAML do Insignia](#configure-insignia-saml-sso-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do SSO de SAML do Insignia](#create-insignia-saml-sso-test-user)** – para ter um equivalente de Brenda Fernandes no Insignia SAML SSO que esteja vinculado à representação do usuário no Azure AD.
...
Para configurar o logon único do Azure AD com o SSO de SAML do Insignia, execute as etapas abaixo:

1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **SSO de SAML do Insignia**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único em Domínio e URLs do Insignia SAML SSO](common/sp-identifier.png)
...
6. Na seção **Configurar o SSO de SAML do Insignia**, copie as URLs apropriadas de acordo com suas necessidades.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, selecione **SSO de SAML do Insignia**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Insignia SAML SSO**.

    ![O link do Insignia SAML SSO na lista de Aplicativos](common/all-applications.png)
...
Ao clicar no bloco do SSO de SAML do Insignia no Painel de Acesso, você deverá ser conectado automaticamente ao SSO de SAML do Insignia para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
