...
* Você pode permitir que os usuários sejam conectados automaticamente ao Carlson Wagonlit Travel (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Carlson Wagonlit Travel

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O Carlson Wagonlit Travel dá suporte ao SSO iniciado por **IDP**
...
Nesta seção, você configurará e testará o logon único do Azure AD com o Carlson Wagonlit Travel, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Carlson Wagonlit Travel.
...
2. **[Configurar o logon único do Carlson Wagonlit Travel](#configure-carlson-wagonlit-travel-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Carlson Wagonlit Travel](#create-carlson-wagonlit-travel-test-user)** – para ter um equivalente de Brenda Fernandes no Carlson Wagonlit Travel que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Carlson Wagonlit Travel**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único em Domínio e URLs do Carlson Wagonlit Travel](common/idp-identifier.png)
...
6. Na seção **Configurar o Carlson Wagonlit Travel**, copie as URLs apropriadas de acordo com suas necessidades.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Carlson Wagonlit Travel**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Carlson Wagonlit Travel**.

    ![O link Carlson Wagonlit Travel na lista de aplicativos](common/all-applications.png)
...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Carlson Wagonlit Travel. Trabalhe com a [equipe de suporte do Carlson Wagonlit Travel](http://www.carlsonwagonlit.in/content/cwt/in/en/technical-assistance.html) para adicionar os usuários à plataforma Carlson Wagonlit Travel. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Carlson Wagonlit Travel no Painel de Acesso, você deverá ser conectado automaticamente ao Carlson Wagonlit Travel, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
