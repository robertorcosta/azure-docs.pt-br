...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no eDigitalResearch. Trabalhe com a [equipe de suporte do eDigitalResearch](https://www.maruedr.com/contact) para adicionar os usuários na plataforma do eDigitalResearch. Os usuários devem ser criados e ativados antes de usar o logon único.
...
Ao clicar no bloco do eDigitalResearch no Painel de Acesso, você deverá ser conectado automaticamente ao eDigitalResearch, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
