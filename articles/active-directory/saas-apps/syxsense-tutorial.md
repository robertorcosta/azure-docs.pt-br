...
1. Clique no **Ícone de Configurações**.
    ...
    ![Configuração do Syxsense](./media/syxsense-tutorial/configure1.png)
...
1. Clique em **Autenticação Externa** e forneça o valor da **URL de metadados de federação do aplicativo** na caixa de texto **Metadados SAML 2.0** e clique em **Salvar**.
    ...
    ![Configuração do Syxsense](./media/syxsense-tutorial/configure2.png)
...
1. Clique em **Contas de Usuário** no painel de navegação à esquerda.
    ...
    ![Configuração do Syxsense](./media/syxsense-tutorial/user1.png)

1. Clique em **Adicionar**.

    ![Configuração do Syxsense](./media/syxsense-tutorial/user2.png)

1. Forneça os detalhes do usuário de acordo com os requisitos da sua organização e clique em **Salvar**.

    ![Configuração do Syxsense](./media/syxsense-tutorial/user3.png)

## <a name="test-sso"></a>Testar o SSO

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Syxsense no Painel de Acesso, você deverá ser conectado automaticamente ao Syxsense, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Como proteger o Syxsense com visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
