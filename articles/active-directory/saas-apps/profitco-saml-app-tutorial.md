...
Ao selecionar o bloco do Profit.co no Painel de Acesso, você deverá ser conectado automaticamente ao Profit.co, para o qual você configurou o SSO. Para obter mais informações, confira [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Como proteger o Profit.co com visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)