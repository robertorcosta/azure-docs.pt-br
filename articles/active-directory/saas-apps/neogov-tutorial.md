...
Nesta seção, você criará um usuário com o nome B.Fernandes no NEOGOV. Trabalhe com a  [equipe de suporte do NEOGOV](mailto:itops@neogov.net) para adicionar os usuários à plataforma NEOGOV. Os usuários devem ser criados e ativados antes de usar o logon único.
