...
* Você pode usar os Meus Aplicativos da Microsoft. Ao clicar no bloco do Expensify em Meus Aplicativos, isso redirecionará você à URL de Logon do Expensify. Para obter mais informações sobre os Meus Aplicativos, confira [Introdução aos Meus Aplicativos](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
