...
| :--- | :--- | :--- |
| ![logotipo – Atlassian Cloud](./media/tutorial-list/active-directory-saas-atlassian-cloud-tutorial.png)| [Atlassian Cloud](atlassian-cloud-tutorial.md)| [Atlassian Cloud – Provisionamento de Usuário](atlassian-cloud-provisioning-tutorial.md)|
...
| ![logotipo – Slack](./media/tutorial-list/active-directory-saas-slack-tutorial.png)| [Margem de atraso](slack-tutorial.md)|[Slack – Provisionamento de Usuário](slack-provisioning-tutorial.md)|
...
## <a name="cloud-integrations"></a>Cloud Integrations

| Logotipo | Tutorial do aplicativo para logon único | Tutorial do aplicativo para provisionamento de usuário |
| :--- | :--- | :--- |
| ![logotipo – Console do AWS (Amazon Web Services)](./media/tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Console do AWS (Amazon Web Services)](amazon-web-service-tutorial.md)| [Console do AWS (Amazon Web Services) – Provisionamento de Funções](amazon-web-service-tutorial.md#configure-azure-ad-sso) |
| ![logotipo – Alibaba Cloud Service (SSO baseado em função)](./media/tutorial-list/active-directory-saas-alibaba-tutorial.png)| [Alibaba Cloud Service (SSO baseado em função)](alibaba-cloud-service-role-based-sso-tutorial.md)| |
| ![logotipo – Google Cloud Platform](./media/tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Google Cloud Platform](google-apps-tutorial.md)| [Google Cloud Platform – Provisionamento de Usuário](g-suite-provisioning-tutorial.md) |
...
| ![logotipo – SAP Cloud Identity Platform](./media/tutorial-list/active-directory-saas-sapboc-tutorial.png)| [SAP Cloud Identity Platform](saphana-tutorial.md)|[SAP Cloud Identity Platform – Provisionamento](./sap-cloud-platform-identity-authentication-provisioning-tutorial.md) |
...
| ![logotipo – Adobe Identity Management](./media/tutorial-list/active-directory-saas-adobe-identity-management-tutorial.png)| [Gerenciamento de identidade do Adobe](adobe-identity-management-tutorial.md)|
| ![logotipo – Aha!](./media/tutorial-list/active-directory-saas-aha-tutorial.png)| [Aha!](aha-tutorial.md)|
| ![logotipo – AlertOps](./media/tutorial-list/active-directory-saas-alertops-tutorial.png)| [AlertOps](alertops-tutorial.md)|
...
| ![logotipo – DocuSign](./media/tutorial-list/active-directory-saas-docusign-tutorial.png)| [DocuSign](docusign-tutorial.md)|
...
| ![logotipo – ExpenseIn](./media/tutorial-list/active-directory-saas-expensein-tutorial.png)| [ExpenseIn](expensein-tutorial.md)|
| ![logotipo – EZOfficeInventory](./media/tutorial-list/active-directory-saas-ezofficeinventory-tutorial.png)| [EZOfficeInventory](ezofficeinventory-tutorial.md)|
| ![logotipo – Foodee](./media/tutorial-list/active-directory-saas-foodee-tutorial.png)| [Foodee](foodee-tutorial.md)|
| ![logotipo – Freedcamp](./media/tutorial-list/active-directory-saas-freedcamp-tutorial.png)| [Freedcamp](freedcamp-tutorial.md)|
| ![logotipo – Freshservice](./media/tutorial-list/active-directory-saas-freshservice-tutorial.png)| [FreshService](freshservice-tutorial.md)|
| ![logotipo – Harness](./media/tutorial-list/active-directory-saas-harness-tutorial.png)| [Harness](harness-tutorial.md)|
...
| ![logotipo – Terraform Cloud](./media/tutorial-list/active-directory-saas-terraform-cloud-tutorial.png)| [Terraform Cloud](terraform-cloud-tutorial.md)|
| ![logotipo – TextMagic](./media/tutorial-list/active-directory-saas-textmagic-tutorial.png)| [TextMagic](textmagic-tutorial.md)|
| ![logotipo – SAML do Timeclock 365](./media/tutorial-list/active-directory-saas-timeclock-365-saml-tutorial.png)| [SAML do Timeclock 365](timeclock-365-saml-tutorial.md)|
...
| ![logotipo – Yodeck](./media/tutorial-list/active-directory-saas-yodeck-tutorial.png)| [Yodeck](yodeck-tutorial.md)|  
| ![logotipo – Zendesk](./media/tutorial-list/active-directory-saas-zendesk-tutorial.png)| [Zendesk](zendesk-tutorial.md)|  
| ![logotipo – Zoom](./media/tutorial-list/active-directory-saas-zoom-tutorial.png)| [Zoom](zoom-tutorial.md)|
| ![logotipo – Zscaler](./media/tutorial-list/active-directory-saas-zscaler-tutorial.png)| [Zscaler](zscaler-tutorial.md)|
| ![logotipo – Zscaler Beta](./media/tutorial-list/active-directory-saas-zscaler-beta-tutorial.png)| [Zscaler Beta](zscaler-beta-tutorial.md)|
| ![logotipo – Zscaler One](./media/tutorial-list/active-directory-saas-zscaler-one-tutorial.png)| [Zscaler One](zscaler-one-tutorial.md)|
| ![logotipo – ZPA (Zscaler Private Access)](./media/tutorial-list/active-directory-saas-zscalerprivateaccess-tutorial.png)| [Zscaler Private Access (ZPA)](zscalerprivateaccess-tutorial.md)|  
| ![logotipo – Zscaler Three](./media/tutorial-list/active-directory-saas-zscaler-three-tutorial.png)| [Zscaler Three](zscaler-three-tutorial.md)|
| ![logotipo – Zscaler Two](./media/tutorial-list/active-directory-saas-zscaler-two-tutorial.png)| [Zscaler Two](zscaler-two-tutorial.md)|  
| ![logotipo – Zscaler ZSCloud](./media/tutorial-list/active-directory-saas-zscaler-zscloud-tutorial.png)| [Zscaler ZSCloud](zscaler-zscloud-tutorial.md)|
