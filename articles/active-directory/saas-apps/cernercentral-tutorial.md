...
Ao clicar no bloco Cerner Central no Painel de Acesso, você deve ser conectado automaticamente ao Cerner Central no qual configurou o logon único. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
