...
Para saber mais sobre a integração de aplicativos SaaS (software como serviço) ao Azure AD, confira [O que é SSO (logon único)?](https://docs.microsoft.com/azure/active-directory/manage-apps/what-is-single-sign-on).
