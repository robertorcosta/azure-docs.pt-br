...
* Uma conta de usuário no Hoxhunt com permissões de administrador.
...
Para configurar o Hoxhunt para dar suporte ao provisionamento com o Azure AD, escreva um email para o suporte do Hoxhunt ( support@hoxhunt.com ).
Eles fornecerão o **token de autenticação** e a **URL do ponto de extremidade scim**.
