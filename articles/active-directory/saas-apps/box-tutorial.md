...
* Depois de configurar o Box, você poderá impor o controle de sessão, que fornece proteção contra exportação e infiltração dos dados confidenciais da sua organização em tempo real. O controle da sessão é estendido do acesso condicional. [Saiba como impor o controle de sessão com o Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad)
...
1. Na seção **Configuração Básica do SAML** , insira os valores para os seguintes campos:
    ...
    c. Na caixa de texto **URL de Resposta** , insira uma URL: `https://sso.services.box.net/sp/ACS.saml2`
...
Ao clicar no bloco do Box no Painel de Acesso, você deverá ser conectado automaticamente ao Box no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Como proteger o Box com visibilidade e controles avançados](/cloud-app-security/protect-box)