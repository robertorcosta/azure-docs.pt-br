...
* O Box é compatível com provisionamento e desprovisionamento de usuário [**automatizados**](./box-userprovisioning-tutorial.md) (recomendado)
...
## <a name="configure-and-test-azure-ad-sso-for-box"></a>Configurar e testar o SSO do Azure AD para o Box
...
Para configurar e testar o SSO do Azure AD com o Box, execute as seguintes etapas:
...
1. No portal do Azure, na página de integração de aplicativos do **Box**, localize a seção **Gerenciar** e selecione **Logon único**.
...
1. Na seção **Configuração Básica do SAML**, insira os valores para os seguintes campos:
    ...
    c. Na caixa de texto **URL de Resposta**, digite a URL: `https://sso.services.box.net/sp/ACS.saml2`
...
1. Para automatizar a configuração no Box, é necessário instalar a **extensão do navegador Entrada Segura dos Meus Aplicativos** clicando em **Instalar a extensão**.

    ![Extensão Meus Aplicativos](common/install-myappssecure-extension.png)

2. Depois de adicionar a extensão ao navegador, clicar em **Configurar caixa** o direcionará ao aplicativo Box. Nele, forneça as credenciais de administrador para entrar no Box. A extensão do navegador configurará automaticamente o aplicativo e automatizará a etapa 3.

    ![Configuração da instalação](common/setup-sso.png)

3. Se você quiser configurar a caixa manualmente, em outra janela do navegador da Web, entre no site da empresa Box como administrador e siga o procedimento em [Configurar o SSO por conta própria](https://community.box.com/t5/How-to-Guides-for-Admins/Setting-Up-Single-Sign-On-SSO-for-your-Enterprise/ta-p/1263#ssoonyourown).
...
* Clique em **Testar este aplicativo** no portal do Azure. Isso o redirecionará para a URL de Logon do Box, na qual você poderá iniciar o fluxo de logon.

* Acesse diretamente a URL de Logon do Box, na qual você iniciará o fluxo de logon.

* Você pode usar os Meus Aplicativos da Microsoft. Quando você clicar no bloco do Box em Meus Aplicativos, isso redirecionará você à URL de Logon do Box. Para obter mais informações sobre os Meus Aplicativos, confira [Introdução aos Meus Aplicativos](../user-help/my-apps-portal-end-user-access.md).


## <a name="next-steps"></a>Próximas etapas

Depois de configurar o Box, você poderá impor o controle de sessão, que fornece proteção contra exportação e infiltração dos dados confidenciais da sua organização em tempo real. O Controle de Sessão é estendido do acesso condicional. [Saiba como impor o controle de sessão com o Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad)