...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Clever Nelly. Trabalhe com a [equipe de suporte do Clever Nelly](mailto:support@elephantsdontforget.com) para adicionar os usuários na plataforma do Clever Nelly. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-sso"></a>Testar o SSO

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Clever Nelly no Painel de Acesso, você deverá ser conectado automaticamente ao Clever Nelly em que configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
