...
## <a name="configure-and-test-azure-ad-sso-for-easysso-for-bamboo"></a>Configurar e testar o SSO do Azure AD para o EasySSO for Bamboo
...
Para configurar e testar o SSO do Azure AD com o EasySSO for Bamboo, conclua estas etapas:
...
1. No portal do Azure, na página de integração do aplicativo **EasySSO for Bamboo**, localize a seção **Gerenciar** e selecione **logon único**.
...
1. Navegue até a seção **Gerenciar Aplicativos**. 
...
7. Para ter a melhor experiência de teste, navegue até a guia **Aparência** e habilite a opção **Botão de Logon SAML**. Isso habilitará o botão separado na tela de logon do Bamboo, especificamente para testar a integração do SAML do Azure AD de ponta a ponta. Deixe esse botão ativado e configure também seu posicionamento, sua cor e sua conversão no modo de produção.
...
Quando clicar no bloco do EasySSO para Bamboo em Meus Aplicativos, você deverá ser conectado automaticamente à instância do Bamboo para a qual configurou o SSO. Para obter mais informações sobre os Meus Aplicativos, confira [Introdução aos Meus Aplicativos](../user-help/my-apps-portal-end-user-access.md).
