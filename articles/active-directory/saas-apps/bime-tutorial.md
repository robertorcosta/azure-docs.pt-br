...
> [!NOTE]
> É possível usar qualquer outra ferramenta de criação da conta de usuário do Bime ou APIs fornecidas pelo Bime para provisionar as contas de usuário do Azure AD.
