...
2. Na barra de ferramentas na parte superior, clique em **Configuração** e, em seguida, selecione **Assinatura**.
...
3. Digite o nome na caixa de texto Novo Usuário e, em seguida, clique em **Adicionar com Detalhes**.
...
Ao clicar no bloco do Rally Software no Painel de Acesso, você deverá ser conectado automaticamente ao Rally Software para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
