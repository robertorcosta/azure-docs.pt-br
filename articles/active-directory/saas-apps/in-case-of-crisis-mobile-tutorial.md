...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no In Case of Crisis – Mobile. Trabalhe com a [equipe de suporte do In Case of Crisis – Mobile](https://www.rockdovesolutions.com/features/enterprise-ready) para adicionar os usuários na plataforma do In Case of Crisis – Mobile. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do In Case of Crisis – Mobile no Painel de Acesso, você deverá ser conectado automaticamente ao In Case of Crisis – Mobile, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
