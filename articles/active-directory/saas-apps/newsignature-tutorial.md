...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Portal de Gerenciamento de Nuvem para Microsoft Azure. Trabalhe com a [equipe de suporte do Portal de Gerenciamento de Nuvem para Microsoft Azure](mailto:jczernuszka@newsignature.com) para adicionar os usuários do Portal de Gerenciamento de Nuvem para a plataforma Microsoft Azure. Os usuários devem ser criados e ativados antes de usar o logon único.
