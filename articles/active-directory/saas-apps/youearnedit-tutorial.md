...
* Você pode permitir que seus usuários entrem automaticamente no YouEarnedIt (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do YouEarnedIt

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O YouEarnedIt é compatível com o SSO iniciado por **SP**
...
4. Na caixa de pesquisa, digite **YouEarnedIt**, selecione **YouEarnedIt** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![YouEarnedIt na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure AD com o YouEarnedIt, com base em um usuário de teste chamado **Branda Fernandes**.
Para que o logon único funcione, uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no YouEarnedIt precisa ser estabelecida.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **YouEarnedIt**, selecione **Logon único**.
...
6. Na seção **Configurar o YouEarnedIt**, copie as URLs apropriadas, de acordo com suas necessidades.
...
### <a name="configure-youearnedit-single-sign-on"></a>Configurar o logon único do YouEarnedIt

Para configurar o logon único no **YouEarnedIt**, é necessário enviar o **certificado (Base64)** baixado e as URLs apropriadas copiadas do portal do Azure para o gerenciador de Sucesso dos Clientes do YouEarnedIt. Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, escolha **Todos os aplicativos** e, em seguida, **YouEarnedIt**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, digite e selecione **YouEarnedIt**.

    ![O link YouEarnedIt na lista de aplicativos](common/all-applications.png)
...
### <a name="create-youearnedit-test-user"></a>Criar um usuário de teste do YouEarnedIt
...
Ao clicar no bloco do YouEarnedIt no painel de acesso, você será conectado automaticamente ao YouEarnedIt no qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
