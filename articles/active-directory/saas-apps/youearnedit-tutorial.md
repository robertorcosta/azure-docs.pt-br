---
title: 'Tutorial: Integração do Azure Active Directory ao YouEarnedIt | Microsoft Docs'
...
Ao clicar no bloco do YouEarnedIt no painel de acesso, você será conectado automaticamente ao YouEarnedIt no qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
