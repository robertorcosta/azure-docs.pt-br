...
Nesta seção, você criará uma usuária chamada B.Fernandes no Fastly Edge Cloud. Trabalhe com a [equipe de suporte do Fastly Edge Cloud](mailto:support@fastly.com) para adicionar os usuários à plataforma do Fastly Edge Cloud. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Fastly Edge Cloud no Painel de Acesso, você deverá ser conectado automaticamente ao Fastly Edge Cloud para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
