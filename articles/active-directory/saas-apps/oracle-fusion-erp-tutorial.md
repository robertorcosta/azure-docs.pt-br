...
Para configurar e testar o SSO do Azure AD com o Oracle Fusion ERP, execute as seguintes etapas:
...
1. No portal do Azure, na página de integração do aplicativo **Oracle Fusion ERP**, localize a seção **Gerenciar** e selecione **Logon único**.
...
* Clique em **Testar este aplicativo** no portal do Azure. Isso redirecionará você à URL de Logon do Oracle Fusion ERP na qual será possível iniciar o fluxo de logon. 

* Acesse diretamente a URL de Logon do Oracle Fusion ERP e inicie o fluxo de logon nela.

* Você pode usar os Meus Aplicativos da Microsoft. Quando você clicar no bloco do Oracle Fusion ERP em Meus Aplicativos, será redirecionado para a URL de Logon do Oracle Fusion ERP. Para obter mais informações sobre os Meus Aplicativos, confira [Introdução aos Meus Aplicativos](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Próximas etapas

Depois de configurar o Oracle Fusion ERP, você poderá impor um controle de sessão, que fornece proteção contra a exfiltração e infiltração dos dados confidenciais da sua organização em tempo real. O controle da sessão é estendido do acesso condicional. [Saiba como impor o controle de sessão com o Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).