...
## <a name="configure-and-test-azure-ad-single-sign-on-for-certent-equity-management"></a>Configurar e testar o logon único do Azure AD para o Certent Equity Management
...
Para configurar e testar o SSO do Azure AD com o Certent Equity Management, conclua os seguintes blocos de construção:
...
1. **[Configurar o SSO do Certent Equity Management](#configure-certent-equity-management-sso)** – para configurar o logon único no lado do aplicativo.
    * **[Criar um usuário de teste do Certent Equity Management](#create-certent-equity-management-test-user)** – para ter um equivalente de B. Fernandes no Certent Equity Management que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Certent Equity Management**, localize a seção **Gerenciar** e selecione **logon único**.
...
- [Experimentar o Certent Equity Management com o Azure AD](https://aad.portal.azure.com/)
