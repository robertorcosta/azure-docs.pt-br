...
## <a name="configure-and-test-azure-ad-single-sign-on-for-arc-publishing---sso"></a>Configurar e testar logon único do Azure AD para o Arc Publishing – SSO
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Arc Publishing – SSO** , localize a seção **Gerenciar** e selecione **Logon único** .
...
Ao clicar no bloco do Arc Publishing – SSO no Painel de Acesso, você deve ser conectado automaticamente ao Arc Publishing – SSO para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Avaliar o Arc Publishing – SSO com o Azure AD](https://aad.portal.azure.com/)