---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao ProNovos Analytics | Microsoft Docs'
...
ms.locfileid: "92505778"
---
# <a name="tutorial-tutorial-azure-active-directory-single-sign-on-sso-integration-with-pronovos-analytics"></a>Tutorial: Integração do SSO (logon único) do Azure Active Directory ao ProNovos Analytics
...
Ao clicar no bloco do ProNovos Analytics no Painel de Acesso, você deverá ser conectado automaticamente ao ProNovos Analytics, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
