...
2. No painel do Vidyard, selecione **Grupo** > **Segurança**
    ...
    ![A captura de tela mostra a opção Segurança selecionada em Grupo no site do Vidyard Software.](./media/vidyard-tutorial/configure1.png)

3. Clique na guia **Novo Perfil**.

    ![A captura de tela mostra o botão Novo Perfil.](./media/vidyard-tutorial/configure2.png)

4. Na seção **Configuração SAML**, execute as seguintes etapas:

    ![A captura de tela mostra a seção Configuração de SAML, em que você pode inserir os valores descritos.](./media/vidyard-tutorial/configure3.png)
...
5. Na guia Logon Único, selecione **Atribuir** ao lado de um perfil existente
    ...
    ![A captura de tela mostra o botão Atribuir para o perfil de SSO do Azure AD.](./media/vidyard-tutorial/configure4.png)
...
6. Selecione o grupo da organização, que fica visível nos **Grupos Disponíveis para Atribuir**.
    ...
    ![A captura de tela mostra a seção Atribuir Configuração de SAML a Organizações, em que você pode selecionar seu grupo.](./media/vidyard-tutorial/configure5.png)
...
7. É possível visualizar os grupos atribuídos em **Grupos Atualmente Atribuídos**. Selecione uma função para o grupo de acordo com a organização e clique em **Confirmar**.
    ...
    ![A captura de tela mostra a seção Atribuir Configuração de SAML a Organizações, em que você pode selecionar uma função.](./media/vidyard-tutorial/configure6.png)

    > [!NOTE]
    > Para saber mais, veja [este documento](https://knowledge.vidyard.com/hc/articles/360009990033-SAML-based-Single-Sign-On-SSO-in-Vidyard).
...
Ao clicar no bloco do Vidyard no Painel de Acesso, você deverá ser conectado automaticamente ao Vidyard no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
