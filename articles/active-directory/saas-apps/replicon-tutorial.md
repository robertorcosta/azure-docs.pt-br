...
Ao selecionar o bloco Replicon no Painel de Acesso, você deverá entrar automaticamente no Replicon, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
