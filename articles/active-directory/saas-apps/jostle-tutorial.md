...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Jostle. Trabalhe com a [equipe de suporte do Jostle](mailto:support@jostle.me) para adicionar os usuários à plataforma Jostle. Os usuários devem ser criados e ativados antes de usar o logon único.
...
Ao clicar no bloco do Jostle no Painel de Acesso, você deverá ser conectado automaticamente ao Jostle, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
