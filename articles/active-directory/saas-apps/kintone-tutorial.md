...
* Você pode permitir que os usuários sejam conectados automaticamente ao Kintone (logon único) com suas contas do Azure AD.
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Kintone.
...
2. **[Configurar o logon único do Kintone](#configure-kintone-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Kintone](#create-kintone-test-user)** – para ter um equivalente de Brenda Fernandes no Kintone que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Kintone**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    > [!NOTE]
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Contate a [equipe de suporte do Cliente Kintone](https://www.kintone.com/contact/) para obter esses valores. Você também pode consultar os padrões exibidos na seção **Configuração Básica de SAML** no portal do Azure.

5. Na página **Configurar logon único com SAML**, na seção **Certificado de Autenticação SAML**, clique em **Fazer o download** para fazer o download do **Certificado (Base64)** usando as opções fornecidas de acordo com seus requisitos e salve-o no computador.

    ![O link de download do Certificado](common/certificatebase64.png)

6. Na seção **Configurar o Kintone**, copie as URLs apropriadas de acordo com suas necessidades.
...
1. Em outra janela do navegador da Web, entre em seu site de empresa do **Kintone** como administrador.

1. Clique no **ícone de Configurações**.

    ![Configurações](./media/kintone-tutorial/ic785879.png "Configurações")
...
1. Em **Administração do Sistema \> Segurança**, clique em **Logon**.
    ...
    ![Logon](./media/kintone-tutorial/ic785881.png "Logon")

1. Selecione **Habilitar a autenticação do SAML**.

    ![Captura de tela que mostra a opção "Usuários e Administração do Sistema" selecionada.](./media/kintone-tutorial/ic785882.png "Autenticação do SAML")
...
1. Na seção Autenticação do SAML, execute as seguintes etapas:
    ...
    c. Clique em **Procurar** para carregar o certificado baixado do portal do Azure.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Kintone**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, escolha **Kintone**.

    ![O link do Kintone na lista Aplicativos](common/all-applications.png)
...
### <a name="create-kintone-test-user"></a>Criar um usuário de teste do Kintone

Para permitir que os usuários do Azure AD entrem no Kintone, eles precisam ser provisionados no Kintone. No caso do Kintone, o provisionamento é uma tarefa manual.
...
1. Entre em seu site de empresa do **Kintone** como administrador.
...
1. Clique em **Novo Usuário**.
    ...
    ![Captura de tela que mostra a seção "Usuários" com a ação "Novo Usuário" selecionada.](./media/kintone-tutorial/ic785889.png "Novos usuários")
...
Ao clicar no bloco do Kintone no Painel de Acesso, você deverá ser conectado automaticamente ao Kintone, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
