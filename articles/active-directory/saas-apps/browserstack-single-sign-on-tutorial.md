...
- [Como proteger o BrowserStack Single Sign-On com controles e visibilidade avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)