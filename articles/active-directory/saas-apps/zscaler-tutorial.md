...
* Você pode usar os Meus Aplicativos da Microsoft. Ao clicar no bloco do Zscaler em Meus Aplicativos, você será redirecionado à URL de Logon do Zscaler. Para obter mais informações sobre os Meus Aplicativos, confira [Introdução aos Meus Aplicativos](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
