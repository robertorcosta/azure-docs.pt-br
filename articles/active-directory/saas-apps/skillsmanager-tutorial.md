...
* Você pode permitir que os usuários entrem automaticamente no Skills Manager (Logon Único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Skills Manager

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O Skills Manager dá suporte a SSO iniciado por **IDP**
...
4. Na caixa de pesquisa, digite **Skills Manager**, selecione **Skills Manager** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
     ...
     ![Skills Manager na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Skills Manager.
...
2. **[Configurar o logon único do Skills Manager](#configure-skills-manager-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar usuário de teste do Skills Manager](#create-skills-manager-test-user)** – para ter um equivalente de Brenda Fernandes no Skills Manager que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Skills Manager**, selecione **Logon único**.
...
6. Na seção **Configurar Skills Manager**, copie as URLs apropriadas de acordo com suas necessidades.
...
### <a name="configure-skills-manager-single-sign-on"></a>Configurar o logon único do Skills Manager

Para configurar o logon único no lado do **Skills Manager**, é necessário enviar o **Certificado (Base64)** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do Skills Manager](https://www.ibm.com/support/uk/?lnk=msu_uk). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, selecione **Todos os aplicativos** e, em seguida, **Skills Manager**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Skills Manager**.

    ![O link do Skills Manager na lista de Aplicativos](common/all-applications.png)
...
### <a name="create-skills-manager-test-user"></a>Criar usuário de teste do Skills Manager
...
Ao clicar no bloco do Skills Manager no Painel de Acesso, você deverá entrar automaticamente no Skills Manager para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
