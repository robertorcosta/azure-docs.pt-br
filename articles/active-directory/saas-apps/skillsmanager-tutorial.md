---
title: 'Tutorial: Integração do Azure Active Directory com o Skills Manager | Microsoft Docs'
...
Ao clicar no bloco do Skills Manager no Painel de Acesso, você deverá entrar automaticamente no Skills Manager para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
