...
Ao selecionar o bloco do NS1 SSO for Azure no Painel de Acesso, você deverá ser conectado automaticamente ao NS1 SSO for Azure, para o qual configurou o SSO. Para obter mais informações, confira [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
