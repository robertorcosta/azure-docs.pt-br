...
2. No menu na parte superior, clique em **Configurações do Sistema**. 
    ...
    ![Captura de tela que mostra a opção Configurações do Sistema selecionada no seu site de empresa do Questetra BPM Suite.][10]

3. Para abrir a página **SingleSignOnSAML**, clique em **SSO (SAML)** . 
   
    ![Captura de tela que mostra a opção SSO (SAML) selecionada.][11]
...
Ao clicar no bloco do Questetra BPM Suite no Painel de Acesso, você deverá ser conectado automaticamente ao Questetra BPM Suite no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
