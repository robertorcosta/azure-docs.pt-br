...
3. Use o Painel de Acesso da Microsoft. Ao clicar no bloco do EAComposer no Painel de Acesso, você será redirecionado à URL de Logon do EAComposer. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
