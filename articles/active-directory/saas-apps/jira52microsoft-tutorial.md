...
6. Realize as seguintes etapas na página de configuração:
    ...
    > [!NOTE]
    > Para obter mais informações sobre instalação e solução de problemas, visite o [Guia do Administrador do Conector de SSO para MS JIRA](./ms-confluence-jira-plugin-adminguide.md), e há também as [perguntas frequentes](./ms-confluence-jira-plugin-adminguide.md) para auxiliá-lo
