...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no Schoox. Trabalhe com a [equipe de suporte do Schoox](https://www.schoox.com/help/) para adicionar os usuários na plataforma do Schoox. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Schoox no Painel de Acesso, você deverá ser conectado automaticamente ao Schoox, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
