...
2. Clique em **Usuários**.
    ...
    ![A captura de tela mostra os Usuários selecionados no site do UNIFI.](./media/unifi-tutorial/app1.png)

3. Clique em **Adicionar Novo Provedor de Identidade**.

    ![Captura de tela que mostra a opção Adicionar Novo Provedor de Identidade selecionada.](./media/unifi-tutorial/app2.png)

4. Na seção **Adicionar Provedor de Identidade** , execute as seguintes etapas:

    ![A captura de tela mostra a página Adicionar Provedor de Identidade, na qual você pode inserir os valores descritos.](./media/unifi-tutorial/app3.png) 
...
Ao clicar no bloco do UNIFI no Painel de Acesso, você deverá ser conectado automaticamente ao UNIFI, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
