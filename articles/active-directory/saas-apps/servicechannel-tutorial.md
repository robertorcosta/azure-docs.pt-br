...
## <a name="configure-and-test-azure-ad-sso-for-servicechannel"></a>Configurar e testar o SSO do Azure AD para ServiceChannel
...
Para configurar e testar o SSO do Azure AD com o ServiceChannel, execute as seguintes etapas:
...
1. No portal do Azure, na página de integração de aplicativos do **ServiceChannel**, localize a seção **Gerenciar** e selecione **logon único**.
...
Depois de configurar o ServiceChannel, você poderá impor o controle de sessão, que fornece proteção contra a exfiltração e infiltração dos dados confidenciais da sua organização em tempo real. O controle da sessão é estendido do acesso condicional. [Saiba como impor o controle de sessão com o Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
