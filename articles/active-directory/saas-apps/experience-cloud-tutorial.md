...
Nesta seção, você criará um usuário chamado B.Fernandes no Experience Cloud. Trabalhe com a [equipe de suporte do Experience Cloud](mailto:support@medallia.com) para adicionar os usuários à plataforma Experience Cloud. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Experience Cloud no Painel de Acesso, você deverá ser conectado automaticamente ao Experience Cloud, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
