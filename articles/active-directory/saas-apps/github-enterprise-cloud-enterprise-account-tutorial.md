...
- [Como proteger a conta do GitHub Enterprise Cloud – Conta Empresarial com visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)