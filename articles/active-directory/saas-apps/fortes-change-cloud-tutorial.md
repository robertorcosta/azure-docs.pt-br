...
## <a name="configure-and-test-azure-ad-single-sign-on-for-fortes-change-cloud"></a>Configurar e testar o logon único do Azure AD para o Fortes Change Cloud
...
Para configurar e testar o SSO do Azure AD com o Fortes Change Cloud, conclua os seguintes blocos de construção:
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Fortes Change Cloud**, localize a seção **Gerenciar** e selecione **logon único**.
...
1. Clique em **Definir URLs adicionais** e execute o passo seguinte se quiser configurar a aplicação no modo **SP** iniciado:
    ...
    Na caixa de texto **URL de logon**, digite um URL usando o seguinte padrão: `https://<identifier>.fortes-online.com/saml/SSO`
...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no Fortes Change Cloud. Trabalhe com a [equipe de suporte do Fortes Change Cloud](mailto:support@fortes.nl) para adicionar os usuários à plataforma do Fortes Change Cloud. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Fortes Change Cloud no Painel de Acesso, você deverá ser conectado automaticamente ao Fortes Change Cloud para o qual você configurou um SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Experimente o Fortes Change Cloud com o Azure AD](https://aad.portal.azure.com/)

- [O que é controle de sessão no Microsoft Cloud App Security?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Como proteger o Fortes Change Cloud com visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
