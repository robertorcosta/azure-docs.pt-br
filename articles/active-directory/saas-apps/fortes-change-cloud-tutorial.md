...
Ao clicar no bloco do Fortes Change Cloud no Painel de Acesso, você deverá ser conectado automaticamente ao Fortes Change Cloud para o qual você configurou um SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Como proteger o Fortes Change Cloud com visibilidade e controles avançados](/cloud-app-security/proxy-intro-aad)