...
Para configurar o logon único no lado do **Whimsical**, é necessário carregar o **XML de Metadados de Federação** recém-baixado para as [configurações do workspace](https://whimsical.com/workspace/settings).
