---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao Hub Planner | Microsoft Docs'
description: Saiba como configurar o logon único entre o Azure Active Directory e o Hub Planner.
...
Neste tutorial, você aprenderá a integrar o Hub Planner ao Azure Active Directory (Azure AD). Ao integrar o Hub Planner ao Azure AD, você poderá:

* Controlar, no Azure AD, quem tem acesso ao Hub Planner.
* Permitir que os usuários sejam conectados automaticamente ao Hub Planner com as contas do Azure AD deles.
...
* Uma assinatura do Hub Planner com SSO (logon único) habilitado.
...
1. **[Configurar o SSO do Hub Planner](#configure-hub-planner-sso)** – para definir as configurações de logon único no lado do aplicativo.
    1. **[Criar um usuário de teste do Hub Planner](#create-hub-planner-test-user)** – para ter um equivalente de B.Fernandes no Hub Planner que esteja vinculado à representação de usuário do Azure AD.
...
1. Na seção **Configuração Básica do SAML**, insira os valores para os seguintes campos:
    ...
    a. Na caixa de texto **URL de logon**, digite um URL usando o seguinte padrão: `https://<SUBDOMAIN>.hubplanner.com`

    b. Na caixa **Identificador**, digite uma URL usando o seguinte padrão: `https://<SUBDOMAIN>.hubplanner.com/sso/metadata`

    c. No **URL de resposta** caixa de texto, digite uma URL usando o seguinte padrão: `https://<SUBDOMAIN>.hubplanner.com/sso/callback`
...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Hub Planner. Trabalhe com a [equipe de suporte do Hub Planner](mailto:hello@hubplanner.com) para adicionar os usuários à plataforma do Hub Planner. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Hub Planner no Painel de Acesso, você deverá ser conectado automaticamente ao Hub Planner para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Experimente o Hub Planner com o Azure AD](https://aad.portal.azure.com/)

- [O que é controle de sessão no Microsoft Cloud App Security?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Como proteger o Hub Planner com visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
