...
Ao clicar no bloco do Hub Planner no Painel de Acesso, você deverá ser conectado automaticamente ao Hub Planner para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Como proteger o Hub Planner com visibilidade e controles avançados](/cloud-app-security/proxy-intro-aad)