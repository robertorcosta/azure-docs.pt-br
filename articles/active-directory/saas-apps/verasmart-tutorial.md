...
Ao clicar no bloco do VeraSMART no Painel de Acesso, você deverá ser conectado automaticamente ao VeraSMART, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
