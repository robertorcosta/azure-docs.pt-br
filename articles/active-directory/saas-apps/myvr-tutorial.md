---
title: 'Tutorial: Integração do SSO (logon único) do Azure Active Directory ao MyVR | Microsoft Docs'
...
ms.locfileid: "92522539"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-myvr"></a>Tutorial: Integração do SSO (logon único) do Azure Active Directory ao MyVR
...
* O MyVR dá suporte ao SSO iniciado por **SP e IDP**
...
Configure e teste o SSO do Azure AD com o MyVR usando um usuário de teste com o nome **B.Fernandes**. Para que o SSO funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do MyVR.
...
1. **[Configurar o SSO do MyVR](#configure-myvr-sso)** – para configurar o logon único no lado do aplicativo.
    1. **[Criar um usuário de teste do MyVR](#create-myvr-test-user)** – para ter um equivalente de B.Fernandes no MyVR que esteja vinculado à representação de usuário do Azure AD.
...
1. O aplicativo MyVR espera as declarações do SAML em um formato específico, o que exige que você adicione mapeamentos de atributo personalizados à configuração dos atributos do token SAML. A captura de tela a seguir mostra a lista de atributos padrão.

    ![image](common/edit-attribute.png)

1. Além do indicado acima, o aplicativo MyVR espera que mais alguns atributos sejam passados novamente na resposta SAML, que são mostrados abaixo. Esses atributos também são pré-populados, mas você pode examiná-los de acordo com seu requisito.
...
Nesta seção, um usuário com o nome B.Fernandes será criado no MyVR. O MyVR é compatível com o provisionamento de usuário just-in-time, que é habilitado por padrão. Não há itens de ação para você nesta seção. Se um usuário ainda não existir no MyVR, um usuário será criado após a autenticação.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do MyVR no Painel de Acesso, você deverá ser conectado automaticamente ao MyVR, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
