...
Ao clicar no bloco do Reprints Desk – Article Galaxy no Painel de Acesso, você deverá ser conectado automaticamente ao Reprints Desk – Article Galaxy, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Como proteger o Reprints Desk – Article Galaxy com visibilidade e controles avançados](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
