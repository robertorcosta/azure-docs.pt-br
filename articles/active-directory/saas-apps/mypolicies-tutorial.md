...
* Você pode controlar no Azure AD quem tem acesso ao myPolicies.
* Você pode permitir que os usuários sejam conectados automaticamente ao myPolicies (logon único) com suas contas do Azure AD.
...
* O myPolicies dá suporte ao SSO iniciado por **IDP**
...
Nesta seção, você configurará e testará o logon único do Azure AD com o myPolicies, com base em um usuário de teste chamado **Brenda Fernandes**.
...
2. **[Configurar o logon único do myPolicies](#configure-mypolicies-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do myPolicies](#create-mypolicies-test-user)** – para ter um equivalente de Brenda Fernandes no myPolicies que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **myPolicies**, selecione **Logon único**.
...
6. Na seção **Configurar o myPolicies**, copie as URLs apropriadas de acordo com suas necessidades.
...
Para configurar o logon único no lado do **myPolicies**, é necessário enviar o **Certificado (Base64)** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do myPolicies](mailto:support@mypolicies.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **myPolicies**.
...
### <a name="create-mypolicies-test-user"></a>Criar um usuário de teste do myPolicies
...
Ao clicar no bloco do myPolicies no Painel de Acesso, você deverá ser conectado automaticamente ao myPolicies, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
