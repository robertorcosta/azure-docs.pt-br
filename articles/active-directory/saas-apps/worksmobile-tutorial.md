...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do LINE WORKS.
...
2. **[Configurar o logon único do LINE WORKS](#configure-line-works-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do LINE WORKS](#create-line-works-test-user)** – para ter um equivalente de Brenda Fernandes no LINE WORKS vinculado à representação do usuário no Azure AD.
...
### <a name="configure-line-works-single-sign-on"></a>Configurar o logon único do LINE WORKS
...
1. No portal do Azure, escolha **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, escolha **LINE WORKS**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, escolha **LINE WORKS**.

    ![O link do LINE WORKS na Lista de aplicativos](common/all-applications.png)
...
Ao clicar no bloco do LINE WORKS no Painel de Acesso, você deverá entrar automaticamente no LINE WORKS para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
