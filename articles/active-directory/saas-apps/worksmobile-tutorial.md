...
3. Use o Painel de Acesso da Microsoft. Ao clicar no bloco LINE WORKS no Painel de Acesso, você será redirecionado para a URL de Logon do LINE WORKS. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
