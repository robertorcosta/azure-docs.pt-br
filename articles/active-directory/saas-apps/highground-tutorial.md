...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no HighGround. Trabalhe com a [equipe de suporte do HighGround](https://youearnedit.freshdesk.com/support/home) para adicionar os usuários na plataforma do HighGround. Os usuários devem ser criados e ativados antes de usar o logon único.

## <a name="test-sso"></a>Testar o SSO 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do HighGround no Painel de Acesso, você deverá ser conectado automaticamente ao HighGround para o qual você configurou um SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Como proteger o HighGround com visibilidade e controles avançados](/cloud-app-security/proxy-intro-aad)