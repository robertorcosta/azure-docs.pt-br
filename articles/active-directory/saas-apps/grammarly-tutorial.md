...
2. Use o Painel de Acesso da Microsoft. Ao clicar no bloco do Grammarly no Painel de Acesso, você será conectado automaticamente ao Grammarly, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
