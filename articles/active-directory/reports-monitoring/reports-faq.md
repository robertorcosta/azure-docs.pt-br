...
**P: atualmente uso o `https://graph.windows.net/<tenant-name>/reports/` as APIs de ponto de extremidade para extrair relatórios de uso de aplicativos integrados e auditoria do Azure AD em nossos sistemas de relatórios programaticamente. O que devo mudar?**
