...
*   Quais aplicativos têm as entradas com mais falhas? 
*   Quais são os principais erros de entrada de cada aplicativo?
...
3. Na seção **Atividade**, selecione **Uso e insights** para abrir o relatório. 
...
Clicar em **carregar mais** na parte inferior da lista permite que você exiba aplicativos adicionais na página. Você pode selecionar o intervalo de datas para exibir todos os aplicativos que foram usados no intervalo.
...
Quando você seleciona um dia no grafo de uso do aplicativo, pode obter uma lista detalhada das atividades de entrada do aplicativo.  
