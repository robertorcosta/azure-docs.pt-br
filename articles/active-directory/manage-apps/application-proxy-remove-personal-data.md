---
title: Remover dados pessoais - Proxy do aplicativo de diretório ativo do Azure
...
![Mostra um trecho de código com o código destacado para remover](./media/application-proxy-remove-personal-data/01.png)
