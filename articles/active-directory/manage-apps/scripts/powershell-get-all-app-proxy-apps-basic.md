---
title: Amostra powershell - Listar informações básicas para aplicativos proxy de aplicativos
description: Exemplo do PowerShell que lista os aplicativos proxy do Azure Active Directory (Azure AD) juntamente com o ID do aplicativo (AppId), nome (DisplayName) e ID de objeto (ObjId).
...
---
# <a name="get-all-application-proxy-apps-and-list-basic-information"></a>Obtenha todos os aplicativos proxy do aplicativo e liste informações básicas

Este exemplo de script do PowerShell lista informações sobre todos os aplicativos de proxy do Azure Active Directory (Azure AD), incluindo o ID do aplicativo (AppId), nome (DisplayName) e ID de objeto (ObjId).
