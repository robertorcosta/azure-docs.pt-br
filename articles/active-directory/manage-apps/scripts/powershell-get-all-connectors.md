---
title: Exemplo do PowerShell – listar todos os grupos de conectores de proxy de aplicativo
description: Exemplo do PowerShell que lista todos os grupos e conectores do proxy de aplicativo Azure Active Directory (Azure AD) no seu diretório.
...
Este exemplo de script do PowerShell lista todos os grupos e conectores do proxy de aplicativo Azure Active Directory (Azure AD) no seu diretório.
...
| [Get-AzureADApplicationProxyConnectorGroupMembers](https://docs.microsoft.com/powershell/module/azuread/get-azureadapplicationproxyconnectorgroupmembers?view=azureadps-2.0) | Obtém todos os conectores de proxy de aplicativo associados a cada grupo de conectores.|
