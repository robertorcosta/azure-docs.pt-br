...
O progresso do provisionamento pode ser exibido na portal do Azure, no **Azure Active Directory &gt; Enterprise Apps &gt; \[nome do aplicativo**\] &gt; guia de provisionamento.
