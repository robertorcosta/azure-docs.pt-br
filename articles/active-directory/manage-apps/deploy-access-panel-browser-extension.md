...
1. Vá para a guia **Ações.** Em seguida, clique **em Tarefas** > **Novas Compartilhamento...**

    ![Captura de tela mostra onde encontrar novo compartilhamento na tela Tarefas](./media/deploy-access-panel-browser-extension/shares.png)
...
1. Faça login no servidor que hospeda a instalação do AD DS (Active Directory Domain Services, serviços de domínio de diretório ativo).
1. No Gerenciador de Servidores, vá para **Tools** > **Group Policy Management**.
...
1. No painel esquerdo da janela **Gerenciamento de Política de Grupo** , exiba sua hierarquia de UO (unidade organizacional) e determine em qual escopo você gostaria de aplicar a política de grupo. Por exemplo, você poderá optar por escolher uma UO pequena a ser implantada para alguns usuários para teste ou poderá escolher uma UO de nível superior a ser implantada em toda a sua organização.
   ...
   > [!NOTE]
   > Se você quiser criar ou editar suas Unidades de Organização (OUs), volte para o Gerenciador de servidores e vá para Usuários**e Computadores ativos**de **ferramentas** > .
...
1. Depois de selecionar uma UO, clique com o botão direito do mouse nela e selecione **Criar um GPO neste domínio e vinculá-lo aqui...**
    ...
    ![Captura de tela mostra a opção Criar uma nova OPÇÃO GPO](./media/deploy-access-panel-browser-extension/create-gpo.png)
...
## <a name="step-4-auto-enable-the-extension-for-internet-explorer"></a>Passo 4: Habilite automaticamente a extensão para o Internet Explorer
...
## <a name="step-5-optional-disable-remember-password-prompt"></a>Passo 5 (Opcional): Desativar o prompt "Lembrar senha"
...
![Mostra o "Gostaria de armazenar sua senha..." Prompt](./media/deploy-access-panel-browser-extension/remember-password-prompt.png)
...
1. Na janela **Ativar o recurso de preenchimento automático para nomes de usuário e senhas em formulários**, selecione **Desabilitado**.
    ...
    ![Selecione a opção "Desativado" para ativar o recurso de preenchimento automático](./media/deploy-access-panel-browser-extension/disable-passwords.png)
...
## <a name="step-6-testing-the-deployment"></a>Passo 6: Testando a implantação
...
1. Pode ser necessário um par de logins para que as alterações de política do grupo atualizem totalmente com esta máquina. Para forçar a atualização, abra um **Prompt de comando** e execute o seguinte comando: `gpupdate /force`
