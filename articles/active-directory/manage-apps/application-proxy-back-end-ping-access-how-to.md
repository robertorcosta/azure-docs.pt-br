---
title: Como configurar um aplicativo proxy de aplicativo para usar o PingAccess
...
Para obter detalhes sobre cada uma dessas etapas, consulte nossa [Documentação de Logon único com cabeçalhos](application-proxy-configure-single-sign-on-with-ping-access.md).
