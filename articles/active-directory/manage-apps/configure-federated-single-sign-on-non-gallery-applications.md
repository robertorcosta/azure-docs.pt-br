---
title: Como configurar o login único federado para um aplicativo que não é galeria
...
6. clique **em aplicativo não-galeria** na seção **Adicionar seu próprio aplicativo**
