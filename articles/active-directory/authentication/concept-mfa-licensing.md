...
As edições Azure AD Premium estão disponíveis por meio de seu representante da Microsoft, do [programa Open Volume License](https://www.microsoft.com/licensing/licensing-programs/open-license.aspx)e do [programa provedores de soluções na nuvem](https://go.microsoft.com/fwlink/?LinkId=614968&clcid=0x409). Os assinantes do Azure e do Office 365 também podem comprar o Active Directory Premium P1 e P2 online. [Entre](https://portal.office.com/Commerce/Catalog.aspx) para comprar.
