...
![Relatórios sobre SSPR usando os registros de auditoria no Azure AD][Reporting]
...
5. Selecione Registros de **auditoria** na lâmina **Usuários.** Isso mostra todos os eventos de auditoria que ocorreram em relação a todos os usuários no diretório. Você pode filtrar essa exibição para ver todos os eventos relacionados a senhas.
6. No menu **Filtro** na parte superior do painel, selecione a lista suspenso **do Serviço** e altere-a para o tipo de serviço de gerenciamento **de senhas de autoatendimento.**
...
Se você estiver participando da pré-visualização pública do registro convergente, as informações relativas à atividade do usuário nos registros de auditoria serão encontradas nos**Métodos de Autenticação de** **Segurança** > .
...
Os seguintes tipos de atividades aparecem na categoria de evento **de auditoria de gerenciamento de senhas de autoatendimento:**
...
* Desbloquear conta de [usuário (self-service)](#activity-type-unlock-a-user-account-self-service)): Indica que um usuário desbloqueou com sucesso sua conta do Active Directory sem redefinir sua senha do portal de redefinição de [senha do Azure AD](https://passwordreset.microsoftonline.com) usando o recurso Active Directory de desbloqueio da conta sem redefinir.
...
* **Ator de atividade**: o administrador que realizou a redefinição da senha em nome de outro usuário final ou administrador. Deve ser um administrador de senhas, administrador de usuário ou administrador de helpdesk.
