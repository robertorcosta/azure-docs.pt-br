---
title: Entrada de chave de segurança sem senha (versão prévia)-Azure Active Directory
...
Os recursos de registro para métodos de autenticação com senha contam com o recurso de registro combinado. Siga as etapas no artigo [habilitar o registro de informações de segurança combinadas (versão prévia)](howto-registration-mfa-sspr-combined.md)para habilitar o registro combinado.
