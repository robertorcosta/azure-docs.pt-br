...
| --- | --- | --- |
| O [registro combinado para a autenticação multifator do Azure e a SSPR (redefinição de senha de autoatendimento)](howto-registration-mfa-sspr-combined.md) está habilitado (recurso de visualização) | √ | √ |
