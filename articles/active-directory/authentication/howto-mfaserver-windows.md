...
* Se 'Exigir correspondência de usuário de autenticação multifatorial do Azure' for verificada e você não estiver na lista de usuários, você não poderá fazer login na máquina após a reinicialização.
