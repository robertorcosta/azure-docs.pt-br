---
title: Considerações de implantação para Azure Active Directory redefinição de senha de autoatendimento
description: Saiba mais sobre as considerações e a estratégia de implantação para a implementação bem-sucedida da redefinição de senha de autoatendimento do Azure AD
...
---
# <a name="plan-an-azure-active-directory-self-service-password-reset-deployment"></a>Planejar uma Azure Active Directory implantação de redefinição de senha de autoatendimento

> [!IMPORTANT]
> Este plano de implantação oferece orientações e práticas recomendadas para implantar a SSPR (redefinição de senha de autoatendimento) do Azure AD.
>
> **Se você for e o usuário final e precisar voltar à sua conta, vá para [https://aka.ms/sspr](https://aka.ms/sspr) **.
...
> [Habilitar SSPR (redefinição de senha de autoatendimento)](tutorial-enable-sspr.md)
...
* Para começar a implantar o SSPR, consulte [habilitar redefinição de senha de autoatendimento do Azure ad](tutorial-enable-sspr.md)
