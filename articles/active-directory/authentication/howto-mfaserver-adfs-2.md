...
4. Insira o endereço IP, o intervalo de endereços IP ou a sub-rede que deve ser permitida. Se inserir uma sub-rede, selecione a Máscara de Rede apropriada e clique no botão **OK**.
