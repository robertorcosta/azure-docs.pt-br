...
Para remover uma conta do cache, localize a conta que precisa ser removida e, em seguida `PublicClientApplicatoin.removeAccount()` , chame conforme mostrado no exemplo a seguir:
