...
#### <a name="warning-should-you-have-one-or-two-slashes-in-the-scope-corresponding-to-a-v10-web-api"></a>Aviso: Se você tiver uma ou duas barras no escopo correspondentes a uma API web v1.0
