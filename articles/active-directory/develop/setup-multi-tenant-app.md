...
- Tenha uma compreensão geral de [como configurar um aplicativo para ser multilocatário](https://docs.microsoft.com/azure/active-directory/develop/howto-convert-app-to-be-multi-tenant)
