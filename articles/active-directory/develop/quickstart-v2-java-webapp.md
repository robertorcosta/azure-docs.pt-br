...
>
> 1. Adicionar URLs de resposta como `http://localhost:8080/msal4jsamples/secure/aad` e `http://localhost:8080/msal4jsamples/graph/me`.
...
Se você estiver executando o aplicativo Web em um IDE, clique em Executar e navegue até a home page do projeto. Nesta amostra, a URL da home page padrão é http://localhost:8080
...
Adicione uma referência à MSAL4J incluindo o seguinte código ao início do arquivo no qual você usará a MSAL4J:
