...
Para proteger sua API Web com Azure AD B2C, primeiro você precisa registrá-la. Confira [Registrar seu aplicativo](../../active-directory-b2c/add-web-application.md) para ver as etapas detalhadas.
