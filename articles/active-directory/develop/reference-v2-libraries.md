...
description: Bibliotecas de cliente compatíveis e bibliotecas de middleware de servidor, juntamente com links de exemplo, de biblioteca e de origem relacionados, para a plataforma Microsoft Identity.
...
A [plataforma de identidade da Microsoft ](../azuread-dev/azure-ad-endpoint-comparison.md) dá suporte aos protocolos OAuth 2,0 e OpenID Connect 1,0 padrão do setor. A MSAL (biblioteca de autenticação da Microsoft) foi projetada para trabalhar com a plataforma de identidade da Microsoft. Você também pode usar bibliotecas de código-fonte aberto que dão suporte a OAuth 2,0 e a OpenID Connect 1,0.
...
* **Compatível**: a Microsoft testou essas bibliotecas em cenários básicos e confirmou que elas funcionam com a plataforma de identidade da Microsoft. A Microsoft não fornece correções para essas bibliotecas e não fez uma análise dessas bibliotecas. Os problemas e solicitações de recursos devem ser direcionados ao projeto de software livre da biblioteca.

Para obter uma lista de bibliotecas que funcionam com a plataforma de identidade da Microsoft, consulte as seções a seguir.
...
Para qualquer biblioteca compatível com padrões, você pode usar a plataforma de identidade da Microsoft. É importante saber para onde ir para obter suporte:
...
* [Crie uma solicitação de suporte](../../azure-portal/supportability/how-to-create-azure-support-request.md) se você encontrar um problema em que a plataforma de identidade da Microsoft não está em conformidade com o OAuth 2,0 ou o OpenID Connect 1,0.
