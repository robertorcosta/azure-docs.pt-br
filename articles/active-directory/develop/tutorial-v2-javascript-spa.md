...
>[!NOTE]
> Se você é novo na plataforma de identidade da Microsoft, recomendamos que comece com o [início rápido Conectar usuários e obter um token de acesso em um SPA JavaScript](quickstart-v2-javascript.md).
