...
>Observação: o `account_mode` deve ser definido como **vários** para aplicativos B2C. Consulte a documentação para obter mais informações sobre [aplicativos cliente públicos de várias contas](https://docs.microsoft.com/azure/active-directory/develop/single-multi-account#multiple-account-public-client-application).
