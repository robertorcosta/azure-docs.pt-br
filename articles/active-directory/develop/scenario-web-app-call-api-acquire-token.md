...
Ele tenta obter um token do cache de token e, em seguida, chama a API da Web depois de definir o cabeçalho Authorization. Se não puder, ele assinará novamente o usuário.
