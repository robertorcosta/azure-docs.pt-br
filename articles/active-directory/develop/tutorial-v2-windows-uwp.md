...
>[!NOTE]
> Este guia requer o Visual Studio com o desenvolvimento da Plataforma Universal do Windows instalado. Para obter instruções de como baixar e configurar o Visual Studio para desenvolver aplicativos da Plataforma Universal do Windows, confira [Prepare-se para começar](https://docs.microsoft.com/windows/uwp/get-started/get-set-up).
