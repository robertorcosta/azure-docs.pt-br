...
Para ter um aplicativo de cache de token persistente, será necessário personalizar a serialização. As classes e interfaces Java envolvidas na serialização de cache de token são as seguintes:
