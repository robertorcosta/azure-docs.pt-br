...
Agora que você adquiriu `access_token`com sucesso um , você pode usar o token `Authorization` em solicitações para APIs da Web, incluindo-o no cabeçalho:
