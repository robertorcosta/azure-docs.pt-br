...
Mas o uso desse fluxo impõe restrições em seus aplicativos. Por exemplo, os aplicativos que usam esse fluxo não podem conectar um usuário que precisa realizar a autenticação multifator ou o acesso condicional. Seus aplicativos também não se beneficiam do logon único.
