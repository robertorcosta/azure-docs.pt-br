...
Siga as [instruções para registrar um novo aplicativo de página única](https://docs.microsoft.com/zure/active-directory/develop/scenario-spa-app-registration).
