---
title: Tratar erros e exceções em MSAL para iOS/macOS
titleSuffix: Microsoft identity platform
description: Saiba como lidar com erros e exceções, desafios de declarações de acesso condicional e repetições em MSAL para aplicativos iOS/macOS.
...
ms.locfileid: "98761110"
---
# <a name="handle-errors-and-exceptions-in-msal-for-iosmacos"></a>Tratar erros e exceções em MSAL para iOS/macOS

[!INCLUDE [Active directory error handling introduction](../../../includes/active-directory-develop-error-handling-introduction.md)]

## <a name="error-handling-in-msal-for-iosmacos"></a>Tratamento de erros no MSAL para iOS/macOS
...
Considere habilitar o [registro em log no MSAL para IOS/MacOS](msal-logging-ios.md) para ajudá-lo a diagnosticar e depurar problemas.
