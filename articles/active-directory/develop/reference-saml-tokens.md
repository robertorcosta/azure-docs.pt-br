...
> | {1&gt;Nome&lt;1} | Declaração JWT Equivalente | Descrição | {1&gt;Exemplo&lt;1} |
> | --- | --- | --- | ------------|
...
> |Emissor | `iss` |Identifica o STS (serviço de token de segurança) que constrói e retorna o token. Nos tokens que o AD do Azure retorna, o emissor é sts.windows.net. O GUID no valor de declaração do emissor é a ID de locatário do diretório do AD do Azure. A ID do locatário é um identificador imutável e confiável do diretório. | `<Issuer>https://sts.windows.net/cbb1a5ac-f33b-45fa-9bf5-f37db0fed422/</Issuer>` |
