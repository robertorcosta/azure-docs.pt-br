...
1. Em **concessão implícita**, selecione **tokens de ID** e **tokens de acesso**. Tokens de ID e tokens de acesso são necessários porque esse aplicativo precisa conectar usuários e chamar uma API.
1. Selecione **Salvar**.
