---
title: Tutorial do MSAL para iOS e macOS – plataforma de identidade da Microsoft | Azure
...
>[!NOTE]
> Se você é novo na plataforma de identidade da Microsoft, recomendamos que comece com [Conectar usuários e chamar a API do Microsoft Graph em um aplicativo iOS ou macOS](quickstart-v2-ios.md).
...
2. Abra a folha Registros de aplicativo e clique em **+Novo registro**.
...
7. Clique em **Experimentar a nova experiência** ao lado da parte superior da tela para abrir a nova experiência de registro de aplicativo e, em seguida, clique em **+ Novo registro** >  **+ Adicionar uma plataforma** > **iOS/macOS**.
...
8. Clique em `Configure` e salve a **Configuração da MSAL** exibida na página **Configuração da MSAL** para que você possa inseri-la quando configurar o aplicativo mais tarde.  Clique em **Concluído**.
