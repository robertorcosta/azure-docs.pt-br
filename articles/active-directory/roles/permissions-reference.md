...
-------- | ------------------- | -------------
Administradores de Empresa | Administrador global | [Nome alterado para mais clareza](permissions-reference.md#role-template-ids)
Administrador de serviços do CRM | Administrador do Dynamics 365 | [Reflete a identidade visual atual do produto](permissions-reference.md#role-template-ids)
...
Gravadores de diretório | Não exibido porque não deve ser usado | [Documentação dos gravadores de diretório](permissions-reference.md#directory-writers)
Usuário Convidado | Não exibido porque não pode ser usado  | NA
Administrador de serviços do Lync | Administrador do Skype for Business | [Reflete a identidade visual atual do produto](permissions-reference.md#role-template-ids)
