...
O Azure AD B2B pode ser configurado para federar com provedores de identidade que usam o protocolo WS-Redirecionado com os requisitos específicos listados abaixo. Atualmente, os dois provedores WS-Fed que foram testados quanto à compatibilidade com o Azure AD incluem o AD FS e o Shibboleth. Aqui, usaremos Serviços de Federação do Active Directory (AD FS) (AD FS) como um exemplo do provedor de identidade WS-enalimentado. Para obter mais informações sobre como estabelecer uma relação de confiança de terceira parte confiável entre um provedor compatível com WS-alimentado com o Azure AD, baixe os documentos de compatibilidade do provedor de identidade do Azure AD.
