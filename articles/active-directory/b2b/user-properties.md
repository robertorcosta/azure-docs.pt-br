...
description: Azure Active Directory B2B propriedades do usuário convidado e estados antes e depois do resgate do convite
...
Este artigo descreve as propriedades e estados do objeto de usuário convidado B2B no Azure Active Directory (Azure AD) antes e depois do resgate do convite. Um usuário de colaboração Azure AD business-to-business (B2B) é um usuário com UserType = Convidado. Normalmente, esse usuário convidado representa uma organização parceira e, por padrão, tem privilégios limitados no diretório que convida.
...
- Estado 2: Abrigado em uma Microsoft ou outra conta e representado como usuário convidado na organização do host. Nesse caso, o usuário convidado entra com uma conta Microsoft ou uma conta social (google.com ou semelhante). A identidade do usuário convidado é criada como uma conta Microsoft no diretório da organização que fez o convite durante o resgate de oferta.
...
- Estado 4: Abrigado no Azure AD da organização anfitriã com UserType = Convidado e credenciais que a organização anfitriã gerencia.

  ![Diagrama representando os quatro estados de usuário](media/user-properties/redemption-diagram.png)
...
![Captura de tela mostrando propriedades do usuário antes de oferecer resgate](media/user-properties/before-redemption.png)
...
- Diretório Ativo externo do Azure: Este usuário está abrigado em uma organização externa e autentica usando uma conta Azure AD que pertence à outra organização. Esse tipo de acesso corresponde ao Estado 1.
