...
1.  O esquema de Active Directory na floresta do domínio gMSA precisa ser atualizado para o Windows Server 2016.
...
4.  Um servidor ingressado no domínio em que o agente está sendo instalado precisa ser o Windows Server 2016 ou posterior.
...
|Permitir |Conta do gMSA |Criar/excluir objetos de usuário|Este objeto e todos os objetos descendentes| 
