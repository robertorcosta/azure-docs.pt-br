...
|-----|----|
|[Acrescentar](#append)|seleciona um valor da cadeia de caracteres de source e acrescenta o sufixo ao final dela.|
...
|[Join](#join) |Join() é semelhante a Append(), exceto por poder combinar diversos valores de cadeia de caracteres **source** em uma única cadeia de caracteres, e cada valor será separado por uma cadeia de caracteres de **separator**.| 
|[Left](#left)|a função Left retorna um número especificado de caracteres a partir da esquerda de uma cadeia de caracteres.|
|[Mid](#mid) |retorna uma subcadeia de caracteres do valor de source. Uma subcadeia de caracteres é uma cadeia de caracteres que contém apenas alguns dos caracteres da cadeia de caracteres de source.|
...
|[Not](#not) |Inverte o valor booliano de **source**. Se o valor de **source** for "*True*", retorna "*False*". Caso contrário, retorna "*True*".| 
...
|[Switch](#switch)|Quando o valor de **source** corresponde a um parâmetro **key**, retorna **value** para esse parâmetro **key**. | 
...
**Parâmetros:**<br> 
   ...
   | Nome | Obrigatório/repetição | Type | Observações |
   | --- | --- | --- | --- |
   | **origem** |Obrigatório |String |O valor de **origem** a ser verificado. |
