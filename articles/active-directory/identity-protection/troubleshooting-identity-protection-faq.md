...
**Ignorar o risco do usuário** no Identity Protection define o ator no histórico de riscos do usuário em identidade Protection para ** \<o nome do administrador com um hiperlink apontando para\>a folha do usuário**.
