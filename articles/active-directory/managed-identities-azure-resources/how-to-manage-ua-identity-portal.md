---
title: Gerenciar uma identidade gerenciada atribuída pelo usuário no portal Azure - Azure AD
...
4. Selecione **controle de acesso (IAM)** e selecione **Adicionar atribuição de função**.
