---
title: Tutorial`:` Use identidade gerenciada para acessar o Azure Storage usando credencial SAS - Azure AD
...
2. Digite seu **Nome de Usuário** e **Senha** para os quais você adicionou quando criou a VM do Windows. 
...
>[Usando assinaturas de acesso compartilhado (SAS)](/azure/storage/common/storage-dotnet-shared-access-signature-part-1)
