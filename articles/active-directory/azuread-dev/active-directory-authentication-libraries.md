...
- [Cenários de autenticação do Active Directory do Azure](v1-authentication-scenarios.md)
- [Amostras do código do Azure Active Directory](sample-v1-code.md)
