...
O conhecimento de aplicativos [únicos e multilocatários](../develop/howto-convert-app-to-be-multi-tenant.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json) e [padrões de autenticação comuns](v1-authentication-scenarios.md) é assumido.
