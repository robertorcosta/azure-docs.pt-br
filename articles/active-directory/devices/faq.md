...
Na maioria dos casos, a junção híbrida do Azure AD tem precedência sobre o estado registrado do Azure AD, resultando no seu dispositivo ser considerado híbrido do Azure AD ingressado para qualquer autenticação e avaliação de acesso condicional. No entanto, às vezes, esse estado duplo pode resultar em uma avaliação não determinística do dispositivo e causar problemas de acesso. É altamente recomendável atualizar para o Windows 10 versão 1803 e superior, onde limpamos automaticamente o estado registrado do Azure AD. Saiba como [evitar ou limpar esse estado duplo no computador com Windows 10](hybrid-azuread-join-plan.md#review-things-you-should-know). 
