...
[Configurando a junção híbrida do Azure AD para dispositivos Windows ingressados no domínio que são federados usando o ADFS](manage-stale-devices.md)
