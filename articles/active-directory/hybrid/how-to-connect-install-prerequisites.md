...
* Se você usar o caminho de instalação de configurações personalizadas, então você terá mais opções para ver [Contas no Diretório Ativo](reference-connect-accounts-permissions.md#custom-installation-settings)
