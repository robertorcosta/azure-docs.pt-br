...
A seção **Detalhes de cobrança por produto** lista os encargos totais de cada produto associado a este perfil de cobrança. Você pode exibir um detalhamento diário dos encargos de cada produto no CSV de uso e encargos do Azure. Para saber mais sobre como reconciliar o PDF da fatura com o CSV de uso e encargos do Azure, confira [Entender sua fatura do Contrato de Parceiro da Microsoft](review-partner-agreement-bill.md).
