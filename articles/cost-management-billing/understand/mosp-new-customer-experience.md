...
**Nenhuma alteração aos recursos do Azure** O acesso aos recursos do Azure definidos usando RBAC (controle de acesso baseado em função) do Azure não é afetado pela atualização.
