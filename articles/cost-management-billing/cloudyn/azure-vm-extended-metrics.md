...
> [!NOTE]
> A coleta de dados de métrica estendida só é compatível com o monitoramento no nível do convidado do Azure. O Cloudyn não é compatível com a extensão de VM do [Agente de Análise de Logs](../../azure-monitor/agents/agents-overview.md).
