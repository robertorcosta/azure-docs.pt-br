...
Se você quiser obter grandes quantidades de dados exportados regularmente, confira [Recuperar grandes conjuntos de dados de custo de modo recorrente com exportações](ingest-azure-usage-at-scale.md).
