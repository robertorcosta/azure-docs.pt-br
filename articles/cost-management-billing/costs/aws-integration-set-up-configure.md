...
2. Insira **S3**.
3. Selecione a **lista** de > de **nível de acesso** > **ListBucket**. Esta ação Obtém a lista de objetos no Bucket S3.
...
2. Selecione a **lista** de > de **nível de acesso** > **ListAccounts**. Essa ação Obtém os nomes das contas.
