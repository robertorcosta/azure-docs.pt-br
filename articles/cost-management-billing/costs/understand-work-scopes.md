...
- [**Conta de cobrança**](../manage/view-all-accounts.md) – representa um registro de ea. As notas fiscais são geradas nesse escopo. As compras que não são baseadas em uso, como Marketplace e reservas, estão disponíveis somente nesse escopo. Eles não são representados em departamentos ou contas de registro.
...
- [**Conta de cobrança**](../manage/view-all-accounts.md) – representa um proprietário de conta única para uma ou mais assinaturas do Azure. Atualmente, ele não dá suporte à concessão de acesso a várias pessoas ou acesso a exibições de custo agregado.
