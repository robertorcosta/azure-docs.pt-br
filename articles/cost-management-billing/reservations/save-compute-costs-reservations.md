...
- Saiba mais sobre reservas para planos de serviço:
    ...
    - [Recursos de computação de Banco de Dados SQL do Azure com capacidade reservada](../../azure-sql/database/reserved-capacity-overview.md) Saiba mais sobre reservas para planos de software:
