...
description: Saiba como um desconto de compra prévia do Azure Databricks se aplica ao seu uso. É possível usar o Databricks a qualquer momento durante a vigência da compra.
author: yashesvi
ms.reviewer: yashar
