...
2. A página de saldo oferece informações sobre o crédito restante e o usado. Você pode encontrar a data de expiração do crédito abaixo do gráfico de crédito.  
    ...
    ![Captura de tela que mostra informações de crédito da assinatura do Azure for Students](./media/azurestudents-subscription-disabled/azurestudents-credit-balance.png)
...
3. Para verificar o uso de serviços que estão consumindo o crédito do Azure, selecione **Uso** no painel de navegação esquerdo e, em seguida, selecione a assinatura do Azure for Students.
    ...
    ![Captura de tela que mostra informações de uso de crédito do Azure for Students](./media/azurestudents-subscription-disabled/azurestudents-credit-usage.png)

A tabela contém as seguintes colunas:

* **Nome do serviço:** serviço que está consumindo o crédito do Azure.
* **Recurso de serviço:** unidade de medida para o serviço que está sendo consumido.
* **Gasto:** valor de crédito em USD($) gasto no serviço.
