---
title: Administração do portal do EA do Azure para parceiros
description: Descreve os tópicos de administração do portal pertencentes aos Parceiros
author: bandersmsft
...
ms.locfileid: "84298169"
---
# <a name="azure-ea-portal-administration-for-partners"></a>Administração do portal do EA do Azure para parceiros

Este artigo explica as tarefas comuns que um administrador do EA realiza no portal do EA do Azure (https://ea.azure.com).
...
![Exemplo mostrando a caixa Adicionar Contato ](./media/ea-partner-portal-administration/create-ea-manage-partner-notification.png)
...
- Para obter informações introdutórias sobre o Portal do EA do Azure, confira o artigo [Introdução ao Portal do EA do Azure](ea-portal-get-started.md).
