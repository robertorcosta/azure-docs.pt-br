---
title: Termos em sua folha de preços do contrato do cliente da Microsoft-Azure
...
Se você for o proprietário, o colaborador, o leitor ou o gerenciador de faturas de um perfil de cobrança, baixe a planilha de preços de sua organização no portal do Azure. Confira [Exibir e baixar o preço de sua organização](ea-pricing.md).
...
| Produto  | Nome do produto que acumula os encargos. Por exemplo: BD SQL básico versus BD SQL padrão  |
...
- [Exibir e baixar o preço de sua organização](ea-pricing.md)
