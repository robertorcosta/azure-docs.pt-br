...
| Aplicativos Lógicos do Azure               | Microsoft.Logic/workflows       | Permite que os aplicativos lógicos acessem contas de armazenamento. |
...
| Stream Analytics do Azure         | Microsoft.StreamAnalytics       | Permite que os dados de um trabalho de streaming sejam gravados no armazenamento de BLOBs. Esse recurso está atualmente na visualização. [Saiba mais](../../stream-analytics/blob-output-managed-identity.md). |
