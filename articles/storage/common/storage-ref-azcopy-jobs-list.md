---
title: lista de trabalhos do azcopy | Microsoft Docs
description: Este artigo fornece informações de referência para o comando de lista de trabalhos do azcopy.
author: normesta
ms.service: storage
ms.topic: reference
ms.date: 07/24/2020
