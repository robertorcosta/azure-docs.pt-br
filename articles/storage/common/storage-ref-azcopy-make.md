...
|--cota-GB UInt32|Especifica o tamanho máximo do compartilhamento em gigabytes (GiB), zero significa que você aceita a cota padrão do serviço de arquivo.|
