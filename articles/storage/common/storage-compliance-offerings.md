...
description: Leia um resumo das ofertas de conformidade no armazenamento do Azure para obter os requisitos nacionais, regionais e específicos do setor que regem a coleta e o uso de dados.
services: storage
author: fhryo-msft
ms.service: storage
ms.topic: conceptual
...
* [FDA CFR Título 21 Parte 11](https://aka.ms/AzureCompliance)
...
* [VPATS Seção 508](https://www.microsoft.com/trustcenter/compliance/accessibility)
...
* [NZ CC Framework (Nova Zelândia)](https://www.microsoft.com/trustcenter/compliance/nzcc)
...
O Microsoft Azure e o Armazenamento do Azure mantêm a liderança em ofertas de conformidade. Encontre a cobertura mais recente e detalhes no [Microsoft TrustCenter](https://www.microsoft.com/TrustCenter/Compliance/default.aspx).
