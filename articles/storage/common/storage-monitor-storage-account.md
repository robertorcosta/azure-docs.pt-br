...
description: Saiba como monitorar uma conta de armazenamento no Azure usando o portal do Azure e Análise de Armazenamento do Azure.
author: normesta
ms.service: storage
ms.topic: conceptual
ms.date: 01/09/2020
...
1. Selecione **Diagnóstico** na seção **MONITORAMENTO** da folha de menu.
    ...
    ![Captura de tela que realça a opção configurações de diagnóstico (clássico) na seção monitoramento (clássico).](./media/storage-monitor-storage-account/storage-enable-metrics-00.png)
...
1. Selecione **Configurações de diagnóstico (clássico)** na seção **Monitoramento (clássico)** da folha de menu.
