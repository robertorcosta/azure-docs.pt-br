...
ms.locfileid: "87374160"
---
# <a name="transition-to-metrics-in-azure-monitor"></a>Transição para métricas no Azure Monitor

O armazenamento do Azure agora integra as métricas à plataforma Azure Monitor. Em **31 de agosto de 2023** análise de armazenamento métricas, também conhecidas como *métricas clássicas* serão desativadas. Se você usar métricas clássicas, certifique-se de fazer a transição para métricas em Azure Monitor antes dessa data. Este artigo ajuda você a fazer a transição.
