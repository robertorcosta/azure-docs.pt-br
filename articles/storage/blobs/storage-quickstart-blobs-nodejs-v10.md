---
title: 'Início Rápido: biblioteca de clientes do Armazenamento de Blobs do Azure v10 para JavaScript'
...
> [Referência de API de JavaScript](https://docs.microsoft.com/javascript/api/overview/azure/storage/client)
