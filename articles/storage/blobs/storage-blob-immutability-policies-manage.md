...
Bloquear políticas de imutabilidade (adicionar `-Force` para ignorar o prompt):
...
Remover uma política de imutabilidade desbloqueada `-Force` (Adicionar para ignorar o prompt):
