...
| Operações de Dados – Logs  | Sim | Sim | *Disponível agora* (visualização). Consulte [problemas conhecidos](data-lake-storage-known-issues.md).<br><br> Integração de Monitoramento do Azure – *Ainda não disponível* |
...
| Gerenciamento de Dados                             | Validade do arquivo                                                                                                                                        | Políticas de ciclo de vida                                                                                                                                                                                                                                                                                                                                                                                                          | Políticas de ciclo de vida *disponíveis agora* (visualização). Consulte [problemas conhecidos](data-lake-storage-known-issues.md).                                                                                                                     |
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SDK .NET                  | [Link](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Disponível agora* | *Disponível agora* |
...
| Logs de diagnóstico                                                                                        | [Link](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Disponível agora* (visualização). Consulte [problemas conhecidos](data-lake-storage-known-issues.md). <br>Integração do monitoramento do Azure- *ainda não disponível* |
