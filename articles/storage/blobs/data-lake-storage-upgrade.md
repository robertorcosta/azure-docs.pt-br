...
Esta tabela descreve quais conjuntos de APIs estão disponíveis para seus aplicativos personalizados. Para tornar as coisas um pouco mais claras, separamos esses conjuntos de API em dois tipos: APIs de gerenciamento e APIs do sistema de arquivos.

As APIs de gerenciamento ajudam a gerenciar contas, enquanto as APIs do sistema de arquivos ajudam você a operar nos arquivos e pastas.
