...
## <a name="supportedazureservices"></a>Serviços do Azure com suporte
...
|Serviço do Azure |Nível de suporte |{1&gt;{2&gt;Artigos relacionados&lt;2}&lt;1} |
|---------------|-------------------|---|
...
|Pesquisa Cognitiva do Azure| {1&gt;Preview&lt;1}|[Indexar e Pesquisar Azure Data Lake Storage Gen2 documentos (visualização)](https://docs.microsoft.com/azure/search/search-howto-index-azure-data-lake-storage)|
