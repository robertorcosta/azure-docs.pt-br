...
Para ler páginas, use o método [PageBlobClient. download](/dotnet/api/azure.storage.blobs.specialized.blobbaseclient.downloadto) para ler um intervalo de bytes do blob de páginas. 
