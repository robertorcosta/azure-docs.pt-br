...
|Suporte VNET|[Integração VNET](../../data-lake-store/data-lake-store-network-security.md)|[Pontos finais de serviço](../common/storage-network-security.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json), [pontos finais privados (visualização pública)](../common/storage-private-endpoints.md)|
...
|Logs de diagnóstico|Troncos clássicos<br>[Monitor Azure integrado](../../data-lake-store/data-lake-store-diagnostic-logs.md)|[Logs clássicos](../common/storage-analytics-logging.md) (Em visualização pública)<br>Integração do monitor Azure – linha do tempo TBD|
