...
O exemplo de código a seguir mostra como excluir um blob e seus instantâneos no .NET, `blobClient` em que é um objeto do tipo [BlobClient](/dotnet/api/azure.storage.blobs.blobclient)):
