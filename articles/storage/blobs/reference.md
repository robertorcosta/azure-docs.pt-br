...
| :-------: | ----------------------- | ------- | ---------- |
| 12.x | [Biblioteca de cliente de armazenamento de BLOBs do Azure para .NET](/dotnet/api/overview/azure/storage.blobs-readme) | [Pacote (NuGet)](https://www.nuget.org/packages/Azure.Storage.Blobs/) | [Início rápido: Biblioteca de clientes do Armazenamento de Blobs do Azure v12 para .NET](./storage-quickstart-blobs-dotnet.md) |
