...
* Uma extensão do Visual Studio Code para depuração do navegador, como:
    * [Depurador para o Microsoft Edge](vscode:extension/msjsdiag.debugger-for-edge)
    * [Depurador para o Chrome](vscode:extension/msjsdiag.debugger-for-chrome)
    * [Depurador para o Firefox](vscode:extension/firefox-devtools.vscode-firefox-debug)
