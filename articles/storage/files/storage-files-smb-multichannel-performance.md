...
- O desempenho de compartilhamento Premium é associado pelo tamanho do compartilhamento provisionado (IOPS/egresso/entrada) e limites de arquivo único. Para obter detalhes, consulte [noções básicas sobre provisionamento de compartilhamentos de arquivos Premium](storage-files-planning.md#understanding-provisioning-for-premium-file-shares).
