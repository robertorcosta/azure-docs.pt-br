...
1. Selecione um local para sua conta de armazenamento e verifique se ele é [uma das replicações com suporte para grandes compartilhamentos de arquivos](storage-files-planning.md#regional-availability).
