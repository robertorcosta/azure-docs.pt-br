...
Os cmdlets de exclusão reversível estão disponíveis na versão 2.1.3 e mais recentes do [módulo CLI do Azure](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest).
