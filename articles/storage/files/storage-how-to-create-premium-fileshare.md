...
description: Neste artigo, saiba como criar um compartilhamento de arquivos premium do Azure usando o portal do Azure, o PowerShell ou o CLI do Azure.
author: roygara
ms.service: storage
ms.topic: how-to
ms.date: 05/05/2019
