...
|----|----------------------|--------------|------------------|
| Versão v 11.1- [KB4539951](https://support.microsoft.com/en-us/help/4539951)| 11.1.0.0 | 4 de novembro de 2020 | Com suporte-comprovante |
...
- O agente requer pelo menos 2 GiB de memória. Se o servidor estiver sendo executado em uma máquina virtual com memória dinâmica ativada, a VM deverá ser configurada com um mínimo de 2048 MiB de memória. Confira [Recursos do sistema recomendados](https://docs.microsoft.com/azure/storage/files/storage-sync-files-planning#recommended-system-resources) para obter mais informações.
