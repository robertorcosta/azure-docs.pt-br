...
> [!NOTE]  
> A funcionalidade de teste integrada ao `Disabled` portal ignora a configuração. Isso significa que uma função desativada ainda é executada quando iniciada a partir da janela **teste** no portal. 
