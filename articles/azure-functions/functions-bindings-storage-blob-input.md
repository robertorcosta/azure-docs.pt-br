...
Acessar dados de blob por meio do parâmetro digitado como [InputStream](/python/api/azure-functions/azure.functions.inputstream). Consulte o [exemplo de entrada](#example) para obter detalhes.
