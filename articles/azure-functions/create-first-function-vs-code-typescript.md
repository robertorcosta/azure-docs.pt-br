---
title: Criar uma função TypeScript usando o Visual Studio Code – Azure Functions
...
Também há uma [versão baseada na CLI](create-first-function-cli-typescript.md) deste artigo.
