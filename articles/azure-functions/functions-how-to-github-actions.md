...
| Seção | Tarefas |
| ------- | ----- |
| **Autenticação** | <ol><li>Define a service principal.</li><li>Download publishing profile.</li><li>Create a GitHub secret.</li></ol>|
| **Compilar** | <ol><li>Set up the environment.</li><li>Compile o aplicativo de funções.</li></ol> |
| **Implantar** | <ol><li>Deploy the function app.</li></ol>|
