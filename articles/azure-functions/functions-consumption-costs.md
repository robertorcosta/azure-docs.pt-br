...
You chose the plan that best supports your function performance and cost requirements. Para saber mais, confira [Escala e hospedagem do Azure Functions](functions-scale.md).
...
1. At the left, select **Metrics** > **Select a resource**, then use the settings below the image to choose your function app.
    ...
    |---------|---------|---------|
    | Subscription    |  Sua assinatura  | The subscription with your function app.  |
    | Resource group     | Seu grupo de recursos  | The resource group that contains your function app.   |
    | Tipo de recurso     |  Serviços de Aplicativos | Function apps are shown as App Services instances in Monitor. |
    | Grupos     |  Your function app  | The function app to monitor.        |
