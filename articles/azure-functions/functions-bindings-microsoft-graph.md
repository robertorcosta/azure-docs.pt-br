...
- Use a identidade do aplicativo para lidar com todas as assinaturas. This will require consent from an Azure Active Directory admin. This can be used by all languages supported by Azure Functions.
