...
Quando um aplicativo é implantado no Windows, comandos específicos de idioma `dotnet restore` , como (C# `npm install` ) ou (JavaScript), são executados.
