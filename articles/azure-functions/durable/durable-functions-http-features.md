...
A resposta HTTP mencionada anteriormente foi criada para ajudar a implementar APIs assíncronas HTTP de execução longa com as Durable Functions. This pattern is sometimes referred to as the *polling consumer pattern*. O fluxo de cliente/servidor funciona da seguinte maneira:
