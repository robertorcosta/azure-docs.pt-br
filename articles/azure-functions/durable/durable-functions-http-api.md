...
|-----------------------|-----------|-------------|
| **`runtimeStatus`**   | cadeia de caracteres    | O status de runtime da instância. Os valores incluem *Em execução*, *Pendente*, *Falha*, *Cancelado*, *Encerrado*, *Concluído*. |
