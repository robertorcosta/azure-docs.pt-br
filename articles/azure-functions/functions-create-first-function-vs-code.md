...
1. Forneça as seguintes informações nos prompts:
    ...
    - **Selecione uma versão do Java** : escolha `Java 8` ou `Java 11`, na quais suas funções serão executadas no Azure. Escolha uma versão do Java verificada localmente.
