---
title: 'Azure ExpressRoute: Migre vnets clássicos para gerenciador de recursos'
...
* Verifique se você tem as versões mais recentes dos módulos Azure PowerShell. Para obter mais informações, consulte [Como instalar e configurar o Azure PowerShell](/powershell/azure/overview). Para instalar o módulo PowerShell Service Management (necessário para o modelo clássico de implantação), consulte [Instalando o Módulo de Gerenciamento de Serviços Do Azure PowerShell](/powershell/azure/servicemanagement/install-azure-ps).
...
* Examine a documentação de migração de recurso a seguir:
    ...
    * [Migração suportada por plataforma de recursos IaaS de classic para Azure Resource Manager](../virtual-machines/virtual-machines-windows-migration-classic-resource-manager.md)
...
* Não há suporte para a migração entre assinaturas do circuito do ExpressRoute. Para obter mais informações, consulte [o suporte ao movimento Microsoft.Network](../azure-resource-manager/management/move-support-resources.md#microsoftnetwork).
