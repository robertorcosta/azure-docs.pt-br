...
description: Saiba mais sobre o que significa mover um circuito do Azure ExpressRoute do modelo de implantação clássico para o Azure Resource Manager.
