...
description: Saiba como criar e gerenciar a configuração de roteamento de um circuito do ExpressRoute no modelo de implantação do Gerenciador de recursos usando o PowerShell.
