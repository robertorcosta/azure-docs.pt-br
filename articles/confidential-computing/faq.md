...
Este artigo fornece respostas a algumas das perguntas mais comuns sobre a execução de [cargas de trabalho de computação confidencial no Azure](overview.md).
