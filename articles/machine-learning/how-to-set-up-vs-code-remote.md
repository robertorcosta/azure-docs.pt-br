...
* Instância de computação habilitada para SSH. Para obter mais informações, [consulte o guia criar uma instância de computação](concept-compute-instance.md#create).
