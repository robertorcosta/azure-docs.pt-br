...
> [!TIP]
> A instância de computação tem o disco do sistema operacional de 120 GB. Se você ficar sem espaço em disco, desmarque espaço suficiente antes de tentar parar/reiniciar a instância de computação.
