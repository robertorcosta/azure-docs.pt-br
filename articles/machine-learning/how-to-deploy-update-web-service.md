...
Para obter mais informações, consulte a documentação de [atualização do serviço AZ ml](/cli/azure/ext/azure-cli-ml/ml/service#ext-azure-cli-ml-az-ml-service-update) .
