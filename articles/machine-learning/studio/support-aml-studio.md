---
title: Suporte ao tutorial do ML Studio (clássico) & treinamento – Azure
...
+ **Fórum do usuário**: faça perguntas, responda perguntas e conecte-se a outros usuários no [Fórum de suporte do Azure Machine Learning Studio (clássico)](https://docs.microsoft.com/answers/topics/azure-machine-learning.html).
