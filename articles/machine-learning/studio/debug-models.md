...
description: Como depurar erros produzidos pelos módulos Train Model e Score Model no Azure Machine Learning Studio (clássico).
...
1. O tipo de modelo de machine learning a partir da coleção de modelos fornecidos pelo Azure Machine Learning Studio (clássico).
