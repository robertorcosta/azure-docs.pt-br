...
ms.locfileid: "79218220"
---
# <a name="consuming-an-azure-machine-learning-studio-classic-web-service-from-excel"></a>Consumindo um Azure Machine Learning Studio (clássico) Web Service do Excel
...
Publicar um serviço Web. [Tutorial 3: Implantar modelo de risco de crédito](tutorial-part3-credit-risk-deploy.md) explica como fazê-lo. Atualmente, o recurso de pasta de trabalho do Excel só tem suporte para serviços de Solicitação/Resposta que têm uma única saída (ou seja, um único rótulo de pontuação). 
...
1. Na guia **PAINEL** para o serviço Web, há uma linha para o serviço de **SOLICITAÇÃO/RESPOSTA**. Se esse serviço tiver uma única saída, você deve ver o link **Baixar Pasta de Trabalho do Excel** nessa linha.
    ...
    ![Baixe o Excel Workbook usando o portal Studio (clássico) Web Service](./media/consuming-from-excel/excellink.png)
...
2. Será exibido um Aviso de Segurança; clique no botão **Habilitar Edição** .
    ...
    ![Habilite a edição para remover o aviso de segurança de exibição protegido](./media/consuming-from-excel/enableeditting.png)
3. Será exibido um Aviso de Segurança. Clique no botão **Habilitar Conteúdo** para executar macros na sua planilha.

    ![Habilite o conteúdo para desativar as macros de desativação do Aviso de Segurança](./media/consuming-from-excel/enablecontent.png)
