...
A [partição e][partition-and-sample] o módulo de exemplo podem ser usados para atribuir aleatoriamente dobras aos dados. No exemplo de configuração a seguir para o módulo, definimos cinco dobras e atribuímos aleatoriamente um número de dobras para as instâncias de amostra.
