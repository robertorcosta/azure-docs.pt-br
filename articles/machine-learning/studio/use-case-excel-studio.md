...
| Erro Absoluto Médio (%) |<span style="background-color: 00FF00;">6, 3%</span> |12,2% |<span style="background-color: 00FF00;">6, 3%</span> |
...
Também descobrimos que é aconselhável usar a [Seleção de Recursos com Base em Filtro][filter-based-feature-selection] para acelerar projetos de previsão futuros. Ao aplicar a seleção de recursos aos seus dados, você pode criar um modelo aprimorado no Studio (clássico) com melhor desempenho geral. 
