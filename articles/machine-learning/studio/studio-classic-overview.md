...
Para obter ajuda sobre navegação por meio da grande biblioteca de algoritmos de machine learning disponíveis, confira [Como escolher algoritmos para o Microsoft Machine Learning Studio (clássico)](algorithm-choice.md).
