...
Consulte o [instruções](how-to-train-with-datasets.md#mount-files-to-remote-compute-targets) para obter um exemplo de como usar a `Dataset` classe para montar dados em seu destino de computação.
