...
> [!TIP]
> Se você não tiver certeza sobre a memória, a CPU ou as necessidades de GPU de sua implantação, poderá usar a criação de perfil para aprender isso. Para obter mais informações, consulte [como e onde implantar um modelo](how-to-deploy-and-where.md#prepare-to-deploy).
