...
+ Na Web:
    ...
    + [Azure Machine Learning designer](concept-designer.md) – disponível apenas em espaços de trabalho do [Enterprise Edition](overview-what-is-azure-ml.md#sku) .
