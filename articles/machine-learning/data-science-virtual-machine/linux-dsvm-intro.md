...
## <a name="create-your-centos-data-science-virtual-machine"></a>Criar sua Máquina Virtual de Ciência de Dados do CentOS

Veja as etapas para criar uma instância da Máquina Virtual de Ciência de Dados do CentOS:
...
1. Digite "máquina virtual de ciência de dados" na barra de pesquisa e selecione a DSVM do CentOS.

    ![Resultado da pesquisa do CentOS](./media/linux-dsvm-intro/search-centos.png)
...
1. Você deve ser redirecionado para a folha "Criar uma máquina virtual".
   ...
   ![Guia Noções básicas correspondente à máquina virtual do CentOS](./media/linux-dsvm-intro/review-create-centos.png)
...
## <a name="how-to-access-the-centos-data-science-virtual-machine"></a>Como acessar a Máquina Virtual de Ciência de Dados do CentOS

É possível acessar a DSVM do CentOS usando três métodos:
...
1. Agora você deve ver a interface gráfica para sua DSVM do CentOS. 


### <a name="jupyterhub-and-jupyterlab"></a>JupyterHub e JupyterLab

A DSVM do CentOS executa o [JupyterHub](https://github.com/jupyterhub/jupyterhub), um servidor Jupyter multiusuário. Para conectar, execute as seguintes etapas:
