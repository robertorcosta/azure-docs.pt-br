...
* [**Máquina virtual de ciência de dados Linux**](https://azure.microsoft.com/marketplace/apps/microsoft-dsvm.ubuntu-1804). Para obter informações sobre como provisionar a máquina virtual, consulte [provisionar o Linux máquina virtual de ciência de dados](linux-dsvm-intro.md).
...
> [!NOTE]
> Este tutorial foi criado com o uso de um DSVM Linux de um tamanho D2 v2 (Ubuntu 18, 4 Edition). Você pode usar um DSVM esse tamanho para concluir os procedimentos que são demonstrados neste passo a passos.
...
* Colunas como **palavra\_freq\_** Word indicam a porcentagem de palavras no email que correspondem à *palavra*. Por exemplo, se **Word\_freq\_Make** for **1**, 1% de todas as palavras no email foram *feitas*.
* Colunas como **Char\_freq\_char** indicam a porcentagem de todos os caracteres no email que são *Char*.
...
1. Selecione **Windows** > **drivers de exibição**do Windows.
...
O SQL Data Warehouse do Azure é um banco de dados baseado em nuvem e escalável que pode processar volumes maciços e não relacionais. Para obter mais informações, consulte [O que é Azure SQL Data Warehouse?](../../synapse-analytics/sql-data-warehouse/sql-data-warehouse-overview-what-is.md)
