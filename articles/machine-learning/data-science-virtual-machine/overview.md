...
description: 'Visão geral da Máquina Virtual de Ciência de Dados do Azure: uma máquina virtual fácil de criar e usar na plataforma de nuvem do Azure, com ferramentas e bibliotecas configuradas e pré-instaladas para fazer ciência de dados e desenvolver aplicativos inteligentes.'
...
As edições do Windows da DSVM vêm pré-instaladas com drivers de GPU, estruturas e versões de GPU de estruturas de aprendizado profundo. Na edição para Linux, o aprendizado profundo em GPUs está habilitado nos DSVMs CentOS e Ubuntu. 
