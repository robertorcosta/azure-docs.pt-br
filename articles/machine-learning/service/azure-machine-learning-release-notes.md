...
+ **Correções de bugs e melhorias**
  ...
  + **azureml-automl-Core**
    ...
    + Permitir que os dados intermediários em Azure Machine Learning pPipeline sejam convertidos em um DataSet tabular e usados em `AutoMLStep`.
