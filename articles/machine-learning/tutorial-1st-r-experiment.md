---
title: 'Tutorial: Usar o R para criar um modelo de machine learning (versão prévia)'
titleSuffix: Azure Machine Learning
description: Neste tutorial, você usará o SDK do R do Azure Machine Learning para criar um modelo de regressão logística que prevê a probabilidade de uma fatalidade em um acidente de carro.
...
> [!IMPORTANT]
> No momento, o SDK do R do Azure Machine Learning está em versão prévia pública.
...
1. Execute `git clone https://github.com/Azure/azureml-sdk-for-r` no terminal para clonar o repositório.
...
A instância de computação já tem a última versão do SDK do R do CRAN instalada. Caso deseje instalar a versão de desenvolvimento do GitHub em vez de selecionar as correções de bug mais recentes, execute o seguinte:
...
> [!WARNING]
> Durante o processo de instalação, se você receber o aviso "`Would you like to install Miniconda? [Y/n]:`", responda a ele com "`n`", pois a instância de computação já tem o Anaconda instalado e uma instalação do Miniconda não é necessária.

Prossiga e importe o pacote **azuremlsdk**.
...
Com seu modelo, você pode prever o perigo de morte decorrente de uma colisão. Use o Azure ML para implantar seu modelo como um serviço de previsão. Neste tutorial, você implantará o serviço Web no ACI [(Instâncias de Contêiner do Azure)](../container-instances/index.yml).
