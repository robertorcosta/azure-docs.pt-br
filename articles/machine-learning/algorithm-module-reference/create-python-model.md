...
Este artigo mostrará como usar o **modelo de criação de Python** com um pipeline simples. Abaixo está o grafo do pipeline.

![criar-Python-Model](./media/module/create-python-model.png)
