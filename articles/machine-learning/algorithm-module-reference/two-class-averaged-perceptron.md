...
description: Saiba como usar o módulo Two-Class Averageed perceptron no Azure Machine Learning para criar um modelo de aprendizado de máquina com base no algoritmo de média de perceptron.
