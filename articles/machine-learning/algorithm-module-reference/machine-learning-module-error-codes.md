...
|Tipo de parâmetro sem suporte ' {parameter_name} ' especificado.|
|Tipo de parâmetro sem suporte ' {parameter_name} ' especificado. Motivo: {reason}.|
...
## <a name="error-0154"></a>Erro 0154  
 Ocorrerá uma exceção quando o usuário tentar unir dados em colunas de chave com tipo de coluna incompatível.
