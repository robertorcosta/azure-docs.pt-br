...
Este exemplo procura a cadeia de caracteres especificada em qualquer posição dentro da segunda coluna do conjunto de um. A posição é indicada aqui pelo valor de índice de 1. A correspondência diferencia maiúsculas de minúsculas.
...
1. Na caixa **expressão relacional** , insira uma expressão que executa uma operação de comparação em uma única coluna.
   ...
   - Use o caractere de e comercial, `&`, para a operação e. Use o caractere de barra vertical, `|`, para a operação ou.
