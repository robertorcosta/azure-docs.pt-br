...
Para instalar pacotes R `install.packages()` adicionais, use o método. Certifique-se de especificar o repositório CRAN. Os pacotes são instalados para cada módulo **execute R Script** e não são compartilhados em outros módulos execute R **Script.**
