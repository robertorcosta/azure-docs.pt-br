...
Crie o [`AmlCompute`](https://docs.microsoft.com/python/api/azureml-core/azureml.core.compute.amlcompute%28class%29?view=azure-ml-py) destino em seu espaço de`ws`trabalho () se ele ainda não existir.
