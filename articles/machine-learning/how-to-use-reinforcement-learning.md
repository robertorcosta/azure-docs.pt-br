---
title: Treinar e implantar um modelo de aprendizado por reforço.
titleSuffix: Azure Machine Learning
description: Saiba como usar o RL (Reinforcement Learning) do Azure Machine Learning para treinar um agente de RL para jogar Pong.
...
Este artigo se baseia no [exemplo do Pong de RLlib](https://aka.ms/azureml-rl-pong) que pode ser encontrado no [repositório GitHub](https://aka.ms/azureml-rl-notebooks) do notebook do Azure Machine Learning.
...
Execute este código em um dos ambientes a seguir. Recomendamos que você use a instância de computação do Azure Machine Learning para uma experiência de inicialização mais rápida. Os notebooks de exemplo de reforço estão disponíveis para clonar e executar rapidamente em uma instância de computação do Azure Machine Learning.
 ...
 - Seu próprio servidor Jupyter Notebook
    ...
    - Instale o [SDK do RL do Azure Machine Learning](https://review.docs.microsoft.com/python/api/azureml-contrib-reinforcementlearning/?view=azure-ml-py&branch=harnvirdebug): `pip install --upgrade azureml-contrib-reinforcementlearning`
...
Nesta seção, você aprenderá a usar o [ReinforcementLearningEstimator](https://review.docs.microsoft.com/python/api/azureml-contrib-reinforcementlearning/azureml.contrib.train.rl.reinforcementlearningestimator?view=azure-ml-py&branch=harnvirdebug) para enviar um trabalho de treinamento para o Azure Machine Learning.
...
Neste artigo, você aprendeu a treinar um agente de aprendizado por reforço usando um agente de aprendizado do IMPALA. Para ver exemplos adicionais, vá para o [Repositório GitHub do Reinforcement Learning do Azure Machine Learning](https://aka.ms/azureml-rl-notebooks).