...
> [!NOTE]
> As instâncias de computação (versão prévia) estão disponíveis somente para espaços de trabalho com uma região de **EUA Central norte** ou **sul do Reino Unido**.
