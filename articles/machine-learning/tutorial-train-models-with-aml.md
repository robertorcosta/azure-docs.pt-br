...
>[!NOTE]
> O código deste artigo foi testado com a versão 1.0.83 do [SDK do Azure Machine Learning](https://docs.microsoft.com/python/api/overview/azure/ml/intro?view=azure-ml-py&preserve-view=true).
