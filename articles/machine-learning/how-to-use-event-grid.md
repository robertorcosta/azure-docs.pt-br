...
É possível instalar a [CLI do Azure](/cli/azure/install-azure-cli) mais recente ou usar o Azure Cloud Shell fornecido como parte da assinatura do Azure.
