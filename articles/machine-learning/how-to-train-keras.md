...
- Instância de computação de Azure Machine Learning-nenhum download ou instalação é necessário
 ...
 - Seu próprio servidor Jupyter Notebook
    ...
    - `mnist-keras.py` [Baixe os arquivos de script de exemplo](https://github.com/Azure/MachineLearningNotebooks/tree/master/how-to-use-azureml/training-with-deep-learning/train-hyperparameter-tune-deploy-with-keras) e`utils.py`
