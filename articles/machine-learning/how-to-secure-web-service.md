...
Para desabilitar o TLS para um modelo implantado no serviço kubernetes do `SslConfiguration` Azure `status="Disabled"`, crie um com e, em seguida, execute uma atualização:
