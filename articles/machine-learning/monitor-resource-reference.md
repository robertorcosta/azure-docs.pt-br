...
- Consulte [monitoramento Azure Machine Learning](service/monitor-azure-machine-learning.md) para obter uma descrição do Azure Machine Learning de monitoramento.
