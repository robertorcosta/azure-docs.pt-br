...
Neste estágio, você desenvolverá uma arquitetura da solução do pipeline de dados. Você desenvolverá o pipeline em paralelo com o próximo estágio do projeto de ciência de dados. Dependendo das necessidades da sua empresa e das restrições dos seus sistemas existentes nos quais esta solução está sendo integrada, o pipeline pode ser uma das seguintes opções: 
