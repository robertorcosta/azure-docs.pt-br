...
1. **Classificação binária**: para prever se uma gorjeta foi paga ou não por uma corrida, ou seja, um *valor\_Tip* maior que $0 é um exemplo positivo, enquanto um *valor Tip\_* de $0 é um exemplo negativo.
