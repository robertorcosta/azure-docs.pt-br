...
Dependendo se seus dados estão no local, na nuvem ou em streaming em tempo real, existem diferentes mecanismos disponíveis para mover os dados para o ponto final do seu serviço web para pontuação.
...
* Para obter uma explicação de como implantar seu serviço Web de pontuação, confira [Implantar um serviço Web de Azure Machine Learning](../studio/deploy-a-machine-learning-web-service.md)
