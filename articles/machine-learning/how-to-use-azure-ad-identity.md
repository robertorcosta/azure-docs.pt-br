...
- Acesso ao cluster AKS usando o comando `kubectl`. Para obter mais informações, consulte [conectar-se ao cluster](https://docs.microsoft.com/azure/aks/kubernetes-walkthrough#connect-to-the-cluster)
...
Se você tiver dado seu acesso de leitura de identidade do Azure aos dados dentro de um **blob de armazenamento**, seu `score.py` poderá acessá-lo usando o código a seguir.
