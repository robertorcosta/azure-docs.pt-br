...
description: Neste artigo, você aprenderá sobre os conceitos que se aplicam aos Serviços meteorológicos do Microsoft Azure Maps.
author: philmea
ms.author: philmea
ms.date: 11/20/2019
ms.topic: conceptual
...
Este artigo introduz conceitos que se aplicam aos [Serviços meteorológicos do Azure Maps.](https://aka.ms/AzureMapsWeatherService) Recomendamos passar por este artigo antes de começar com as APIs meteorológicas. 

## <a name="unit-types"></a>Tipos de unidades

Algumas das APIs de serviço meteorológico permitem que o usuário especifique se os dados são devolvidos em unidades métricas ou em unidades imperiais. As respostas retornadas para essas APIs incluem unitType e um valor numérico que pode ser usado para traduções unitárias. Veja a tabela abaixo para interpretar esses valores.
...
|5       |Medidor               |
|6       |Quilômetro           |
|7       |quilômetrosPerHour   |
|8       |Nós               |
|9       |milhasPerHour        |
|10      |metersPerSegundo     |
|11      |hectoPascals        |
|12      |polegadasOfMercury     |
|13      |kiloPascals         |
|14      |Milibares           |
...
Algumas das APIs de `iconCode` serviço meteorológico retornam na resposta. O `iconCode` é um valor numérico usado para definir o ícone. Não se vincule diretamente a essas imagens de seus aplicativos, os URLs podem e serão alterantes.

| Número do ícone |ícone| Dia | Noite | Texto |
|-------------|:----:|-----|-------|------|
| 1           |![](./media/weather-services-concepts/sunny-i.png)                      | Sim |  Não    | Ensolarado|
| 2           |![](./media/weather-services-concepts/mostly-sunny.png)                | Sim |  Não    | Principalmente ensolarado|
...
| 6           |![](./media/weather-services-concepts/mostly-cloudy.png)               | Sim |  Não    | Principalmente nublado|
...
| 11           |![](./media/weather-services-concepts/fog-i.png)                       | Sim |  Sim   | Nevoeiro|
| 12           |![](./media/weather-services-concepts/showers-i.png)                   | Sim |  Sim   | Chuveiros|
| 13           |![](./media/weather-services-concepts/mostly-cloudy-showers.png)       | Sim |  Não    | Principalmente nublado com chuveiros|
| 14           |![](./media/weather-services-concepts/partly-sunny-showers.png)        | Sim |  Não    | Parcialmente ensolarado com chuveiros|
| 15           |![](./media/weather-services-concepts/tstorms-i.png)                   | Sim |  Sim   | Trovoadas|
| 16           |![](./media/weather-services-concepts/mostly-cloudy-tstorms.png)       | Sim |  Não    | Principalmente nublado com trovoadas|
| 17           |![](./media/weather-services-concepts/partly-sunny-tstorms.png)        | Sim |  Não    | Parcialmente ensolarado com tempestades|
| 18           |![](./media/weather-services-concepts/rain-i.png)                      | Sim |  Sim   | Chuva|
| 19           |![](./media/weather-services-concepts/flurries-i.png)                  | Sim |  Sim   | Nevões|
| 20           |![](./media/weather-services-concepts/mostly-cloudy-flurries.png)      | Sim |  Não    | Principalmente nublado com turbulências|
...
| 23           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | Sim |  Não    | Principalmente nublado com neve|
| 24           |![](./media/weather-services-concepts/ice-i.png)                       | Sim |  Sim   | Gelo |
| 25           |![](./media/weather-services-concepts/sleet-i.png)                     | Sim |  Sim   | Granizo|
| 26           |![](./media/weather-services-concepts/freezing-rain.png)              | Sim |  Sim   | Chuva congelante|
...
| 34           |![](./media/weather-services-concepts/mostly-clear-night.png)          | Não  |  Sim   | Principalmente Claro|
...
| 38           |![](./media/weather-services-concepts/mostly-cloudy-night.png)         | Não  |  Sim   | Principalmente nublado|
| 39           |![](./media/weather-services-concepts/partly-cloudy-showers-night.png)  | Não  |  Sim   | Parcialmente nublado com chuveiros|
| 40           |![](./media/weather-services-concepts/mostly-cloudy-showers-night.png)  | Não  |  Sim   | Principalmente nublado com chuveiros|
| 41           |![](./media/weather-services-concepts/partly-cloudy-tstorms-night.png)  | Não  |  Sim   | Parcialmente nublado com trovoadas|
| 42           |![](./media/weather-services-concepts/mostly-cloudy-tstorms-night.png)  | Não  |  Sim   | Principalmente nublado com trovoadas|
| 43           |![](./media/weather-services-concepts/mostly-cloudy-flurries-night.png) | Não  |  Sim   | Principalmente nublado com turbulências|
| 44           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | Não  |  Sim   | Principalmente nublado com neve|


## <a name="radar-and-satellite-imagery-color-scale"></a>Escala de cores de radares e imagens de satélite

Via [Get Map Tile v2 Os](https://aka.ms/AzureMapsWeatherTiles) usuários da API podem solicitar imagens de radar e satélite infravermelho mais recentes. Veja abaixo o guia para ajudar a interpretar as cores usadas para radares e telhas de satélite.

### <a name="radar-images"></a>Imagens de radar

A tabela abaixo fornece orientação para interpretar as imagens do radar e criar uma legenda de mapa para dados de ladrilhos do Radar.

| Código de cor hex | Amostra de cor | Condição meteorológica |
|----------------|--------------|-------------------|
| #93c701        | ![](./media/weather-services-concepts/color-93c701.png) | Luz da Chuva |
...
| #ae6ee6        | ![](./media/weather-services-concepts/color-ae6ee6.png) | Mistura-moderada |
| #8a32d7        | ![](./media/weather-services-concepts/color-8a32d7.png) | Mistura-pesado |
| #6500ba        | ![](./media/weather-services-concepts/color-6500ba.png) | Mix-Severe |

A paleta de cores detalhada para ladrilhos de radar com códigos de cores Hex e valores dBZ é mostrada abaixo. dBZ representa intensidade de precipitação no radar meteorológico. 

| **Chuva**             | **Gelo**              | **Neve**              | **MIXED**             |
|----------------------|----------------------|-----------------------|-----------------------|
...
| 17.75 (#1B8103) | (#E67DB4) 20 | (#4BA2E0) 20  | (#A560E1) 20 |
| 19 (#187102) | 21.25 (#E275B0) | 21.25 (#459EDF) | 21.25 (#A35DE0) |
| 20.25 (#166102) | 22,5 (#DF6DAD) | 22.5 (#409BDE)  | 22,5 (#A15ADF) |
| 20,75 (#165B02) | (#DC66AA) 23.75 | 23.75 (#3A98DD)  | 23.75 (#9F56DE) |
| 22 (#135001) | (#D85EA6) 25 | (#3595DC)  | (#9D53DD) |
...
| 27 (#114401) | 30 (#CB409C) | 30 (#2173E2)  | (#8E39D8) 30 |
| 28.25 (#0F3D01) | 31.25 (#C7399A) | (#1C66E5)  | (#8A32D7) 31.25 |
| 28,75 (#0F3A01) | 32.5 (#C43298) | 32.5 (#1858E9)  | 32.5 (#862ED2) |
| 30 (#375401) | 33.75 (#C12B96) | 33.75 (#144BED)  | (#832BCE) |
| 31.25 (#5F6E01) | 35 (#BD2494) | (#1348EA) 35  | 35 (#7F28C9) |
| 32.5 (#878801) | 36.25 (#BA1D92) | 36.25 (#1246E7)  | 36.25 (#7C25C5) |
| (#AFA201) | 37.5 (#B71691) | 37.5 (#1144E4)  | 37.5 (#7822C1) |
| (#D7BC01) 35 | 38.75 (#B51690) | 38.75 (#1142E1)  | (#751FBC) 38.75 |
...
| 41.25 (#F89209) | 45 (#AB168B) | (#0D38D2) 45  | 45 (#6D16B4) |
...
| 45.5 (#DC250E) | 50 (#A41687) | (#0A30C6)  | 50 (#6B12B5) |
| 46.75 (#D21C0C) | 51.25 (#A21686) | 51.25 (#0A2EC4)  | (#6B11B5) 51.25 |
...
| 65 (#9315c8) | (#8B1579) 65 | 65 (#0513A9)  | 65 (#6707B8) |
...
A tabela abaixo fornece orientação para interpretar as imagens de satélite infravermelha mostrando nuvens por sua temperatura e como criar uma lenda do mapa para essas telhas. 
...
A paleta de cores detalhada para telhas de satélite infravermelhas é mostrada abaixo.

|**Temperatura (K)**|**Código de cor hex**|
|--------|--------------|
|198     |#fe050505     |
|198.43  |#fe120505     |
|198.87  |#fc1f0505     |
