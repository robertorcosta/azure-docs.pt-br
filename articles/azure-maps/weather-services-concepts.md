...
| Icon Number |ícone| Dia | Night | Texto |
|-------------|:----:|-----|-------|------|
| 1           |![](./media/weather-services-concepts/sunny-i.png)                      | SIM |  Não    | Ensolarado|
| 2           |![](./media/weather-services-concepts/mostly-sunny.png)                | SIM |  Não    | Mostly Sunny|
| 3           |![](./media/weather-services-concepts/partly-sunny.png)                | SIM |  Não    | Partly Sunny|
| 4           |![](./media/weather-services-concepts/intermittent-clouds.png)         | SIM |  Não    | Intermittent Clouds|
| 5           |![](./media/weather-services-concepts/hazy-sunshine.png)               | SIM |  Não    | Hazy Sunshine |
| 6           |![](./media/weather-services-concepts/mostly-cloudy.png)               | SIM |  Não    | Mostly Cloudy|
| 7           |![](./media/weather-services-concepts/cloudy-i.png)                     | SIM |  SIM   | Cloudy |
| 8           |![](./media/weather-services-concepts/dreary-overcast.png)             | SIM |  SIM   | Dreary (Overcast)|
| 11           |![](./media/weather-services-concepts/fog-i.png)                       | SIM |  SIM   | Fog|
| 12           |![](./media/weather-services-concepts/showers-i.png)                   | SIM |  SIM   | Showers|
| 13           |![](./media/weather-services-concepts/mostly-cloudy-showers.png)       | SIM |  Não    | Mostly Cloudy with Showers|
| 14           |![](./media/weather-services-concepts/partly-sunny-showers.png)        | SIM |  Não    | Partly Sunny with Showers|
| 15           |![](./media/weather-services-concepts/tstorms-i.png)                   | SIM |  SIM   | Thunderstorms|
| 16           |![](./media/weather-services-concepts/mostly-cloudy-tstorms.png)       | SIM |  Não    | Mostly Cloudy with Thunderstorms|
| 17           |![](./media/weather-services-concepts/partly-sunny-tstorms.png)        | SIM |  Não    | Partly Sunny with Thunderstorms|
...
| 20           |![](./media/weather-services-concepts/mostly-cloudy-flurries.png)      | SIM |  Não    | Mostly Cloudy with Flurries|
| 21           |![](./media/weather-services-concepts/partly-sunny-flurries.png)       | SIM |  Não    | Partly Sunny with Flurries|
| 22           |![](./media/weather-services-concepts/snow-i.png)                      | SIM |  SIM   | Snow|
| 23           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | SIM |  Não    | Mostly Cloudy with Snow|
| 24           |![](./media/weather-services-concepts/ice-i.png)                       | SIM |  SIM   | Ice |
| 25           |![](./media/weather-services-concepts/sleet-i.png)                     | SIM |  SIM   | Sleet|
| 26           |![](./media/weather-services-concepts/freezing-rain.png)              | SIM |  SIM   | Freezing Rain|
| 29           |![](./media/weather-services-concepts/rain-snow.png)                  | SIM |  SIM   | Rain and Snow|
| 30           |![](./media/weather-services-concepts/hot-i.png)                       | SIM |  SIM   | Quente|
| 31           |![](./media/weather-services-concepts/cold-i.png)                      | SIM |  SIM   | Frio|
| 32           |![](./media/weather-services-concepts/windy-i.png)                     | SIM |  SIM   | Windy|
| 33           |![](./media/weather-services-concepts/clear-night.png)                | Não  |  SIM   | Desmarcar|
| 34           |![](./media/weather-services-concepts/mostly-clear-night.png)          | Não  |  SIM   | Mostly Clear|
| 35           |![](./media/weather-services-concepts/partly-cloudy-night.png)         | Não  |  SIM   | Partly Cloudy|
| 36           |![](./media/weather-services-concepts/intermittent-clouds-Night.png)   | Não  |  SIM   | Intermittent Clouds|
| 37           |![](./media/weather-services-concepts/hazymoon-light.png)             | Não  |  SIM   | Hazy Moonlight|
| 38           |![](./media/weather-services-concepts/mostly-cloudy-night.png)         | Não  |  SIM   | Mostly Cloudy|
| 11,8           |![](./media/weather-services-concepts/partly-cloudy-showers-night.png)  | Não  |  SIM   | Partly Cloudy with Showers|
| 40           |![](./media/weather-services-concepts/mostly-cloudy-showers-night.png)  | Não  |  SIM   | Mostly Cloudy with Showers|
| 41           |![](./media/weather-services-concepts/partly-cloudy-tstorms-night.png)  | Não  |  SIM   | Partly Cloudy with Thunderstorms|
| 42           |![](./media/weather-services-concepts/mostly-cloudy-tstorms-night.png)  | Não  |  SIM   | Mostly Cloudy with Thunderstorms|
| 43           |![](./media/weather-services-concepts/mostly-cloudy-flurries-night.png) | Não  |  SIM   | Mostly Cloudy with Flurries|
| 44           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | Não  |  SIM   | Mostly Cloudy with Snow|
