...
description: Saiba como adicionar formas a mapas. Consulte exemplos de código que usam o SDK do Android do Azure Maps para adicionar uma linha e um polígono a um mapa.
author: anastasia-ms
ms.author: v-stharr
ms.date: 04/26/2019
ms.topic: how-to
