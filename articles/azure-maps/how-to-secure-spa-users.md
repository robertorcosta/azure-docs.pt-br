...
7. Configure o controle de acesso baseado em função do Azure para usuários ou grupos. Consulte as [seções a seguir para habilitar o RBAC](#grant-role-based-access-for-users-to-azure-maps).
