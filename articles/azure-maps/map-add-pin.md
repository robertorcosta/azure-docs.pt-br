...
- Geojson MultiPoint Geometry-este objeto contém as coordenadas de vários pontos e nada mais. A classe auxiliar `atlas.data.MultiPoint` pode ser usada para criar facilmente esses objetos.
