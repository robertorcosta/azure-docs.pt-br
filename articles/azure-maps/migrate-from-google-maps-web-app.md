...
- As coordenadas no Google Maps usam "latitude, longitude", enquanto o Azure Mapas usa "longitude, latitude". O formato do Azure Mapas está alinhado com o padrão `[x, y]`, seguido pela maioria das plataformas GIS.
