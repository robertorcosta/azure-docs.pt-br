---
title: Entender sua fatura do Contrato de Parceiro da Microsoft no Azure
description: Saiba como ler e entender sua fatura do Contrato de Parceiro da Microsoft no Azure
author: bandersmsft
manager: jureid
tags: billing
...
ms.locfileid: "74226063"
---
# <a name="terms-in-your-microsoft-partner-agreement-invoice"></a>Termos em sua fatura do Contrato de Parceiro da Microsoft

Este artigo se aplica a uma conta de cobrança do Azure para um Contrato de Parceiro da Microsoft. [Verifique se você tem acesso a um Contrato de Parceiro da Microsoft](#check-access-to-a-microsoft-partner-agreement).
...
| Termos de pagamento |Como você paga pela fatura da Microsoft. *60 dias líquidos* significa que você paga dentro de 60 dias da data da fatura. |
...
## <a name="billing-details-by-product"></a>Detalhes de cobrança por produto

A seção **Detalhes de cobrança por produto** lista os encargos totais de cada produto associado a este perfil de cobrança. Você pode exibir um detalhamento diário dos encargos de cada produto no CSV de uso e encargos do Azure. Para saber mais sobre como reconciliar o PDF da fatura com o CSV de uso e encargos do Azure, confira [Entender sua fatura do Contrato de Parceiro da Microsoft](billing-mpa-understand-your-bill.md).

## <a name="how-to-pay"></a>Como pagar

Na parte inferior da fatura, há instruções para pagar sua fatura. Você pode pagar por transferência ou cheque dentro de 60 dias da data da fatura.
