...
Para entender e visualizar a aplicação de suas reservas do Azure nos relatórios de uso de faturamento, confira [Entender o uso de reserva do Azure](billing-understand-reserved-instance-usage-ea.md).
...
* [Pagar antecipadamente pelos recursos de computação do Azure Data Explorer com a capacidade reservada do Azure Data Explorer](../data-explorer/pricing-reserved-capacity.md)  
