...
### <a name="microsoft-online-services-program"></a>Programa Microsoft Online Services
 ...
 ![Captura de tela que mostra a hierarquia MOSP](./media/billing-view-all-accounts/mosp-hierarchy.png)
...
![Captura de tela que mostra a hierarquia de EA](./media/billing-view-all-accounts/ea-hierarchy.png)
...
![Captura de tela que mostra a hierarquia de MCA](./media/billing-view-all-accounts/mca-hierarchy.png)
...
![Captura de tela que mostra a hierarquia de MPA](./media/billing-view-all-accounts/mpa-hierarchy.png)
...
3. Na página de visão geral, selecione **Alternar escopo**.
   ...
   ![Captura de tela que mostra os escopos do orçamento](./media/billing-view-all-accounts/overview-select-scopes.png)
...
4. Selecione um escopo para exibir detalhes.
   ...
   ![Captura de tela que mostra os escopos do orçamento](./media/billing-view-all-accounts/list-of-scopes.png)
