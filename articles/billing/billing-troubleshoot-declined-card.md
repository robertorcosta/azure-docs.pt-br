...
[você não pode se inscrever no Azure por meio do portal do Azure ou do Centro de Contas do Azure](billing-troubleshoot-azure-sign-up.md)
...
Para obter mais informações sobre como pagar por fatura, confira [Enviar uma solicitação para pagar a assinatura do Azure por fatura.](billing-how-to-pay-by-invoice.md)

## <a name="your-credit-card-information-is-outdated"></a>Suas informações de cartão de crédito estão desatualizadas 

Para obter informações sobre como gerenciar as informações do seu cartão, inclusive como alterar ou remover um cartão, confira [Adicionar, atualizar ou remover um crédito do Azure](billing-how-to-change-credit-card.md).
