...
Se você quiser apenas excluir o servidor flexível PostgreSQL, poderá executar o comando [AZ postgres exflexíveis-Server Delete](/cli/azure/PostgreSQL/server#az-PostgreSQL-flexible-server-delete) .
