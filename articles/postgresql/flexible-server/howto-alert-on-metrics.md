...
* Saiba mais sobre como [configurar webhooks em alertas](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-webhooks).
* Tenha uma [visão geral da coleção de métricas](https://docs.microsoft.com/azure/monitoring-and-diagnostics/insights-how-to-customize-monitoring) para verificar se o serviço está disponível e responsivo.
