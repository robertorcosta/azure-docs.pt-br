...
Crie um servidor flexível com o comando [az postgreSQL flexible-server create](/cli/azure/postgresql/flexible-server?view=azure-cli-latest&preserve-view=true). O seguinte comando criará um servidor usando valores e padrões de serviço do contexto local da CLI do Azure:
