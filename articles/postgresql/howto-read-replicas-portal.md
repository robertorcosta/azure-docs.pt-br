...
4. Reinicie o servidor para aplicar a alteração selecionando **Sim**.
   ...
   :::image type="content" source="./media/howto-read-replicas-portal/confirm-restart.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
5. Você receberá duas notificações de portal do Azure quando a operação for concluída. Há uma notificação para atualizar o parâmetro do servidor. Há outra notificação para a reinicialização do servidor que segue imediatamente.
   ...
   :::image type="content" source="./media/howto-read-replicas-portal/success-notifications.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
3. Selecione **para adicionar réplica**.
   ...
   :::image type="content" source="./media/howto-read-replicas-portal/add-replica.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::

4. Insira um nome para a réplica de leitura. 

    :::image type="content" source="./media/howto-read-replicas-portal/name-replica.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::

5. Selecione um local para a réplica. O local padrão é o mesmo que o do servidor primário.

    :::image type="content" source="./media/howto-read-replicas-portal/location-replica.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
:::image type="content" source="./media/howto-read-replicas-portal/list-replica.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
3. Selecione o servidor de réplica para o qual interromper a replicação.
   ...
   :::image type="content" source="./media/howto-read-replicas-portal/select-replica.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
 
4. Selecione **Parar replicação**.

   :::image type="content" source="./media/howto-read-replicas-portal/select-stop-replication.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
 
5. Selecione **OK** para interromper a replicação.

   :::image type="content" source="./media/howto-read-replicas-portal/confirm-stop-replication.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
2. Abra a página **Visão geral** para o servidor. Selecione **Excluir**.
   ...
   :::image type="content" source="./media/howto-read-replicas-portal/delete-server.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
 
3. Insira o nome do servidor primário a ser excluído. Selecione **excluir** para confirmar a exclusão do servidor primário.

   :::image type="content" source="./media/howto-read-replicas-portal/confirm-delete.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
- No portal do Azure, abra a página **Visão geral** para a réplica de leitura. Selecione **Excluir**.
   ...
   :::image type="content" source="./media/howto-read-replicas-portal/delete-replica.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
4. Selecione **excluir réplica**.
   ...
   :::image type="content" source="./media/howto-read-replicas-portal/select-delete-replica.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
 
5. Insira o nome da réplica a excluir. Selecione **Excluir** para confirmar a exclusão da réplica.

   :::image type="content" source="./media/howto-read-replicas-portal/confirm-delete-replica.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
2.  Selecione **Métricas**. Na janela **métricas** , selecione **atraso máximo entre réplicas**.
    ...
    :::image type="content" source="./media/howto-read-replicas-portal/select-max-lag.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
...
2. Selecione **Métricas**. Na janela **métricas** , selecione **atraso de réplica**.
   ...
   :::image type="content" source="./media/howto-read-replicas-portal/select-replica-lag.png" alt-text="Banco de dados do Azure para PostgreSQL-replicação – definir réplica e salvar":::
