---
title: Servidor de reinicialização - Azure CLI - Banco de dados Azure para PostgreSQL - Servidor Único
description: Este artigo descreve como você pode reiniciar um banco de dados Azure para PostgreSQL - Single Server usando o Azure CLI
author: rachel-msft
ms.author: raagyema
...
Saiba [como definir parâmetros no Banco de Dados Azure para PostgreSQL](howto-configure-server-parameters-using-cli.md)