...
> Java. util. Concurrent. Execuexception: Java. lang. RuntimeException: org. PostgreSQL. util. PSQLException: FATAL: nenhuma entrada\_do PG HBA. conf para o host "123.45.67.890", usuário "citus", banco de dados "citus", SSL
