---
title: Servidor de reinicialização - Portal Azure - Banco de Dados Azure para PostgreSQL - Servidor Único
description: Este artigo descreve como você pode reiniciar um banco de dados Azure para PostgreSQL - Single Server usando o portal Azure.
author: ajlam
ms.author: andrela
...
---
# <a name="restart-azure-database-for-postgresql---single-server-using-the-azure-portal"></a>Reiniciar o banco de dados do Azure para PostgreSQL - Servidor Único usando o portal Azure
...
1. No [portal Azure,](https://portal.azure.com/)selecione seu banco de dados Azure para servidor PostgreSQL.
...
Saiba [como definir parâmetros no Banco de Dados Azure para PostgreSQL](howto-configure-server-parameters-using-portal.md)