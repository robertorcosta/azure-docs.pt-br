---
title: Private Link - Portal Azure - Banco de Dados Azure para PostgreSQL - Servidor único
description: Saiba como configurar link privado para banco de dados Azure para postgreSQL- Único servidor do portal Azure
author: kummanish
ms.author: manishku
...
ms.locfileid: "79370909"
---
# <a name="create-and-manage-private-link-for-azure-database-for-postgresql---single-server-using-portal"></a>Criar e gerenciar o Private Link for Azure Database para PostgreSQL - Servidor único usando o Portal

Um ponto de extremidade privado é o bloco de construção fundamental para o link privado no Azure. Ele permite que os recursos do Azure, como VMs (máquinas virtuais), se comuniquem de forma privada com recursos de link privado.  Neste artigo, você aprenderá a usar o portal Azure para criar uma VM em uma Rede Virtual Azure e um Banco de Dados Azure para servidor PostgreSQL Single com um ponto final privado do Azure.
...
Nesta seção, você criará a rede virtual e a sub-rede para hospedar a VM que é usada para acessar seu recurso De Link Privado (um servidor PostgreSQL no Azure).
...
## <a name="create-an-azure-database-for-postgresql-single-server"></a>Criar um banco de dados Azure para servidor postgreSQL único

Nesta seção, você criará um banco de dados Azure para servidor PostgreSQL no Azure. 

1. No lado superior esquerdo da tela no portal Azure, selecione Criar um**banco de dados de** >  **recursos** > **Azure database para PostgreSQL**.

1. No **Banco de Dados Do Azure para opção de implantação do PostgreSQL,** selecione servidor **único** e forneça essas informações:
    ...
    | Location | Selecione uma região do Azure onde deseja que seu Servidor PostgreSQL resida. |
    |Versão  | Selecione a versão do banco de dados do servidor PostgreSQL que é necessário.|
...
Nesta seção, você criará um servidor PostgreSQL e adicionará um ponto final privado a ele. 
...
Quando terminar de usar o ponto final privado, o servidor PostgreSQL e a VM, exclua o grupo de recursos e todos os recursos que ele contém:
...
Neste como fazer, você criou uma VM em uma rede virtual, um Banco de Dados Azure para PostgreSQL - Servidor Único e um ponto final privado para acesso privado. Você se conectou a uma VM da internet e comunicou com segurança ao servidor PostgreSQL usando o Private Link. Para saber mais sobre os pontos finais privados, consulte [O que é o ponto final privado do Azure](https://docs.microsoft.com/azure/private-link/private-endpoint-overview).
