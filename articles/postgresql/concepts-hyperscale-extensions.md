...
> | [xsyn\_de dictação](https://www.postgresql.org/docs/current/dict-xsyn.html) | Modelo de dicionário de pesquisa de texto para processamento estendido de sinônimo. |
...
> | [fdw\_de arquivo](https://www.postgresql.org/docs/current/file-fdw.html) | Wrapper de dados estrangeiros para acesso de arquivo simples. |
...
> | [freespacemap\_PG](https://www.postgresql.org/docs/current/pgfreespacemap.html) | Examine o mapa de espaço livre (FSM). |
...
> | geocodificador PostGIS\_Tiger\_ | Geocodificador PostGIS Tiger e reverso geocodificador. |
