---
title: Use regras de rede virtual - Azure CLI - Banco de dados Azure para PostgreSQL - Servidor Único
description: Este artigo descreve como criar e gerenciar os pontos finais e regras de serviço vnet para o Banco de Dados Azure para PostgreSQL usando a linha de comando Azure CLI.
author: bolzmj
ms.author: mbolz
...
ms.locfileid: "75974117"
---
# <a name="create-and-manage-vnet-service-endpoints-for-azure-database-for-postgresql---single-server-using-azure-cli"></a>Criar e gerenciar os pontos finais de serviço do VNet para o Banco de Dados Azure para PostgreSQL - Servidor Único usando o Azure CLI
...
Se você optar por instalar e usar a CLI localmente, este artigo exigirá que seja executada a CLI do Azure versão 2.0 ou posterior. Para ver a versão instalada, execute o comando `az --version`. Se você precisar instalar ou atualizar, consulte [Install Azure CLI](/cli/azure/install-azure-cli). 
