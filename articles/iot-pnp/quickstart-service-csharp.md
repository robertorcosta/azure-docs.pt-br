---
title: Interagir com um dispositivo IoT Plug and Play conectado à sua solução de IoT do Azure (C#) | Microsoft Docs
description: Use o C# para se conectar com um dispositivo IoT Plug and Play conectado à solução de IOT do Azure e interagir com ele.
author: ericmitt
ms.author: ericmitt
ms.date: 09/21/2020
ms.topic: quickstart
