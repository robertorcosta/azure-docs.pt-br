---
title: Guia do desenvolvedor do dispositivo (Java)-IoT Plug and Play | Microsoft Docs
description: Descrição do Plug and Play IoT para desenvolvedores de dispositivos Java
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91579518"
---
# <a name="iot-plug-and-play-device-developer-guide-java"></a>Guia do desenvolvedor do dispositivo IoT Plug and Play (Java)
