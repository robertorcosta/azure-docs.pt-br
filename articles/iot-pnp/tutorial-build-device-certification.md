...
Você também precisa concluir o início rápido [Usar um modelo de funcionalidade do dispositivo para criar um dispositivo](quickstart-create-pnp-device-windows.md) para o Windows. O início rápido mostra como configurar seu ambiente de desenvolvimento usando Vcpkg e criar um projeto de exemplo.
...
1. Insira o nome do projeto, algo como **sample_device**. Esse é o nome do aplicativo do dispositivo.
...
Você usará o pacote Vcpkg para criar o stub do código do dispositivo gerado. O aplicativo criado simula um dispositivo que se conecta a um Hub IoT. O aplicativo envia a telemetria e as propriedades e recebe comandos.
