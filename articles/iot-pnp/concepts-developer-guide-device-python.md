---
title: Guia do desenvolvedor do dispositivo (Python) – IoT Plug and Play | Microsoft Docs
description: Descrição do Plug and Play IoT para desenvolvedores de dispositivos Python
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91579628"
---
# <a name="iot-plug-and-play-device-developer-guide-python"></a>Guia do desenvolvedor do dispositivo IoT Plug and Play (Python)
