...
Se a tarefa for concluída com êxito, adicione tarefas de implantação executando as etapas anteriores para cada um dos arquivos de política personalizada. Modifique os `-PolicyId` valores `-PathToFile` de argumento e para cada política.
