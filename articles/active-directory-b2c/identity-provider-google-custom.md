...
8. Clique em **Criar**.
9. Copie os valores da **ID do cliente** e do **segredo do cliente**. Você precisará de ambos para configurar o Google como um provedor de identidade no seu locatário. Segredo do cliente é uma credencial de segurança importante.
