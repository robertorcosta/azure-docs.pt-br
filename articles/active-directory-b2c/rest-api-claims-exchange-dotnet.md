...
## <a name="step-1-create-an-aspnet-web-api"></a>Etapa 1: Criar uma ASP.NET Web API
...
1. No **Gerenciador de Soluções**, clique com o botão direito do mouse na pasta **Modelos**, selecione **Adicionar** e {7}Classe{8}.
