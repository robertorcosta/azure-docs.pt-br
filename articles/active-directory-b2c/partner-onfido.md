...
2. Use [Gerenciador de armazenamento do Azure](https://docs.microsoft.com/azure/virtual-machines/windows/disks-use-storage-explorer-managed-disks) para gerenciar seus arquivos e permissões de acesso.
