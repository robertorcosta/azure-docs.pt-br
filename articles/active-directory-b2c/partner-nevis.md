...
6. Siga as [instruções](https://docs.microsoft.com/azure/active-directory-b2c/customize-ui-with-html#3-configure-cors) e habilite o compartilhamento de recursos entre origens (CORS) para este arquivo.
