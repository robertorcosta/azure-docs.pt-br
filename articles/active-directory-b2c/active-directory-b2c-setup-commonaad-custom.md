...
> [!NOTE]
> Usar `https://login.microsoftonline.com/` como o valor para **ValidTokenIssuerPrefixes** permite que todos os usuários do AD do Azure entrem no seu aplicativo.
