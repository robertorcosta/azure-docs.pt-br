...
Como desenvolvedor ou administrador de ti, você pode usar conectores de API para integrar seus fluxos de usuário de inscrição com APIs Web para personalizar a experiência de inscrição. Com os conectores de API, você pode:
