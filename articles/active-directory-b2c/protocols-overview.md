...
* Um **URI de redirecionamento** ou **identificador de pacote** que pode ser usado para direcionar as respostas de volta para seu aplicativo.
...
* O **proprietário do recurso** é normalmente o usuário final. Ele é a parte que possui os dados e tem o poder de permitir que terceiros acessem esses dados ou recurso.
...
* O **servidor de recursos** é onde residem o recurso ou os dados. Ele confia no servidor de autorização para autenticar e autorizar o cliente OAuth com segurança. Ele também usa os tokens de acesso de portador para garantir a concessão a um recurso.
