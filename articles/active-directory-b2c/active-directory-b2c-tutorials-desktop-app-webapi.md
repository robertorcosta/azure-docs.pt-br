...
Conclua as etapas e os pré-requisitos no [Tutorial: Autentique os usuários em um cliente de área de trabalho nativo](active-directory-b2c-tutorials-desktop-app.md).
...
![Nome de exibição mostrado no painel superior do aplicativo de área de trabalho WPF](media/active-directory-b2c-tutorials-desktop-app-webapi/desktop-app-01-post-api-call.png)
