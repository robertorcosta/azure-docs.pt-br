...
ms.locfileid: "78186804"
---
# <a name="configure-session-behavior-in-azure-active-directory-b2c"></a>Configure o comportamento da sessão no Azure Active Directory B2C
...
- **Configuração de login único** Se você tiver vários aplicativos e fluxos de usuário no seu inquilino B2C, você poderá gerenciar as interações do usuário através deles usando a propriedade **de configuração de login único.** Você pode definir a propriedade com uma das seguintes configurações:
...
2. Certifique-se de que está usando o diretório que contém seu inquilino Azure AD B2C selecionando o filtro **de assinatura Directory +** no menu superior e escolhendo o diretório que contém o inquilino Azure AD B2C.
...
7. Configure a **vida útil da sessão do aplicativo da Web (minutos),** o tempo de sessão do aplicativo da **Web,** **a configuração de logon único**e o **ID Token nas solicitações de logout,** conforme necessário.
