...
Em um [artigo relacionado do Azure AD B2C](rest-api-claims-exchange-dotnet.md), você criará um serviço RESTful (API Web) que se integra aos percursos do usuário do Azure AD B2C (Azure Active Directory B2C) sem autenticação.
...
1. Clique com o botão direito do mouse na pasta *App_Start*, selecione **Adicionar** e selecione **Classe**.
   ...
   ![Adicionar classe ClientAuthMiddleware.cs à pasta App_Start](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth1.png)
...
![Adicionar a marca Autorizar ao controlador](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-authorize.png)
