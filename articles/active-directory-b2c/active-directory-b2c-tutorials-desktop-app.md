...
![Detalhes do token mostrados no painel inferior do aplicativo da área de trabalho do WPF](media/active-directory-b2c-tutorials-desktop-app/desktop-app-01-post-signin.png)
...
> [Tutorial: Permitir acesso a uma API Web do Node.js em um aplicativo da área de trabalho >](active-directory-b2c-tutorials-desktop-app-webapi.md)
