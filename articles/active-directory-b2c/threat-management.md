...
1. Insira as configurações de proteção de senha desejadas e, em seguida, selecione **salvar**.
    ...
    página de proteção de senha do ![portal do Azure nas configurações do Azure AD](./media/threat-management/portal-02-password-protection.png)
