...
| **button_cancel** | Cancelar |
| **local_number_input_placeholder_text** | Telefone |
...
### <a name="verification-display-control-error-messages"></a>Mensagens de erro de controle de exibição de verificação
