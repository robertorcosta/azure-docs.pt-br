...
3. Adicione o provedor de declarações a seguir que faz a solicitação para a API do LinkedIn `/emailAddress` . Para autorizar essa solicitação, você precisa do token de acesso do LinkedIn.
