...
1. Abra o [aplicativo de comandos personalizados criado anteriormente (versão prévia)](./quickstart-custom-speech-commands-create-new.md) e selecione **publicar**
