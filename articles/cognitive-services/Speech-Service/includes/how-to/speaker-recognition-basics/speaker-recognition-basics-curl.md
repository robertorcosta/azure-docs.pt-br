...
Comece [criando um perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/createprofile). Você precisará inserir a região e a chave de assinatura do serviço de Fala para cada um dos comandos curl deste artigo.
...
Agora você está pronto para [verificar um exemplo de áudio em relação ao perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/verifyprofile). Este exemplo de áudio deve conter a mesma frase secreta que os exemplos que você usou para registrar o perfil de voz.
...
Para concluir, [exclua o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textdependent/deleteprofile).
...
Comece [criando um perfil de verificação independente de texto](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/createprofile).
...
Em seguida, [registre o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/createenrollment). Novamente, em vez de enviar três amostras de áudio, você precisa enviar amostras de áudio que contenham um total de 20 segundos de áudio.
...
Para concluir, [exclua o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/verification/textindependent/deleteprofile).
...
Comece [criando um perfil de identificação independente de texto](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/createprofile).
...
Em seguida, [registre o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/createenrollment). Novamente, você precisa enviar amostras de áudio que contenham um total de 20 segundos de áudio. Essas amostras não precisam conter uma frase secreta.
...
Para concluir, [exclua o perfil de voz](https://docs.microsoft.com/rest/api/speakerrecognition/identification/textindependent/deleteprofile).
