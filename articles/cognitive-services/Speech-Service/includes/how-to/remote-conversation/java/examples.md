...
Para o código mostrado aqui, você precisa de uma **versão de conversa remota 1.8.0**, com suporte apenas para Java (1.8.0 ou superior) no Windows e no Linux. 

### <a name="obtaining-the-async-conversation-client-sdk"></a>Obtendo o SDK do cliente de conversa assíncrona

Você pode obter a **conversa remota** editando seu arquivo de pom.xml da seguinte maneira.

1. No final do arquivo, antes da marca de fechamento `</project>` , crie um `repositories` elemento com uma referência ao repositório do Maven para o SDK de fala:
