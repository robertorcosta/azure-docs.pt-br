...
:::row:::
    :::column span="3":::
        Ao desenvolver para Android, existem dois SDKs de fala disponíveis. O Java Speech SDK está disponível nativamente como um pacote Android, ou o .NET Speech SDK pode ser usado com **Xamarin.Android** à medida que implementa o .NET Standard 2.0.
    :::column-end:::
    :::column:::
        <br>
