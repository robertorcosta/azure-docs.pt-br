...
ms.locfileid: "73505304"
---
## <a name="additional-language-and-platform-support"></a>Suporte adicional de linguagem e plataforma

Se você tiver clicado nessa guia, provavelmente não verá um guia de início rápido em sua linguagem de programação favorita. Não se preocupe, temos materiais de início rápido e amostras de código adicionais disponíveis no GitHub. Use a tabela para encontrar a amostra correta para a sua linguagem de programação e combinação de plataforma/sistema operacional.

| Linguagem | Exemplos de código |
|----------|--------------|
| C++ |[Guias de início rápido](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/cpp), [Amostras](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/samples/cpp-linux)|
...
| JavaScript |[Navegador](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/js-browser) |
