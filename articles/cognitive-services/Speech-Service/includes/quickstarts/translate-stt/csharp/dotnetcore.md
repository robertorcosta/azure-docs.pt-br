---
title: 'Início Rápido: Traduzir fala em texto, C# (.NET Core Windows) – Serviço de Fala'
...
1. Substitua a cadeia de caracteres `YourServiceRegion` pela [região](~/articles/cognitive-services/Speech-Service/regions.md).
