...
|--|--|--|
| C# | [Para um arquivo de áudio][1-file] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [Para um arquivo de áudio][2-file] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [Para um arquivo de áudio][3-file] | [Android][java-android], [JRE][java-jre] |
...
| Python | [Para um arquivo de áudio][4-file] | [Windows, Linux, macOS][python] |
