...
ms.locfileid: "75660436"
---
## <a name="prerequisites"></a>Prerequisites

Antes de começar:

* Se este for seu primeiro projeto do C#, use este guia para <a href="../quickstarts/create-project.md?tabs=dotnet" target="_blank">criar um projeto de exemplo vazio</a>.
* <a href="../quickstarts/setup-platform.md?tabs=dotnet" target="_blank">Instale o SDK de Fala para seu ambiente de desenvolvimento</a>.
