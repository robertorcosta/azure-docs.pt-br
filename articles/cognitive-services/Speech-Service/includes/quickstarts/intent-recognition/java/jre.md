...
* Substitua `"YourLanguageUnderstandingServiceRegion"` pelo seu local do LUIS. Use o "parâmetro do SDK de fala" de [região](https://aka.ms/speech/sdkregion)
