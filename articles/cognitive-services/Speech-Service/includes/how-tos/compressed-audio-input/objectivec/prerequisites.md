...
1. Ajuste os caminhos para as estruturas nas *Configurações*do projeto .
   1. Na guia **Geral** o cabeçalho **Binários Incorporados,** adicione a biblioteca SDK como uma estrutura: **Adicione binários incorporados** > **Adicione outros...** > Navegue ao diretório escolhido e selecione ambas as estruturas.
