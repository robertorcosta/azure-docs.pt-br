...
> [!TIP]
> Para obter melhores resultados, é recomendável usar o contêiner de detecção de idioma de fala com os contêineres de fala para texto ou de fala para texto personalizados. 
