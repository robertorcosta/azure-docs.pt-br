...
No entanto, o conjunto de telefone do serviço de fala coloca estresse após a vogal da sílaba sob estresse; o conjunto de telefone do serviço de fala `fr-FR` não dá suporte ao ' ˌ ' de subestresse IPA. Se a subcarga IPA for necessária, você deverá usar o IPA diretamente.
...
> [!TIP]
> O conjunto de telefone do serviço de fala `fr-FR` não dá suporte às seguintes liasions francesa, `n‿`, `t‿`e `z‿`. Se forem necessários, você deve considerar o uso do IPA diretamente.
...
<a id="de-v-2"></a>
**2** *Word-inicialmente apenas em palavras de origem estrangeira, como **um**ppointment. Sílaba – inicialmente em: ' v**e**rstauen.*
...
<a id="de-c-10"></a>
**10** *o `x` IPA é um "ch" rígido após todas as vogais não-frontais (a, AA, Oh, Ah, UW e diphthong aw).*<br>
<a id="de-c-11"></a>
**11** *o `ç` IPA é um "ch" suave após as vogais frontais (IH, iy, eh, AE, uy, UE, OE, a UE também está em diphthongs de los, Oy) e consoantes*<br>
<a id="de-c-12"></a>
...
> [!TIP]
> O conjunto de telefone do serviço de fala `es-ES` não dá suporte aos seguintes IPA em espanhol, `β`, `ð`e `ɣ`. Se forem necessários, você deve considerar o uso do IPA diretamente.

# <a name="zh-cn"></a>[zh-CN](#tab/zh-CN)

O telefone do serviço de fala definido para `zh-CN` é baseado no conjunto <a href="https://en.wikipedia.org/wiki/Pinyin" target="_blank">de <span class="docon docon-navigate-external x-hidden-focus"></span> pinyin</a> de telefone nativo definido.
...
O telefone do serviço de fala definido para `zh-TW` é baseado no número <a href="https://en.wikipedia.org/wiki/Bopomofo" target="_blank">bopomofo <span class="docon docon-navigate-external x-hidden-focus"></span> </a> nativo definido.
...
O telefone do serviço de fala definido para `ja-JP` é baseado no conjunto <a href="https://en.wikipedia.org/wiki/Kana" target="_blank">kana <span class="docon docon-navigate-external x-hidden-focus"></span> </a> do telefone nativo.
