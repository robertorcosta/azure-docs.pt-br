...
| Language                 | Localidade (BCP-47) | Personalizações  | [Detecção de idioma](how-to-automatic-language-detection.md) |
|------------------------------------|--------|---------------------------------------------------|-------------------------------|
...
| Holandês (Países Baixos)                | `nl-NL` | Modelo de linguagem                                   |    Yes                       |
...
| Híndi (Índia)                      | `hi-IN` | Modelo acústico<br>Modelo de linguagem                 |     Yes                      |
...
| Coreano (Coreia do Sul)                     | `ko-KR` | Modelo acústico<br>Modelo de linguagem                 |      Yes                     |
...
| Polonês (Polônia)                    | `pl-PL` | Modelo de linguagem                                   |       Yes                    |
...
| Language | Locale | Gênero | Nome da voz | Suporte de estilo |
|---|---|---|---|---|
...
| Language | Localidade (BCP-47) | Gênero | Nome da voz |
|--|--|--|--|
...
| Language | Localidade (BCP-47) | Verificação dependente do texto | Verificação independente do texto | Identificação independente do texto |
|----|----|----|----|----|
