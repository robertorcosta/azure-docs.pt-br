...
Usando o visemes, você pode criar um assistente de difusão de notícias mais natural e inteligente, jogos e caracteres de desenho mais interativos e vídeos mais intuitivos de ensino de linguagem. A audição deficiente também pode pegar o conteúdo de fala visual e "Lip-Read" que mostra visemes em uma face animada.
