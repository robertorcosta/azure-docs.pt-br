...
## <a name="try-the-speech-service-without-credit-card-info"></a><a id="no-card"></a>Experimente o serviço de fala sem informações de cartão de crédito
...
1. Vá para [experimentar o serviço cognitiva](https://azure.microsoft.com/free/cognitive-services).
...
## <a name="try-the-speech-service-by-creating-an-azure-resource"></a><a id="new-resource"></a>Experimente o serviço de fala criando um recurso do Azure
...
> [Início rápido: reconhecer a fala com a CLI](~/articles/cognitive-services/Speech-Service/quickstarts/speech-to-text-from-microphone.md?pivots=programmer-tool-spx) 
>  de fala [Exemplos do SDK de fala](speech-sdk.md#sample-source-code)
