...
Cada treinamento irá gerar automaticamente áudio de exemplo de 100 para ajudá-lo a testar o modelo. Depois que o modelo de voz for criado com êxito, você poderá testá-lo antes de implantá-lo para uso.

1.  Navegue até **conversão de texto em fala > > de voz personalizada [nome do projeto] > modelo**.

2.  Clique no nome do modelo que você deseja testar.

3.  Na página de detalhes do modelo, você pode encontrar os áudios de exemplo na guia **teste** . 
