---
title: 'Início Rápido: Assistente de voz personalizado, C# (UWP) - Serviço de Fala'
...
1. Escolha **Depurar** > **Iniciar Depuração** (ou pressione **F5**) para iniciar o aplicativo. A janela **helloworld** é exibida.
   ...
   ![Exemplo de aplicativo de assistente de voz UWP em C# – Início rápido](media/sdk/qs-voice-assistant-uwp-helloworld-window.png)
