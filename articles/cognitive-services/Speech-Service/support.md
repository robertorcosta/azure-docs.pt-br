...
description: Como obter ajuda e suporte para perguntas e problemas ao criar aplicativos que se integram ao serviço Speech
...
> [!div class="checklist"]
> * Mantenha-se informado sobre novos desenvolvimentos nos *Serviços Cognitivos do Azure,* ou encontre as últimas notícias relacionadas ao *serviço de fala.*
> * As notas de versão contêm informações para todos os lançamentos.
...
Notícias sobre os serviços Cognitivos são coletadas no [blog de Serviços Cognitivos](https://azure.microsoft.com/blog/topics/cognitive-services/). Para obter as últimas informações sobre o serviço Speech, acompanhe o [blog do serviço de fala](https://azure.microsoft.com/blog/tag/speech-service/).

## <a name="release-notes"></a>Notas de versão

As [notas de lançamento](https://aka.ms/csspeech/whatsnew) são atualizadas assim que uma nova versão estiver disponível. As notas contêm informações sobre novos recursos, melhorias e correções de bugs.
...
Você pode criar um relatório de bugs, solicitar recursos ou fazer uma pergunta geral e compartilhar as melhores práticas. Para relatórios de bugs, siga o modelo fornecido:
...
**Contexto adicional**
 ...
 - Se você relatar um erro para uma interação de serviço específica, informe o SessionId e o tempo (incl. timezone) dos incidentes relatados. A SessionId é informada em todos os retornos de chamada/eventos que você receber.
...
Se você não conseguir encontrar uma resposta para o seu problema através da pesquisa, envie uma nova pergunta para Stack Overflow usando tags [ \[microsoft-cognitive\]\[speech\]](https://stackoverflow.com/questions/tagged/microsoft-cognitive+speech).
