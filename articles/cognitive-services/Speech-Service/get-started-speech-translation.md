---
title: Guia de início rápido da tradução de fala – serviço de fala
titleSuffix: Azure Cognitive Services
description: Saiba como usar o SDK de fala para traduzir a fala. Neste guia de início rápido, você aprende sobre a construção de objetos, os formatos de entrada de áudio com suporte e as opções de configuração para a tradução de fala.
...
* Consulte os [exemplos de início rápido](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart) no github.
