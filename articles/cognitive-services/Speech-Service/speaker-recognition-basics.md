---
title: Noções básicas de Reconhecimento do Locutor – Serviço de Fala
titleSuffix: Azure Cognitive Services
description: 'Saiba como usar o SDK de Fala para responder à pergunta: "quem está falando". Neste artigo, você aprenderá sobre os padrões comuns de design para trabalhar com a verificação e a identificação do locutor.'
...
ms.locfileid: "84632294"
---
# <a name="learn-the-basics-of-speaker-recognition"></a>Aprender as noções básicas do Reconhecimento do Locutor

Neste artigo, você aprenderá os padrões de design básicos para Reconhecimento do Locutor usando o SDK de Fala, incluindo:
...
* Confira a [documentação de referência](https://docs.microsoft.com/rest/api/speakerrecognition/) do Reconhecimento do Locutor para obter detalhes sobre as classes e as funções.

* Confira os exemplos em [C#](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/csharp/dotnet/speaker-recognition) e [C++](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/cpp/windows/speaker-recognition) no GitHub.
