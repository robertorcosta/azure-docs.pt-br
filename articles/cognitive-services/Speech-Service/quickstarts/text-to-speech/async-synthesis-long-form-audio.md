...
* Uma assinatura do Azure e uma chave de assinatura do serviço de fala. [Crie uma conta](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account).
