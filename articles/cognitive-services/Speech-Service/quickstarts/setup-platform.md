---
title: 'Início Rápido: Configurar plataforma de desenvolvimento'
titleSuffix: Azure Cognitive Services
description: Neste início rápido, você aprenderá a instalar o SDK de fala em sua combinação preferida de plataforma e linguagem de programação.
...
ms.locfileid: "92096956"
---
# <a name="quickstart-setup-development-environment"></a>Início Rápido: Configurar ambiente de desenvolvimento
...
#### <a name="browser-based"></a>[Baseado em navegador](#tab/browser)
