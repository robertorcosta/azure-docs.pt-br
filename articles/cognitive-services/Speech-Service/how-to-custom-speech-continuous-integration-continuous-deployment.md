...
- A [CLI de fala do Azure](https://github.com/msimecek/Azure-Speech-CLI) para interagir com o serviço de fala a partir da linha de comando ou de um fluxo de trabalho automatizado.
