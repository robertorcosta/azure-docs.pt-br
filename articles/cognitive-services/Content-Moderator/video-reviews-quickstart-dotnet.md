...
Adicione as propriedades particulares a seguir ao namespace **VideoReviews**, classe **Program**. Atualize os `AzureEndpoint` `CMSubscriptionKey` campos e com os valores de sua URL de ponto de extremidade e chave de assinatura. Você pode encontrá-los na guia **início rápido** do recurso na portal do Azure.
...
Por fim, você verá a revisão de vídeo em seu Content moderator conta de ferramenta de revisão na tela de vídeo de **revisão** > **Video** .
