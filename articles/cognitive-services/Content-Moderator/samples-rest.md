...
description: Use amostras baseadas no recurso Content Moderator dos Serviços Cognitivos do Azure em seus aplicativos por meio de chamadas à API REST.
