...
> [!IMPORTANT]
> Este guia de início rápido usa a API do Reconhecimento de Formulários v1.0. Se a assinatura estiver na região `West US 2` ou `West Europe`, você deverá, em vez disso, seguir o [início rápido da API v2.0](./python-train-extract.md).
