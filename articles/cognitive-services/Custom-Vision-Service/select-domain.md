...
|__Varejo__|Otimizado para imagens encontradas em um catálogo ou site de compras. Caso deseje uma classificação de alta precisão entre vestidos, calças e camisas, use esse domínio. ID: `b30a91ae-e3c1-4f73-a81e-c270bff27c39`|
...
|---|---|---|---|---|---|
|Classificação|Geral (compacto)|`0732100f-1a38-4e49-a514-c9b44c697ab5`|6 MB|13 ms|5 ms|
