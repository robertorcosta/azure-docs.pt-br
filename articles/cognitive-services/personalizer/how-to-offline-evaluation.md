...
1. Configure os seguintes valores:
    ...
    * Descoberta de otimização definida como **Sim**.
    ...
    > ![escolher as configurações de avaliação offline](./media/offline-evaluation/create-an-evaluation-form.png)
...
1. Examine o desempenho das [políticas de aprendizado](concepts-offline-evaluation.md#discovering-the-optimized-learning-policy).
    ...
    > [!div class="mx-imgBorder"]
    > [![examinar os resultados da avaliação](./media/offline-evaluation/evaluation-results.png)](./media/offline-evaluation/evaluation-results.png#lightbox)
