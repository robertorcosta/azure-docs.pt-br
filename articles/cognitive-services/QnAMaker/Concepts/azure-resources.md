...
| Ambiente de Desenvolvimento/Teste   | SKU Standard         | Compartilhado      | Básico        | Publicar até 14 KBs, com tamanho de 2 GB    |
| Ambiente de Produção | SKU Standard         | Básico       | Padrão     | Publicar até 49 KBs, tamanho de 25 GB |

## <a name="when-to-change-a-pricing-tier"></a>Quando alterar um tipo de preço

|Atualize|Motivo|
|--|--|
|[Atualizar](../How-to/set-up-qnamaker-service-azure.md#upgrade-qna-maker-sku) o SKU de gerenciamento de QnA Maker|Você deseja ter mais conjuntos de QnA ou fontes de documento na sua base de dados de conhecimento.|
...
* Armazenar os conjuntos de QnA
* Forneça a classificação inicial (Rank #1) dos conjuntos de QnA em tempo de execução
...
O recurso de QnA Maker fornece acesso às APIs de criação e publicação, bem como à segunda camada de classificação baseada em NLP (processamento de idioma natural) (Rank #2) dos conjuntos de QnA em tempo de execução.
