...
Use a [API de treinamento](https://docs.microsoft.com/rest/api/cognitiveservices/qnamaker4.0/runtime/train) para enviar a resposta correta para QnA Maker, depois que o usuário a selecionar.
