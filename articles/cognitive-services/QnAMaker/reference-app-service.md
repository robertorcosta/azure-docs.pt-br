...
|--|--|
|AzureSearchAdminKey|Pesquisa Cognitiva-usado para QnA conjunto de armazenamento e classificação #1|
|AzureSearchName|Pesquisa Cognitiva-usado para QnA conjunto de armazenamento e classificação #1|
