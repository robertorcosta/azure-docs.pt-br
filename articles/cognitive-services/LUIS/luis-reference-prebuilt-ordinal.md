...
O Ordinal é gerenciado a partir do repositório [GitHub de texto de reconhecimento](https://github.com/Microsoft/Recognizers-Text/blob/master/Patterns/English/English-Numbers.yaml#L45)
...
Saiba mais sobre o [OrdinalV2,](luis-reference-prebuilt-ordinal-v2.md) [número de telefone](luis-reference-prebuilt-phonenumber.md)e entidades de [temperatura.](luis-reference-prebuilt-temperature.md)
