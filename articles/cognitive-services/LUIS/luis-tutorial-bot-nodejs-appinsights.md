...
ms.locfileid: "73498947"
---
# <a name="tutorial-add-luis-results-to-application-insights-from-a-bot-in-nodejs"></a>Tutorial: Adicionar resultados do LUIS ao Application Insights de um Bot no Node.js
