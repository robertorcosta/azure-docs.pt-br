...
1. Na caixa pop-up, selecione **concluído** na página **confirmar padrões** . Você não precisa definir as subentidades ou os recursos das entidades. Você só precisa listar a entidade aprendida por computador.
