...
|--|--|--|
|Chinesa|[zh-CN](#chinese-entity-support)||
...
[DatetimeV2](luis-reference-prebuilt-datetimev2.md):<br>data<br>daterange<br>tempo real<br>timerange   |    V2, V3   | 
