...
Chame [examples.add](/javascript/api/@azure/cognitiveservices-luis-authoring/examples?view=azure-node-lates) com a ID do aplicativo, a ID da versão e o exemplo.
