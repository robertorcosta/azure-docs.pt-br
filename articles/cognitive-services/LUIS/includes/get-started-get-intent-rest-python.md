...
1. Substitua o valor do campo `Ocp-Apim-Subscription-Key` pela sua chave de ponto de extremidade do LUIS.

1. Instale as dependências com `pip install requests`.

1. Execute o script com `python ./quickstart-call-endpoint.py`. Ele exibe o mesmo JSON que você viu anteriormente na janela do navegador.
...
> [Adicionar enunciados e treinar com Python](../luis-get-started-python-add-utterance.md)