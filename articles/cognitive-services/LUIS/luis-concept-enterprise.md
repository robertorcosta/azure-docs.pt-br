...
Entenda como essa hierarquia de chamadas é feita em [dispatcher-application-tutorial](/azure/bot-service/bot-builder-tutorial-dispatch?tabs=cs&view=azure-bot-service-4.0) do Bot Builder v4.  
...
* [Tutorial do modelo de expedição](/azure/bot-service/bot-builder-tutorial-dispatch?tabs=cs&view=azure-bot-service-4.0)
