...
> [!CAUTION]
> Para sua conveniência, muitos dos exemplos usam a [chave inicial](#starter-key) porque ele fornece algumas chamadas de ponto de extremidade de previsão gratuitas em sua [cota](luis-limits.md#key-limits).
