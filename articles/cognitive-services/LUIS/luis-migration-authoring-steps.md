...
1. Escolha criar um recurso de criação de LUIS selecionando para usar um recurso de criação existente ou para criar um novo recurso de criação.
