...
* Não há suporte para a API de Verificação Ortográfica do Bing no ponto de extremidade de previsão v3-continue a usar o ponto de extremidade de previsão da API v2 para correções ortográficas
