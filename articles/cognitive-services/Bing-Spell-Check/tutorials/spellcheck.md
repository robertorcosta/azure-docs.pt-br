...
Para acompanhar o tutorial, você precisa de uma chave de assinatura para a API de Verificação Ortográfica do Bing. Se você não tiver uma, você precisará de:

* Uma assinatura do Azure – [crie uma gratuitamente](https://azure.microsoft.com/free/cognitive-services/)
* [Um recurso de Verificação Ortográfica do Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7)
...
Crie um formulário HTML com um campo de texto. Manipule o evento `onsubmit` e chame a função bingSpellCheck, passando o conteúdo do campo de texto e a chave da API de Verificação Ortográfica do Bing.
