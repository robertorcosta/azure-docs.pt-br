...
- [Guia de referência de SDK do C# da Verificação Ortográfica do Bing](/dotnet/api/overview/azure/cognitiveservices/client/bingspellcheck?view=azure-dotnet)