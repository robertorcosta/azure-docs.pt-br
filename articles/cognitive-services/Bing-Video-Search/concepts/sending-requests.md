---
title: Envie solicitações de pesquisa para a API de pesquisa de vídeo bing
...
-   [Agente de Usuário](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-video-api-v7-reference#useragent)  
