---
title: Kubernetes de detecção de linguagem config e implantação de etapas
titleSuffix: Azure Cognitive Services
description: Kubernetes de detecção de linguagem config e implantação de etapas
...
ms.locfileid: "78262681"
---
### <a name="deploy-the-language-detection-container-to-an-aks-cluster"></a>Implantar o contêiner de detecção de idiomas em um cluster AKS
...
1. Dentro do editor de texto, crie um novo arquivo chamado *language.yaml*e cole o Seguinte YAML nele. Certifique-se `billing/value` de `apikey/value` substituir e com suas próprias informações.
...
1. Execute o comando `apply` Kubernetes com o arquivo *language.yaml* como alvo:
...
1. Verifique se o serviço está disponível e obtenha o endereço IP.
    ...
    A saída para o status de execução do serviço de *idioma* no pod:
