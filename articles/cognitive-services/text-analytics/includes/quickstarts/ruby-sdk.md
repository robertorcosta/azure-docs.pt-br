...
Nesta classe, crie uma função chamada `initialize` para autenticar o cliente. Use suas variável de ambiente `TEXT_ANALYTICS_SUBSCRIPTION_KEY` e `TEXT_ANALYTICS_ENDPOINT`. 
