...
| `2.1.1-amd64-ar-ae-preview` | Imagem de contêiner com a localidade `ar-AE`. |
| `2.1.1-amd64-ar-eg-preview` | Imagem de contêiner com a localidade `ar-EG`. |
| `2.1.1-amd64-ar-kw-preview` | Imagem de contêiner com a localidade `ar-KW`. |
| `2.1.1-amd64-ar-qa-preview` | Imagem de contêiner com a localidade `ar-QA`. |
| `2.1.1-amd64-ar-sa-preview` | Imagem de contêiner com a localidade `ar-SA`. |
| `2.1.1-amd64-ca-es-preview` | Imagem de contêiner com a localidade `ca-ES`. |
| `2.1.1-amd64-da-dk-preview` | Imagem de contêiner com a localidade `da-DK`. |
| `2.1.1-amd64-de-de-preview` | Imagem de contêiner com a localidade `de-DE`. |
| `2.1.1-amd64-en-au-preview` | Imagem de contêiner com a localidade `en-AU`. |
| `2.1.1-amd64-en-ca-preview` | Imagem de contêiner com a localidade `en-CA`. |
| `2.1.1-amd64-en-gb-preview` | Imagem de contêiner com a localidade `en-GB`. |
| `2.1.1-amd64-en-in-preview` | Imagem de contêiner com a localidade `en-IN`. |
| `2.1.1-amd64-en-nz-preview` | Imagem de contêiner com a localidade `en-NZ`. |
| `2.1.1-amd64-en-us-preview` | Imagem de contêiner com a localidade `en-US`. |
| `2.1.1-amd64-es-es-preview` | Imagem de contêiner com a localidade `es-ES`. |
| `2.1.1-amd64-es-mx-preview` | Imagem de contêiner com a localidade `es-MX`. |
| `2.1.1-amd64-fi-fi-preview` | Imagem de contêiner com a localidade `fi-FI`. |
| `2.1.1-amd64-fr-ca-preview` | Imagem de contêiner com a localidade `fr-CA`. |
| `2.1.1-amd64-fr-fr-preview` | Imagem de contêiner com a localidade `fr-FR`. |
| `2.1.1-amd64-gu-in-preview` | Imagem de contêiner com a localidade `gu-IN`. |
| `2.1.1-amd64-hi-in-preview` | Imagem de contêiner com a localidade `hi-IN`. |
| `2.1.1-amd64-it-it-preview` | Imagem de contêiner com a localidade `it-IT`. |
| `2.1.1-amd64-ja-jp-preview` | Imagem de contêiner com a localidade `ja-JP`. |
| `2.1.1-amd64-ko-kr-preview` | Imagem de contêiner com a localidade `ko-KR`. |
| `2.1.1-amd64-mr-in-preview` | Imagem de contêiner com a localidade `mr-IN`. |
| `2.1.1-amd64-nb-no-preview` | Imagem de contêiner com a localidade `nb-NO`. |
| `2.1.1-amd64-nl-nl-preview` | Imagem de contêiner com a localidade `nl-NL`. |
| `2.1.1-amd64-pl-pl-preview` | Imagem de contêiner com a localidade `pl-PL`. |
| `2.1.1-amd64-pt-br-preview` | Imagem de contêiner com a localidade `pt-BR`. |
| `2.1.1-amd64-pt-pt-preview` | Imagem de contêiner com a localidade `pt-PT`. |
| `2.1.1-amd64-ru-ru-preview` | Imagem de contêiner com a localidade `ru-RU`. |
| `2.1.1-amd64-sv-se-preview` | Imagem de contêiner com a localidade `sv-SE`. |
| `2.1.1-amd64-ta-in-preview` | Imagem de contêiner com a localidade `ta-IN`. |
| `2.1.1-amd64-te-in-preview` | Imagem de contêiner com a localidade `te-IN`. |
| `2.1.1-amd64-th-th-preview` | Imagem de contêiner com a localidade `th-TH`. |
| `2.1.1-amd64-tr-tr-preview` | Imagem de contêiner com a localidade `tr-TR`. |
| `2.1.1-amd64-zh-cn-preview` | Imagem de contêiner com a localidade `zh-CN`. |
| `2.1.1-amd64-zh-hk-preview` | Imagem de contêiner com a localidade `zh-HK`. |
| `2.1.1-amd64-zh-tw-preview` | Imagem de contêiner com a localidade `zh-TW`. |
| `2.1.0-amd64-ar-ae-preview` | Imagem de contêiner com a localidade `ar-AE`. |
| `2.1.0-amd64-ar-eg-preview` | Imagem de contêiner com a localidade `ar-EG`. |
| `2.1.0-amd64-ar-kw-preview` | Imagem de contêiner com a localidade `ar-KW`. |
| `2.1.0-amd64-ar-qa-preview` | Imagem de contêiner com a localidade `ar-QA`. |
| `2.1.0-amd64-ar-sa-preview` | Imagem de contêiner com a localidade `ar-SA`. |
| `2.1.0-amd64-ca-es-preview` | Imagem de contêiner com a localidade `ca-ES`. |
| `2.1.0-amd64-da-dk-preview` | Imagem de contêiner com a localidade `da-DK`. |
| `2.1.0-amd64-de-de-preview` | Imagem de contêiner com a localidade `de-DE`. |
| `2.1.0-amd64-en-au-preview` | Imagem de contêiner com a localidade `en-AU`. |
| `2.1.0-amd64-en-ca-preview` | Imagem de contêiner com a localidade `en-CA`. |
| `2.1.0-amd64-en-gb-preview` | Imagem de contêiner com a localidade `en-GB`. |
| `2.1.0-amd64-en-in-preview` | Imagem de contêiner com a localidade `en-IN`. |
| `2.1.0-amd64-en-nz-preview` | Imagem de contêiner com a localidade `en-NZ`. |
| `2.1.0-amd64-en-us-preview` | Imagem de contêiner com a localidade `en-US`. |
| `2.1.0-amd64-es-es-preview` | Imagem de contêiner com a localidade `es-ES`. |
| `2.1.0-amd64-es-mx-preview` | Imagem de contêiner com a localidade `es-MX`. |
| `2.1.0-amd64-fi-fi-preview` | Imagem de contêiner com a localidade `fi-FI`. |
| `2.1.0-amd64-fr-ca-preview` | Imagem de contêiner com a localidade `fr-CA`. |
| `2.1.0-amd64-fr-fr-preview` | Imagem de contêiner com a localidade `fr-FR`. |
| `2.1.0-amd64-gu-in-preview` | Imagem de contêiner com a localidade `gu-IN`. |
| `2.1.0-amd64-hi-in-preview` | Imagem de contêiner com a localidade `hi-IN`. |
| `2.1.0-amd64-it-it-preview` | Imagem de contêiner com a localidade `it-IT`. |
| `2.1.0-amd64-ja-jp-preview` | Imagem de contêiner com a localidade `ja-JP`. |
| `2.1.0-amd64-ko-kr-preview` | Imagem de contêiner com a localidade `ko-KR`. |
| `2.1.0-amd64-mr-in-preview` | Imagem de contêiner com a localidade `mr-IN`. |
| `2.1.0-amd64-nb-no-preview` | Imagem de contêiner com a localidade `nb-NO`. |
| `2.1.0-amd64-nl-nl-preview` | Imagem de contêiner com a localidade `nl-NL`. |
| `2.1.0-amd64-pl-pl-preview` | Imagem de contêiner com a localidade `pl-PL`. |
| `2.1.0-amd64-pt-br-preview` | Imagem de contêiner com a localidade `pt-BR`. |
| `2.1.0-amd64-pt-pt-preview` | Imagem de contêiner com a localidade `pt-PT`. |
| `2.1.0-amd64-ru-ru-preview` | Imagem de contêiner com a localidade `ru-RU`. |
| `2.1.0-amd64-sv-se-preview` | Imagem de contêiner com a localidade `sv-SE`. |
| `2.1.0-amd64-ta-in-preview` | Imagem de contêiner com a localidade `ta-IN`. |
| `2.1.0-amd64-te-in-preview` | Imagem de contêiner com a localidade `te-IN`. |
| `2.1.0-amd64-th-th-preview` | Imagem de contêiner com a localidade `th-TH`. |
| `2.1.0-amd64-tr-tr-preview` | Imagem de contêiner com a localidade `tr-TR`. |
| `2.1.0-amd64-zh-cn-preview` | Imagem de contêiner com a localidade `zh-CN`. |
| `2.1.0-amd64-zh-hk-preview` | Imagem de contêiner com a localidade `zh-HK`. |
| `2.1.0-amd64-zh-tw-preview` | Imagem de contêiner com a localidade `zh-TW`. |
| `2.0.3-amd64-ja-jp-preview` | Imagem de contêiner com a localidade `ja-JP`. |
| `2.0.2-amd64-ar-ae-preview` | Imagem de contêiner com a localidade `ar-AE`. |
| `2.0.2-amd64-ar-eg-preview` | Imagem de contêiner com a localidade `ar-EG`. |
| `2.0.2-amd64-ar-kw-preview` | Imagem de contêiner com a localidade `ar-KW`. |
| `2.0.2-amd64-ar-qa-preview` | Imagem de contêiner com a localidade `ar-QA`. |
| `2.0.2-amd64-ar-sa-preview` | Imagem de contêiner com a localidade `ar-SA`. |
| `2.0.2-amd64-ca-es-preview` | Imagem de contêiner com a localidade `ca-ES`. |
| `2.0.2-amd64-da-dk-preview` | Imagem de contêiner com a localidade `da-DK`. |
| `2.0.2-amd64-de-de-preview` | Imagem de contêiner com a localidade `de-DE`. |
| `2.0.2-amd64-en-au-preview` | Imagem de contêiner com a localidade `en-AU`. |
| `2.0.2-amd64-en-ca-preview` | Imagem de contêiner com a localidade `en-CA`. |
| `2.0.2-amd64-en-gb-preview` | Imagem de contêiner com a localidade `en-GB`. |
| `2.0.2-amd64-en-in-preview` | Imagem de contêiner com a localidade `en-IN`. |
| `2.0.2-amd64-en-nz-preview` | Imagem de contêiner com a localidade `en-NZ`. |
| `2.0.2-amd64-en-us-preview` | Imagem de contêiner com a localidade `en-US`. |
| `2.0.2-amd64-es-es-preview` | Imagem de contêiner com a localidade `es-ES`. |
| `2.0.2-amd64-es-mx-preview` | Imagem de contêiner com a localidade `es-MX`. |
| `2.0.2-amd64-fi-fi-preview` | Imagem de contêiner com a localidade `fi-FI`. |
| `2.0.2-amd64-fr-ca-preview` | Imagem de contêiner com a localidade `fr-CA`. |
| `2.0.2-amd64-fr-fr-preview` | Imagem de contêiner com a localidade `fr-FR`. |
| `2.0.2-amd64-gu-in-preview` | Imagem de contêiner com a localidade `gu-IN`. |
| `2.0.2-amd64-hi-in-preview` | Imagem de contêiner com a localidade `hi-IN`. |
| `2.0.2-amd64-it-it-preview` | Imagem de contêiner com a localidade `it-IT`. |
| `2.0.2-amd64-ja-jp-preview` | Imagem de contêiner com a localidade `ja-JP`. |
| `2.0.2-amd64-ko-kr-preview` | Imagem de contêiner com a localidade `ko-KR`. |
| `2.0.2-amd64-mr-in-preview` | Imagem de contêiner com a localidade `mr-IN`. |
| `2.0.2-amd64-nb-no-preview` | Imagem de contêiner com a localidade `nb-NO`. |
| `2.0.2-amd64-nl-nl-preview` | Imagem de contêiner com a localidade `nl-NL`. |
| `2.0.2-amd64-pl-pl-preview` | Imagem de contêiner com a localidade `pl-PL`. |
| `2.0.2-amd64-pt-br-preview` | Imagem de contêiner com a localidade `pt-BR`. |
| `2.0.2-amd64-pt-pt-preview` | Imagem de contêiner com a localidade `pt-PT`. |
| `2.0.2-amd64-ru-ru-preview` | Imagem de contêiner com a localidade `ru-RU`. |
| `2.0.2-amd64-sv-se-preview` | Imagem de contêiner com a localidade `sv-SE`. |
| `2.0.2-amd64-ta-in-preview` | Imagem de contêiner com a localidade `ta-IN`. |
| `2.0.2-amd64-te-in-preview` | Imagem de contêiner com a localidade `te-IN`. |
| `2.0.2-amd64-th-th-preview` | Imagem de contêiner com a localidade `th-TH`. |
| `2.0.2-amd64-tr-tr-preview` | Imagem de contêiner com a localidade `tr-TR`. |
| `2.0.2-amd64-zh-cn-preview` | Imagem de contêiner com a localidade `zh-CN`. |
| `2.0.2-amd64-zh-hk-preview` | Imagem de contêiner com a localidade `zh-HK`. |
| `2.0.2-amd64-zh-tw-preview` | Imagem de contêiner com a localidade `zh-TW`. |
| `2.0.1-amd64-ar-ae-preview` | Imagem de contêiner com a localidade `ar-AE`. |
| `2.0.1-amd64-ar-eg-preview` | Imagem de contêiner com a localidade `ar-EG`. |
| `2.0.1-amd64-ar-kw-preview` | Imagem de contêiner com a localidade `ar-KW`. |
| `2.0.1-amd64-ar-qa-preview` | Imagem de contêiner com a localidade `ar-QA`. |
| `2.0.1-amd64-ar-sa-preview` | Imagem de contêiner com a localidade `ar-SA`. |
| `2.0.1-amd64-ca-es-preview` | Imagem de contêiner com a localidade `ca-ES`. |
| `2.0.1-amd64-da-dk-preview` | Imagem de contêiner com a localidade `da-DK`. |
| `2.0.1-amd64-de-de-preview` | Imagem de contêiner com a localidade `de-DE`. |
| `2.0.1-amd64-en-au-preview` | Imagem de contêiner com a localidade `en-AU`. |
| `2.0.1-amd64-en-ca-preview` | Imagem de contêiner com a localidade `en-CA`. |
| `2.0.1-amd64-en-gb-preview` | Imagem de contêiner com a localidade `en-GB`. |
| `2.0.1-amd64-en-in-preview` | Imagem de contêiner com a localidade `en-IN`. |
| `2.0.1-amd64-en-nz-preview` | Imagem de contêiner com a localidade `en-NZ`. |
| `2.0.1-amd64-en-us-preview` | Imagem de contêiner com a localidade `en-US`. |
| `2.0.1-amd64-es-es-preview` | Imagem de contêiner com a localidade `es-ES`. |
| `2.0.1-amd64-es-mx-preview` | Imagem de contêiner com a localidade `es-MX`. |
| `2.0.1-amd64-fi-fi-preview` | Imagem de contêiner com a localidade `fi-FI`. |
| `2.0.1-amd64-fr-ca-preview` | Imagem de contêiner com a localidade `fr-CA`. |
| `2.0.1-amd64-fr-fr-preview` | Imagem de contêiner com a localidade `fr-FR`. |
| `2.0.1-amd64-gu-in-preview` | Imagem de contêiner com a localidade `gu-IN`. |
| `2.0.1-amd64-hi-in-preview` | Imagem de contêiner com a localidade `hi-IN`. |
| `2.0.1-amd64-it-it-preview` | Imagem de contêiner com a localidade `it-IT`. |
| `2.0.1-amd64-ja-jp-preview` | Imagem de contêiner com a localidade `ja-JP`. |
| `2.0.1-amd64-ko-kr-preview` | Imagem de contêiner com a localidade `ko-KR`. |
| `2.0.1-amd64-mr-in-preview` | Imagem de contêiner com a localidade `mr-IN`. |
| `2.0.1-amd64-nb-no-preview` | Imagem de contêiner com a localidade `nb-NO`. |
| `2.0.1-amd64-nl-nl-preview` | Imagem de contêiner com a localidade `nl-NL`. |
| `2.0.1-amd64-pl-pl-preview` | Imagem de contêiner com a localidade `pl-PL`. |
| `2.0.1-amd64-pt-br-preview` | Imagem de contêiner com a localidade `pt-BR`. |
| `2.0.1-amd64-pt-pt-preview` | Imagem de contêiner com a localidade `pt-PT`. |
| `2.0.1-amd64-ru-ru-preview` | Imagem de contêiner com a localidade `ru-RU`. |
| `2.0.1-amd64-sv-se-preview` | Imagem de contêiner com a localidade `sv-SE`. |
| `2.0.1-amd64-ta-in-preview` | Imagem de contêiner com a localidade `ta-IN`. |
| `2.0.1-amd64-te-in-preview` | Imagem de contêiner com a localidade `te-IN`. |
| `2.0.1-amd64-th-th-preview` | Imagem de contêiner com a localidade `th-TH`. |
| `2.0.1-amd64-tr-tr-preview` | Imagem de contêiner com a localidade `tr-TR`. |
| `2.0.1-amd64-zh-cn-preview` | Imagem de contêiner com a localidade `zh-CN`. |
| `2.0.1-amd64-zh-hk-preview` | Imagem de contêiner com a localidade `zh-HK`. |
| `2.0.1-amd64-zh-tw-preview` | Imagem de contêiner com a localidade `zh-TW`. |
