...
> [!NOTE]
> Se você estiver extraindo texto no idioma inglês, considere o uso da nova [Operação de leitura](../concept-recognizing-text.md). Há um [Início Rápido do Python](./python-hand-text.md) disponível. 
