...
> [!NOTE]
> Se você estiver extraindo texto no idioma inglês, considere o uso da nova [Operação de leitura](../concept-recognizing-text.md). Há um [Início Rápido do Go](../quickstarts-sdk/client-library.md?pivots=programming-language-go%253fpivots%253dprogramming-language-go#call-the-read-api) disponível.
