...
2. Crie um [recurso de Detecção Facial ](https://portal.azure.com/#create/Microsoft.CognitiveServicesFace) no portal do Azure para obter sua chave. Lembre-se de selecionar a Camada gratuita (F0) durante a instalação. 
3. Depois que os recursos forem implantados, clique em **Ir para o recurso** para coletar sua chave. 
