---
title: 'Início Rápido: Biblioteca de clientes de Detecção Facial para Go | Microsoft Docs'
...
ms.locfileid: "76961224"
---
# <a name="quickstart-face-client-library-for-go"></a>Início Rápido: Biblioteca de clientes de Detecção Facial para Go
...
As classes e interfaces a seguir lidam com alguns dos principais recursos do SDK do Go de Detecção Facial.
