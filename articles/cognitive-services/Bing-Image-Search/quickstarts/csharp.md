...
1. Construa o URI para a solicitação de pesquisa. O termo de pesquisa `SearchTerm` deve ser formatado antes de ser acrescentado à cadeia de caracteres.
