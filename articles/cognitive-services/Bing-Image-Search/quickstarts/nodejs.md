...
description: Use este início rápido para enviar solicitações de pesquisa de imagem para a API REST de Pesquisa de Imagem do Bing usando JavaScript e receba uma resposta JSON.
