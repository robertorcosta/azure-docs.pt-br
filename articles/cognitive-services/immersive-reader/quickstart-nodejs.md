---
title: 'Início Rápido: Criar um aplicativo Web que inicia a Leitura Avançada com Node.js'
...
ms.locfileid: "75945964"
---
# <a name="quickstart-create-a-web-app-that-launches-the-immersive-reader-nodejs"></a>Início Rápido: Criar um aplicativo Web que inicia a Leitura Avançada (Node.js)
...
Neste Início Rápido, você cria um aplicativo Web do zero e integra a Leitura Avançada usando o SDK de Leitura Avançada. Um exemplo de funcionamento completo deste Início Rápido está disponível [aqui](https://github.com/microsoft/immersive-reader-sdk/tree/master/js/samples/quickstart-nodejs).
