---
title: 'Início Rápido: Biblioteca de clientes da Sugestão Automática do Bing para Go | Microsoft Docs'
description: Comece a usar a biblioteca de clientes da Sugestão Automática do Bing para Go e obtenha sugestões de pesquisa com base em cadeias de caracteres de consulta parciais.
