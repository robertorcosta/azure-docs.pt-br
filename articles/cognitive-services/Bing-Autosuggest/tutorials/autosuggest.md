...
description: Neste tutorial, você criará uma página da Web que permite aos usuários consultar a API de Sugestão Automática do Bing e exibe os resultados da consulta.
...
Para acompanhar o tutorial, você precisa de uma chave de assinatura para a API de Sugestão Automática do Bing. Se você não tiver uma, [crie um recurso da Sugestão Automática do Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingAutosuggest-v7) no portal do Azure. Você também pode usar uma [chave de avaliação](https://azure.microsoft.com/try/cognitive-services/).
...
Especifique o ponto de extremidade da API de Sugestão Automática do Bing e declare um objeto XMLHttpRequest, que usaremos para enviar solicitações. Você pode usar o ponto de extremidade global abaixo ou o ponto de extremidade de [subdomínio personalizado](../../../cognitive-services/cognitive-services-custom-subdomains.md) exibido no portal do Azure para seu recurso.
...
Crie um formulário HTML com um campo de texto. Processe o evento `oninput` e chame a função `bingAutosuggest()` transmitindo o conteúdo do campo de texto e a chave de API de Sugestão Automática do Bing.
