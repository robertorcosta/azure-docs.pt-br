...
## <a name="stop-sharing"></a>Parar compartilhamento

Para interromper o compartilhamento de uma instância com uma pessoa, use o ícone de remover para remover seu endereço de email da lista. Isso também remove a instância da lista de instâncias dessas pessoas.

## <a name="next-steps"></a>Próximas etapas

- [Configurar experiência de Sugestão Automática Personalizada](define-custom-suggestions.md)