...
O ponto de extremidade global do Tradutor é definido como `endpoint`. `path` define a rota `translate` e identifica que queremos usar a versão 3 da API.
