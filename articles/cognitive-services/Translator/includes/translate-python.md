...
O ponto de extremidade global de Tradução de Texto é definido como o `endpoint`. `path` define a rota `translate` e identifica que queremos usar a versão 3 da API.
