...
Vamos criar a função principal para nosso aplicativo. Você observará que ela é uma única linha de código. Isso ocorre porque estamos criando uma única função para obter e imprimir a lista de idiomas com suporte para o Tradutor.
