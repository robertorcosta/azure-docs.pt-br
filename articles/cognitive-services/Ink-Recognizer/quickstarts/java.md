...
description: Use a API de Reconhecimento de Tinta Digital e o Java para começar a reconhecer traços de tinta digital neste guia de início rápido.
