...
![Um fluxograma que descreve o envio de uma entrada de traço de tinta à API](media/ink-recognizer-pen-graph.svg)
...
1. Selecione seus dados de traço de tinta e [formate-os](concepts/send-ink-data.md#sending-ink-data) em JSON válido. A API aceita até 1.500 traços de tinta por solicitação. 
