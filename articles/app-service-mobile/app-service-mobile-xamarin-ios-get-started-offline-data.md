---
title: Habilitar sincronização offline (Xamarin iOS)
description: Aprenda a usar o App Service Mobile App para armazenar e sincronizar dados offline em seu aplicativo Xamarin iOS.
...
3. Recompile e execute o aplicativo cliente. O aplicativo funciona da mesma forma que antes de você habilitar a sincronização offline. No entanto, o banco de dados local está agora preenchido com dados que podem ser usados em um cenário offline.
