...
2. Adicione este código ao arquivo *build.gradle* do nível **Module app** dentro da marca *dependencies*:
    ...
    Atualmente, a versão mais recente é a 3.4.0. As versões com suporte são listadas [em bintray][14].
