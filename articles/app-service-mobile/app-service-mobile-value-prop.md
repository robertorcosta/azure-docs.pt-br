...
ms.locfileid: "79499432"
---
# <a name="about-mobile-apps-in-azure-app-service"></a><a name="getting-started"> </a>Sobre Aplicativos Móveis no Serviço de Aplicativo do Azure
...
* **Dimensionamento automático**: Com o Serviço de Aplicativo, você pode escalar verticalmente ou horizontalmente para lidar com todas as cargas de clientes de entrada de maneira rápida. Selecione o número e o tamanho das VMs manualmente ou configure o dimensionamento automático para dimensionar seu back-end de aplicativo móvel com base na carga ou a agenda.
