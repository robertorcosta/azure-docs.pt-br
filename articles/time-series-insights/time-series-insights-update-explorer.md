...
[![Visão geral do Time Series Insights Explorer Preview](media/v2-update-explorer/preview-explorer-overview.png)](media/v2-update-explorer/preview-explorer-overview.png#lightbox)
...
Depois de executar a ação de **zoom** , o conjunto de dados selecionado será exibido. Selecione o controle de formato para percorrer as três representações do eixo y de seus dados de Time Series Insights.
  ...
  [![Exibir eixo y do gráfico](media/v2-update-explorer/tsi-preview-explorer-standard-chart.png)](media/v2-update-explorer/tsi-preview-explorer-standard-chart.png#lightbox)
...
- Leia o documento de visualização de Time Series Insights na [modelagem de dados](./concepts-model-overview.md).
