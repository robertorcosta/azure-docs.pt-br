...
* Por exemplo, o JSON aninhado a seguir:
   ...
   Torna- `data_flow` se: quando achatado.
...
No exemplo acima, a `data["flow"]` Propriedade achatada apresentaria uma colisão de nomenclatura com a `data_flow` propriedade.
