...
Essas alterações serão aplicadas somente a ambientes de visualização (PAYG). Se você tiver um ambiente de SKU TSI Standard (S), poderá desconsiderar essas alterações.

Estamos fazendo alterações no modo como armazenamos e indexamos dados numéricos em Azure Time Series Insights visualização que podem afetar você. Se você for afetado por qualquer um dos casos abaixo, faça as alterações necessárias assim que possível. Seus dados começarão a ser indexados como longos e duplos entre 29 de junho e 30 de junho de 2020, dependendo da sua região. Se você tiver dúvidas ou preocupações sobre essa alteração, envie um tíquete de suporte por meio do portal do Azure e mencione essa comunicação.
...
* Consulte [este](concepts-supported-data-types.md) artigo para exibir a lista completa de tipos de dados com suporte.
