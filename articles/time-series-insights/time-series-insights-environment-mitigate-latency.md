...
- Unir os dados de referência com a telemetria, resultando em um tamanho de evento maior. O tamanho máximo do pacote permitido é de 32 KB; pacotes de dados maiores que 32 KB são truncados.
