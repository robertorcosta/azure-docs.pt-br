...
[exemplo de gráficos de forno inteligente de modelo de série temporal ![](media/v2-update-tsm/time-series-model-smart-oven.png)](media/v2-update-tsm/time-series-model-smart-oven.png#lightbox)
