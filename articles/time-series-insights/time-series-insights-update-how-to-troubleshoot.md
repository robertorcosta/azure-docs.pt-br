...
- A chave de origem do evento pode ter sido regenerada e o ambiente de visualização precisa da nova chave de origem do evento.
...
Para atualizar o ambiente de visualização do Time Series Insights com a nova chave, abra o recurso de Hub no portal do Azure e copie a nova chave. Navegue até o recurso TSI e clique em fontes de evento. 
