...
- Leia [Azure Time Series insights sintaxe de consulta](https://docs.microsoft.com/rest/api/time-series-insights/gen1-query-syntax) para saber mais sobre a sintaxe de consulta para a API REST de acesso a dados Azure Time Series insights.
