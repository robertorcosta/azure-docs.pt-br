...
* [Referência de API](/javascript/api/azure-iot-device/)
...
* [Código-fonte](https://github.com/Azure/azure-iot-sdk-node)
* [Referência de API](/javascript/api/azure-iothub/)
