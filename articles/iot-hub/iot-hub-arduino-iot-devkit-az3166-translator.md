---
title: Faça funções de tradutor c/Azure, Serviços Cognitivos, IoT DevKit
...
1. Em VS Code, clique, `F1`digite e selecione **Azure IoT Device Workbench: Provision Azure Services...**. ![Prestação de serviços do Azure](media/iot-hub-arduino-iot-devkit-az3166-translator/provision.png)
...
1. Abra `Functions\DevKitTranslatorFunction.cs` e atualize as seguintes linhas de código com o nome do dispositivo e a tecla Speech Service que você anotou.
   ```csharp
...
1. Clique, `F1`digite e selecione **Azure IoT Device Workbench: Deploy to Azure...**. Se o código VS pedir confirmação para reimplantação, clique em **Sim**.
...
1. Clique `F1`em Digitar, digite e selecione **Azure IoT Device Workbench: Configure configurações do dispositivo... > Config Device Connection String**. Selecione **Selecione a Cadeia de conexão do dispositivo Hub IoT** para configurá-lo para o Kit de desenvolvimento.
