...
Crie uma [configuração de gerenciamento de dispositivo automática](iot-hub-automatic-device-management.md#create-a-configuration) no aplicativo de back-end para iniciar o processo de atualização de firmware em todos os dispositivos marcados com um **tipo de dispositivo** de resfriador. Nesta seção, você verá como:
