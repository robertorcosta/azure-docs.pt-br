...
* Métodos diretos: [Guia de desenvolvedor do IoT Hub - métodos diretos](iot-hub-devguide-direct-methods.md) e [Tutorial: Use métodos diretos](quickstart-control-device-java.md)
...
**trabalhos de agenda** que usam trabalhos para chamar o método direto **lockDoor** e atualizar as propriedades desejadas do dispositivo em vários dispositivos.
...
2. Na pasta **iot-java-schedule-jobs,** crie um projeto Maven chamado **schedule-jobs** usando o seguinte comando no seu prompt de comando. Observe que este é um comando único e longo:

   ```cmd/sh
   mvn archetype:generate -DgroupId=com.mycompany.app -DartifactId=schedule-jobs -DarchetypeArtifactId=maven-archetype-quickstart -DinteractiveMode=false
   ```

3. No seu prompt de comando, navegue até a pasta **de trabalhos de agendamento.**

4. Usando um editor de texto, abra o arquivo **pom.xml** na pasta **de trabalhos de agendamento** e adicione a seguinte dependência ao nó **dependências.** Essa dependência permite que você use o pacote **iot-service-client** em seu aplicativo para se comunicar com seu hub IoT:
...
9. Adicione as seguintes variáveis no nível da classe à classe **App** . Substitua por `{youriothubconnectionstring}` sua seqüência de conexão de hub IoT que você copiou anteriormente em [Obter a seqüência de conexão do hub IoT](#get-the-iot-hub-connection-string):
...
16. Salvar e fechar o **cronograma-jobs\src\main\java\com\mycompany\app\App.java**

17. Compile o aplicativo **schedule-jobs** e corrija eventuais erros. No prompt de comando, navegue até a pasta **de trabalhos de agendamento** e execute o seguinte comando:
...
1. Na pasta **iot-java-schedule-jobs,** crie um projeto Maven chamado **dispositivo simulado** usando o seguinte comando no seu prompt de comando. Observe que este é um comando único e longo:
...
3. Usando um editor de texto, abra o arquivo **pom.xml** na pasta **do dispositivo simulado** e adicione as seguintes dependências ao nó **dependências.** Essa dependência permite que você use o pacote **iot-device-client** em seu aplicativo para se comunicar com seu hub de IoT:
...
7. Usando um editor de texto, abra o **arquivo simulado\src\main\java\com\mycompany\app\App.java.**
...
9. Adicione as seguintes variáveis no nível da classe à classe **App** . Substitua pela `{yourdeviceconnectionstring}` seqüência de conexões do dispositivo que você copiou anteriormente no Registrar um novo dispositivo na seção [de hub IoT:](#register-a-new-device-in-the-iot-hub)
...
17. Salvar e fechar o **dispositivo simulado\src\main\java\com\mycompany\app\App\java.**

18. Compile o aplicativo **simulated-device** e corrija os erros. No prompt de comando, navegue até a pasta **do dispositivo simulado** e execute o seguinte comando:
...
1. Em um prompt de comando na pasta **de dispositivo simulado,** execute o seguinte comando para iniciar o aplicativo do dispositivo ouvindo as alterações de propriedade desejadas e chamadas diretas do método:
...
* Envie telemetria de dispositivos com o tutorial [Get started with IoT Hub.](quickstart-send-telemetry-java.md)
