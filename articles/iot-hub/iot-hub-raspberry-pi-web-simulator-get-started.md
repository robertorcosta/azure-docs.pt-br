...
* Como criar um Hub IoT do Azure e obter sua nova cadeia de conexão do dispositivo. Se você não tiver uma conta do Azure, [crie uma conta de avaliação gratuita do Azure](https://azure.microsoft.com/free/) em apenas alguns minutos.
