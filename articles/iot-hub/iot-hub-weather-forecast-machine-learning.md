...
1. Clique em configurar**serviço**Web **de previsão de serviço** > Web. O diagrama de experimento preditiva é aberto.
...
1. No [portal do Azure](https://portal.azure.com/), clique em **criar um recurso** > **Internet das coisas** > **trabalho de Stream Analytics**.
...
No Stream Analytics trabalho, clique em **Iniciar** > **agora** > **.** Depois que o trabalho é iniciado com êxito, o status do trabalho muda de **parado** para **executando**.
