...
ms.locfileid: "81732241"
---
# <a name="upload-files-from-your-device-to-the-cloud-with-iot-hub-nodejs"></a>Faça upload de arquivos do seu dispositivo para a nuvem com o IoT Hub (Node.js)

[!INCLUDE [iot-hub-file-upload-language-selector](../../includes/iot-hub-file-upload-language-selector.md)]

Este tutorial baseia-se no código nas mensagens de enviar nuvem para dispositivo com o tutorial [do IoT Hub](iot-hub-node-node-c2d.md) para mostrar como usar os recursos de upload de arquivos do [IoT Hub](iot-hub-devguide-file-upload.md) para carregar um arquivo para o armazenamento [blob do Azure](../storage/index.yml). Este tutorial mostra como:
...
> [!NOTE]
> O Hub IoT é compatível com muitas plataformas de dispositivo e linguagens (incluindo C, .NET, Javascript, Python e Java) por meio dos SDKs do dispositivo IoT do Azure. Consulte o [Azure IoT Developer Center] para obter instruções passo a passo sobre como conectar seu dispositivo ao Azure IoT Hub.
...
5. Adicione uma variável `iothubconnectionstring` e use-a para criar uma instância de **cliente**.  Substitua `{iothubconnectionstring}` o valor do espaço reservado pela seqüência de conexão de hub IoT que você copiou anteriormente em [Obter a seqüência de conexão do hub IoT:](#get-the-iot-hub-connection-string)
...
A captura de tela a seguir mostra a saída do aplicativo **SimuladoDispositivo:**
