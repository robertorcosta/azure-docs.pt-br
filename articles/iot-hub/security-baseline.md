...
ms.locfileid: "104576877"
---
# <a name="azure-security-baseline-for-azure-iot-hub"></a>Linha de base de segurança do Azure para o Hub IoT do Azure

Essa linha de base de segurança aplica diretrizes da [versão 1,0 do benchmark de segurança do Azure](../security/benchmarks/overview-v1.md) para Microsoft Azure Hub IOT. O Azure Security Benchmark fornece recomendações sobre como você pode proteger suas soluções de nuvem no Azure.
O conteúdo é agrupado pelos **controles de segurança** definidos pelo benchmark de segurança do Azure e pelas diretrizes relacionadas aplicáveis ao Hub IOT do Azure. Os **controles** não aplicáveis ao Hub IOT do Azure foram excluídos.

 
Para ver como o Hub IoT do Azure é mapeado completamente para o benchmark de segurança do Azure, consulte o [arquivo de mapeamento de linha de base de segurança do Hub IOT do Azure completo](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).
...
Depois que o acesso privado for estabelecido, desabilite o acesso à rede pública para o Hub IoT para segurança adicional. Esse controle de nível de rede é imposto em um recurso de Hub IoT específico, garantindo o isolamento. Para manter o serviço ativo para outros recursos do cliente usando o caminho público, seu ponto de extremidade público permanece resolvido, os endereços IP são detectáveis e as portas permanecem abertas. Isso não é uma causa de preocupação, pois a Microsoft integra várias camadas de segurança para garantir o isolamento completo entre os locatários.
...
- [Gerenciar o acesso à rede pública para o Hub IoT](iot-hub-public-network-access.md)

- [Isolamento de locatário no Azure](https://docs.microsoft.com/azure/security/fundamentals/isolation-choices#tenant-level-isolation)

- [prática recomendada de rede grande](https://docs.microsoft.com/azure/iot-fundamentals/security-recommendations#networking)
...
- [Central de segurança do Azure para comunicação de endereço IP suspeito de IoT](/azure/asc-for-iot/concept-security-alerts)
...
- [Configurar logs de IoT do Azure](https://docs.microsoft.com/azure/iot-hub/monitor-iot-hub-reference#resource-logs)
...
- [Configurar logs do Hub IoT do Azure](https://docs.microsoft.com/azure/iot-hub/monitor-iot-hub-reference#resource-logs)
...
**Azure Policy definições internas-Microsoft. Devices**:
...
- [Central de segurança do Azure para alertas de IoT](/azure/asc-for-iot/concept-security-alerts)
...
**Orientação**: para usuários que acessam o Hub IOT, use o SSO do Azure Active Directory (Azure AD). Use as recomendações de acesso e identidade da central de segurança do Azure.
...
**Diretrizes**: habilite a autenticação multifator do Azure Active Directory (Azure AD) para proteger seu locatário geral do Azure, beneficiando todos os serviços. O serviço de Hub IoT não tem suporte à autenticação multifator.
...
**Diretrizes**: Use uma Paw (estação de trabalho com acesso privilegiado) para tarefas administrativas que exigem privilégios elevados.

- [Entenda as estações de trabalho de acesso com privilégios seguras](https://4sysops.com/archives/understand-the-microsoft-privileged-access-workstation-paw-security-model/)
...
**Orientação**: para usuários que acessam o Hub IOT, não há suporte para acesso condicional. Para atenuar isso, use os locais nomeados do Azure Active Directory (AD do Azure) para permitir o acesso somente de agrupamentos lógicos específicos de intervalos de endereços IP ou países/regiões para seu locatário do Azure geral, beneficiando todos os serviços, incluindo o Hub IoT.
...
- [Tokens de segurança do Hub IoT](https://docs.microsoft.com/azure/iot-fundamentals/iot-security-deployment#iot-hub-security-tokens)
...
- [Configurar logs de recursos para o Hub IoT](https://docs.microsoft.com/azure/iot-hub/monitor-iot-hub#collection-and-routing)
...
Cada Hub IoT tem um registro de identidade que pode ser usado para criar recursos por dispositivo no serviço. Um indivíduo ou grupos de identidades de dispositivo podem ser adicionados a uma permissão ou a umalist de bloqueio, permitindo o controle completo sobre o acesso ao dispositivo.
...
- [Como usar identidades gerenciadas para o Hub IoT](https://docs.microsoft.com/azure/iot-hub/virtual-network-support#turn-on-managed-identity-for-iot-hub)
...
Use identidades gerenciadas para fornecer aos serviços do Azure uma identidade gerenciada automaticamente no Azure Active Directory (Azure AD). Identidades gerenciadas permitem que você se autentique em qualquer serviço que ofereça suporte à autenticação do Azure AD, incluindo Key Vault, sem nenhuma credencial em seu código.

- [Tokens de segurança do Hub IoT](https://docs.microsoft.com/azure/iot-fundamentals/iot-security-deployment#iot-hub-security-tokens)

- [Como configurar identidades gerenciadas para o Hub IoT](https://docs.microsoft.com/azure/iot-hub/virtual-network-support#turn-on-managed-identity-for-iot-hub)
...
- [Alta disponibilidade e recuperação de desastres do Hub IoT](https://docs.microsoft.com/azure/iot-hub/iot-hub-ha-dr#achieve-cross-region-ha)
