...
|dailyMessageQuotaUsed|Número total de mensagens usadas|{1&gt;{2&gt;Contagem&lt;2}&lt;1}|Média|Número total de mensagens utilizadas hoje. Este é um valor cumulativo que é reiniciado para zero em 00:00 UTC diariamente.|Nenhum|
