...
Os [logs de diagnóstico](../azure-monitor/platform/resource-logs-overview.md) estão desabilitados por padrão quando você cria um hub IoT. Nesta seção, habilite os logs de diagnóstico para o seu hub.
