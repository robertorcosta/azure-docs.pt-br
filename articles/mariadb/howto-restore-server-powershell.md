...
> [Personalizar o banco de dados do Azure para parâmetros de servidor MariaDB usando o PowerShell](howto-configure-server-parameters-using-powershell.md)
