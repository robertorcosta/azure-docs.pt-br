---
title: Servidor de reinicialização - Azure CLI - Banco de dados Azure para MariaDB
description: Este artigo descreve como você pode reiniciar um banco de dados Azure para servidor MariaDB usando o Cli do Azure.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
ms.locfileid: "79530641"
---
# <a name="restart-azure-database-for-mariadb-server-using-the-azure-cli"></a>Reiniciar o banco de dados Do Azure para o servidor MariaDB usando o Cli do Azure
...
Saiba [como definir parâmetros no Banco de Dados Azure para MariaDB](howto-configure-server-parameters-cli.md)