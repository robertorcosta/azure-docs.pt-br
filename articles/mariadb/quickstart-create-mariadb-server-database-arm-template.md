---
title: Criar um BD do Azure para MariaDB usando um modelo do Resource Manager
description: Neste artigo, aprenda a criar um servidor do Banco de Dados do Azure para MariaDB usando um modelo do Azure Resource Manager.
author: mgblythe
ms.service: mariadb
ms.topic: quickstart
...
ms.locfileid: "84266416"
---
# <a name="quickstart-use-a-resource-manager-template-to-create-an-azure-database-for-mariadb-server"></a>Início Rápido: Usar um modelo do Resource Manager para criar um servidor do Banco de Dados do Azure para MariaDB

O Banco de Dados do Azure para MariaDB é um serviço gerenciado usado para executar, gerenciar e dimensionar bancos de dados MariaDB altamente disponíveis na nuvem. Neste guia de início rápido, você usa um modelo do Resource Manager para criar um Banco de Dados do Azure para MariaDB no portal do Azure, no PowerShell ou na CLI do Azure.
