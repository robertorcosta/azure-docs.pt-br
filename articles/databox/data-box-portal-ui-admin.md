...
description: Saiba como gerenciar o Disco do Data Box usando o portal do Azure. Gerencie pedidos, gerencie discos e acompanhe o status de um pedido conforme ele progride.
services: databox
author: alkohli
ms.service: databox
ms.subservice: disk
...
|Canceled            |Pedido cancelado. <br> Você cancelou o pedido ou ocorreu um erro e o serviço cancelou o pedido.     |
