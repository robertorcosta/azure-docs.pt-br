...
A. O Data Box é compatível com todas as regiões nos EUA, na Europa Ocidental, no Norte da Europa, na França, no Reino Unido, no Japão, na Austrália e no Canadá. Para obter mais informações, acesse [disponibilidade de região](data-box-overview.md#region-availability).
...
A. Se o LED indicador de falha do sistema estiver aceso, ele indicará que o sistema não está íntegro. [Entre em contato com suporte da Microsoft](data-box-disk-contact-microsoft-support.md) para as próximas etapas.
...
- Acesse seu pedido no portal do Azure. Acesse **visão geral** e **Baixe o rótulo de envio**. Para obter mais informações, acesse [Baixar a etiqueta de remessa](data-box-portal-admin.md#download-shipping-label).
...
A.  Depois que o status do pedido para a **cópia de dados** for mostrado como **concluído**, você poderá acessar seus dados imediatamente.
