...
- Obter o Python 2.7, 3.5 ou posterior – Para obter informações sobre como configurar o Python no Windows, confira a [documentação do Python no Windows]( https://docs.microsoft.com/windows/python/)
