...
Use o seguinte comando ou [portal do Azure](/azure/storage/common/storage-auth-aad-rbac-portal#assign-rbac-roles-using-the-azure-portal) para conceder a identidade gerenciada de seu acesso de aplicativo de funções do Azure à sua fila de armazenamento. 
