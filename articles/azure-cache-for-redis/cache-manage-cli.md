...
| EnableNonSslPort |-e, --enable-non-ssl-port |Propriedade EnableNonSslPort do Azure Cache para Redis. Adicione este sinalizador se quiser ativar a porta não-TLS/SSL para o cache |
