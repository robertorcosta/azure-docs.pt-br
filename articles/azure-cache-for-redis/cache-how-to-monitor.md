...
| Porcentagem de memória utilizada | A % da memória total que está sendo usada durante o intervalo de relatório especificado.  Esse valor faz referência ao valor `used_memory` do comando INFO do Redis para calcular a porcentagem. |
