...
1. Copie os arquivos **launch.js** e **tasks.jsem** de services\scripts\local\launch\idesettings\vscode para a pasta **. vscode** que você acabou de criar.
