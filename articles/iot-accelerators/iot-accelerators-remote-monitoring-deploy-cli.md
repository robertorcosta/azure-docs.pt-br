...
|-------|--------------------------------|--------------|----------|
| 1     | [Máquina virtual do Linux](https://azure.microsoft.com/services/virtual-machines/) | Standard D1 V2  | Hospedar microsserviços |
...
| 1     | [Conta de Armazenamento do Azure](../storage/common/storage-introduction.md#types-of-storage-accounts)  | Standard        | Armazenamento de VM e pontos de verificação de streaming |
...
| 1     | [Serviço de provisionamento de dispositivo do Azure](../iot-dps/index.yml)        |       S1          | Provisionamento de dispositivos em escala |
...
| 5     | [Contas de armazenamento do Azure](../storage/common/storage-introduction.md#types-of-storage-accounts)    | Standard        | 4 para armazenamento de máquina virtual e 1 para os pontos de verificação de streaming |
...
> [!NOTE]
> Você pode encontrar informações sobre preços para esses serviços em [https://azure.microsoft.com/pricing](https://azure.microsoft.com/pricing) . Você pode encontrar detalhes de uso e faturamento para sua assinatura no [Portal do Azure](https://portal.azure.com/).
