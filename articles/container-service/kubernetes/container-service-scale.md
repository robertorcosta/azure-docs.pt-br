...
> [!TIP]
> Para a versão atualizada deste artigo que usa o Serviço de Kubernetes do Azure, confira [Escalar um cluster de Serviço de Kubernetes do Azure (AKS)](../../aks/scale-cluster.md).
