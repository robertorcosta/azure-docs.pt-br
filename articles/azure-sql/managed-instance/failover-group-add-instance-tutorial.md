...
## <a name="1---create-a-resource-group-and-primary-managed-instance"></a>1-criar um grupo de recursos e uma instância gerenciada primária
...
## <a name="4---create-a-primary-gateway"></a>4-criar um gateway primário 
