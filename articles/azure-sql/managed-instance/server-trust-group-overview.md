...
O [grupo de confiança do servidor](https://aka.ms/mi-server-trust-group-arm) é um objeto Azure Resource Manager que foi rotulado como **grupo de confiança do SQL** no portal do Azure.
