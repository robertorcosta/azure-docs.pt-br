...
- Corrigir ameaças em potencial em tempo real com [detecção avançada de ameaças](https://docs.microsoft.com/azure/security/fundamentals/threat-detection#advanced-threat-detection-features-other-azure-services) inteligente e alertas de avaliação proativa de vulnerabilidades. 
