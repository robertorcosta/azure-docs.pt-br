...
![A figura 1](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-1.png)
...
A principal vantagem dessa estratégia é o baixo custo da redundância da camada de dados. O banco de dados SQL do Azure faz backup automaticamente de bancos de dados sem regravação de aplicativos sem custo adicional. O custo é incorrido apenas quando os bancos de dados elásticos são restaurados. 
