...
description: Intelligent Insights fornece um log de diagnóstico do banco de dados SQL do Azure e problemas de desempenho do SQL Instância Gerenciada do Azure
...
- Saiba como [monitorar problemas de desempenho usando o análise de SQL do Azure](https://docs.microsoft.com/azure/log-analytics/log-analytics-azure-sql).
