...
Na [parte 2](predictive-model-build-compare-tutorial.md), você aprendeu a criar e treinar vários modelos de machine learning em R e, em seguida, escolheu o mais preciso.

## <a name="prerequisites"></a>Pré-requisitos

* Na parte 3 deste tutorial, assumimos que você concluiu a [**parte 1**](predictive-model-prepare-data-tutorial.md) e a [**parte 2**](predictive-model-build-compare-tutorial.md).
