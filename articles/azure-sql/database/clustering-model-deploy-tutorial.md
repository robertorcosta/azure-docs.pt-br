...
* Na parte 3 deste tutorial, assumimos que você concluiu a [**parte 1**](clustering-model-prepare-data-tutorial.md) e a [**parte 2**](clustering-model-build-tutorial.md).
...
Depois de concluir este tutorial, você poderá excluir o banco de dados tpcxbb_1gb do servidor.
...
* [Tutorial: Preparar dados para treinar um modelo preditivo no R com os Serviços de Machine Learning do Banco de Dados SQL do Azure (versão prévia)](predictive-model-prepare-data-tutorial.md)
...
* [Adicionar um pacote R aos Serviços do Machine Learning do Banco de Dados SQL do Azure (versão prévia)](machine-learning-services-add-r-packages.md)
