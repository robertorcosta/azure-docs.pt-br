---
title: Consultas de relatórios ad hoc em vários bancos de dados
description: Execute consultas de relatório ad hoc em vários bancos de dados SQL do Azure em um exemplo de aplicativo multilocatário.
