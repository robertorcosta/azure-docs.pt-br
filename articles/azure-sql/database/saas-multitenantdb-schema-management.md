...
Em seguida, confira o [tutorial de relatórios ad hoc](../../sql-database/saas-multitenantdb-adhoc-reporting.md) para explorar a execução de consultas distribuídas entre bancos de dados de locatário.
