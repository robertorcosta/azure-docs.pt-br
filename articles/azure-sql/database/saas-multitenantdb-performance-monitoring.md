...
Neste tutorial, vários dos principais cenários de gerenciamento de desempenho usados em aplicativos SaaS são explorados. Usando um gerador de carga para simular atividade entre bancos de dados multilocatários fragmentados, os recursos internos de monitoramento e alerta do banco de dados SQL do Azure são demonstrados.
