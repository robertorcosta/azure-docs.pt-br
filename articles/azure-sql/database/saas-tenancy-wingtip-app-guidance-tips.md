...
- [Implantar o Aplicativo Autônomo SaaS Wingtip Tickets](../../sql-database/saas-standaloneapp-get-started-deploy.md)
- [Implantar o aplicativo do Banco de Dados por locatário do SaaS do Wingtip Ticket](../../sql-database/saas-dbpertenant-get-started-deploy.md)
- [Implantar o aplicativo do Banco de Dados Multilocatário do SaaS do Wingtip Tickets](../../sql-database/saas-multitenantdb-get-started-deploy.md)
