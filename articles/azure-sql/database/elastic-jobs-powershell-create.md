---
title: Criar um agente de Trabalho Elástico usando o PowerShell
...
ms.locfileid: "84024763"
---
# <a name="create-an-elastic-job-agent-using-powershell"></a>Criar um agente de Trabalho Elástico usando o PowerShell
[!INCLUDE[appliesto-sqldb](../includes/appliesto-sqldb.md)]

Os [trabalhos elásticos](job-automation-overview.md#elastic-database-jobs-preview) habilitam a execução de um ou mais scripts T-SQL (Transact-SQL) em paralelo entre vários bancos de dados.
