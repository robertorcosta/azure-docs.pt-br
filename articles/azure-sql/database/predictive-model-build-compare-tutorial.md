...
* A parte dois deste tutorial presume que você concluiu a [**parte um**](predictive-model-prepare-data-tutorial.md) e seus pré-requisitos.
...
![Como comparar os dois modelos](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [Tutorial: Implantar um modelo preditivo no R com os Serviços do Machine Learning do Banco de Dados SQL do Azure (versão prévia)](predictive-model-deploy-tutorial.md)
