...
* [Banco de Dados SQL do Azure com Serviços de Machine Learning (com R)](machine-learning-services-overview.md) habilitado.
...
Se você não pretende continuar com este tutorial, exclua o banco de dados TutorialDB do servidor.
...
> [Tutorial: Criar um modelo preditivo no R com os Serviços do Machine Learning do Banco de Dados SQL do Azure (versão prévia)](predictive-model-build-compare-tutorial.md)
