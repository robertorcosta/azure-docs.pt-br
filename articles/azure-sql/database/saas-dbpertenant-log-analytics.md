...
ms.locfileid: "84027997"
---
# <a name="set-up-and-use-azure-monitor-logs-with-a-multitenant-azure-sql-database-saas-app"></a>Configurar e usar logs de Azure Monitor com um aplicativo SaaS multilocatário do banco de dados SQL do Azure
...
* O aplicativo de banco de dados por locatário SaaS Wingtip Tickets é implantado. Para implantá-lo em menos de cinco minutos, veja [Implantar e explorar o aplicativo de banco de dados por locatário SaaS Wingtip Tickets](../../sql-database/saas-dbpertenant-get-started-deploy.md).
...
1. No ISE do PowerShell, abra *.. \\ Repositório wingtipticketssaas-MultiTenantDb-Master os \\ módulos de aprendizado \\ monitoramento e gerenciamento de desempenho \\ log Analytics \\Demo-LogAnalytics.ps1*.
