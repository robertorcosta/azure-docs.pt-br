...
Para saber mais sobre como usar os logs do Azure Monitor para consultar e definir alertas, confira [Trabalhar com regras de alertas nos logs do Azure Monitor](https://docs.microsoft.com/azure/log-analytics/log-analytics-alerts-creating).
