...
![Modelo treinado com saída adicional](./media/r-train-score-model-create-quickstart/r-train-model-with-additional-output.png)
...
2. Preveja a distância de parada segundo esses novos valores de velocidade.
   ...
   **Resultados**
   ...
   ![Conjunto de resultados para previsão da distância de parada](./media/r-train-score-model-create-quickstart/r-predict-stopping-distance-resultset.png)
...
- [Criar e executar scripts R simples em Serviços do Machine Learning do Banco de Dados SQL do Azure (versão prévia)](r-script-create-quickstart.md)
