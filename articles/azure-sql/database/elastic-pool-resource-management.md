...
- Para obter uma introdução aos pools elásticos, consulte [pools elásticos ajudam você a gerenciar e dimensionar vários bancos de dados no banco de dados SQL do Azure](https://docs.microsoft.com/azure/sql-database/sql-database-elastic-pool).
