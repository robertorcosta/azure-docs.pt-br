...
* A parte dois deste tutorial presume que você concluiu a [**parte um**](clustering-model-prepare-data-tutorial.md) e seus pré-requisitos.
...
As quatro médias de cluster são fornecidas usando as variáveis definidas na [parte um](clustering-model-prepare-data-tutorial.md#separate-customers):
...
> [Tutorial: Implantar um modelo de clustering no R com os Serviços de Machine Learning do Banco de Dados SQL do Azure (versão prévia)](clustering-model-deploy-tutorial.md)
