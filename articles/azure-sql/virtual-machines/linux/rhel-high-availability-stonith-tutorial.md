...
> [Tutorial: Configurar ouvinte do grupo de disponibilidade para o SQL Server em máquinas virtuais do RHEL no Azure](rhel-high-availability-listener-tutorial.md)
