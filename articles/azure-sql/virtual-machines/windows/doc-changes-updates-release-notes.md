...
| **Criar AG usando o PowerShell** | Agora é possível simplificar a criação de um grupo de disponibilidade usando o [PowerShell](availability-group-az-commandline-configure.md) , bem como o CLI do Azure. | 
