...
- As credenciais de cliente usadas para registrar as máquinas virtuais existentes em qualquer uma das seguintes funções de RBAC: **Colaborador de máquina virtual**, **Colaborador** ou **Proprietário**. 
...
## <a name="resister-all-vms-in-a-resource-group"></a>Registrar todas as VMs em um grupo de recursos
...
## <a name="register-specific-vms-in-single-resource-group"></a>Registrar VMs específicas em um grupo de recursos único
