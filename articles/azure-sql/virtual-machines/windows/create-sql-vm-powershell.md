...
Modifique conforme desejado e, em seguida, execute o cmdlet a seguir para inicializar essas variáveis. É recomendável utilizar os [SSDs Premium](../../../virtual-machines/windows/disks-types.md#premium-ssd) para cargas de trabalho de produção.
