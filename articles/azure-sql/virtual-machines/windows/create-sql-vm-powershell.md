...
Este guia explica as opções para criar VMs do SQL Server do Windows com o Azure PowerShell. Para obter um exemplo do PowerShell do Azure simplificado com mais valores padrão, consulte o [início rápido da VM do SQL do Azure PowerShell](sql-vm-create-powershell-quickstart.md).
...
Modifique conforme desejado e, então, execute o cmdlet a seguir para iniciar essas variáveis. É recomendável utilizar os [SSDs Premium](../../../virtual-machines/windows/disks-types.md#premium-ssd) para cargas de trabalho de produção.
