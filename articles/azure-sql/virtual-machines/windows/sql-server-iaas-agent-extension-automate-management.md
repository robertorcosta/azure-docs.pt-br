...
A extensão de IaaS do SQL Server é instalada quando você registra sua VM do SQL Server com o [provedor de recursos de VM do SQL](sql-vm-resource-provider-register.md). Se necessário, instale o SQL Server IaaS Agent manualmente usando o comando do PowerShell abaixo: 
