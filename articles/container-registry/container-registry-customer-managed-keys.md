...
Para obter as etapas para criar um cofre de chaves, consulte [início rápido: definir e recuperar um segredo de Azure Key Vault usando o portal do Azure](../key-vault/quick-create-portal.md).
...
O modelo a seguir cria um novo registro de contêiner e uma identidade gerenciada atribuída pelo usuário. Copie o conteúdo a seguir em um novo arquivo e salve-o usando um nome de arquivo, como `CMKtemplate.json`.
