...
*Soluções potenciais*: Experimente uma maneira diferente de autenticar, por exemplo, com credenciais de administrador. Se os usuários precisarem autenticar usando Azure Active Directory, abra um problema em https://aka.ms/acr/issues.
