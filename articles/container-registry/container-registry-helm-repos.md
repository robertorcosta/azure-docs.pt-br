...
- **Azure CLI versão 2.0.71** `az --version` ou posterior - Corra para encontrar a versão. Se você precisa instalar ou atualizar, consulte [Instalar a CLI do Azure][azure-cli-install].
