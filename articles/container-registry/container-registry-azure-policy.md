...
1. Use os filtros para limitar os Estados de conformidade ou para pesquisar políticas ![a conformidade da política no portal](./media/container-registry-azure-policy/azure-policy-compliance.png).
