---
title: Formato de telemetria do editor OPC da Microsoft
description: Este artigo fornece uma visão geral do arquivo de definições de configuração
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787510"
---
# <a name="opc-publisher-telemetry-format"></a>Formato de telemetria do editor OPC

O editor OPC versão 2,6 e superior suportam o formato JSON de PubSub OPC UA padronizado conforme especificado na [parte 14 da especificação OPC UA](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) e tem a seguinte aparência:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Além disso, todas as versões do editor OPC oferecem suporte a um formato de telemetria JSON simples e não padronizado, que é compatível com [Azure Time Series insights](https://azure.microsoft.com/services/time-series-insights/) e tem a seguinte aparência:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>Formato do arquivo de configuração de telemetria do Publicador OPC
```
