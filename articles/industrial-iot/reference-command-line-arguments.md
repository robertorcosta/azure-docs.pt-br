---
title: Argumentos de linha de comando do Microsoft OPC Publisher
description: Este artigo fornece uma visão geral dos argumentos de linha de comando do Publicador OPC
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787518"
---
# <a name="command-line-arguments"></a>Argumentos de linha de comando

A seguir, há vários argumentos de linha de comando descritos que podem ser usados para definir configurações globais para o editor OPC.

## <a name="opc-publisher-command-line-arguments-for-version-25-and-below"></a>Argumentos de linha de comando do Publicador OPC para a versão 2,5 e inferior

* Uso: opcpublisher.exe \<applicationname> [ \<iothubconnectionstring> ] [ \<options> ]
    
* ApplicationName: o nome do aplicativo OPC UA a ser usado, necessário o nome do aplicativo também é usado para registrar o Publicador com esse nome no registro do dispositivo do Hub IoT.
    
* iothubconnectionstring: o proprietário do Hub IoT ConnectionString, opcional. Normalmente, você especifica a ConnectionString do proprietário IoTHub somente no primeiro início do aplicativo. A cadeia de conexão é criptografada e armazenada no repositório de certificados de plataformas.
Nas chamadas subsequentes, ele é lido a partir daí e reutilizado. Se você especificar o ConnectionString em cada início, o dispositivo, criado para o aplicativo no registro de dispositivo do Hub IoT, será removido e recriado a cada vez.
    
Há algumas variáveis de ambiente, que podem ser usadas para controlar o aplicativo:
```
...
## <a name="opc-publisher-command-line-arguments-for-version-26-and-above"></a>Argumentos de linha de comando do Publicador OPC para a versão 2,6 e superior
```
      --pf, --publishfile=VALUE
                                       the filename to configure the nodes  to publish.
...
Outros recursos podem ser encontrados nos repositórios GitHub:

> [!div class="nextstepaction"]
> [Repositório do GitHub do Publicador OPC](https://github.com/Azure/Industrial-IoT)

> [!div class="nextstepaction"]
> [Repositório GitHub da plataforma IIoT](https://github.com/Azure/iot-edge-opc-publisher)