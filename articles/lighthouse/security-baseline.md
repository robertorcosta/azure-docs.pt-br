...
- [Azure Security Benchmark – Gerenciamento de ativos](/azure/security/benchmarks/security-controls-v2-incident-response)
...
- [Azure Security Benchmark – Segurança de rede](/azure/security/benchmarks/security-controls-v2-logging-threat-detection)
