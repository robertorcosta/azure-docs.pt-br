...
Para obter instruções detalhadas sobre como criar sua oferta, incluindo todas as informações e ativos que você precisará fornecer, consulte [criar uma oferta de serviço gerenciado](../../marketplace/create-managed-service-offer.md).
...
Depois de concluir todas as seções, a próxima etapa é publicar a oferta no Azure Marketplace. Selecione o botão **Publicar** para iniciar o processo de ativação da oferta. Mais informações sobre esse processo podem ser encontradas [aqui](../../marketplace/review-publish-offer.md).
...
- [Vincule sua ID de parceiro](partner-earned-credit.md) para acompanhar seu impacto nos compromissos do cliente.
