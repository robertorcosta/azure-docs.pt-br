...
description: Como um provedor de serviços usando o Azure Lighthouse, você pode exibir todos os recursos e assinaturas do cliente delegado Acessando meus clientes na portal do Azure.
ms.date: 07/06/2020
ms.topic: how-to
