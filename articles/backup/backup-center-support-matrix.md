...
| Ações | Configurar backup | <li> Máquina Virtual do Azure <br><br> <li> Servidor do Banco de Dados do Azure para PostgreSQL <br><br> <li> SQL na VM do Azure <br><br> <li> SAP HANA na VM do Azure <br><br> <li> Arquivos do Azure<br/><br/> <li>Blobs do Azure<br/><br/> <li>Azure Managed Disks | Consulte matrizes de suporte para backup de [VM do Azure](./backup-support-matrix-iaas.md) e [banco de dados do Azure para backup de servidor PostgreSQL](backup-azure-database-postgresql.md#support-matrix) |
