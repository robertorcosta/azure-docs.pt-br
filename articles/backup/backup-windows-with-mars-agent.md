...
1. No assistente de agendamento de backup, selecione **introdução** > **Avançar**.
...
1. Na página **escolher tipo de backup inicial** , decida se deseja fazer o backup inicial pela rede ou usar o backup offline. Para fazer o backup inicial pela rede, selecione **automaticamente pela rede** > **Avançar**.
...
1. Na guia **Limitação**, selecione **Habilitar limitação de uso da largura de banda de Internet para operações de backup**.
