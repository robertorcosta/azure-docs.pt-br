...
2. Instale o agente no Exchange Server selecionando **Management > agents > instalar** no console do administrador do DPM. Confira [Instalar o agente de proteção do DPM](/system-center/dpm/deploy-dpm-protection-agent?view=sc-dpm-2019) para conhecer as etapas detalhadas.
