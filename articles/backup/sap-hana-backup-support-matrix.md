...
| **Versões do HANA**          | SDC no HANA 1. x, MDC no HANA 2. x <= SPS04 Rev 53, SPS05 (ainda para ser validado para cenários habilitados para criptografia)      |                                                            |
