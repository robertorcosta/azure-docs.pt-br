...
--- | ---
**Backup direto do computador local que está executando o Linux** | Não há suporte. O agente MARS só pode ser instalado em computadores Windows.
...
**Usando o MABS ou o DPM para fazer backup de VMs do Linux Azure** | Não há suporte.
...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| VM do Azure               | Sim.   Com suporte para VMs criptografadas e VMs com menos de 4 TB de disco | Todas as regiões públicas do Azure.  |
