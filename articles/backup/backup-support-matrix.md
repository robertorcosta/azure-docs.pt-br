...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| VM do Azure               | Com suporte para VMs do Azure com discos gerenciados e não gerenciados. Não compatível com VMs clássicas. | Todas as regiões públicas do Azure.  |
