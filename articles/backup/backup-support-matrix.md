...
| SQL/SAP HANA | Sim                                                          | Oeste dos EUA 2 (WUS2), Oeste EUA Central (WCUS), Canadá central (CNC), leste do Canadá (CNE), leste dos EUA (EUS), oeste dos EUA (WUS), leste do Japão (JPE), leste do Japão (JPE) |
