...
|Pré-requisitos do Linux|-Você pode fazer backup de máquinas virtuais do Linux usando o MABS. Somente instantâneos consistentes com arquivos têm suporte.|
