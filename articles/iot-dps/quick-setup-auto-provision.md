...
Você precisará de uma assinatura do Azure para começar a usar este artigo. Você pode criar uma [conta gratuita](https://azure.microsoft.com/free/?WT.mc_id=A261C142F), se ainda não tiver uma.
