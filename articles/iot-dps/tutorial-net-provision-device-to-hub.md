...
description: Este tutorial mostra como provisionar seu dispositivo para um único hub IoT usando o Serviço de Provisionamento de Dispositivos no Hub IoT do Azure (.NET)
author: wesmc7777
ms.author: wesmc
ms.date: 11/12/2019
ms.topic: tutorial
