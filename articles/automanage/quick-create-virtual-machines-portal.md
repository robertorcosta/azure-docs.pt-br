...
> [!IMPORTANT]
> A permissão RBAC a seguir é necessária para habilitar o gerenciamento automático: Função de **Proprietário** ou **Colaborador** junto com funções de **Administrador de Acesso do Usuário**.
