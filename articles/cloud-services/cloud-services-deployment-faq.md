...
Para obter ajuda para mitigar tais falhas de alocação, consulte [falha de alocação do Cloud Service: Soluções](cloud-services-allocation-failures.md#solutions).
...
Como o Cloud Service é um recurso clássico que não é diretamente compatível com o modelo do Azure Resource Manager, você não pode associá-lo às contas do Azure Resource Manager Storage. Veja algumas opções: 
...
- Implantar por meio do [Portal do Azure](https://portal.azure.com).
    ...
    Isso funcionará a partir do [portal Azure](https://portal.azure.com) à medida que a chamada passar por um proxy/shim que permite a comunicação entre o Azure Resource Manager e os recursos Classic. 
