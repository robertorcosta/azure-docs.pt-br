...
description: Um arquivo de definição de serviço (.csdef) define um modelo de serviço para um aplicativo, contendo funções disponíveis, pontos finais e valores de configuração para o serviço.
ms.custom: ''
ms.date: 04/14/2015
