...
| Codificar |var x = RoleEnvironment.IsEmulated; |
...
| Codificar |var deploymentId = RoleEnvironment.DeploymentId; |
...
| Codificar |var id = RoleEnvironment.CurrentRoleInstance.Id; |
...
| Codificar |var ud = RoleEnvironment.CurrentRoleInstance.UpdateDomain; |
...
| Codificar |var fd = RoleEnvironment.CurrentRoleInstance.FaultDomain; |
...
| Codificar |var rname = RoleEnvironment.CurrentRoleInstance.Role.Name; |
...
| Codificar |var setting = RoleEnvironment.GetConfigurationSettingValue("Setting1"); |
...
| Codificar |var localResourcePath = RoleEnvironment.GetLocalResource("LocalStore1").RootPath; |
...
| Codificar |var localResourceSizeInMB = RoleEnvironment.GetLocalResource("LocalStore1").MaximumSizeInMegabytes; |
...
| Codificar |var prot = RoleEnvironment.CurrentRoleInstance.InstanceEndpoints["Endpoint1"].Protocol; |
...
| Codificar |var address = RoleEnvironment.CurrentRoleInstance.InstanceEndpoints["Endpoint1"].IPEndpoint.Address |
...
| Codificar |var port = RoleEnvironment.CurrentRoleInstance.InstanceEndpoints["Endpoint1"].IPEndpoint.Port; |
