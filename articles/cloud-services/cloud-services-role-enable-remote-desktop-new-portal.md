...
1. Clique em **Serviços de Nuvem** , selecione o nome do serviço de nuvem e depois selecione **Área de Trabalho Remota** .
    ...
    ![Captura de tela que realça a opção Área de Trabalho Remota.](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop.png)
...
3. Clique em **Conectar** para baixar um arquivo RDP para a instância da função.
    ...
    ![Captura de tela que realça o botão Conectar.](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop_Connect.png)
