...
| ***Platéia*** | Seu aplicativo deve ser para usuários de linha de negócios e proprietários de empresas. | Obrigatório | 
...
| ***Gerenciamento de clientes potenciais*** | Habilite o CRM para aceitar dados de clientes potenciais antes de recebê-los da vitrine.<ul> <li>Como exemplos de CRMs temos: Marketo, Microsoft Dynamics ou Salesforce</li> </ul> | Obrigatório |  
...
| ***Platéia*** | Suas ofertas devem ser para profissionais de TI, desenvolvedores de nuvem ou outras funções técnicas do cliente. | list<br />transação<br />versão de avaliação |  
| ***Gerenciamento de clientes potenciais*** | Habilite seu CRM (Marketo, Microsoft Dynamics ou Salesforce) para aceitar dados de cliente potencial antes de recebê-los da vitrine. | list<br />transação<br />versão de avaliação |  
...
#### <a name="requirements-azure-marketplace-trial-free-trial--saas-trial"></a>Requisitos: Azure Marketplace: avaliação: avaliação gratuita/avaliação de SaaS  
