...
Para publicar uma nova imagem de contêiner, você precisa atender aos seguintes pré-requisitos:

- Acesso ao Portal do Microsoft Cloud Partner. Para obter mais informações, consulte o guia de publicação do Azure Marketplace e AppSource.
- Contrato com os Termos do Marketplace do Azure
- Hospede seu ativo técnico de contêiner em um Registro de Contêiner do Azure.
