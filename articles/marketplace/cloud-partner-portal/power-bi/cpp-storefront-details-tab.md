...
|   Campo                                  |   Descrição                                                        |
| --------------                           | ---------------------                                                |
| **Mercados**                           | Selecione o setor no qual seu aplicativo se adapta melhor. Se seu aplicativo estiver relacionado a vários setores, deixe esse campo em branco.      |
...
| **Logotipo de oferta (formato png, 216x216)\*** | Carregue um logotipo para ser exibido na página de detalhes do aplicativo.  AppSource dá suporte apenas ao formato PNG, com uma resolução de 216 x 216 px.  |
| *Vídeos*                             |                                                                   |
...
| *Capturas\**                      | Adicione até cinco capturas de tela.                        |
