...
A tabela a seguir descreve os campos de formulário e a entrada necessária para cada campo. Os campos obrigatórios são indicados por um asterisco (*).
...
Depois de concluir a fornecer informações de suporte, você está pronto para [publicar sua oferta](./cpp-publish-offer.md).
