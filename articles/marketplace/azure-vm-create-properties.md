...
Na página **Propriedades** , você define as categorias que são usadas para agrupar sua oferta de VM (máquina virtual) no Azure Marketplace, sua versão do aplicativo e os contratos legais que dão suporte à sua oferta.

## <a name="select-a-category"></a>Selecionar uma categoria

Selecione categorias e subcategorias para posicionar sua oferta nas áreas de pesquisa do Azure Marketplace apropriadas. Descreva como sua oferta dá suporte a essas categorias na descrição da oferta. Selecione:
