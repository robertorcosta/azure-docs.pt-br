...
Confira a [documentação das Instâncias de Contêiner do Azure](/azure/container-instances/) para ver início rápido, tutoriais e amostras.
...
- [Gerenciador de Armazenamento do Azure](/azure/vs-azure-tools-storage-manage-with-storage-explorer.md?tabs=windows)
