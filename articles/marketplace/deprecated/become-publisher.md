---
title: Torne-se um Editor nas vitrines do mercado | Mercado Azure
...
| 4 |  Entrar no Portal do Cloud Partner | 1 a 3 dias | [Inscreva-se no Portal de Parceiros em Nuvem](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account#sign-in-with-a-work-account) |  
...
## <a name="1-register-in-microsoft-partner-network"></a>1. Registre-se na Microsoft Partner Network  
| 15 min |  
A participação no mercado em nuvem da Microsoft requer a participação na Microsoft Partner Network (MPN), que também fornece os principais benefícios, programas e rastreamento de desempenho dos parceiros. Se sua organização ainda não for um membro, entre no MPN (Microsoft Partner Network) para se tornar um parceiro da Microsoft oficial e receber benefícios e suporte adicional para a publicação no marketplace. 
...
Abra um ticket com [o suporte de parceiros](https://partner.microsoft.com/support) da Microsoft para problemas com o registro de MPN.

---

## <a name="2-create-a-microsoft-account"></a>2. Crie uma conta Microsoft  
| 15 min |  
...
## <a name="3-create-a-partner-center-account"></a>3. Crie uma conta do Partner Center  
| 15 min |  

Após [enviar a solução](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) ao Marketplace, nossa equipe de integração entrará em contato com você para auxiliá-lo na experiência de publicação. Veja como [criar uma conta do Partner Center](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account) para obter mais informações.
...
---
## <a name="4-sign-into-cloud-partner-portal"></a>4. Inscreva-se no Portal de Parceiros em Nuvem
| 1 a 3 dias | <br>
...
*    Se você não recebeu o e-mail de boas-vindas, verifique sua pasta de spam para obter um e-mail com a linha de assunto "Bem-vindo ao Microsoft Marketplace!". Se não houver nenhum email na sua pasta de spam, [entre em contato com o suporte da Microsoft](https://support.microsoft.com/getsupport?wf=0&tenant=classiccommercial&oaspworkflow=start_1.0.0.0&locale=&supportregion=&pesid=16230&forceorigin=esmc&ccsid=636595105151894820). Na página de suporte, selecione: Tipo de Problema > Integração do Marketplace.  Nossa Equipe de Integração de Editores do Marketplace terá satisfação em ajudá-lo com suas perguntas. 


## <a name="5-register-in-dev-center-for-transact-publishing-option-only"></a>5. Registre-se no Dev Center (apenas para opção de publicação transato) 
| 5 a 10 dias |  
...
O processo de registro do [Centro de Desenvolvimento](https://developer.microsoft.com/store/register) pode ser iniciado antes de criar sua oferta no Portal do Cloud Partner, mas deve ser concluído antes de publicar sua oferta do marketplace. Dada a duração típica de 5 a 10 dias desta etapa, recomendamos iniciar este processo o mais rápido possível se você pretende usar a opção de publicação de transações. 
...
Depois de concluir o registro do [Dev Center,](https://developer.microsoft.com/store/register) vincule seu Perfil de Parceiro na Nuvem com sua conta [do Dev Center](https://developer.microsoft.com/store/register) [(veja os passos detalhados aqui).](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal-orig/cloud-partner-portal-manage-publisher-profile) Esta etapa deve ser concluída antes de publicar sua oferta de transação. 

>[!Note]
>Para dispensar a taxa de inscrição do Centro de Desenvolvedores de US$ 99, preencha o [formulário de registro](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) do marketplace e você receberá um e-mail contendo seu código promocional. Veja como [criar uma conta do Partner Center](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account) para obter mais informações.
...
* Conheça as vitrines do marketplace: [Comparando o AppSource e o Azure Marketplace](https://docs.microsoft.com/azure/marketplace/comparing-appsource-azure-marketplace).
