---
title: Como configurar os detalhes de listagem da oferta de Aplicativo Azure
description: Saiba como configurar os detalhes de listagem para sua oferta de aplicativo do Azure no Partner Center.
author: aarathin
ms.author: aarathin
...
As informações fornecidas na página de **listagem de ofertas** para sua oferta de aplicativo Azure serão exibidas nas lojas online do Microsoft Commercial Marketplace. Isso inclui as descrições de sua oferta, capturas de tela e seus ativos de marketing. Para ver como isso se parece, consulte [detalhes da listagem de ofertas](plan-azure-application-offer.md#offer-listing-details).

> [!NOTE]
> A oferta de conteúdo de listagem (como descrição, documentos, capturas de tela e termos de uso) não precisa estar em inglês se a descrição da oferta começar com a frase "este aplicativo está disponível somente em [idioma diferente do inglês]". Também é aceitável fornecer uma URL de _Link útil_ para oferecer conteúdo em um idioma diferente daquele usado no conteúdo de listagem da oferta.
...
1. Na caixa **Descrição curta** , insira até 256 caracteres de texto sem formatação. Este resumo será exibido na página de detalhes da sua oferta.
...
1. Adicional Nas caixas **Pesquisar palavras-chave** , insira até três palavras-chave de pesquisa que os clientes podem usar para encontrar sua oferta no Marketplace comercial. Você não precisa incluir o **nome** e a **Descrição** da oferta porque esse texto é incluído automaticamente na pesquisa.
...
## <a name="add-marketplace-media"></a>Adicionar mídia do Marketplace
...
- [Como adicionar um público de visualização para sua oferta de Aplicativo Azure](create-new-azure-apps-offer-preview.md)
