...
Para conectar-se a VM com base em Linux, é necessário um cliente do protocolo (SSH) de um shell seguro. As etapas a seguir usam o [terminal SSH de](https://www.ssh.com/ssh/putty/) saída gratuita.
