...
5.  Ao terminar, clique em **Criar**. O Azure AD atribui uma ID de *aplicativo* exclusiva ao seu aplicativo e você\'Redirecionado para a página de registro principal do aplicativo\'s. Dependendo de se o seu aplicativo é Web ou nativo, diferentes opções serão fornecidas para adicionar mais recursos ao aplicativo.
