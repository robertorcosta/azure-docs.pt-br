...
20. Selecione **Salvar** para salvar o fluxo. O Microsoft Flow automaticamente irá testar o fluxo de erros. Se não houver nenhum erro, seu fluxo começará a ser executado após ser salvo.
