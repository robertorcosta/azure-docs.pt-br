---
title: Criar uma nova oferta do Dynamics 365 Business central no Microsoft Commercial Marketplace
description: Como criar uma nova oferta do Dynamics 365 Business central para listagem ou venda no Azure Marketplace, Microsoft AppSource ou por meio do programa CSP (provedor de soluções na nuvem) usando o portal do Marketplace comercial no Microsoft Partner Center.
author: dsindona
ms.author: dsindona
...
A página de listagem da oferta é onde você define detalhes para sua oferta (como nome, descrição, imagens, etc.).
...
Nesta seção, você pode fornecer logotipos e imagens que serão usados ao mostrar sua oferta ao cliente. Todas as imagens devem estar no formato. png. Carregue seu logotipo de oferta em dois tamanhos: **pequeno (48 x 48)** e **grande (216 x 216)**.
...
Se você selecionou **conectar** acima, forneça a URL para a instalação do aplicativo aqui. Para serviços conectados que não exigem instalação, forneça a URL da página de aterrissagem ou página de inscrição do serviço.
