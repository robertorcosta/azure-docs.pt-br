---
title: Criar um projeto do Dynamics 365 para o envolvimento do cliente & a oferta do PowerApps no Microsoft Commercial Marketplace
description: Como criar um novo Dynamics 365 for Customer Engagement & a oferta do PowerApps para listagem ou venda no Azure Marketplace, AppSource ou por meio do programa CSP (provedor de soluções na nuvem) no Partner Center.
author: dsindona
ms.author: dsindona
...
3. Na página Visão geral, selecione **+ nova oferta** > **Dynamics 365 for Customer Engagement & PowerApps**.
...
Selecione pelo menos uma e até três categorias. Eles são usados para posicionar sua oferta nas áreas de pesquisa do Marketplace apropriadas. Não se esqueça de descrever como sua oferta dá suporte a essas categorias na descrição da oferta.
...
Forneça seus próprios termos e condições legais aqui. Você também pode fornecer o endereço onde os termos e condições podem ser encontrados. Os clientes serão solicitados a aceitar esses termos antes que possam experimentar sua oferta.
...
Defina detalhes do Marketplace para cada idioma/mercado aqui, como nome da oferta, descrição e imagens. Selecione o idioma/nome do mercado para fornecer essas informações.
...
Insira o endereço onde os clientes podem saber mais sobre sua oferta.

#### <a name="privacy-policy-url"></a>URL da política de privacidade

Insira o endereço para a política de privacidade da sua organização. Você é responsável por garantir que seu aplicativo esteja em conformidade com as leis e regulamentos de privacidade e para fornecer uma política de privacidade válida.

### <a name="contacts"></a>Contacts

Forneça o nome, o email e o número de telefone para um **contato de suporte** e um **contato de engenharia**. Essas informações não são mostradas aos clientes, mas estarão disponíveis para a Microsoft e podem ser fornecidas aos parceiros CSP.
...
Forneça logotipos e imagens para sua oferta. Todas as imagens devem estar no formato PNG.
...
- **Pequeno** (necessário; 48 x 48)
- **Grande** (necessário; 216 x 216)
...
Esta página permite que você defina onde e como tornar sua oferta disponível.

### <a name="markets"></a>Mercados

Especifique os mercados nos quais sua oferta deve estar disponível. Para fazer isso, selecione **Editar mercados**, que exibirá a janela pop-up **seleção do mercado** .

Por padrão, não há mercados selecionados, mas você deve selecionar pelo menos um mercado para publicar sua oferta. Escolha **selecionar tudo** para disponibilizar sua oferta em todos os possíveis mercados ou selecione os mercados específicos que você deseja adicionar.
...
- **Duração do teste de unidade** (obrigatório) – Insira o número de horas que o Test Drive permanecerá ativo. O testdDrive é encerrado automaticamente após o término desse período de tempo. Essa duração só pode ser definida em horas inteiras (por exemplo, "2" horas é válida; "1,5" não é).
...
- **Máximo de unidades de teste simultâneas** (obrigatórias) – defina o número máximo de clientes que podem usar seu Test Drive ao mesmo tempo. Cada usuário simultâneo consumirá uma licença do Dynamics 365 enquanto o test drive estiver ativo, portanto, você precisará garantir que você tenha licenças suficientes disponíveis para dar suporte ao limite máximo definido. O valor recomendado é 3-5.

- **Duração do teste de unidade** (obrigatório) – Insira o número de horas que o Test Drive permanecerá ativo. Após esse tempo, a sessão será encerrada e não consumirá mais uma de suas licenças. Recomendamos um valor de 2-24 horas, dependendo da complexidade da sua oferta. Essa duração só pode ser definida em horas inteiras (por exemplo, "2" horas é válida; "1,5" não é). O usuário pode solicitar uma nova sessão se ela ficar sem tempo e desejar acessar a test drive novamente.
...
Para permitir que a Microsoft implante o test drive em seu nome, crie e forneça uma assinatura do Azure separada e exclusiva (não é necessária para Power BI unidades de teste).
...
- **Vídeos** (opcional) – carregar vídeos em um site de hospedagem externo referência do link e da imagem em miniatura (533 x 324 pixels) aqui. Isso permite que o cliente exiba um passo a passo de informações para ajudá-los a entender melhor o test drive, incluindo como usar com êxito os recursos de sua oferta e entender os cenários que destacam seus benefícios.
  - **Nome** (obrigatório)
  - **Endereço** (obrigatório; YouTube ou Vimeo apenas)
  - Imagem em **miniatura** (o arquivo de imagem deve estar no formato PNG e 533 x 324 pixels)
...
Carregue um arquivo PDF que lista os principais cenários de uso da sua oferta. Todos os cenários podem ser verificados por nossa equipe de validação antes de aprovarmos sua oferta para o Marketplace.
...
- Consulte o status de conclusão de cada seção da oferta.
    ...
    - **Concluir** -a seção está concluída, todos os dados necessários foram fornecidos e não há erros. Todas as seções da oferta devem estar em um estado completo antes que você possa enviar a oferta.
