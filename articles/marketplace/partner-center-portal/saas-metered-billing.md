...
* Atenda a todos os requisitos de oferta para uma oferta de [Venda por meio da Microsoft](./create-new-saas-offer.md#sell-through-microsoft) , conforme descrito em [criar uma oferta de SaaS](./create-new-saas-offer.md).
...
Em seguida, a oferta de SaaS pode ser integrada às [APIs do serviço de medição do Marketplace](./marketplace-metering-service-apis.md) para informar a Microsoft de eventos faturáveis.
...
* Além das tarifas recorrentes, um plano de tarifas simples também pode incluir dimensões personalizadas opcionais usadas para cobrar os clientes pelo uso excedente não incluído na taxa fixa.  Cada dimensão representa uma unidade Faturável que seu serviço irá comunicar com a Microsoft usando a [API do serviço de medição do Marketplace](./marketplace-metering-service-apis.md).
...
Como preço de taxa simples, os preços de dimensão de cobrança podem ser definidos por país ou região com suporte. O Publicador precisa usar o recurso de importação e exportação de dados de preços no Partner Center.

1. Primeiro, defina as dimensões desejadas e marque quais mercados têm suporte. 
1. Em seguida, exporte esses dados para o arquivo.
...
[![Dimensões do serviço de medição do Marketplace](./media/metering-service-dimentions.png "Clique para ver a exibição ampliada")](./media/metering-service-dimentions.png)
