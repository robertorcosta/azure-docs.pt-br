...
A documentação desta versão da API não está mais disponível. Se você sentir que precisa acessá-lo, entre em contato com saas-api-v1@microsoft.com .

Para todos os novos desenvolvimentos, vá para a [versão V2 da API](./pc-saas-fulfillment-api-v2.md) mesmo se você já usa v1. Esta versão será completamente preterida no futuro.
