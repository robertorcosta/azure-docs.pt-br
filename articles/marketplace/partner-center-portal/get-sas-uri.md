...
Se você tiver dificuldades em criar um Uri SAS, consulte [problemas comuns de URL SAS](https://aka.ms/AzureSAS_URI_FAQ). Caso contrário, salve as URI(s) a SAS para um local seguro para uso posterior. Você precisará dele para publicar sua oferta de VM no Partner Center.

* [Crie uma oferta de Máquina Virtual do Azure](https://aka.ms/Create_AzureVMoffer)
