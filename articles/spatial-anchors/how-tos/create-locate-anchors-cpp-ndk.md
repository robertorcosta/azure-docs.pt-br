...
Saiba mais sobre o struct [CloudSpatialAnchorSession](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession).
...
Saiba mais sobre o struct [SessionConfiguration](/cpp/api/spatial-anchors/ndk/sessionconfiguration).
...
Saiba mais sobre o delegado [TokenRequiredDelegate](/cpp/api/spatial-anchors/ndk/tokenrequireddelegate).
...
Saiba mais sobre o método [Start](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#start).
...
Saiba mais sobre o método [ProcessFrame](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#processframe).
...
Saiba mais sobre o delegado [SessionUpdatedDelegate](/cpp/api/spatial-anchors/ndk/sessionupdateddelegate).
...
Saiba mais sobre o struct [CloudSpatialAnchor](/cpp/api/spatial-anchors/ndk/cloudspatialanchor).
...
Saiba mais sobre o método [GetSessionStatusAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#getsessionstatusasync).
...
Saiba mais sobre o método [AppProperties](/cpp/api/spatial-anchors/ndk/cloudspatialanchor#appproperties).
...
Saiba mais sobre o método [UpdateAnchorPropertiesAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#updateanchorpropertiesasync).
...
Saiba mais sobre o método [GetAnchorPropertiesAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#getanchorpropertiesasync).
...
Saiba mais sobre o método [Expiration](/cpp/api/spatial-anchors/ndk/cloudspatialanchor#expiration).
...
Saiba mais sobre o método [CreateWatcher](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#createwatcher).
...
Saiba mais sobre o delegado [AnchorLocated](/cpp/api/spatial-anchors/ndk/anchorlocateddelegate).
...
Saiba mais sobre o método [DeleteAnchorAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#deleteanchorasync).
...
Saiba mais sobre o método [Stop](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#stop).
...
Saiba mais sobre o método [Reset](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#reset).
