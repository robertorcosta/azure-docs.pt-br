...
Localize `case DemoStep::ConfigSession:` e adicione a seguinte linha, substituindo em seu domínio de conta anterior: `configuration.AccountDomain("MyAccountDomain");`.
