...
> [!IMPORTANT] 
> O uso desse recurso requer a lista de permissões. Envie um email para anffeedback@microsoft.com com sua ID de assinatura para solicitar esse recurso.
