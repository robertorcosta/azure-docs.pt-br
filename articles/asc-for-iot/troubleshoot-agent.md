...
1. Se necessário, repita os processos anteriores para forçar a interrupção do agente e recuperar os erros se o agente continuar a falhar o processo de inicialização.
