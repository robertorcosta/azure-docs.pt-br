...
description: Investigue recomendações de segurança com o serviço de segurança Central de Segurança do Azure para IoT.
...
ms.locfileid: "88143985"
---
# <a name="quickstart-investigate-security-recommendations"></a>Início Rápido: Investigar recomendações de segurança


A análise oportuna e a mitigação de recomendações feitas pela central de segurança do Azure para IoT é a melhor maneira de melhorar a postura de segurança e reduzir a superfície de ataque em sua solução de IoT.
