---
title: Guia para instalar e implantar agente Linux C do Azure Security Center para agente IoT| Microsoft Docs
...
2. Adiciona um usuário de serviço (com sinal interativo desativado).
