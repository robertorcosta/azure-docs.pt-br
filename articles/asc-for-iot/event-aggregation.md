...
ms.locfileid: "81311412"
---
# <a name="azure-security-center-for-iot-event-aggregation"></a>Agregação do Azure Security Center for IoT

O Azure Security Center para agentes de segurança de IoT coleta dados e eventos do sistema do seu dispositivo local e envia esses dados para a nuvem do Azure para processamento e análise. O agente de segurança coleta muitos tipos de eventos de dispositivos, incluindo novos processos e novos eventos de conexão. Tanto o novo processo quanto novos eventos de conexão podem ocorrer legitimamente em um dispositivo dentro de um segundo e, embora importante para uma segurança robusta e abrangente, o número de mensagens que os agentes de segurança são forçados a enviar podem atingir ou exceder rapidamente sua cota e limites de custo do IoT Hub. No entanto, esses eventos contêm informações de segurança altamente valiosas que são cruciais para proteger seu dispositivo.
