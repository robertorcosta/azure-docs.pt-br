...
## <a name="azure-security-center-for-iot-alerts-available-for-customization"></a>Central de segurança do Azure para alertas de IoT disponíveis para personalização 



| Gravidade | Nome do alerta | Fonte de dados | Description | Correção sugerida|
|---|---|---|---|---|
