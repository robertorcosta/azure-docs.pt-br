...
Para saber mais sobre como criar várias instâncias, consulte [Implantar várias instâncias de um recurso ou propriedade em modelos do Azure Resource Manager](./create-multiple-instances.md)
