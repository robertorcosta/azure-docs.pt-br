...
description: Saiba como implantar um serviço em várias regiões com o Azure Deployment Manager e sobre práticas de implantação seguras.
ms.topic: conceptual
ms.date: 11/21/2019
ms.custom: seodec18
