...
Ambos os usos são descritos mais detalhadamente neste artigo. Para um tutorial, consulte [Tutorial: crie várias instâncias de recursos usando modelos do Resource Manager](template-tutorial-create-multiple-instances.md).
