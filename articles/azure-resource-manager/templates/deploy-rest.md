...
---
# <a name="deploy-resources-with-arm-templates-and-resource-manager-rest-api"></a>Implantar recursos com modelos ARM e a API REST do Gerenciador de recursos

Este artigo explica como usar a API REST do Gerenciador de recursos com modelos de Azure Resource Manager (ARM) para implantar seus recursos no Azure.
...
1. Para implantar um modelo, forneça sua ID de assinatura, o nome do grupo de recursos, o nome da implantação no URI de solicitação.
   ...
   No corpo da solicitação, forneça um link para seu modelo e arquivo de parâmetro. Para obter mais informações sobre o arquivo de parâmetro, consulte [criar arquivo de parâmetro do Resource Manager](parameter-files.md).
...
- Para saber mais sobre modelos, consulte [entender a estrutura e a sintaxe de modelos ARM](template-syntax.md).
