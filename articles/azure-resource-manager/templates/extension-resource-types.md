...
- Para obter a ID de recurso para um recurso de extensão em um modelo de Azure Resource Manager, use o [extensionResourceId](template-functions-resource.md#extensionresourceid).
