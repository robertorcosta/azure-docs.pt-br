...
* Use uma [loop de cópia em variáveis](create-multiple-instances.md#variable-iteration) para criar um padrão repetido de objetos JSON.

* Remover variáveis não utilizadas.

## <a name="resource-dependencies"></a>Dependências de recursos

Ao decidir quais são as [dependências](define-resource-dependency.md) a serem definidas, use as seguintes diretrizes:
