---
title: Referência do C# ponto de extremidade RESTful do provedor personalizado
...
Este artigo é uma referência básica para um ponto de C# extremidade RESTful de provedor personalizado. Caso você não esteja familiarizado com os Provedores Personalizados do Azure, confira [a visão geral sobre provedores de recursos personalizados](overview.md).
