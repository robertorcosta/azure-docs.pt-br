---
title: Provedores de recursos por serviços Do Azure
description: Lista todos os namespaces do provedor de recursos para o Azure Resource Manager e mostra o serviço Azure para esse namespace.
ms.topic: conceptual
ms.date: 03/17/2020
...
Este artigo mostra como os namespaces do provedor de recursos mapeiam os serviços do Azure.
...
| Microsoft.Attestation | Serviço de Atestado Azul |
...
| Microsoft.AzureData | Registro do SQL Server |
...
| Microsoft.CertificateRegistration | [Certificados de serviço de aplicativos](../../app-service/configure-ssl-certificate.md#import-an-app-service-certificate) |
| Microsoft.ChangeAnalysis | [Azure Monitor](../../azure-monitor/index.yml) |
| Microsoft.ClassicCompute | Modelo clássico de implantação máquina virtual |
| Microsoft.ClassicInfrastructureMigrate | Migração clássica do modelo de implantação |
| Microsoft.ClassicNetwork | Modelo clássico de implantação rede virtual |
| Microsoft.ClassicStorage | Armazenamento clássico do modelo de implantação |
...
| Microsoft.CustomerLockbox | Cofre de clientes para Microsoft Azure |
...
| Microsoft.DesktopVirtualização | [Área de Trabalho Virtual do Windows](/azure/virtual-desktop/) |
| Microsoft.DeploymentManager | [Gerente de implantação do Azure](../templates/deployment-manager-overview.md) |
...
| Microsoft.SerialConsole | [Console serial azure para Windows](../../virtual-machines/troubleshooting/serial-console-windows.md) |
...
Para obter mais informações sobre provedores de recursos, consulte [provedores e tipos de recursos do Azure](resource-providers-and-types.md)
