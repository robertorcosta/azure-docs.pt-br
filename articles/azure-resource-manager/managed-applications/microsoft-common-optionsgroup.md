---
title: Elemento de UI do OptionsGroup
description: Descreve o elemento Microsoft.Common.OptionsGroup da interface do usuário para o Portal do Azure. Permite que os usuários selecionem entre as opções disponíveis ao implantar um aplicativo gerenciado.
author: tfitzmac
ms.topic: conceptual
ms.date: 06/27/2018
ms.author: tomfitz
