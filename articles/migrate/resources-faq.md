...
- **VMware VMs**: Revise as [geografias suportadas pelo](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-vmware) Azure Migrate para VMs VMware.
- **Hiper-VMs**: Revise as [geografias suportadas pelo](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-hyper-v) Azure Migrate para VMs Hiper-V.
