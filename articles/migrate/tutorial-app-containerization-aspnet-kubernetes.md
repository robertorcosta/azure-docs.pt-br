---
title: Conteinerização de Aplicativo Azure ASP.NET; Conteinerização e migração de aplicativos Web ASP.NET para o Kubernetes do Azure.
description: 'Tutorial: Conteinerizar e migrar aplicativos Web ASP.NET para o Serviço de Kubernetes do Azure.'
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
...
ms.locfileid: "105561790"
---
# <a name="aspnet-app-containerization-and-migration-to-azure-kubernetes-service"></a>Conteinerização e migração de aplicativo ASP.NET para o Serviço de Kubernetes do Azure
...
3. **Configuração da implantação do aplicativo**: depois de concluir as etapas acima, você precisará especificar a configuração de implantação do aplicativo. Clique em **Configurar** para personalizar a implantação do aplicativo. Na etapa de configuração, você pode oferecer as seguintes personalizações:
    ...
    ![Captura de tela da configuração do aplicativo de implantação.](./media/tutorial-containerize-apps-aks/deploy-aspnet-app-config.png)
