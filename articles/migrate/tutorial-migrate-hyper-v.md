...
- Se você seguiu o segundo tutorial para [avaliar VMs Hyper-V](tutorial-assess-hyper-v.md), então já configurou um projeto de Migrações para Azure e pode adicionar a ferramenta agora.
