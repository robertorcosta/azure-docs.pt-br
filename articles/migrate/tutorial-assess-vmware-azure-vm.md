---
title: Avaliar servidores do VMware quanto à migração para o Azure nas Migrações para Azure
description: Saiba como avaliar servidores do VMware quanto à migração para VMs do Azure com as Migrações para Azure.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Este artigo mostra como avaliar os servidores descobertos do seu ambiente VMware em preparação para migração para VMs do Azure usando a ferramenta Migrações para Azure: descoberta e avaliação.
...
3. Em **Avaliar servidores** > **Tipo de avaliação**
...
1. Em **Windows, Linux e SQL Server** > **Migrações para Azure: descoberta e avaliação**, clique no número ao lado de **Avaliação da VM do Azure**.
