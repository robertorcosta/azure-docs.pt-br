---
title: Avaliar as VMs do VMware quanto à migração para as VMs do Azure usando a Avaliação de Servidor nas Migrações para Azure
description: Aprenda como avaliar as VMs do VMware quanto à migração para as VMs do Azure com a Avaliação de Servidor.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
ms.locfileid: "96753137"
---
# <a name="tutorial-assess-vmware-vms-for-migration-to-azure-vms"></a>Tutorial: Avaliar VMs do VMware para migração para VMs do Azure
...
Este artigo mostra como avaliar as VMs (máquinas virtuais) descobertas do VMware para se preparar para a migração para as VMs do Azure usando as Migrações para Azure: Avaliação de Servidor.
...
9. Clique em **Salvar** se você fizer alterações.

    ![Propriedades de avaliação](./media/tutorial-assess-vmware-azure-vm/assessment-properties.png)

10. Em **Avaliar Servidores**, clique em **Próximo**.
11. Em **Selecionar computadores para avaliar**, selecione **Criar** e especifique um nome de grupo. 
12. Selecione o dispositivo e as VMs que você deseja adicionar ao grupo. Em seguida, clique em **Próximo**.

     ![Adicionar VMs a um grupo](./media/tutorial-assess-vmware-azure-vm/assess-group.png)

13. Em **Examinar + criar avaliação, examine os detalhes da avaliação e clique em **Criar avaliação** para criar o grupo e executar a avaliação.
