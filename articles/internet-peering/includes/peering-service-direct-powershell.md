...
1. Exibir conexões no peering direct selecionado.
    ...
    ```
1. Selecione a conexão que deseja habilitar para peering Service. Para este exemplo, usaremos a única conexão disponível.
    ```powershell
    ...
    ConnectionState             : Active
    ```
1. Agora salve as alterações feitas no peering direto usando o comando abaixo.
    ```powershell
    $directPeering | Update-AzPeering
    ```
    
    Abaixo está uma saída de amostra:
