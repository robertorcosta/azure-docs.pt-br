...
| **Filas-GetQueueAsync** <br/>Barramento de Serviço<br/>```GET https://management.core.windows.net/{subscription ID}/services/ServiceBus/Namespaces/{namespace name}/queues/{queueName}``` | [Obter](/rest/api/servicebus/queues/get) | &nbsp; | &nbsp; | 
