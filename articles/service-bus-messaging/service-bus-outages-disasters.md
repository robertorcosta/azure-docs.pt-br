...
* **Perda ou atraso de mensagens**: suponha que o remetente tenha enviado com êxito uma mensagem m1 para a fila primária e então a fila ficou indisponível antes do destinatário receber m1. O remetente envia uma mensagem m2 subsequente para a fila secundária. Se a fila primária estiver temporariamente indisponível, o receptor recebe m1 após a fila ficar disponível novamente. Em caso de desastre, o receptor pode nunca receber m1.
* **Recebimento duplicado**: suponha que o remetente enviar uma mensagem m para a fila primária. O Barramento de Serviço processa m com êxito, mas falha ao enviar uma resposta. Após a operação de envio exceder o limite, o remetente envia uma cópia idêntica de m para a fila secundária. Se o receptor for capaz de receber a primeira cópia de m antes da fila primária ficar indisponível, o receptor recebe ambas as cópias de m aproximadamente ao mesmo tempo. Se o receptor não for capaz de receber a primeira cópia de m antes que a fila primária fique indisponível, ele recebe primeiro a segunda cópia de m, mas, a seguir, recebe uma outra cópia de m quando a fila primária fica disponível.
...
* [Projeto de aplicativos resilientes do Azure][Azure resiliency technical guidance]
