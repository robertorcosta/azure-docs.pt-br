...
## <a name="create-a-service-bus-namespace-and-a-queue"></a>Criar um namespace do Barramento de Serviço e uma fila
...
[Criar uma regra de autorização do Barramento de Serviço para um namespace e uma fila usando um modelo do Azure Resource Manager](service-bus-resource-manager-namespace-auth-rule.md)
