...
- Use a autenticação do Azure AD com [funções RBAC](/azure/role-based-access-control/overview).
...
Para saber mais sobre a auditoria de banco de dados e como habilitá-la, confira [Introdução à auditoria de Banco de Dados SQL](/azure/sql-database/sql-database-auditing).
