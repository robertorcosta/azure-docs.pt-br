---
title: Documentação de conceitos básicos de segurança do Azure
description: Saiba mais sobre a segurança do Azure.
services: security
author: arob98
manager: angrobe
layout: LandingPage
...
ms.locfileid: "72792363"
---
# <a name="azure-security-fundamentals-documentation"></a>Documentação de conceitos básicos de segurança do Azure

Saiba mais sobre a segurança do Azure.
        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Desenvolver e implantar aplicativos seguros</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">Melhores práticas de desenvolvimento seguro</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-network-security">Segurança de rede do Azure</a>
                            </li>
                            <li style="list-style: none;">
