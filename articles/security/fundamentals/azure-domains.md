...
|[Armazenamento de Blobs do Azure](../../storage/blobs/index.yml)|*.blob.core.windows.net|
|[Serviços de nuvem do Azure](../../cloud-services/cloud-services-choose-me.md) e [máquinas virtuais do Azure](../../virtual-machines/index.yml)|*.cloudapp.net|
|[Serviços de Nuvem do Azure](../../cloud-services/cloud-services-choose-me.md)|*. cloudapp.azure.com|
...
|[Arquivos do Azure](../../storage/files/storage-files-introduction.md)|*.file.core.windows.net|
...
|[Barramento de Serviço do Azure](../../service-bus-messaging/service-bus-messaging-overview.md)|*.servicebus.windows.net|
...
|[Armazenamento de Tabelas do Azure](../../storage/tables/table-storage-overview.md)|*.table.core.windows.net|
|[Gerenciador de Tráfego do Azure](../../traffic-manager/traffic-manager-overview.md)|*. trafficmanager.net|
