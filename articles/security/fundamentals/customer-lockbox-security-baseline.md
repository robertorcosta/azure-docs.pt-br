---
title: Linha de base de segurança do Azure para Sistema de Proteção de Dados do Cliente para Microsoft Azure
description: Linha de base de segurança do Azure para Sistema de Proteção de Dados do Cliente para Microsoft Azure
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 06/05/2020
...
**Orientação** : não aplicável; Não é possível associar uma rede virtual, sub-rede ou grupo de segurança de rede a Sistema de Proteção de Dados do Cliente.
...
**Orientação** : não aplicável; Não é possível associar uma rede virtual, sub-rede ou grupo de segurança de rede com o Azure Sistema de Proteção de Dados do Cliente.
...
**Orientação** : não aplicável; Não é possível associar uma rede virtual, sub-rede ou grupo de segurança de rede a Sistema de Proteção de Dados do Cliente. Não há nenhuma configuração de rede para fazer ou monitorar.
...
**Orientação** : não aplicável; A Microsoft mantém a fonte de tempo usada para recursos como Sistema de Proteção de Dados do Cliente.
...
**Orientação** : não aplicável; Sistema de Proteção de Dados do Cliente não processa nem produz logs relacionados a anti-malware.
...
**Orientação** : não aplicável; Sistema de Proteção de Dados do Cliente não processa nem produz logs relacionados ao DNS.
...
**Orientação** : não aplicável; o acesso a Sistema de Proteção de Dados do Cliente é por meio do portal do Azure e é reservado para contas com a função de locatário do proprietário. Não há suporte para logon único.
...
**Orientação** : Use Azure Active Directory PRIVILEGED Identity Management (PIM) para a geração de logs e alertas quando uma atividade suspeita ou não segura ocorrer no ambiente.
...
Você tem acesso a Azure Active Directory atividade de entrada, auditoria e riscos de log de eventos de evento, que permitem a integração com o Azure Sentinel ou um SIEM de terceiros.
...
**Orientação** : essa recomendação não se aplica a sistema de proteção de dados do cliente.
...
**Orientação** : essa recomendação não é aplicável; as marcas não têm suporte para Sistema de Proteção de Dados do Cliente.
...
**Orientação** : não aplicável; Sistema de Proteção de Dados do Cliente em si não mantém nenhum dado do cliente.
...
**Orientação** : não aplicável; Sistema de Proteção de Dados do Cliente em si não mantém os dados do cliente.
...
**Orientação** : não aplicável; A Microsoft executa o gerenciamento de vulnerabilidades nos sistemas subjacentes que dão suporte ao Sistema de Proteção de Dados do Cliente.
...
**Orientação** : marcas não são suportadas para sistema de proteção de dados do cliente.
...
**Orientação** : não aplicável, sistema de proteção de dados do cliente não tem configurações de segurança configuráveis.
...
**Orientação** : não aplicável; o acesso a Sistema de Proteção de Dados do Cliente solicitações é limitado ao proprietário da assinatura do Azure que hospeda o recurso. Não há senhas, segredos ou chaves necessárias para acessar Sistema de Proteção de Dados do Cliente fora do logon como o proprietário do locatário.
...
**Diretriz** : não aplicável; essa diretriz destina-se a recursos de computação. O Microsoft Antimalware está habilitado no host subjacente que dá suporte à solução de Sistema de Proteção de Dados do Cliente.
...
**Diretrizes** : o Microsoft Antimalware está habilitado no host subjacente que dá suporte a serviços do Azure, como sistema de proteção de dados do cliente.
...
**Orientação** : não aplicável; Sistema de Proteção de Dados do Cliente em si não armazena os dados do cliente.
...
**Orientação** : não aplicável; Sistema de Proteção de Dados do Cliente em si não armazena os dados do cliente, ele também não usa chaves ou senhas para acesso.
