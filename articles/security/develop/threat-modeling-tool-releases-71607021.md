...
titleSuffix: Azure
description: Leia as notas de versão da atualização da ferramenta de modelagem de ameaças lançada em 7/2/2019. As observações incluem melhorias de acessibilidade e correções de bugs.
author: jegeib
ms.author: jegeib
ms.service: security
