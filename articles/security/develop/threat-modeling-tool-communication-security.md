...
| **Backup de banco de dados** | <ul><li>[Garantir a validação de certificado e a criptografia da conexão do SQL Server](#sqlserver-validation)</li><li>[Forçar a comunicação criptografada para o SQL Server](#encrypted-sqlserver)</li></ul> |
...
| **Etapas** | A habilitação da criptografia SSL aumenta a segurança dos dados transmitidos pelas redes entre instâncias do SQL Server e aplicativos. |
