...
![Informações da Interação](./media/threat-modeling-tool-getting-started/interactioninfo.png)
...
![Informações da Interação](./media/threat-modeling-tool-feature-overview/report.png)
