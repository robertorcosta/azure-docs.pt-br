...
description: Saiba mais sobre a validação de entrada no Threat Modeling Tool. Veja informações de mitigação e exiba exemplos de código.
services: security
...
| **Backup de banco de dados** | <ul><li>[Não use consultas dinâmicas em procedimentos armazenados](#stored-proc)</li></ul> |
...
| **Atributos**              | N/D  |
| **Referências**              | [Segurança do XSLT](/previous-versions/windows/desktop/ms763800(v=vs.85)), [Propriedade XsltSettings](/dotnet/api/system.xml.xsl.xsltsettings.enablescript) |
...
| **Tecnologias aplicáveis** | Genérico |
| **Atributos**              | N/D  |
| **Referências**              | [Segurança do IE8 parte V - proteção abrangente](/archive/blogs/ie/ie8-security-part-v-comprehensive-protection)  |
...
| **Tecnologias aplicáveis** | Genérico |
| **Atributos**              | N/D  |
| **Referências**              | [Expansão de Entidade XML](https://capec.mitre.org/data/definitions/197.html), [Ataques de negação de serviço de XML e defesas](/archive/msdn-magazine/2009/november/xml-denial-of-service-attacks-and-defenses), [Visão geral de segurança do MSXML](/previous-versions/windows/desktop/ms754611(v=vs.85)), [Práticas recomendadas para proteger o código do MSXML](/previous-versions/windows/desktop/ms759188(v=vs.85)), [Referência de protocolo NSXMLParserDelegate](https://developer.apple.com/library/ios/#documentation/cocoa/reference/NSXMLParserDelegate_Protocol/Reference/Reference.html), [Resolvendo referências externas](/dotnet/standard/data/xml/resolving-external-resources) |
...
| **Tecnologias aplicáveis** | Genérico |
| **Atributos**              | N/D  |
| **Referências**              | [Upload de arquivo irrestrito](https://owasp.org/www-community/vulnerabilities/Unrestricted_File_Upload), [Tabela de assinatura de arquivo](https://www.garykessler.net/library/file_sigs.html) |
...
| **Atributos**              | N/D  |
| **Referências**              | [Como evitar scripts entre sites no ASP.NET](/previous-versions/msp-n-p/ff649310(v=pandp.10)), [Scripts entre sites](https://cwe.mitre.org/data/definitions/79.html), [Folha de consulta de prevenção de XSS (Cross Site Scripting)](https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html) |
...
| **Atributos**              | N/D  |
| **Referências**              | [Adicionando Validação](https://www.asp.net/mvc/overview/getting-started/introduction/adding-validation), [Validando Dados de Modelo em um Aplicativo MVC](/previous-versions/dd410404(v=vs.90)), [Princípios Básicos para Aplicativos ASP.NET MVC](/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **Tecnologias aplicáveis** | Genérico |
| **Atributos**              | N/D  |
| **Referências**              | [Codificar a entrada não segura](/previous-versions/msp-n-p/ff647397(v=pandp.10)#paght000003_step3), [HTML Sanitizer](https://github.com/mganss/HtmlSanitizer) |
...
| **Tecnologias aplicáveis** | Genérico, MVC5, MVC6 |
| **Atributos**              | N/D  |
| **Referências**              | [Validando dados de modelo em um aplicativo MVC](/previous-versions/dd410404(v=vs.90)), [Princípios básicos para aplicativos ASP.NET MVC](/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **Tecnologias aplicáveis** | MVC5, MVC6 |
| **Atributos**              | N/D  |
| **Referências**              | [Validação de modelo na ASP.NET Web API](https://www.asp.net/web-api/overview/formats-and-model-binding/model-validation-in-aspnet-web-api) |
