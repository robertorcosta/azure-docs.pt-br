---
title: Visão geral do benchmark de segurança do Azure v1
description: Visão geral do benchmark de segurança do Azure v1
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
> [!NOTE]
> O benchmark de segurança mais atualizado do Azure está disponível [aqui](overview.md).
