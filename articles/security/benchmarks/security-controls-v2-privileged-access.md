...
- [Protegendo o acesso privilegiado para implantações de nuvem e híbridos no Azure AD](../../active-directory/users-groups-roles/directory-admin-roles-secure.md)
