...
- [Como configurar o Microsoft antimalware para serviços de nuvem](https://docs.microsoft.com/powershell/module/servicemanagement/azure/set-azureserviceantimalwareextension?view=azuresmps-4.0.0)
