...
O [Blueprint de segurança e conformidade do Azure – matriz de responsabilidades do cliente do FFIEC](https://aka.ms/ffiec-crm) lista todos os objetivos exigidos pelo FFIEC. A matriz indica se a implementação de cada controle é responsabilidade da Microsoft, do cliente ou é compartilhada pelos dois.
