...
1. No painel esquerdo, na seção **monitoramento** , selecione **Monitor de conexão (versão prévia)**.
   ...
   :::image type="content" source="./media/connection-monitor-2-preview/cm-resource-view.png" alt-text="Captura de tela que mostra os monitores de conexão criados na visualização do monitor de conexão.":::
