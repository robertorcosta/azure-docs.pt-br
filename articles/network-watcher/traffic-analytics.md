...
3. Selecione uma conta de armazenamento existente na qual armazenar os logs de fluxo. Verifique se o armazenamento não tem "Data Lake Storage Gen2 namespace hierárquico habilitado" definido como true.
