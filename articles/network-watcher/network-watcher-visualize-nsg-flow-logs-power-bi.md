...
description: Saiba como usar Power BI para visualizar os logs de fluxo do grupo de segurança de rede para permitir que você exiba informações sobre o tráfego IP no observador de rede do Azure.
