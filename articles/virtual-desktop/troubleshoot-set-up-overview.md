...
| Acessando modelos de Azure Resource Manager do GitHub                                  | Consulte a seção [criando VMs de host de sessão de área de trabalho virtual do Windows](troubleshoot-set-up-issues.md#creating-windows-virtual-desktop-session-host-vms) de [locatário e criação de pool de hosts](troubleshoot-set-up-issues.md). Se o problema ainda não for resolvido, entre em contato com a [equipe de suporte do GitHub](https://github.com/contact). <br> <br> Se o erro ocorrer depois de acessar o modelo no GitHub, entre em contato com o [suporte do Azure](https://azure.microsoft.com/support/create-ticket/).|
