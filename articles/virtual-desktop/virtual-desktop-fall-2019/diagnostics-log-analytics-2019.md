...
Para poder usar Log Analytics com o recurso de diagnóstico, você precisará [criar um espaço de trabalho](../../azure-monitor/vm/quick-collect-windows-computer.md#create-a-workspace).
