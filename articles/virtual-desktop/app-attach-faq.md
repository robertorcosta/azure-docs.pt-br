...
A anexação de aplicativo MSIX não usa FSLogix. No entanto, o app Attach e o FSLogix são projetados para trabalhar juntos para proporcionar uma experiência de usuário tranqüila.
...
Sim, o MSIX app Attach é um recurso incluído no Windows 10 Enterprise e pode ser usado fora da área de trabalho virtual do Windows. No entanto, não há nenhum plano de gerenciamento para anexação de aplicativo MSIX fora da área de trabalho virtual do Windows.
...
Windows 10 Enterprise e Windows 10 Enterprise Multi-Session.

## <a name="next-steps"></a>Próximas etapas

Se você quiser saber mais sobre o anexo de aplicativo do MSIX, confira nosso [Glossário](app-attach-glossary.md)de [visão geral](what-is-app-attach.md) . Caso contrário, comece a [Configurar a anexação de aplicativo](app-attach.md).