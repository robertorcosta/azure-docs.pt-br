...
Você pode criar patches usando o [JsonPatchDocument](/dotnet/api/azure.jsonpatchdocument?view=azure-dotnet&preserve-view=true)do SDK do .net do Azure. Veja um exemplo.
