...
```
Essa chamada retorna dados de texto cruzado como um tipo de objeto fortemente tipado, como `BasicDigitalTwin` . Aqui está um exemplo de como usar isso para exibir os detalhes de entrelaçamento:
