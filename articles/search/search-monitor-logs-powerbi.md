...
1. Habilite o log de diagnóstico para o serviço de pesquisa:
...
1. Selecione a **chave** como o método de autenticação e forneça sua chave de conta de armazenamento. Selecione **privado** como o nível de privacidade. Clique em entrar e para iniciar o processo de carregamento.
