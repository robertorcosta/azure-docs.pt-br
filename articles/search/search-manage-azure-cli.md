...
Para obter mais informações sobre como criar pontos de extremidade privados no PowerShell, consulte o [início rápido do link privado](../private-link/create-private-endpoint-cli.md)
