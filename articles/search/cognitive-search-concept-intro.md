...
As habilidades cognitivas na Pesquisa Cognitiva do Azure são baseadas nos modelos de machine learning na API de Serviços Cognitivos: [Pesquisa Visual Computacional](https://docs.microsoft.com/azure/cognitive-services/computer-vision/) e [Análise de Texto](https://docs.microsoft.com/azure/cognitive-services/text-analytics/overview). 
