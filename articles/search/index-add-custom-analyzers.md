...
|[minúsculas](https://lucene.apache.org/core/6_6_1/analyzers-common/org/apache/lucene/analysis/core/LowerCaseFilter.html)|(o tipo aplica-se somente quando há opções disponíveis)  |Normaliza o texto do token para letras minúsculas. |  
