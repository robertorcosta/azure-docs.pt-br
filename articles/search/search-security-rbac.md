...
| [Função interna do Colaborador do Serviço de Pesquisa](../role-based-access-control/built-in-roles.md#search-service-contributor) | Equivalente à função Colaborador. |
