...
+ [Início Rápido: definir e recuperar um segredo do Azure Key Vault usando o PowerShell](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-powershell)
