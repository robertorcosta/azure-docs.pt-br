...
Com o `tableprojection` nó definido na `outputs` seção acima, agora podemos usar o recurso de divisão para projetar partes do `tableprojection` nó em tabelas diferentes:
