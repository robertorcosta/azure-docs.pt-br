...
> [!Note]
> Um exemplo de código que mostra o uso da chave de consulta pode ser encontrado em [consultar C#um índice de pesquisa cognitiva do Azure no ](search-query-dotnet.md).
