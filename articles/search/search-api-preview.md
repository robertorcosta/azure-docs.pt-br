...
| Indexador do SharePoint Online | Fonte de dados do indexador | Nova fonte de dados para indexação baseada em indexador de conteúdo do SharePoint. | [API REST de Pesquisa 2020-06-30-Versão prévia](/rest/api/searchservice/) |
