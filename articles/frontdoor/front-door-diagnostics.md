...
| Métrica | Nome de exibição da métrica | Unidade | Dimensões | Description |
| --- | --- | --- | --- | --- |
...
2. Selecione **log de atividades**.
    ...
    ![Logs de atividades](./media/front-door-diagnostics/activity-log.png)
