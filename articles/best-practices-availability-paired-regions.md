...
4. O **Azure Resource Manager** -Resource Manager fornece inerentemente isolamento lógico de componentes entre regiões. Isso significa que falhas lógicas em uma região são apresentam menor probabilidade de afetar as outras.
