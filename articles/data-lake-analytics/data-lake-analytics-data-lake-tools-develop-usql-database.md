...
1. Adicione referências do projeto C# que inclui o UDO/UDAG/UDF para o projeto de banco de dados U-SQL.
   ...
   ![Ferramentas de Data Lake para Visual Studio – Adicionar referência](./media/data-lake-analytics-data-lake-tools-develop-usql-database/data-lake-tools-add-project-reference.png)
...
1. No **Assistente para implantar banco de dados U-SQL**, selecione a **conta adla** para a qual você deseja implantar o banco de dados. Há suporte para as contas locais e ADLA.

1. A **Fonte do Banco de Dados** é preenchida automaticamente apontando para o pacote .usqldbpack na pasta de saída de compilação do projeto.
...
1. Para implantar o banco de dados U-SQL, selecione **Enviar**. Todos os recursos (assemblies e arquivos adicionais) serão carregados e um trabalho do U-SQL que inclui todas as instruções DDL será enviado.
...
1. Abra **Gerenciador de servidores**. Em seguida, expanda a conta **Azure Data Lake Analytics**, para a qual você gostaria de implantar o banco de dados.

1. Clique com o botão direito do mouse nos **Bancos de Dados U-SQL**, e escolha **Implantar Banco de Dados**.

1. Defina a **Fonte do Banco de Dados** para o caminho (arquivo .usqldbpack) do pacote de implantação do banco de dados U-SQL.

1. Insira o **Nome do Banco de Dados** para criar um banco de dados. Se houver um banco de dados com o mesmo nome na conta do Azure Data Lake Analytics de destino, todos os objetos que são definidos no projeto de banco de dados serão criados sem recriar o banco de dados.
