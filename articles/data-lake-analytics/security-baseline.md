---
title: Linha de base de segurança do Data Lake Analytics para o benchmark de segurança do Azure
...
ms.locfileid: "86530930"
---
# <a name="data-lake-analytics-security-baseline-for-azure-security-benchmark"></a>Linha de base de segurança do Data Lake Analytics para o benchmark de segurança do Azure
...
* [Gerenciar a Análise Azure Data Lake usando o Azure PowerShell](https://docs.microsoft.com/azure/data-lake-analytics/data-lake-analytics-manage-use-powershell)
...
* [Acessando os logs de diagnóstico do Azure Data Lake Analytics](https://docs.microsoft.com/azure/data-lake-analytics/data-lake-analytics-diagnostic-logs)
...
**Diretrizes**: data Lake Analytics não tem o conceito de senhas padrão, pois a autenticação é fornecida com Azure Active Directory e protegida por RBAC (controles de acesso baseado em função).

* [Visão geral de Azure Data Lake Analytics](https://docs.microsoft.com/azure/data-lake-analytics/data-lake-analytics-overview)
...
**Diretrizes**: Use Azure Active Directory (AD do Azure) como o sistema de autenticação e autorização central. O Azure AD fornece o RBAC (controle de acesso baseado em função) para um controle refinado sobre o acesso de um cliente a recursos de Data Lake Analytics.
...
* [Integrar logs do Azure AD com logs de Azure Monitor](https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-integrate-activity-logs-with-log-analytics)
...
* [Como proteger contas de armazenamento do Azure](https://docs.microsoft.com/azure/storage/common/storage-security-guide)
...
* [Lista de operações de exemplo](https://docs.microsoft.com/rest/api/datalakeanalytics/operations/list)
...
* [Criptografia de dados no Azure Data Lake Storage Gen1](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-encryption)
...
* [Entender as recomendações da central de segurança do Azure](https://docs.microsoft.com/azure/security-center/recommendations-reference)
...
* [Gerenciar recursos do Armazenamento de Dados do Azure Data Lake Gen1 usando o Storage Explorer](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-in-storage-explorer)

* [Copiar dados de blobs de armazenamento do Azure para Azure Data Lake Storage Gen1](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-copy-data-azure-storage-blob)
...
* [Protegendo dados armazenados no Azure Data Lake Storage Gen1](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-secure-data)
