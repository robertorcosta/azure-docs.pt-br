...
1. Depois que o **Marketplace** for aberto, na caixa de pesquisa, digite `logic apps b2b`e selecione **aplicativos lógicos B2B**.
...
| **ID de rastreamento** | A ID que correlaciona todos os gatilhos e todas as ações em um aplicativo lógico |
| **Tipo de MSG** | O tipo da mensagem EDIFACT |
