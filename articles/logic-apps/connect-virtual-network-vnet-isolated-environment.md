...
1. Forneça esses detalhes para o seu ambiente e escolha **revisar + criar**, por exemplo:
   ...
   |----------|----------|-------|-------------|
   | **Assinatura** | Sim | <*Azure-nome da assinatura* > | A assinatura do Azure a ser usada para seu ambiente |
   ...
   | **Localidade** | Sim | <*Azure-datacenter-região* > | A região do datacenter do Azure onde implantar seu ambiente |
