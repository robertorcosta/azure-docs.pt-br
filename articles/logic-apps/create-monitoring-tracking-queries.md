...
1. Inicie de uma consulta vazia ou de quaisquer consultas existentes disponíveis.
   ...
   * Para verificar se alguma consulta existente está disponível, na barra de ferramentas de consulta, selecione uma consulta de **exemplos** > **histórico**, que mostra consultas de execuções de consulta anteriores ou selecione **Gerenciador de consultas**, que mostra consultas predefinidas.
   ...
   * Para iniciar de uma consulta vazia, no editor de consultas, comece a digitar a [linguagem de consulta Kusto](../azure-monitor/log-query/query-language.md) para sua consulta.
