...
| SCHEMA |Selecione o esquema carregado anteriormente que você deseja usar de sua Conta de Integração associada. |
...
| SCHEMA |Selecione o esquema a ser usado. Esquema estão localizados na sua conta de integração. Para acessar seus esquemas, vincule sua conta de integração ao seu aplicativo lógico. |
...
| Aplicar os segmentos UNG (Cabeçalho de Grupo de Função) |Marque essa caixa de seleção para criar segmentos de agrupamento no cabeçalho de grupo funcional nas mensagens enviadas ao parceiro convidado. Os seguintes valores são usados para criar os segmentos UNG: <p>Para **UNG1**, insira um valor alfanumérico com um mínimo de um caractere e um máximo de seis caracteres. <p>Para **UNG2.1**, insira um valor alfanumérico com um mínimo de um caractere e um máximo de 35 caracteres. <p>Para **UNG2.2**, digite um valor alfanumérico, com um máximo de quatro caracteres. <p>Para **UNG3.1**, insira um valor alfanumérico com um mínimo de um caractere e um máximo de 35 caracteres. <p>Para **UNG3.2**, digite um valor alfanumérico, com um máximo de quatro caracteres. <p>Para **UNG6**, insira um valor alfanumérico com um mínimo de um caractere e um máximo de três caracteres. <p>Para **UNG7.1**, insira um valor alfanumérico com um mínimo de um caractere e um máximo de três caracteres. <p>Para **UNG7.2**, insira um valor alfanumérico com um mínimo de um caractere e um máximo de três caracteres. <p>Para **UNG7.3**, insira um valor alfanumérico com um mínimo de um caractere e um máximo de seis caracteres. <p>Para **UNG8**, insira um valor alfanumérico com um mínimo de um caractere e um máximo de 14 caracteres. |
...
Para obter mais detalhes técnicos sobre este conector, como ações e limites descritos pelo arquivo Swagger do conector, consulte a [página de referência do conector](https://docs.microsoft.com/connectors/edifact/).
