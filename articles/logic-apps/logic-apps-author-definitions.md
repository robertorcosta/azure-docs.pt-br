...
Para criar, gerenciar e implantar aplicativos lógicos, você pode usar [Azure PowerShell](/powershell/module/az.logicapp), [CLI do Azure](../azure-resource-manager/templates/deploy-cli.md), ou [APIs REST de Aplicativo Lógico do Azure](/rest/api/logic/).
