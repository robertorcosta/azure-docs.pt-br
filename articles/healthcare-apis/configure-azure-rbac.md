...
:::image type="content" source="media/rbac/add-azure-rbac-role-assignment.png" alt-text="Adicionar atribuição de função RBAC do Azure":::
...
Neste artigo, você aprendeu a atribuir funções de RBAC do Azure para o plano de dados FHIR. Em seguida, saiba mais sobre as configurações adicionais para a API do Azure para FHIR:
