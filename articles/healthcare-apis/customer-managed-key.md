...
- [Configurar a sua instância do AKV](../cosmos-db/how-to-setup-cmk.md#configure-your-azure-key-vault-instance)
-  [Adicionar uma política de acesso à sua instância do AKV](../cosmos-db/how-to-setup-cmk.md#add-an-access-policy-to-your-azure-key-vault-instance)
- [Gerar uma chave no AKV](../cosmos-db/how-to-setup-cmk.md#generate-a-key-in-azure-key-vault)
