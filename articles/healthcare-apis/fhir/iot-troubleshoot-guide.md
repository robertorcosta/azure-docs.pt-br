...
|Estágio de fluxo de dados|Descrição|
|---------------|-----------|
...
|Unknown|O tipo de operação é desconhecido quando ocorreu um erro|
...
|Nome do erro|Descrição|Tipo (s) de erro|Severidade do erro|Estágio (s) de fluxo de dados|
|----------|-----------|-------------|--------------|------------------|
