...
> [!NOTE]
> - O recurso de **registro de esquema** está atualmente em **Visualização** e está disponível somente nas camadas **padrão** e **dedicada** , não na camada **básica** .
