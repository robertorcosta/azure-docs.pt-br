...
Este artigo forneceu uma introdução aos Hubs de Eventos para Kafka. Para saber mais, consulte [o guia de desenvolvedores Apache Kafka para o Azure Event Hubs](apache-kafka-developer-guide.md).
