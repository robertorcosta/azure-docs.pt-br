...
>
> Aqui estão alguns dos serviços que não podem acessar os recursos de hubs de eventos quando a filtragem de IP está habilitada. Observe que a lista **não** é exaustiva.
>
