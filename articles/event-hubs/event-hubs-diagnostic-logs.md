...
* **[Logs de atividade](../azure-monitor/platform/platform-logs-overview.md)** : esses logs contém informações sobre as operações executadas em um trabalho. Os logs estão sempre habilitados.
