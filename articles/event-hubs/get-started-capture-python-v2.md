...
> [!IMPORTANT]
> Este início rápido usa a versão 5 do SDK do Python dos Hubs de Eventos do Azure. Para obter um início rápido que usa a versão 1 do SDK do Python, confira [este artigo](event-hubs-capture-python.md). 
