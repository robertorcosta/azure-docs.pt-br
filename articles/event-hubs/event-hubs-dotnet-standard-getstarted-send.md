...
> [!WARNING]
> Este quickstart usa o antigo pacote **Microsoft.Azure.EventHubs.** Para obter um início rápido que use a biblioteca **Azure.Messaging.EventHubs** mais recente, consulte [Enviar e receber eventos usando a biblioteca Azure.Messaging.EventHubs](get-started-dotnet-standard-send-v2.md). Para mover seu aplicativo de usar a biblioteca antiga para uma nova, consulte o [Guia para migrar do Microsoft.Azure.EventHubs para o Azure.Messaging.EventHubs](https://github.com/Azure/azure-sdk-for-net/blob/master/sdk/eventhub/Azure.Messaging.EventHubs/MigrationGuide.md).
