...
O último cenário requer a replicação de eventos já replicados novamente. A técnica é demonstrada e explicada no exemplo de [EventHubToEventHubMerge](https://github.com/Azure-Samples/azure-messaging-replication-dotnet/main/code/EventHubToEventHubMerge) .
