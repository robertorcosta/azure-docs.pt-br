...
description: A linha de base de segurança do banco de dados do Azure para MySQL fornece diretrizes de procedimento e recursos para implementar as recomendações de segurança especificadas no benchmark de segurança do Azure.
author: msmbaldwin
ms.service: mysql
ms.topic: conceptual
ms.date: 09/02/2020
...
- [Como configurar o link privado para o banco de dados do Azure para MySQL](howto-configure-privatelink-portal.md)

- [Como criar e gerenciar pontos de extremidade de serviço VNet e regras de VNet no banco de dados do Azure para MySQL](/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview)

- [Como configurar as regras de firewall do banco de dados do Azure para MySQL](howto-manage-firewall-using-portal.md)
...
- [Como configurar a proteção avançada contra ameaças para o banco de dados do Azure para MySQL](howto-database-threat-protection-portal.md)
...
- [Entender o uso da marca de serviço para o banco de dados do Azure para MySQL](concepts-data-access-and-security-vnet.md#terminology-and-description)
...
- [Entender os logs do servidor para o banco de dados do Azure para MySQL](concepts-monitoring.md#server-logs)
...
- [Como configurar e acessar logs de consulta lentos para o banco de dados do Azure para MySQL](howto-configure-server-logs-in-portal.md)

- [Como configurar e acessar os logs de auditoria do banco de dados do Azure para MySQL](howto-configure-audit-logs-portal.md)
...
- [Para obter mais informações sobre o Log Analytics](../azure-monitor/log-query/get-started-portal.md)
...
- [Como habilitar a proteção avançada contra ameaças para o banco de dados do Azure para MySQL (versão prévia)](howto-database-threat-protection-portal.md)
...
- [Entender as operações do provedor de recursos do banco de dados do Azure para MySQL](../role-based-access-control/resource-provider-operations.md#microsoftdbformysql)

- [Entender o gerenciamento de acesso do banco de dados do Azure para MySQL](concepts-security.md#access-management)
...
- [Como criar contas adicionais para o banco de dados do Azure para MySQL](howto-create-users.md)
...
- [Entenda como criar usuários administradores no banco de dados do Azure para MySQL](howto-create-users.md)
...
- [Usar Azure Active Directory para autenticação com o banco de dados do Azure para MySQL](howto-configure-sign-in-azure-ad-authentication.md)

- [Entender a API REST do banco de dados do Azure para MySQL](/rest/api/mysql/)
...
- [Como configurar e acessar logs de consulta lentos para o banco de dados do Azure para MySQL](/Azure/mysql/howto-configure-server-logs-in-portal)

- [Como configurar e acessar os logs de auditoria do banco de dados do Azure para MySQL](/Azure/mysql/howto-configure-audit-logs-portal)
...
- [Como configurar o link privado para o banco de dados do Azure para MySQL](concepts-data-access-security-private-link.md)

- [Como criar e gerenciar pontos de extremidade de serviço VNet e regras de VNet no banco de dados do Azure para MySQL](/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview)

- [Como configurar as regras de firewall do banco de dados do Azure para MySQL](concepts-firewall-rules.md)
...
- [Como mitigar o data vazamento para o banco de dados do Azure para MySQL](concepts-data-access-security-private-link.md#data-exfiltration-prevention)
...
- [Como configurar a criptografia em trânsito para o banco de dados do Azure para MySQL](concepts-ssl-connection-security.md)
...
- [Como configurar o acesso do usuário com o SQL para o banco de dados do Azure para MySQL](howto-create-users.md)
...
- [Entender a criptografia em repouso para o banco de dados do Azure para MySQL](concepts-security.md)

- [Como configurar chaves gerenciadas pelo cliente para o banco de dados do Azure para MySQL](concepts-data-encryption-mysql.md)
...
**Orientação**: siga as recomendações da central de segurança do Azure para proteger seu banco de dados do Azure para MySQL e recursos relacionados.

A Microsoft executa o gerenciamento de vulnerabilidades nos sistemas subjacentes que dão suporte ao banco de dados do Azure para MySQL.
...
- [Entender os backups do banco de dados do Azure para MySQL](concepts-backup.md)

- [Entender a configuração inicial do banco de dados do Azure para MySQL](tutorial-design-database-using-portal.md)
...
- [Entender os backups do banco de dados do Azure para MySQL](howto-restore-server-portal.md) 
...
- [Entender o backup e a restauração no banco de dados do Azure para MySQL](concepts-backup.md)
