...
- [Como criar e gerenciar pontos de extremidade de serviço VNet e regras de VNet no banco de dados do Azure para MySQL](../azure-sql/database/vnet-service-endpoint-rule-overview.md)
...
- [Para obter mais informações sobre o Log Analytics](../azure-monitor/log-query/log-analytics-tutorial.md)
