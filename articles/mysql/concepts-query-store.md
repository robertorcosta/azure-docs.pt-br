...
- Estatísticas de espera usa exemplo para capturar uma fração de eventos. A frequência pode ser modificada usando o `query_store_wait_sampling_frequency`parâmetro.
