...
description: Este guia de início rápido fornece um exemplo do Azure PowerShell de como gerar uma cadeia de conexão para se conectar ao Banco de Dados do Azure para MySQL.
author: ajlam
ms.author: andrela
ms.service: mysql
...
ms.locfileid: "87544909"
---
# <a name="azure-database-for-mysql-generate-a-connection-string-with-powershell"></a>Banco de Dados do Azure para MySQL: Gerar uma cadeia de conexão com o PowerShell
