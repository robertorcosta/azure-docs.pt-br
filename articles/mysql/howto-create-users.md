...
## <a name="to-create-additional-admin-users-in-azure-database-for-mysql"></a>Para criar usuários administrativos adicionais no banco de dados do Azure para MySQL
