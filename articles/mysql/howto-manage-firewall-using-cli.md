---
title: Gerenciar regras de firewall - Azure CLI - Banco de dados Azure para MySQL
...
As regras de firewall em nível de servidor podem ser usadas para gerenciar o acesso a um banco de dados Do Zure para MySQL Server a partir de um endereço IP específico ou de uma série de endereços IP. Usando comandos convenientes da CLI do Azure, você pode criar, atualizar, excluir, listar e mostrar as regras de firewall para gerenciar o servidor. Para obter uma visão geral do Banco de Dados Azure para firewalls MySQL, consulte [O Banco de Dados Do Azure para as regras de firewall do servidor MySQL](./concepts-firewall-rules.md).
...
- **lista**: Liste as regras de firewall do servidor Azure MySQL.
...
## <a name="sign-in-to-azure-and-list-your-azure-database-for-mysql-servers"></a>Faça login no Azure e liste seu banco de dados Azure para servidores MySQL
