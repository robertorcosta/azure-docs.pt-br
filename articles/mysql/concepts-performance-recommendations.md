---
title: Recomendações de desempenho - Banco de dados Azure para MySQL
description: Este artigo descreve o recurso de recomendação de desempenho no Banco de Dados Azure para MySQL
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
Abra **as recomendações** de desempenho da seção Desempenho **Inteligente** da barra de menus na página do portal Azure para o servidor MySQL.
