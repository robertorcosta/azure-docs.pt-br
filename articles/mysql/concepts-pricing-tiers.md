...
| Atributo de armazenamento   | Básico | Propósito geral | Otimizado para memória |
|:---|:----------|:--------------------|:---------------------|
