...
Para obter um guia de migração detalhado e abrangente, consulte o [Guia de migração do MySQL para o banco de dados do Azure](https://github.com/Azure/azure-mysql/tree/master/MigrationGuide). 
