---
title: Link privado para o método de instalação do portal do banco de dados do Azure para MySQL (versão prévia)
...
ms.locfileid: "75978619"
---
# <a name="create-and-manage-private-link-for-azure-database-for-mysql-preview-using-portal"></a>Criar e gerenciar um link privado para o banco de dados do Azure para MySQL (versão prévia) usando o portal
...
1. No lado superior esquerdo da tela na portal do Azure, selecione **criar um recurso** > **bancos** de **dados > banco de dados do Azure para MySQL**.
...
1. No **banco de dados do Azure para MySQL** , forneça estas informações:
    ...
    | Local | Selecione uma região do Azure em que você deseja que o servidor MySQL resida. |
...
8. Em **Criar um ponto de extremidade privado (versão prévia) – configuração**, insira ou selecione estas informações:
    ...
    |Zona DNS privado |Selecione *(novo) privatelink. Database. Azure. com* |
    |||
...
2. Insira  `nslookup  myServer.mysql.privatelink.database.azure.com`. 
