...
É possível fornecer argumentos adicionais para esse comando a fim de personalizá-lo. Confira todos os argumentos do comando [az mysql flexible-server create](/cli/azure/mysql/flexible-server?view=azure-cli-latest#az_mysql_flexible_server_create).
