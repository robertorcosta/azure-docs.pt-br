...
Instalar o PHP em seu próprio servidor ou crie um [aplicativo Web](https://docs.microsoft.com/azure/app-service/overview) do Azure que inclua o PHP.  Consulte [Criar e gerenciar regras de firewall](./how-to-manage-firewall-portal.md) para saber como criar regras de firewall.
