...
![Captura de tela das opções de configuração das configurações de diagnóstico](./media/howto-configure-server-logs-in-portal/configure-diagnostic-setting.png)
