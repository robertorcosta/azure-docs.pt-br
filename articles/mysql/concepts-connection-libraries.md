...
| C | Windows, Linux, Mac OS X | [Guia do desenvolvedor do MySQL Connector/C](https://dev.mysql.com/doc/refman/8.0/en/c-api.html) | [Baixar](https://dev.mysql.com/downloads/connector/c/)
