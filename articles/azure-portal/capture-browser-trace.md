...
1. Pressione F12 ou selecione ![captura de tela do ícone de configurações do navegador](media/capture-browser-trace/chromium-icon-settings.png) > **mais ferramentas** > **ferramentas de desenvolvedor**.
