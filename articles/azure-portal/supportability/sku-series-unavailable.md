...
1. Para **Selecionar tipo de problema**, escolha uma opção, por exemplo, **não é possível acessar minha assinatura ou recurso** > **meu problema não está listado acima**. Selecione **Salvar**.
