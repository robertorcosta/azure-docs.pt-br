...
[**mv-expande**](https://docs.microsoft.com/azure/kusto/query/mvexpandoperator): Expande coleções de vários valores a partir de uma coluna de digitação dinâmica para que cada valor na coleção obtenha uma linha separada. Todas as outras colunas em uma linha expandida são duplicadas. É o oposto de makelist.

A consulta a seguir gera dados de amostra criando um conjunto e, em seguida, usando-os para demonstrar os recursos **de expansão de mv.**
...
O conjunto de linhas também é considerado como serializado se for resultado de: **operadores de classificação,** **topo**ou **intervalo,** seguidos opcionalmente por **project**, **project-away,** **extend**, **onde,** **parse,** **mv-expand,** ou **levar** operadores.
