...
Examine [as práticas recomendadas para segurança de cluster AKs][best-practices-security] Leia mais sobre [criptografia baseada em host](/azure/virtual-machines/linux/disk-encryption#host-based-encryption).
