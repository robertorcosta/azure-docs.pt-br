...
Leia a [seção práticas de triagem](https://docs.microsoft.com/azure/architecture/operator-guides/aks/aks-triage-practices) do guia de operações do AKS Day-2.
