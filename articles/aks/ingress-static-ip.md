...
Desinstale as versões com `helm uninstall` o comando. O exemplo a seguir desinstala a implantação de entrada do NGINX e as implantações do Gerenciador de certificados.
