...
O Gerenciador de Tráfego usa DNS (camada 3) para moldar o tráfego. [O Azure Front Door Service](https://docs.microsoft.com/azure/frontdoor/front-door-overview) fornece uma opção de roteamento HTTP/HTTPS (camada 7). Os recursos adicionais do Azure Front Door Service incluem terminação SSL, domínio personalizado, firewall de aplicativos web, regravação de URL e afinidade de sessão. Examine as necessidades de seu tráfego de aplicativo para entender qual é a solução mais adequada.
...
* [Recuperação do site do Azure](https://azure.microsoft.com/blog/asr-managed-disks-between-azure-regions/)
