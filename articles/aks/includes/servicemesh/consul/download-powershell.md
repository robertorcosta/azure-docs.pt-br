...
---
Em um shell baseado no PowerShell no Windows, use `Invoke-WebRequest` para baixar a versão do gráfico Consul Helm e, em seguida, extrair com `Expand-Archive` como a seguir:
