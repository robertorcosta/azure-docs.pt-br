...
Em um shell baseado no PowerShell no Windows, use `Invoke-WebRequest` para baixar a versão do İSTİO e, em `Expand-Archive` seguida, extrair com da seguinte maneira:
